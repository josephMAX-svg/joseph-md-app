# PENDIENTES DE JOSEPH · régimen v5.15

**Generado:** 08-sep-2026 · **re-fechado a v5.10 el 12-sep** · **consolidado tras la SEGUNDA CAPA el dom 13-sep-2026** · **re-fechado a v5.11 el lun 14-sep** · **re-fechado a v5.12 el mar 15-sep** · **re-fechado a v5.13 el mié 16-sep** · **re-fechado a v5.14 el sáb 19-sep** · **re-fechado a v5.15 el mar 22-sep** · **D1 = MIÉRCOLES 23-SEP-2026 · EXAMEN STEP 1 TARGET LUN 8-FEB-2027**

> ⚠ **El régimen vigente es v5.15 desde el 23-sep-2026.** Es el **decimocuarto corrimiento** (el lun 21 y el mar 22-sep
> tampoco se estudiaron). Instrucción literal de Joseph en este: *"todo comienza a partir del día 23, no modifiques los temas
> solo corre los días, si es necesario ampliar días los amplías — y aumenta los días para no perder NBME — no hay necesidad
> de una reestructuración, solo correr días"*. De ahí las **tres reglas del corrimiento RÍGIDO**:
> 1. **Ni un tema ni un subtema se toca** — no se fusiona ni se recorta nada. Verificado con el multiset (system|sub) del plan
>    Step 1 contra la versión anterior: **dif 0** (95 días, 5560Q, 73/73 filas de contenido, 0 fines de semana).
> 2. **Los 12 hitos NBME/UWSA dejan de estar clavados por fecha**: corren con el plan y conservan su **D# exacto**
>    (D1 · 10 · 25 · 40 · 55 · 65 · 72 · 77 · 82 · 83 · 85 · 87), así **ningún NBME vuelve a perder días de preparación por delante** —
>    que es justo lo que pasaba en cada corrimiento anterior. Efecto visible: **los hitos ya no caen en viernes** (casi todos pasan a martes).
> 3. **Donde un plan tenía el final clavado, se AMPLÍAN días** en vez de perder sesiones: ENCAPS 92 días hasta el **mar 2-feb**
>    (antes el cierre fijo del vie 29-ene costaba sesiones) y MIR mantenimiento 57 días hasta el **vie 2-abr**.
>
> **CONSECUENCIA: el plan Step 1 de 95 días termina el VIE 5-FEB-2027 (D95 = último día del plan: sesión mínima AM, `USMLE_TAPER.d95`/`dMenos1`)
> → examen target LUN 8-FEB-2027** (`DAILY_META.examenTarget`); el **jue 4-feb (D94)** es la última sesión de banco, el **sáb 6 y el dom 7-feb**
> quedan libres y el **D-1 real es el domingo 7** (solo ritual de test-day: permiso, IDs, Ziplocs, ruta, cama temprano; cero estudio).
> **Tienes que agendar/reprogramar el Prometric al lun 8-feb y confirmar que tu eligibility period lo cubre** (si no: extenderlo,
> o decidir recortar temario — ver ⚪ fila 0 y 🔴). Franjas y metas **no se movieron**.
> **Los 12 hitos v5.15:** UWSA1 **mié 23-sep (D1, 09:00-13:00)** · NBME 25 **mar 6-oct** · 26 **mar 27-oct** · 27 **mar 17-nov** ·
> 28 **mar 8-dic** · 29 **mar 22-dic** · 30 **mar 5-ene** · UWSA2 **mar 12-ene** · NBME 31 GO/NO-GO **mar 19-ene** · 32 **mié 20-ene** ·
> 33 **vie 22-ene** · Free 120 **mar 26-ene**. Primer día de CONTENIDO = **jue 24-sep (D2)**; Cardio arranca el **mié 30-sep (D6)**.
> El contenido cierra el **lun 18-ene (D81, Bioquímica)** y el NBME 31 GO/NO-GO se rinde el día siguiente (mar 19-ene = D82) sin días de
> banco de consolidación delante; los 2 random timed 2×40Q de la Fase B siguen en D84 (jue 21-ene) y D86 (lun 25-ene) — ver ⚪ fila 0-bis.
> **⚠ Desde aquí cada día no estudiado mueve el examen un día hábil más (o exige recortar).**
> **Regla al leer este doc: el D# es ahora lo estable; la FECHA es lo que se mueve** — con el corrimiento rígido los D# no cambian,
> así que verifica la fecha contra el `.ts` del plan antes de actuar. Todas las fechas de abajo fueron releídas de los `.ts` el 22-sep-2026 (v5.15).
...
## 🔴 ANTES DEL D1 (hoy mar 22-sep / mié 23-sep temprano)

Sin esto el plan arranca ciego, con el contenido equivocado o con la app vieja en producción el primer día.

- [ ] **🔴 AGENDAR EL STEP 1 EN PROMETRIC PARA EL LUN 8-FEB-2027 (o reprogramar la cita si ya existía en la ventana 25-29 ene o en cualquiera de las fechas target anteriores: lun 1-feb, mar 2-feb, jue 4-feb) y CONFIRMAR QUE EL ELIGIBILITY PERIOD CUBRE EL 8-FEB.** El plan v5.15 termina el vie 5-feb (D95 = último día del plan); el jue 4-feb (D94) es la última sesión de banco y el sáb 6 / dom 7-feb quedan libres antes del examen. Si el eligibility period no llega al 8-feb: pedir la extensión a ECFMG (con costo) o decidir recortar temario (⚪ fila 0). Anotar aquí la fecha/hora confirmada y el centro. **Bloqueante: sin cita no hay examen.** *(USMLE — Prometric/ECFMG)*
- [x] **Deploy a Vercel de la v5.15 — VERIFICADO el mar 22-sep (tarde)**: commits `5193b5b` (corrimiento) + `ecd1f24` (últimas cadenas visibles) → push → bundle `index-a2484a35…` (6.588.313 bytes) servido en https://joseph-md-app.vercel.app con `USMLE Step 1 v5.15`, `inicio:'2026-09-23'` ×8, `examenTarget:'2027-02-08'`, `descansoD1:'2027-02-05'` y los marcadores de la sistematización de v5.14 intactos (`dress_rehearsal` ×2, `poolConFallback` ×3). **0 ocurrencias de `2026-09-21`** y una sola de «v5.14», que es una referencia histórica deliberada. Comprobado por contenido del bundle, no por hash.
      **Mié 23-sep 09:00 al abrir la web**: EEUU debe mostrar Día 1/95 = UWSA1 mié 23-09, Readiness examen 2027-02-08 y ENCAPS D1/92 (origen `study_metrics`); el Home debe pasar de «FASE 6 · transición» a «FASE 7 · STEP 1 PRINCIPAL». *(sistema)*
...
- [ ] **Crear los 10 sub-decks `APEX::DERMA::A…X`** en Anki escritorio (o `createDeck` por AnkiConnect) y verificar con
      ...
      importar. *(Derma — antes de la sesión d1 = **mié 23-sep** (v5.15: el mié 23-sep es su d1 y coincide con el D1 del régimen; el jue 24-sep es día Research)*
...
- [ ] **Protocolo test-day para el UWSA1 (MIÉ 23-SEP 09:00-13:00)** — 3 bolsas Ziploc BREAK 1/2/3 (huevo duro,
      ...
      > Contexto v5.15: **ahora los 12 hitos corren con el plan** (ya no hay hitos clavados por fecha), así que el UWSA1 sigue siendo el D1 pero ya no es el único que se mueve
      > (vie 11 → lun 14 → mar 15 → mié 16 → jue 17 → lun 21 → **mié 23-sep**): se rinde el **mié 23-sep = D1**, SIN un solo
      > día de contenido encima. Es la línea base pura que prescribe Palmerton: no lo leas como un mal resultado.
- [ ] **Confirmar el re-orden Research v5.10b (mismo orden; v5.15 corre +2 hábiles más — releído del `.ts` el 22-sep)**: el ciclo 1 arranca el **jue 24-sep** (R0); M1 (Dr. Ciro) **mié 30-sep (d3)** ·
      C-2 **jue 8-oct (d6)** · T-1 (ética/CEI) **lun 12-oct (d7)** · M3 (Finlay) **mié 14-oct (d8)** · R9 (¿ya existe la SR?) **vie
      16-oct (d9)** antes de C-6 (**mié 28-oct, d13**) y R6 (**vie 30-oct, d14**) · CR-1 **mar 3-nov (d15)** y CR-2 **jue 5-nov (d16)** · T-2 (STROBE)
      **vie 13-nov (d19)** · R7 **jue 19-nov (d21)** · R2 **mié 23-dic (d33)** · CR-9 (SUBMIT case report #1) **lun 1-feb (d35)**. Si no lo aceptas, es 1 línea en `gen_research_plan.js` + regenerar + `gen_research_calendar.js --check`.
      *(Research)*
- [ ] **⚪ v5.15 · DOS FECHAS LÍMITE EXTERNAS de Research quedaron REBASADAS por el corrimiento** (lo detectó el re-fechado de overlays del 22-sep; es consecuencia de los días no estudiados, no un fallo del pipeline):
      **T-1** cae el **lun 12-oct** pero su texto dice *"solicitud CEI expedita ≤ 30-sep"*, y **C-6** cae el **mié 28-oct** pero su texto dice *"FECHA LÍMITE EXTERNA ≤ 15-oct-2026"* (ventana de letters del journal diana).
...
- [ ] **Retomar el quick-log de VITALS a las 07:00** (20 s: horas de sueño + agua) y, desde el mié 23-sep, **registrar
...
## 🟠 ESTA SEMANA (23-25 sep · semana corta: el D1 cae en miércoles)

### Mié 23-sep (D1) — rituales que estrenan instrumento
...
- [ ] **04:55** — `node D:/joseph-md-app/DATA/_scripts/journal_hoy.js --abrir` (el enlace 📓 journal de la app abre
      ...
      retrasa. *(SYNAPSE)*
- [ ] **16:15** — resolver `BANCO_PROPIO/pretest_arranque_2026-09-23.html` (parte 1: 20Q = 5Q × II-3 · I-3 · V-2 · III-5; **19/20 reales con clave oficial**, 1 nuevo en II-3 — regenerado el 22-sep)
      y el **jue 24-sep (D2)** la parte 2 (`…_2026-09-24.html`: II-5 · I-4 · IV-1+IV-2 · II-4, **20/20 reales**). En cada uno «Generar JSON» →
      guardar → `node DATA/_scripts/gen_encaps_minisim.js --registrar <export.json> --append` (**no** la línea de 1
      renglón: dejaría la ronda como MIX sin línea base por crítico). Los `banco_2026-09-23` y `banco_2026-09-24` existen pero están marcados
      `_meta.sustituido_por` (el pre-test ocupa su contenido; el horario no cambia); las salidas de las fechas 21 y 22-sep ya no existen. **Semana 1 regenerada el 22-sep:**
      `eval_2026-09-23` (D1: 5Q de fallos previos, no hay día anterior) y `eval_2026-09-24` (5Q del código de ayer, II-3);
      el **vie 25-sep = primera mini-sim del ciclo** (`sim_n` 3, día 3) y al cerrar la semana hay que pre-generar la del 28-sep (`--semana 2026-09-28`).
      ⚠ **El pool I-3 queda a 0 tras `banco_2026-09-24`** y el de II-3 a 5Q: reponer sets nuevos antes de su siguiente instancia (ver `_inventario_banco_por_codigo.json`, regenerado el 22-sep). *(ENCAPS)*
...
- [ ] **18:25** — crear la **primera nota del diario USMLE** `01_USMLE/05_DIARY/2026-09-23.md` en el vault (Insertar
...
- [ ] **Vie 25-sep (D3, "setup Anki FSRS"; v5.15) — completar la configuración Palmerton §4.2 que la app aún no lista**
...
- [ ] **P0 de seguridad · `datos_tesis` (55 filas de MENORES, RLS OFF, anon key en repo con remoto).** Ejecutar UNA opción
      **antes del T-8 (jue 3-dic)** y anotarla en `etica.md` fila 8 — o ya en D1-D2 en vez de esperar al proyecto S6 del
      vibecoding (mié 28-oct → mar 3-nov, v5.15): **A (recomendada)** `ALTER TABLE public.datos_tesis ENABLE ROW LEVEL SECURITY;` (sin policies:
...
- [ ] **Anki telemetría con Anki abierto** — `node DATA/_scripts/anki_telemetria.js` una vez con sesión de AnkiWeb para
      validar el `sync` y el KPI `primeraReview`; el proyecto **S2 (mié 30-sep → mar 6-oct, v5.15)** crea la tarea programada
...
- [ ] **Mié 30-sep · M1 (Research d3; v5.15 — semana siguiente) — WhatsApp + reunión con el Dr. Ciro**: 3 coautorías, vía CEI de la tesis, versión
      del CADI usada, su ORCID; es también el arranque del case report (**regla escrita en MENTORES fila 6: si el jue
      22-oct (d11, ~3 semanas desde M1) no ha dado caso → mensaje único de `caso_candidatos.md` §2 al colega SPD**). *(Esta semana el único átomo Research es R0, jue 24-sep: abrir las 10 cuentas; R1 (PICO) cae el lun 28-sep.)* Los documentos de ética se reúnen
      desde este día (chip en M1). *(Research)*
- [ ] **Vie 25-sep · primera mini-sim del ciclo (ENCAPS · día 3 en v5.15, `sim_n` 3 en el SQL)** — cargar la nota /25 **UNA sola vez** (cierre tipo `mini_sim` en el formulario
      → espejo automático en `study_sim_scores`, o en ▲ SIM; si cargas ambas con valores distintos gana la última).
      Las dos partes del pre-test (mié 23 + jue 24) ya estarán hechas: los 8 críticos tienen línea base antes de la primera mini-sim.
      A las **17:00**: `node DATA/_scripts/gen_encaps_semana.js --sql` → primer override (semana del 28-sep) → `node DATA/_scripts/gen_encaps_mantenimiento_2027.js 2026-09-23 --override DATA/ENCAPS/TRACKING_ERRORES/SEMANAS/override_2026-09-28.json --bk study_schedule_bk_0925`
      → revisar SQL (DELETE solo MANTENIMIENTO) → `execute_sql` → pegar la
      verificación que imprime (**75 banqueo1h + 17 mini_sim** = 92 filas, v5.15). *(ENCAPS)*
- [ ] **Verificación EN VIVO en tu Chrome real** (el MCP chrome-devtools no conectó el 13-sep; nadie lo probó en
      ...
      - **AURUM** (`expo start` → AurumHub): «✎ registrar semana» abre el editor y el semáforo cambia; en **D15 (mar 13-oct, v5.15)**
        aparece la rúbrica y el score se guarda en `jmd-aurum-rubrica`; en **D40 (mar 17-nov)** la tarjeta VARIANTE LIVIANO.
- [x] ~~**Calendar — una sesión de 20' con el MCP GCal (hallazgos #1-#4 del crítico + gap MIR 8)**~~ **RESUELTO el 19-sep y RE-FECHADO a v5.15 el 22-sep**: overlays 🏁 D94
      `neboplchsaua4snj39nrl480nc` ahora **jue 4-feb** y 🛌 D95 `n90bdqhohadu1eqbctv148dn28` ahora **vie 5-feb**; overlay del examen `oinh139dsnbuma9r3kfu56dhkc` → **lun 8-feb**;
      **los 12 overlays 🎯 de hito cambiaron de fecha por primera vez** (hasta v5.14 solo se movía el UWSA1) y los 12 🔬 Research se re-fecharon con `gen_research_calendar.js` (`--check` = 0);
      las 5 series de EXTENSIÓN USMLE siguen en lun 1 / mar 2 / mié 3-feb (ahora D91-D93) con descripción v5.15, la eval 18:00 y el pre-test 08:15 se **recrearon** para incluir el miércoles
      (`recurrenceData` no se puede actualizar) y se creó una **EXTENSIÓN ENCAPS** lun 1 + mar 2-feb (los 2 días que añade la ampliación del ciclo).
      **Solo quedan tus decisiones** (⚪ Calendar · 6 decisiones + los 4 títulos): GYM/BAILE de la víspera, ALUMUERZO, ALISTARSE martes, series secundarias el lun 8-feb. *(lo pedido, histórico:)* *(sistema)*
      ...
      > sáb/dom, 🧠 IA 04:15, misión 12:30 y PC sáb/dom **ya están en v5.10** (12-13 sep, verificadas con `get_event`); las horas no cambiaron en v5.11, v5.12, v5.13 ni v5.14; el 16-sep se re-fecharon los overlays de hito a v5.13 y el 19-sep a v5.14; **el 22-sep se re-fecharon a v5.15 los 12 hitos (por primera vez cambian TODOS), el examen (→ lun 8-feb 07:00-16:00), D94/D95 y los 12 🔬 Research** (verificado con `get_event` y con `gen_research_calendar.js --check` = 0); detalle en `DATA/ENCAPS/CALENDAR_SEGMENTOS_V5_6.md` §17.
- [x] ~~**Crear el evento recurrente `📋 REVISIÓN SEMANAL`**~~ **CREADO el 19-sep: `21fbiohc1i47r4lqmaa3eb76l4`** (sáb 07:15-07:35, `WEEKLY;UNTIL=20270207;BYDAY=SA`, S1 = sáb 26-sep → sáb 6-feb; medido con `get_event`). En v5.15 el UNTIL del sáb 6-feb sigue sirviendo: el plan cierra el vie 5-feb y el examen es el lun 8-feb, así que la última revisión útil es la del sáb 6-feb. *(pedido original: sáb 07:15-07:35 desde el sáb 26-sep, con el default documentado en `REVISION_SEMANAL.md`)*
...
- [ ] **EKER — revisar la frase 6** añadida el 12-sep («Soy un médico USMLE-ready: cada pregunta ciega es un dato, no un
      juicio.», vigente hasta el **lun 8-feb**, día del examen) y cambiarla si quieres otra; las 5 originales están intactas. *(rutina)*
...
- [x] ~~**Alinear `D:\agente_estudio\config\fases.json`**~~ **HECHO 19-sep (integrador LIVIANO/SYNAPSE/Derma): FASE_4 `is_current_phase = false`, FASE_7 `true` e `inicio = 2026-09-21`; copia previa en el scratchpad (`fases.json.bak_0919`); queda opcional el `git init` local.** ⚠ **v5.15: `FASE_7.inicio` sigue en `2026-09-21` y debería ser `2026-09-23`** — 1 línea en `D:\agente_estudio\config\fases.json`. *(texto original:)* sigue con `FASE_4_ENCAPS_DOMINANTE.is_current_phase = true` y
...
- [ ] **Los D# de LIVIANO vuelven a moverse en v5.15 (los 16 casos siguen en viernes, pero el 1.º pasa al vie 2-oct = D8: con D1 en miércoles el primer viernes del plan es el d3 y el generador coloca los casos cada 5 días desde el d8)**:
      casos **D8 · D13 · D18 · D23 · D28 · D33 · D38 · D43 · D48 · D53 · D58 · D63 · D75 · D80 · D85 · D90** (vie 2-oct … vie 29-ene) ·
      drills de cifras ancla **D36 (mié 11-nov) / D57 (jue 10-dic) / D74 (jue 7-ene) / D87 (mar 26-ene, repaso integral I)** · Síntesis M2 **D37 (jue 12-nov)** ·
      Acceso Perú **D39-D42 + D44 (lun 16 → lun 23-nov)** · trimestral I **D45 (mar 24-nov)** y II **D89 (jue 28-ene)** · capstone **D88 (mié 27-ene)** ·
      **⚠ caso 16 integral D90 (vie 29-ene) = DESPUÉS del capstone** — la inversión que v5.14 había resuelto reaparece (decisión ⚪ fila D).
      Docs y código del repo alineados el 22-sep (LIVIANO_ACADEMIA, LIVIANO_PROTOCOLO_CLINICO_v1, `empresaData.ts`, `livianoScore.ts`, `LivianoTodayPlan.tsx`, overlay del Calendar); queda solo cualquier nota EXTERNA tuya (Notability/Obsidian) que cite los D# viejos. **Con el corrimiento rígido el D# es lo estable; lo que se mueve es la fecha.** *(LIVIANO)*
...
Fechas releídas de `researchDailyPlan.ts` el 22-sep. v5.15: el ciclo 1 sigue teniendo **los mismos 42 átomos** (multiset de códigos vs v5.14 = **dif 0**: no se perdió ni se fusionó nada), pero **varios d# cambian y un átomo cruza la pausa**. Causa real (verificada en `gen_research_plan.js` §`fecharCiclo1`): la pausa por el Step 1 está clavada al **4→29-ene** y, al correr el D1 dos hábiles, **cabe un átomo menos antes de la pausa** → el mecanismo de *spill* del generador manda el último `recortable` al otro lado. En v5.14 el spill era X-7… en v5.15 **R3 (ver una SR de punta a punta + instalar R/metafor) pasa a DESPUÉS de la pausa (d37, vie 5-feb)** y todo lo que venía detrás sube un d#: el disparador del case report pasa de d11 a d10, CR-9 de d36 a **d35** y X-8 de d37 a **d36**. ⚠ **Decisión tuya:** (a) aceptar el spill — R3 es prep de SR-1 y el ciclo 2 empieza justo después, o (b) **mover la ventana de pausa** en `gen_research_plan.js` (`PAUSA`) para que cubra la Fase B/C real de v5.15 (4-ene → 5-feb), lo que devolvería R3 a su sitio pero **retrasaría CR-9 del lun 1-feb al mié 10-feb**. El plan corre hoy con (a). El ciclo 1 arranca el jue 24-sep y termina el vie 19-feb-2027; pausa
4-ene → 29-ene por el Step 1 (último átomo antes de la pausa: X-7 mar 29-dic, d34). ✅ v5.15: **CR-9 (SUBMIT del case report, lun 1-feb = d35) sigue lejos del examen y ahora tiene una semana entera por delante: es el D91 del Step 1 (primer día-Research tras la pausa)**; el mié 3-feb es X-8 (d36), cuyo texto dice «re-arranque post-Step 1» aunque el examen es el lun 8-feb — ver ⚪ B.

- [ ] **M2 · mar 6-oct (d5)** — registrarse en `https://risingscholars.net/accounts/register/` y publicar la solicitud de
      mentor (3 piezas: carta, tesis, case report; 3-4 h). **Regla escrita en MENTORES fila 2: si el mar 3-nov no hay
      mentor asignado → contratar editor profesional (US$200-400, RUTA §3.1)** (4 semanas desde M2; es la fecha que ya lleva el chip del átomo) que cubra las 3 piezas. Confirmar ambas reglas.
- [ ] **C-2 · jue 8-oct (d6) — elegir el artículo diana** en `CARTA_1/candidatos.md` §1 y **leer ESE DÍA con tu Chrome**
      ...
      §1 filas 1-2 (a más tardar en T-7, vie 27-nov). Actas y Anais ya están leídos en vivo (12-sep). Recomendación #4
      (JAAD `10.1016/j.jaad.2026.08.115`) si admiten "unpublished data"; si no, #1 (JCD `10.1111/jocd.71104`).
      > ⚠ **C-6 = SUBMIT de la carta el mié 28-oct (d13)**, contra un deadline interno del ≤15-oct: **13 días TARDE en v5.15** →
      > cerrar el paquete y hacer el SUBMIT el jue 15-oct fuera del átomo (C-5 formateo cae el lun 26-oct: habría que adelantarlo) o elegir en C-2 una fila
...
- [ ] **T-1 · lun 12-oct (d7) — ética de la tesis** (el interno ≤ 30-sep queda 12 días atrás: si importa, presentar la solicitud el mié 30-sep, que es día de M1): localizar el **nº y fecha del CEI** (`etica.md` 1.1) **o presentar
      ...
      exención, el envío T-8 (jue 3-dic) pasa a feb-2027.** Además: localizar los **PDF del modelo de consentimiento
...
- [ ] **M3 · mié 14-oct (d8)** — email a **Finlay**; antes verificar en la página del CADI de Cardiff el procedimiento de
      licencia (`technologytransfer@cardiff.ac.uk` según fragmento de búsqueda; la página no respondió) y su dirección.
- [ ] **R9 · vie 16-oct (d9)** — rellenar las columnas AMSTAR-2 y "hueco que deja" de las 5 SR/MA de `lines/L4-complicaciones.md`
      §6.1 (PMID 41249530 · 37178872 · 39214904 · 36574028 · 40406769, verificados) y marcar UNA salida (a/b/c) en §6.3 con
      fecha; **sin eso R6 (vie 30-oct, d14) no fija el PICO**.
- [ ] **Mar 20-oct (d10)** — disparador del plan B del case report: si el Dr. Ciro no dio caso (~3 semanas desde M1, mié 30-sep), enviar el mensaje único de
      `caso_candidatos.md` §2 al colega SPD (el chip del átomo ya lleva esa fecha exacta). **CR-1 (caso + consentimiento de publicación + senior author) = mar 3-nov (d15)**
      y **CR-2 = jue 5-nov (d16)**: en v5.15 **los DOS caen ya DESPUÉS del 31-oct** (en v5.14 CR-1 era aún el vie 30-oct, el último hábil antes del límite). El chip lo dice literal —
...
- [ ] **T-7 · vie 27-nov (d24)** — antes de depositar el CSV de-identificado en OSF/Zenodo, revisar
...
- [ ] **Free 120 en el Prometric de Lima (mar 26-ene-2027, D87)** — Palmerton §8.2: práctica en el mismo centro, 1-2
      semanas antes, registro con hasta 7 días de espera; costo **$155 internacional según el cuaderno (A VERIFICAR)**. Al
      agendar el examen para el lun 8-feb (🔴; el Free 120 sigue 13 días antes) verificar en `usmle.org` / `prometric.com` si Lima ofrece la práctica presencial y
      reservarla; si no existe, dejarlo escrito en README §3 para no volver a abrirlo. Hoy el overlay del Free 120 (D87 en v5.15) lo hace "en la
...
- [ ] **A VERIFICAR del cierre pre-examen**: repasos Anki 200-300/día en las últimas 2 semanas (cifra del studio guide, no
      de transcripción) — sirve para dimensionar D94/D95 (jue 4-feb = última sesión de banco y vie 5-feb = D-1 dentro del plan, `USMLE_TAPER`) y el fin de semana libre (sáb 6 / dom 7-feb, entre el D95 y el examen del lun 8: el dom 7 es el D-1 real, solo ritual de test-day).
...
- [ ] **Anclaje First Aid en d12 (vie 23-oct, SJS/TEN/DRESS) y d24 (jue 26-nov, melanoma) — fechas v5.15 de `dermaDailyPlan.ts` (d1 = mié 23-sep)**: la sección/página no consta
...
- [ ] **Verificar DeLorenzi 2017** (ASJ, PMID 28333326; acceso OUP/UF) — UI de hialuronidasa por "área" (~450 y ~900 UI
      ...
      VERIFICAR: **no fijar esas cifras en Anki**. Deadline: drill de oclusión **d19 = jue 12-nov** (v5.15).
...
*Átomos D37-D44 (**12 → 23-nov**, fechas releídas de `livianoStudyPlan.ts` el 22-sep, v5.15: D36 mié 11-nov = drill de cifras, D37 jue 12-nov = síntesis M2/protocolo y el módulo ACCESO PERÚ ocupa D39-D42 (lun 16 → jue 19-nov) + D44 (lun 23-nov); caso 7 el vie 13-nov = D38, caso 8 el vie 20-nov = D43 y caso 9 el vie 27-nov = D48). Cierran los 2 pendientes ROJOS desde junio ("Legalidad DIGEMID"
...
- [ ] **D37 · jue 12-nov — Rellenar `LIVIANO_PROTOCOLO_CLINICO_v1.md` §2**: criterio numérico de elegibilidad (Obesity
...
- [ ] **D39 · lun 16-nov — Registro sanitario DIGEMID**: portal público (URL sin verificar), captura fechada de semaglutida
      SC/oral y tirzepatida → columna `registro` de `LIVIANO_ACCESO_PERU` (`empresaData.ts`).
- [ ] **D40 · mar 17-nov — Condición de venta por molécula** → columna `condicion` + flujo receta → farmacia → paciente.
- [ ] **D41 · mié 18-nov — 2 cotizaciones escritas y fechadas** (cadena + independiente) → `precioFarmacia`; recalcular
      el "medicamento 3 m = S/ 3,600" del value stack.
- [ ] **D42 · jue 19-nov — Dictamen de legalidad del magistral** (QF + abogado de salud: **nombres a definir**) +
      cotización Sterilelabs con certificado de análisis por lote → `costoLiviano`, KPI COGS, estado "VERIFICADO".
- [ ] **D44 · lun 23-nov — Tiempo fuera de refrigeración** por producto (ficha técnica) → guion de cadena de frío (v5.15: el caso 8 «post-infarto que solo quiere verse mejor» cae el vie 20-nov, D43, y el caso 9 «lo consigo más barato en una web» el vie 27-nov, D48).
...
- [ ] **🎯 DISPARADOR · Convocatoria SERUMS 2027-I → fecha real del examen ENCAPS.** Las dos fechas asumidas son
      **imposibles**: `study_metrics.extra.exam_date = dom 28-mar-2027` es **Domingo de Pascua** y el default viejo del
      ...
      (1) `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-09 <fecha>` (o `2027-02-10 <fecha>`; v5.15: el default es `--base 2026-09-23`, offset 92; el mantenimiento llega ampliado hasta el **mar 2-feb = día 92**, el vie 5-feb (día 95) es el **D95 = último día del plan Step 1** y el lun 8-feb (día 96) es el **examen** → propuesta D1 de la intensiva = **mar 9-feb (día 97, con el pre-test del 2026-II como primera sesión) o mié 10-feb (día 98)**; ver ⚪ A; pasar `--base` solo si el D1 del mantenimiento vuelve a moverse) →
      ...
      (`src/lib/dermaDailyPlan.ts`, YYYY-MM-DD) para que las sesiones Derma a ±3 hábiles pasen a taper 'encaps' (v5.15: si cae
      en la semana del 22-26 mar, los candidatos son d64-d66: peelings I-II y láser I; en la del 29-mar → 2-abr, d67-d68: láser II-III; d69 lun 5-abr = láser IV y d70 mié 7-abr = microneedling); hasta entonces la pestaña
      Cerebro muestra «hoy null · A VERIFICAR (13-sep)». *(ENCAPS/Derma)*
- [ ] **🎯 DISPARADOR · Resultado del UWSA1 (mié 23-sep).** Si sale **<40 %** → bajar **D2-D10 a 20 Q/día** (protocolo
      Jay; `qDia` en `gen_usmle_v5.js` + regenerar). Lectura por tramos (Palmerton §9.3, +5 %/mes hasta el 19-ene):
      **<40 %** → protocolo Jay · **40-48 %** → llega justo a 65-68 % · **≥48 %** → on-track. La app hoy dice "baseline:
      cualquier valor sirve" y no muestra los tramos (hallazgo #12): **el baseline del 23-sep, no el GO/NO-GO del 19-ene,
...
- [x] ~~**Antes del 1-feb-2027 · extender las series del Calendar con `UNTIL=20270130`**~~ **RESUELTO el 19-sep con 6 SERIES DE EXTENSIÓN D93-D95** (`create_event`, no `delete`: ANKI AM 05:00 `gfapfa25hm5d9s65n7oiu0jsms` · repaso 07:15 `vi7lrsm2blitpqistrt87i3sqk` · pre-test 08:15 `mlqvrm4m8bn38qfl37qddjgk5g` solo lun 1-feb · DEEP PRIME `39dm9gk3a58u3iqu9lk28noum0` · 30Q `u6alh9h3o43l2fu98gmvkvtk90` · eval 18:00 `r850pocdgcm8pi6a42cvv37v1k` MO,TU); las 9 GYM/BAILE ya llevan etiqueta v5.14 (3 ids nuevos); **ENCAPS 16:15 `papebi46etlo8glgfs5akd5mig` NO se extiende a propósito** (termina el 29-ene; la intensiva lleva serie propia cuando decidas su arranque, ⚪ A). **⚠ v5.15 (22-sep):** como el mantenimiento se AMPLIÓ hasta el **mar 2-feb**, sí se creó aparte una **EXTENSIÓN ENCAPS lun 1 + mar 2-feb** (los 2 días nuevos), y las series de extensión USMLE, que siguen en lun 1 / mar 2 / mié 3-feb, cubren ahora **D91-D93**: el **D94 (jue 4-feb)**, el **D95 (vie 5-feb)** y el **examen (lun 8-feb)** van por overlay — detalle en el 🟠 Calendar. *(histórico:)* ⚠ v5.14: el D93 es el lun 1-feb, el D95 el mié 3-feb y el examen el jue 4-feb, así que el `UNTIL` ya no cubre ni D93-D95, ni el examen, ni la intensiva: extender a `20270204` (o más) — son **7 series**, no 2
...
- [ ] **Antes del d19 (jue 12-nov) · importar `DATA/DERMATOLOGIA/ANKI_COLA/PLANTILLA_SESION.txt`** en Anki (notetype Basic);
      a partir de ahí copiar la plantilla por sesión (`SESION_dNN_<fecha>.txt`). *(Derma)*
- [ ] **Antes del d45 (mié 27-ene-2027) · decidir y comprar el dermatoscopio de bolsillo** (DermLite o Heine; modelo y
      precio A VERIFICAR en sus webs oficiales) para la fase práctica 2027. *(Derma)*
- [ ] **Lun 8-feb-2027 (= DÍA DEL EXAMEN Step 1 en v5.15) · sesión Derma OPCIONAL (d49, segunda pasada parcial III)**: decidir si la
      haces al volver del Prometric o la saltas (o el swap d43↔taper de ⚪ C); no se pierde contenido en ningún caso. El jue 4-feb (D94 del Step 1, última sesión de banco) es d48 (parcial II, 1 caso + FSRS); el vie 5-feb (D95, sesión mínima AM) no es día Derma (es Research: R3, d37). *(Derma)*
- [ ] **Desde el mié 10-feb-2027 (d50, v5.15) · confirmar en la app que 3 casos/sesión caben en los 45′** con los 10Q como
      variable de ajuste; si no, la alternativa documentada es 2 casos + alargar el ciclo 2 (d74-d103, lun 19-abr → jue 8-jul; sin
      fusionar nada). *(Derma)*
...
- [ ] **Lun 1-feb-2027 (última A-unit SYNAPSE, d132 · v5.15) · página oficial de la certificación CCA-F**: no aparece enlazada en
...
- [ ] **Post-D88 (mié 27-ene-2027, capstone; v5.15) · revisión por par del protocolo LIVIANO** por un médico con experiencia en
...
### USMLE · decisión del corrimiento v5.12 (15-sep), re-fechada en v5.13, v5.14 y **v5.15 (22-sep)** — el examen sigue fuera de la ventana

| # | Decisión | Hoy corre así |
|---|---|---|
| 0 | **El plan de 95 días desborda la ventana 25-29 ene: D95 = vie 5-feb-2027 = último día del plan → target LUN 8-FEB-2027.** Con D1 en miércoles el D94 (jue 4-feb) es la última sesión de banco, el D95 (vie 5-feb) es una sesión mínima por la mañana, y el **sáb 6 / dom 7-feb** quedan libres: el **D-1 real es el domingo 7** (solo ritual de test-day, cero estudio — Palmerton: D-1 sin banco). Opciones: **(a)** aceptar el lun 8-feb: agendar/reprogramar en Prometric y **confirmar que el eligibility period cubre el 8-feb** (si no, pedir extensión a ECFMG, con costo) — es lo que hace el plan (`DAILY_META.examenTarget = 2027-02-08`, `descansoD1 = 2027-02-05`); **(b)** rendir dentro de la ventana (≤ vie 29-ene) recortando el sprint final — va contra tu regla de no recortar; **(c)** estudiar sábados para recuperar días y volver a la ventana (también contra el régimen L-V). **Cada día más sin estudiar mueve el examen otro hábil (mar 9-feb, mié 10-feb…) y arrastra la intensiva ENCAPS, el pitch AURUM v5 y el taper Derma.** | (a) · examen lun 8-feb · D94 jue 4-feb (última sesión de banco) · D95 vie 5-feb (último día del plan) · finde 6-7 libre (`USMLE_TAPER.d94` / `d95` / `dMenos1` / `examen`) |
| 0-bis | **v5.14 lo abrió y v5.15 lo mantiene: el contenido cierra el lun 18-ene (D81, Bioquímica día doble) y el NBME 31 GO/NO-GO se rinde AL DÍA SIGUIENTE (mar 19-ene, D82) sin ningún día de banco de consolidación entre medias** (los 2 random timed 2×40Q de la Fase B van en D84 jue 21-ene y D86 lun 25-ene, DESPUÉS del NBME 31; la Fase B es D82-D86 con los 3 NBME dentro: 32 mié 20-ene, 33 vie 22-ene). **Lo que SÍ mejora en v5.15:** como los hitos ya no están clavados por fecha, el NBME 31 (y todos los demás) conservan su D#, así que **ya no se comen días de preparación en cada corrimiento**. Opciones: **(a)** aceptar — el NBME 31 mide el estado real al cierre de contenido y la regla del GO exige «2 NBME ≥68 %», así que el 32 y el 33 confirman o revierten; **(b)** trasladar la decisión formal GO/NO-GO al NBME 32 (mié 20-ene, D83) — tampoco gana días de banco; **(c)** cualquier día perdido desde hoy lo agrava (mueve el examen, no el hueco). | (a) · GO/NO-GO en el NBME 31 (`usmleStep1Daily.ts` D82, `HITOS_ONTRACK`) |

### Consecuencias del corrimiento v5.15 en los frentes secundarios (22-sep) — decisiones nuevas y resueltas

| # | Decisión | Hoy corre así |
|---|---|---|
| A | **ENCAPS · el mantenimiento se AMPLIÓ hasta el mar 2-feb (día 92) en vez de perder 2 sesiones**, así que la fase intensiva ya no pisa la recta final del Step 1: los días 3-7 feb quedan sin fila y el examen Step 1 es el lun 8-feb. **Propuesta: arrancar la intensiva el mar 9-feb o el mié 10-feb**, con el pre-test del examen 2026-II como primera sesión (`node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-09 <fecha-examen>` o `… 2027-02-10 …`). El ensayo en seco del 19-sep mostró que arrancar en lunes/martes da semana 1 completa (señales + calentamiento + pre-test del viernes). | SQL de la intensiva NO aplicado; default documentado en `FASE_INTENSIVA_2027-I.md`; nada que ejecutar hasta la convocatoria SERUMS |
| B | ~~Research · CR-9 (SUBMIT del case report #1) cae en la víspera del examen~~ **SIGUE RESUELTA en v5.15:** CR-9 se queda el **lun 1-feb** (`RESEARCH_HITOS`, d35), que ahora es el **D91** del Step 1: hay una semana entera por delante del examen. **NUEVO v5.15 (menor, pero es un texto desalineado):** el átomo **X-8, cuyo enunciado dice «re-arranque post-Step 1», cae el mié 3-feb (d36) y el examen es el lun 8-feb** — o se mueve detrás del examen o se le cambia el texto en `gen_research_plan.js`. **NUEVO v5.15 (orden):** al correr el D1 dos hábiles cabe **un átomo menos antes de la pausa 4→29-ene**, y el mecanismo de *spill* del generador manda **R3** (prep de SR-1) al otro lado: pasa a **d37 vie 5-feb**, y CR-9/X-8 suben a d35/d36. Los 42 átomos siguen ahí (multiset dif 0), pero cambia el orden → aceptar el spill (así corre hoy) o mover la ventana `PAUSA` a 4-ene → 5-feb, que devolvería R3 a su sitio pero retrasaría CR-9 al mié 10-feb. **NUEVO v5.15 (externo):** dos fechas límite escritas en los hitos quedaron rebasadas — T-1 (lun 12-oct) dice «CEI expedita ≤ 30-sep» y C-6 (mié 28-oct) dice «ventana del journal ≤ 15-oct» (ver el 🔴 de arriba). | CR-9 lun 1-feb; los 12 overlays 🔬 re-fechados el 22-sep (`--check` = 0) |
| C | **Derma · el mar 19-ene (NBME 31, GO/NO-GO) es d42 y el jue 21-ene es d43 = Mohs, sesión NORMAL de 2 casos; el lun 8-feb (DÍA DEL EXAMEN) es d49 = última sesión del taper (opcional)** (el taper es posicional d44-d49 y con d1 = mié 23-sep va del **lun 25-ene** al **lun 8-feb**; d48 = jue 4-feb = D94; el ciclo retoma carga completa el mié 10-feb = d50). Alternativa: swap d43↔taper (Mohs al lun 8-feb —tras el examen— y el jue 21-ene en modo taper de 1 caso + FSRS). | d43 normal · taper 25-ene → 8-feb (`DERMA_DAILY_META.taperStep1`) · d49 opcional |
| D | **⚠ LIVIANO · la inversión VUELVE en v5.15: el caso integral 16/16 cae DESPUÉS del capstone.** Con D1 en miércoles el primer viernes del plan es el d3 (25-sep) pero el generador coloca los 16 casos cada 5 días desde el **d8 (vie 2-oct)**, así que el cierre queda: **D87 mar 26-ene** repaso integral · **D88 mié 27-ene capstone** · **D89 jue 28-ene** revisión trimestral II · **D90 vie 29-ene caso integral 16/16**. En v5.14 (D1 en lunes) el caso 16 caía antes del capstone. Opciones: **(a)** aceptar — el caso integral pasa a ser la prueba final del protocolo ya ensamblado (defendible, pero deja de servir para detectar secciones que faltan); **(b)** intercambiar D88↔D90 en `gen_business_plan.py` / `livianoStudyPlan` para recuperar el orden de v5.14. | (a) · `livianoStudyPlan.ts` (caso 16 = D90 vie 29-ene, capstone = D88 mié 27-ene) |
| E | **SYNAPSE · la última A-unit cae el lun 1-feb (`FIN_PLAN = 2027-02-01`), D91 del Step 1** — ver la fila SYNAPSE de abajo (mantener o adelantar). | lun 1-feb |
| F | **AURUM · el PITCH v5 (d95) cae el vie 5-feb = D95 = último día del plan Step 1** — ya NO es la víspera del examen (el examen es el lun 8-feb y el finde queda libre), así que el conflicto de v5.14 se disolvió solo; queda decidir si lo grabas ese día o lo adelantas al jue 4-feb. | vie 5-feb |
| G | **MIR · el mantenimiento va en modo REDUCIDO (10Q) hasta el lun 8-feb INCLUSIVE (día del examen) y pasa a modo normal el mar 9-feb** (`REDUCIDO_HASTA = '2027-02-08'`). Decide si el lunes del examen lo dejas reducido (como está) o vacío. | reducido hasta el 8-feb · normal desde el 9-feb |
| I | **MIR · el handoff "entrada a la fase principal" estaba clavado al 31-mar y el mantenimiento ahora cierra el vie 2-abr** (se amplió para no perder sesiones), así que el 1 y el 2 de abril quedaban dentro del banqueo pero la app ya los graduaba con el umbral de la fase principal (consolidada 75 % / anclas 60 % en vez de 70/55). Aplicado por coherencia con la regla del corrimiento: **handoff → vie 2-abr-2027** y la fase principal arranca el **lun 5-abr** (`mirData.ts` `MIR_HITOS.handoff` · `mirEvalLog.ts` `MIR_CIERRE_UMBRAL_FASES`). Si prefieres mantener el 31-mar por una razón externa (convocatoria, viaje), son 2 líneas. | handoff vie 2-abr · umbral de banqueo hasta el 2-abr inclusive |
| H | **Vibecoding · el flag `deload` sigue desalineado: las semanas post-NBME son S6 (mié 28-oct → mar 3-nov, tras el NBME 26 del mar 27-oct) y S12 (mié 9 → mar 15-dic, tras el NBME 28 del mar 8-dic), pero el flag lo lleva S7 (mié 4 → mar 10-nov, motor de preguntas ENCAPS)**. Además, con D1 en miércoles los bloques de 5 hábiles ya NO coinciden con las semanas de calendario (van de miércoles a martes). Opciones: swap S6↔S7 en `DATA/SYNAPSE/vibecoding_proyectos.json` o mover el flag a S6 (`gen_vibecoding_plan.js` + `gen_synapse_plan.js`). | flag en S7 (catálogo, `vibecodingPlan.ts`) · `PROTOCOLO_MODO_MINIMO.md` §4 |
...
| 4 | **Free 120 en Prometric Lima + maratón de resistencia** (Palmerton §8.1 #4: un simulacro más largo que el examen). Única ventana sin tocar franjas: **D85, vie 22-ene** (v5.15; NBME 33 + 3 bloques de *flagged* ≈ 5 h) cediendo Research/Derma/AURUM ese día; `POR_MATERIA` §E dice "un viernes" (en v5.15 el D85 sí cae en viernes, pero los hitos ya no están anclados a ese día) → corregirlo al decidir | Solo el Free 120 en D87 (mar 26-ene), en casa |
| 6 | **Mover la eval timed 18:00-18:45 a 12:00-12:45** ("estudiar cansado = 2-4× más lento"; solaparía SYNAPSE 12:30) | 18:00-18:45 |
| 8 | **Si el UWSA1 (mié 23-sep) sale <40 % → D2-D10 a 20Q/día** (tipo Jay). Se decide ese mismo miércoles con el % real | Sin regla activa |
...
- [ ] **Régimen · ¿se acepta seguir con 5 días L-V o se recupera algo?** El plan bajó de ~606 h (97 d) a ~594 h (95 d) y el
      colchón consumido desde el 31-ago son **17 días hábiles** (v5.15: 31-ago → 22-sep, ninguno estudiado) — el examen ya salió de la ventana. *(USMLE)*
- [ ] **🔴 EL COLCHÓN SE ROMPIÓ (v5.12, 15-sep; v5.13 y v5.14 lo empeoraron un hábil cada una y v5.15 dos de golpe): el examen ya está FUERA de la ventana 25-29 ene (target lun 8-feb) y no hay ningún día de reserva.** Un día más sin
      estudiar mueve el examen al mar 9-feb (y así sucesivamente: cada corrimiento = reprogramar Prometric otra vez, si el eligibility period lo permite) o obliga a
      ...
      Prometric para el lun 8-feb + confirmar eligibility** (🔴). *(USMLE — bloqueante)*
- [x] ~~**Decisión (v5.11): el D95 = jue 28-ene ya no es descanso puro sino sesión mínima (D-1 dentro del plan).**~~ **SUPERSEDIDA por v5.12 (15-sep) y REPUESTA por v5.13 (16-sep):** con D1 en jueves el D95 vuelve a ser el D-1 DENTRO del plan (lun 1-feb: sesión mínima AM ≤2 h + ritual de test-day, `USMLE_TAPER.d95`/`dMenos1`), el D94 (vie 29-ene) es la última sesión de banco (`USMLE_TAPER.d94`) y el sáb 30 / dom 31 quedan libres (solo Anki vencido). **v5.14 (19-sep) conserva la estructura con D1 en lunes: D94 mar 2-feb = última sesión de banco, D95 mié 3-feb = D-1 dentro del plan, finde 30-31 ene libre entre D92 y D93.** **v5.15 (22-sep), con D1 en miércoles: D94 jue 4-feb = última sesión de banco, D95 vie 5-feb = D-1 dentro del plan, y el finde libre pasa a ser el sáb 6 / dom 7-feb, ya pegado al examen — el D-1 real de calendario es el domingo 7.** Lo que hay que confirmar ahora es la fila 0 (examen lun 8-feb). *(USMLE)*
- [ ] **SYNAPSE · la última A-unit (d132, cierre F2 + CCA-F) cae el LUNES 1-feb-2027** (v5.15: con D1 en miércoles las 19 semanas del motor **ya NO coinciden con las de calendario** —van de miércoles a martes— y el plan cierra el lun 1-feb = **D91** del Step 1, primer día de la última semana de banco; v5.14: vie 29-ene; v5.13: mar 26-ene; v5.12: lun 25-ene; v5.11: sáb 23-ene; v5.10: vie 22-ene). Decidir si se mantiene (15' un lunes de sprint) o se adelanta (regenerar con `gen_synapse_plan.js` cambiando el cierre). El texto de esa A-unit ya dice «CIERRE F2 (último día del motor, lun 1-feb en v5.15)». *(SYNAPSE)*
- [ ] **Puente MIR ↔ Step 1** — Cardiología MIR (D5, **mar 29-sep**) precede a Cardiovascular Step 1 (D6, **mié 30-sep**)
      por 1 hábil; Psiquiatría MIR arranca el **jue 7-ene** (D74) y *Psychiatry & Behavioral* el **vie 8-ene** (D75) — 1 hábil de ventaja (v5.15). Los otros 9 bloques
...
- [ ] **Materias sin columna vertebral en el corpus Palmerton — decidir la fuente sustituta** *(USMLE)*:
      - **13 días completos**: Micro/ID (D58-D64, **vie 11-dic → lun 21-dic**, justo tras el NBME 28 del mar 8-dic; el vie 18-dic = D63 es el único viernes de nivel 4), MSK/Reuma+Derma (D71, D73-D74:
        **lun 4, mié 6 y jue 7-ene**; el dermato Step 1 va en D74 jue 7-ene; el NBME 30 del mar 5-ene es D72) y Psiquiatría (D75, D76 y D78: **vie 8, lun 11 y mié 13-ene**; el UWSA2 del mar 12-ene es D77) — D# v5.15. Propuesta: **subir el peso del pre-test 10Q de las
        08:15 como FUENTE** y de la *shopping list*; no buscar "el vídeo de Palmerton".
      - **Cardio D8 (vie 2-oct, curvas PV/Wiggers/Starling — en v5.15 él mismo es un viernes de nivel 3) y D16 (mié 14-oct, valvulopatías y soplos — cae DESPUÉS del
        NBME 25 del mar 6-oct y del viernes nivel 3 de Cardio, D13 vie 9-oct)**: PV loops, Frank-Starling con retorno venoso, Laplace, maniobras de soplos, S2 y Jones
        **CONFIRMADOS AUSENTES**. ¿Costanzo, B&B o First Aid? Decidir **antes de esa mañana**.
      - **Bioestadística (D79, jue 14-ene-2027)**: el corpus cubre la mitad conceptual pero **no la de cálculo** → repartir
...
- [ ] **MIR · jueves Tier C REDUCIDOS (v5.15, releído de `mirMantenimiento.ts` el 22-sep: M1 jue 14-ene · M6 jue 21-ene · M11 jue 28-ene · M16 jue 4-feb, 10Q — el mantenimiento arranca el propio jue 14-ene, así que su día 1 ya es un Tier C y ahora son 4, no 3)**: las 10Q del día son todas Tier C, sin formulario de la
...
- [ ] **MIR · mini-MIR D77 (mar 12-ene-2027)**: semilla = `dia.fecha` (si el día se corre otra vez la mezcla cambia). **Default = por fecha**; alternativa semilla fija «D77». *(MIR)*
...
- [ ] **ENCAPS · fecha real del examen 2027-I (convocatoria SERUMS)** antes de sembrar la intensiva (⛔ el SQL no se aplica hasta entonces) — ya en 🟡; se repite aquí
      porque el arranque (mar 9-feb vs **mié 10-feb**, ⚪ A) depende de ella. *(ENCAPS)*
- [ ] **LIVIANO · los 8 sub-decks `APEX::LIVIANO::*` no existen en Anki** (Anki cerrado el 19-sep): se crean al importar `LIVIANO_mecanismo.csv` (🟠, D16 mié 14-oct) o antes
      a mano. **Default = al importar el CSV.** *(LIVIANO)*
- [ ] **Calendar · series secundarias el lun 8-feb (examen) y GYM/BAILE del último hábil previo (vie 5-feb = D95, BAILE 19:00-20:30; el sáb 6 y el dom 7 ya están libres)**: dejarlas (el overlay ya avisa; **default**) o
      vaciarlas a mano. **A VERIFICAR (22-sep)** con `list_events` del 4 al 8-feb. *(sistema)*
...
- [ ] **MIR · modo "reducido" de enero** — leído de `mirMantenimiento.ts` el 22-sep (v5.15): mantenimiento **57 días, jue 14-ene →
      vie 2-abr-2027** (arranca el jue 14 para no pisar el D78 del mié 13-ene; el fin ya NO está clavado al ENCAPS: se AMPLIÓ, así que no se pierde ningún slot — **45 slots lun-jue + 12 viernes**), `modoReducidoHasta = 2027-02-08` (**18 días** reducidos = solo Anki + 10Q mixtas, hasta el lun 8-feb = día del examen inclusive; 12 jueves con
      Tier C express en las semanas 1-12, el primero jue 14-ene = D1, Traumatología · miembro inferior). Si prefieres el bloque completo también en enero, hay que regenerar con esa constante cambiada
      (`gen_mir_mantenimiento.js`). ⚠ El **lun 8-feb (examen Step 1)** es el D18 y el ÚLTIMO día en modo reducido (10Q mixtas Cardiología + Ginecología):
      decidir si ese día va reducido o vacío. El primer día en modo normal es el **mar 9-feb (D19: 15Q Gastroenterología + 10Q Cardiología)**. *(MIR)*
...
- [ ] **Research · ¿nov-2026 o feb-2027 para el SUBMIT de la tesis L0?** `RUTA_PUBLICACION_2027.md` §3.1 dice "envío
      feb-2027"; el plan fija **T-8 = jue 3-dic-2026** (v5.15, d26) con el gate CEI + inglés (si falla, cascada a feb-2027 automática).
      Decidir cuál prevalece; si es feb-2027, es 1 línea en el script + regenerar. *(Research)*
- [ ] **AURUM · política de semanas** (leído de `aurumDailyPlan.ts` el 22-sep, v5.15: D1 mié 23-sep → D130 vie 26-mar-2027): las 16
      variantes LIVIANO caen en MARTES del d40 al d65 (17-nov → 22-dic), el d70 en MIÉRCOLES 30-dic (deriva por el 25-dic) y en VIERNES desde el d75 (8-ene … d115 5-mar) — 7 fuera de viernes; PITCH 1-3 en martes (d15 13-oct · d35 10-nov · d55 8-dic = día del NBME 28),
      PITCH 4-7 en viernes (d75 8-ene · d95 5-feb · d115 5-mar · d130 26-mar). Se respeta "1 de cada 5 drills". Si quieres viernes
      estrictos, cambiar la política en `gen_aurum_plan.js` (saltar feriados sin desplazar la semana). ✅ El PITCH v5 (d95) **ya NO es la víspera del examen**: cae el **vie 5-feb = D95 = último día del plan Step 1**, con el finde 6-7 libre por delante (v5.14: mié 3-feb; v5.13: lun 1-feb; v5.12: vie 29-ene). Solo queda decidir si lo grabas ese viernes o lo adelantas al jue 4-feb — ⚪ F. *(AURUM)*
- [ ] **Business · los 2 últimos OUTPUT** caen mié 20-ene (S16, cierre, D120) y jue 21-ene-2027 (extra, retro
      del formato L; D121 = último día) porque las lecturas se agotan antes (v5.15, releído el 22-sep: el OUTPUT S15 sí cae en viernes, 15-ene = D115, tras 4 colchones META lun 11 → jue 14-ene, y quedan 2 colchones más el lun 18 y el mar 19-ene; 121 filas = 84 trabajo + 37 descansos). Si quieres S16 en viernes, añadir
      lecturas META en `plan_pulso_v3_L.json` (el plan lo regenera `gen_business_plan.py`, ya integrado en el remap). *(Business)*
- [ ] **LIVIANO · posición de los drills de cifras** (v5.15, releído de `livianoStudyPlan.ts` el 22-sep: **D36 mié 11-nov · D57 jue 10-dic · D74 jue 7-ene · D87 mar 26-ene** = repaso integral); el
      análisis pedía D38/D58/D75 y en v5.15 **ya no coincide ninguno** (la Síntesis M2 es D37, jue 12-nov). Si prefieres esos D# exactos, mover
      `drill: true` en `liviano_curriculum.json` y regenerar. ⚠ La cabecera de `src/lib/livianoScore.ts` todavía documenta «D37 · D58 · D75 · D88, v5.14»: es solo un comentario, pero conviene corregirlo en la próxima pasada de código. *(LIVIANO — menor)*
- [ ] **Calendar · 6 decisiones personales** (no se cambian horas sin tu OK) *(sistema)*: (a) reponer o no el NAP
      ...
      ¿cerrar la eval a las 18:30 o mover ALISTARSE?; (f) GYM/BAILE del jue 4-feb (D94) y del vie 5-feb (D95, último hábil antes del examen), y del finde libre sáb 6 / dom 7-feb previo al examen del lun 8-feb (ver 🟠 Calendar 1).
- [ ] **Renombrar `DATA/ENCAPS/CALENDAR_SEGMENTOS_V5_6.md` → `_V5_15.md`?** El contenido va por v5.10-v5.15 (12-22 sep), el nombre
...
- [ ] **Corregir en §0 la frase "los hitos van en viernes"** — en v5.15 dejó de ser cierta por diseño: los 12 hitos ya no están
      anclados a ninguna fecha, corren con el plan conservando su D# y la mayoría cae en martes (NBME 31 **mar 19-ene** · NBME 32
      **mié 20-ene** · NBME 33 **vie 22-ene** · Free 120 **mar 26-ene** · UWSA1 = D1, **mié 23-sep**). Ya no hay nada que "confirmar como
      intencional": lo que falta es reescribir esa línea en `CALENDAR_SEGMENTOS`. *(USMLE/sistema)*
...
- [x] ~~**`DATA/MIR/README.md`** §1 tabla de pesos + aviso ≈80 %~~ **RESUELTO 19-sep** (docs-resto: tabla de las 16 asignaturas fuera del plan y aviso
  «cobertura medida ≈80 %» en la fila D78; §6 quedó en v5.14: 57 días mar 12-ene → mié 31-mar). ⚠ **v5.15: ese §6 y el §6.1 de `CALENDAR_SEGMENTOS_V5_6` quedan desfasados — el mantenimiento es ahora jue 14-ene → vie 2-abr.**
...
- [x] ~~**Bloque MIR en `gen_revision_semanal.js` y `vibecodingPlan.ts`** (gap MIR 7) + diffs de `vibecoding`~~ **RESUELTO 19-sep salvo una línea**:
  ...
  `primeraReview`/`primeraReviewEstado` + alarma ≥2 días; `homeBriefing.ts` `STEP1_SEMANAS` ya v5.15 (= 20 semanas, S1 = 21-25 sep con el D1 el mié 23); `CockpitStatusBar` colorea ANKI con `primeraReviewDe`.
  **Parcial:** `gen_revision_semanal.js:450` dice hoy «fuera del rango S1-S12 (21-sep → 11-dic, v5.14)» → en v5.15 debe decir **23-sep → 15-dic** (orquestador, SISTEMATIZACION §6).
...
- [x] ~~**`PROTOCOLO_MODO_MINIMO.md` §4 fila S7**~~ **RESUELTO 14-sep, re-fechado a v5.14 el 19-sep y a v5.15 el 22-sep**: con D1 en miércoles los bloques de 5 hábiles van de miércoles a martes, y el deload post-NBME 26 (mar 27-oct) es la semana **S6 (mié 28-oct
  → mar 3-nov)**; el flag `deload` sigue en S7 (mié 4 → mar 10-nov) → decisión ⚪ H (swap S6↔S7 o mover el flag; default vigente: flag en S7).
...
- [x] ~~**`CALENDAR_SEGMENTOS_V5_6.md` §6.2/§11.2/§6.1**~~ **RESUELTO 19-sep** (calendar-doc: §6.1 con Derma 73 → 13-abr y MIR 57 → 31-mar; §16 nuevo con los ids
  de la pasada v5.14). **v5.15 (22-sep): esas dos cifras cambiaron — Derma 73 → jue 15-abr y MIR 57 → vie 2-abr — y la pasada de Calendar de esta versión quedó en §17**; el renombrado a `_V5_15.md` sigue siendo tu decisión, ⚪ Resto.
...
- [x] ~~**LIVIANO no mide retención**~~ **RESUELTO 19-sep en la app** (`src/lib/livianoScore.ts` NUEVO: pre-tests 5Q · drills — su cabecera aún dice D37/D58/D75/D88 (v5.14), en v5.15 son **D36/D57/D74/D87** — · rúbrica 0-2×4 de los 16 casos,
  ...
  importar el CSV (🟠 D16 mié 14-oct) — los 8 sub-decks se crean al importarlo. *(histórico del gap:)* existen los 18 pre-tests de lunes y los 4 drills en
...
- **Siembra ENCAPS segura**: el backup se llama `study_schedule_bk_<YYYYMMDD>` y el SQL **aborta si ya existe** (mismo día →
  ...
  `SEMANAS/overrides_acumulado.json`. **No re-ejecutar** `_encaps_mantenimiento_2027.sql` (bk_0922 existe: es correcto que aborte; bk_0919/0916/0915/… siguen intactos).
...
- **Taper Derma es POSICIONAL (d44-d49; v5.15: lun 25-ene → lun 8-feb, con d48 jue 4-feb = D94 y d49 = día del examen)**: si un futuro corrimiento mueve el D1, comprobar con
  `dermaVentanaTaper('2027-02-08')` qué d caen en la ventana y repetir el swap si cambian (el remap avisa).
- **Generadores idempotentes**: `remap_inicio.js 2026-09-14` ×2 + los 9 generadores → `git diff` vacío (comprobado el
  13-sep con v5.10; en v5.11 el orquestador corrió `2026-09-15`, en v5.12 `2026-09-16`, en v5.13 `2026-09-17`, en v5.14 `2026-09-21` y en v5.15 `2026-09-23` — **A VERIFICAR (22-sep)** la idempotencia con una segunda pasada). Si un `git diff` aparece tras correrlos, algo cambió de verdad: no lo pises.
- ~~**Cabeceras de comentario desfasadas en `src/lib`**~~ **RESUELTO en v5.13 y re-verificado en v5.14 (19-sep) y en v5.15 (22-sep, grep):** `mirDailyPlan.ts` línea 3 ya dice "v5.15 · … D1 = mié 2026-09-23 → D78 mié 2027-01-13" y la nota Derma d48 dice "jue 4-feb = D94, última sesión de banco del Step 1; vie 5-feb = D95 = D-1; finde libre". ⚠ La única que sigue en v5.14 es la de `livianoScore.ts` (drills D37/D58/D75/D88). *(sistema)*
