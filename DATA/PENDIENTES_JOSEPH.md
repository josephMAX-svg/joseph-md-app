...
- [ ] **🔴 v5.15 · DEPLOY del corrimiento a Vercel**: commit de cierre + push y verificar por **contenido del bundle** (no por hash) que se sirve `USMLE Step 1 v5.15`, `inicio:'2026-09-23'`, `examenTarget:'2027-02-08'`, `ENCAPS:92`. **Mié 23-sep 09:00 al abrir la web**: EEUU debe mostrar Día 1/95 = UWSA1 mié 23-09, Readiness examen 2027-02-08 y ENCAPS D1/92 (origen `study_metrics`). *(sistema)*
