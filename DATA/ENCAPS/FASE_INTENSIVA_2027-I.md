...
> **Qué es:** las 5-8 semanas en que ENCAPS vuelve a **bloque principal** (el USMLE Step 1 se rinde el 25-29 ene 2027). Empieza el **lunes 1-feb-2027 (D1)** y termina el **D-1** del examen SERUMS 2027-I. Continúa la cuenta de días de la app: mantenimiento = días **1-96** (15-sep-2026 → 29-ene-2027, `modo='MANTENIMIENTO'`; re-fechado el 14-sep-2026, régimen v5.11: el lun 14 de septiembre tampoco se estudió y el ciclo bajó de 97 a 96 días sin mover la fecha de cierre), intensiva = **día 97 en adelante**, `modo='INTENSIVO'`.
...
> **Actualización 14-sep-2026 (régimen v5.11):** el mantenimiento se re-sembró con **D1 = mar 15-sep-2026 (96 días = 78 `banqueo1h` + 18 `mini_sim`, backup `study_schedule_bk_0914`**; los `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos); la intensiva **no se mueve** (sigue arrancando el lun 1-feb-2027) y solo cambia el número de día con que continúa: **97**, no 98. Coherente con la regla de Joseph (no se fusiona ni se recorta nada): el mantenimiento es banqueo puro, se acorta por delante y no pierde temario (la rotación lun-jue corre un hábil entera y pierde su último slot, la 5.ª sesión de V-7+V-10 · esenciales_sismed; los 18 mini-sims conservan viernes y cola larga — detalle en `PROTOCOLO_HORA_MANTENIMIENTO.md` §3.4). El Step 1 cierra ahora el **jue 28-ene-2027 (D95 = D-1, dentro del plan)** y su examen target sigue siendo el vie 29-ene: la semana 1-5 feb sigue siendo la primera de la intensiva. `study_metrics.exam_date` sigue en dom 28-mar-2027 (imposible, §0) y `dias_a_examen` quedó SIN recalcular a propósito hasta que la convocatoria confirme la fecha.
> *(Histórico v5.10, 12-sep: D1 = lun 14-sep, 97 días, backup `bk_0912`, intensiva desde el día 98.)*

---

## 0) ⚠️ ALERTA DE FECHA — Semana Santa 2027 y la convocatoria SERUMS 2027-I

Calendario **verificado** (algoritmo de Meeus, `gen_encaps_intensivo_2027.js`): **Jueves Santo = jue 25-mar-2027 · Viernes Santo = vie 26-mar-2027 · Domingo de Pascua = dom 28-mar-2027**. Ambos jueves y viernes son feriados nacionales en el Perú (el régimen v5.11 no siembra sesiones en feriados). *(La nota previa del workflow que situaba Semana Santa 2027 el 1-2 de abril era incorrecta: esas fechas corresponden a jueves/viernes comunes; la Semana Santa 2026 fue el 2-3 de abril.)*
...
|---|---|---|---|---|---|---|---|---|
| **CORTO** (planificar con este hasta la convocatoria) | 14-mar-2027 | 30 (días 98-127) | 6 | 6 | 4 | jue 11-mar | vie 12-mar | `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 2027-03-14` |
| MEDIO | 21-mar-2027 | 35 (98-132) | 7 | 7 | 5 | jue 18-mar | vie 19-mar | `... 2027-02-01 2027-03-21` |
| (asumido hoy, imposible) | 26/28-mar-2027 | 38 (98-135; salta jue 25-mar) | 7.6 | 7 | 6 | mar 23-mar | mié 24-mar | default del script |
| LARGO | 11-abr-2027 (o 4-abr) | 48 (98-145; salta 25/26-mar) | 10 | 9 | 7 | jue 8-abr | vie 9-abr | `... 2027-02-01 2027-04-11` |
...
2. **Generar:** `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 <fecha-examen> [--pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json] [--sims ruta.json] [--bk study_schedule_bk_intensivo_<AAAAMMDD>] [--base 2026-09-15]`  ✅ **14-sep-2026 (v5.11):** el default del script YA es `--base 2026-09-15` (constante `BASE`, línea 48, comentario v5.11; el script imprime `offset mantenimiento: 96 (esperado 96 si BASE=2026-09-15 y D1=2027-02-01)`), así que la intensiva empieza en el **día 97** sin pasar nada. Si en un futuro corrimiento el D1 del mantenimiento vuelve a moverse, hay que pasar `--base <nuevo D1>` (o corregir la constante) para que la cuenta de la app no quede desfasada. → escribe `DATA/_scripts/_encaps_intensivo_2027.sql` (backup `--bk` → `DELETE ... WHERE examen='ENCAPS' AND modo='INTENSIVO'` → `INSERT` de N filas `dia 97…`). El script avisa si la fecha cae en Semana Santa (⛔) o no es domingo (⚠), no siembra fines de semana ni feriados y continúa la numeración desde el día 96 (última fila del mantenimiento).
...
5. Con el pre-test rendido (5-feb): re-generar con `--pretest` y volver a aplicar (solo se reescriben las filas `INTENSIVO`; el mantenimiento 1-96 queda intacto). **Regla:** nunca correr `gen_encaps_mantenimiento_2027.js` después de sembrar la intensiva sin el filtro de modo (gaps_v3b vacío 7).
