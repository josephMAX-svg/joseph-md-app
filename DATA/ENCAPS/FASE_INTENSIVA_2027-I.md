...
> **Qué es:** las 5-8 semanas en que ENCAPS vuelve a **bloque principal** (el USMLE Step 1 se rinde —target v5.13— el **mar 2-feb-2027**, ya fuera de la ventana 25-29 ene; el lun 1-feb es su D95 = D-1 dentro del plan). Diseño original: empieza el **lunes 1-feb-2027 (D1)** y termina el **D-1** del examen SERUMS 2027-I. Continúa la cuenta de días de la app: mantenimiento = días **1-94** (17-sep-2026 → 29-ene-2027, `modo='MANTENIMIENTO'`; re-fechado el 16-sep-2026, régimen v5.13: el mié 16 de septiembre tampoco se estudió y el ciclo bajó de 95 a 94 días sin mover la fecha de cierre), intensiva = **día 95 en adelante**, `modo='INTENSIVO'`. ⚠ **v5.13: el día 95 = lun 1-feb = D-1 del Step 1 (sesión mínima AM + ritual de test-day) y el día 96 = mar 2-feb = DÍA DEL EXAMEN** → propuesta: arrancar la intensiva el **mié 3-feb-2027** (`node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-03 <fecha-examen>`; con ese D1 el script cuenta offset 96 y la intensiva continúa en el **día 97**, dejando los días 95 y 96 sin fila) — **decisión de Joseph** (`DATA/PENDIENTES_JOSEPH.md`).
...
> **Actualización 16-sep-2026 (régimen v5.13):** el mantenimiento se re-sembró con **D1 = jue 17-sep-2026 (94 días = 76 `banqueo1h` + 18 `mini_sim`, backup `study_schedule_bk_0916`**; los `bk_0915` de v5.12, `bk_0914` de v5.11, `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos). Coherente con la regla de Joseph (no se fusiona ni se recorta nada): el mantenimiento es banqueo puro, se acorta por delante y no pierde temario (la rotación lun-jue corre un hábil entera y pierde su último slot, la 5.ª sesión de II-11 · prep_dual_ptmi; los 18 mini-sims conservan viernes y cola larga; el pre-test de arranque pasa a jue 17 + lun 21-sep — detalle en `PROTOCOLO_HORA_MANTENIMIENTO.md` §1-bis y §3.4). **Lo nuevo:** el Step 1 cierra ahora el **lun 1-feb-2027 (D95 = D-1 DENTRO del plan; D94 vie 29-ene = última sesión de banco; sáb 30 y dom 31-ene libres)** y su examen pasa al **mar 2-feb-2027**: la intensiva ya **no puede** arrancar ni el lun 1-feb (día 95 = D-1 del Step 1) ni el mar 2-feb (día 96 = examen). Propuesta: **D1 = mié 3-feb** (semana 1 = 3-5 feb; el pre-test 2026-II del vie 5-feb no cambia). **A VERIFICAR (16-sep):** qué hace el script con el slot `senales` del lunes cuando el D1 cae en miércoles (estructura de la semana 1, §1) — Joseph decide si `senales` se hace el mié 3 o se absorbe en la semana 2. `study_metrics.exam_date` sigue en dom 28-mar-2027 (imposible, §0) y `dias_a_examen` quedó SIN recalcular a propósito hasta que la convocatoria confirme la fecha.
> *(Histórico v5.12, 15-sep: D1 = mié 16-sep, 95 días, backup `bk_0915`, intensiva propuesta desde el día 97 el mar 2-feb; el Step 1 cerraba el vie 29-ene = D95 y se rendía el lun 1-feb. v5.11, 14-sep: D1 = mar 15-sep, 96 días, backup `bk_0914`, intensiva desde el día 97 el lun 1-feb; el Step 1 cerraba el jue 28-ene = D-1 y se rendía el vie 29-ene. v5.10, 12-sep: D1 = lun 14-sep, 97 días, backup `bk_0912`, intensiva desde el día 98.)*

---

## 0) ⚠️ ALERTA DE FECHA — Semana Santa 2027 y la convocatoria SERUMS 2027-I

Calendario **verificado** (algoritmo de Meeus, `gen_encaps_intensivo_2027.js`): **Jueves Santo = jue 25-mar-2027 · Viernes Santo = vie 26-mar-2027 · Domingo de Pascua = dom 28-mar-2027**. Ambos jueves y viernes son feriados nacionales en el Perú (el régimen —v5.13, como los anteriores— no siembra sesiones en feriados). *(La nota previa del workflow que situaba Semana Santa 2027 el 1-2 de abril era incorrecta: esas fechas corresponden a jueves/viernes comunes; la Semana Santa 2026 fue el 2-3 de abril.)*
...
| Escenario | Examen (dom) | Días hábiles D1→D-1 (con D1 = lun 1-feb, diseño original, numeración desde el día 95; con la propuesta v5.13 D1 = mié 3-feb son dos días menos y la numeración arranca en 97) | Semanas | Viernes | Simulacros 100Q tras el pre-test | D-2 dress rehearsal | D-1 medio día | Comando (sustituir `2027-02-01` por `2027-02-03` si Joseph acepta la propuesta v5.13) |
|---|---|---|---|---|---|---|---|---|
| **CORTO** (planificar con este hasta la convocatoria) | 14-mar-2027 | 30 (días 95-124) | 6 | 6 | 4 | jue 11-mar | vie 12-mar | `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 2027-03-14` |
| MEDIO | 21-mar-2027 | 35 (95-129) | 7 | 7 | 5 | jue 18-mar | vie 19-mar | `... 2027-02-01 2027-03-21` |
| (asumido hoy, imposible) | 26/28-mar-2027 | 38 (95-132; salta jue 25-mar) | 7.6 | 7 | 6 | mar 23-mar | mié 24-mar | default del script |
...
2. **Generar:** `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 <fecha-examen> [--pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json] [--sims ruta.json] [--bk study_schedule_bk_intensivo_<AAAAMMDD>] [--base 2026-09-17]`  ✅ **16-sep-2026 (v5.13):** el default del script YA es `--base 2026-09-17` (constante `BASE`, línea 48, comentario v5.13; el script imprime `offset mantenimiento: 94 (esperado 94 si BASE=2026-09-17 y D1=2027-02-01; 96 si D1=2027-02-03)`), así que con D1 = 1-feb la intensiva empezaría en el **día 95** (= D-1 del Step 1) y con la propuesta v5.13 (`... 2027-02-03 <fecha-examen>`) en el **día 97** (los días 95 = lun 1-feb = D-1 y 96 = mar 2-feb = examen Step 1 quedan sin fila). Si en un futuro corrimiento el D1 del mantenimiento vuelve a moverse, hay que pasar `--base <nuevo D1>` (o corregir la constante) para que la cuenta de la app no quede desfasada. → escribe `DATA/_scripts/_encaps_intensivo_2027.sql` (backup `--bk` → `DELETE ... WHERE examen='ENCAPS' AND modo='INTENSIVO'` → `INSERT` de N filas `dia 95…` o `97…`). El script avisa si la fecha cae en Semana Santa (⛔) o no es domingo (⚠), no siembra fines de semana ni feriados y continúa la numeración desde el día 94 (última fila del mantenimiento). ⚠ El SQL hoy en disco (`_encaps_intensivo_2027.sql`) sigue siendo el ensayo del 8-sep (dia 101-138, base 9-sep): NO refleja v5.13 — regenerar antes de aplicar.
