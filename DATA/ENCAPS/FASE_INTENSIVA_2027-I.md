...
> **Qué es:** las 5-8 semanas en que ENCAPS vuelve a **bloque principal** (el USMLE Step 1 se rinde —target v5.14— el **jue 4-feb-2027**, ya fuera de la ventana 25-29 ene; el mié 3-feb es su D95 = D-1 dentro del plan y el mar 2-feb su D94 = última sesión de banco). Diseño original: empieza el **lunes 1-feb-2027 (D1)** y termina el **D-1** del examen SERUMS 2027-I. Continúa la cuenta de días de la app: mantenimiento = días **1-92** (21-sep-2026 → 29-ene-2027, `modo='MANTENIMIENTO'`; re-fechado el 19-sep-2026, régimen v5.14: ni el jue 17 ni el vie 18 de septiembre se estudiaron y el ciclo bajó de 94 a 92 días sin mover la fecha de cierre), intensiva = **día 93 en adelante**, `modo='INTENSIVO'`. ⚠ **v5.14: el día 93 = lun 1-feb = D93 del Step 1 (última semana de banco: AMBOSS 200 mitad 2), el día 94 = mar 2-feb = D94 (última sesión de banco), el día 95 = mié 3-feb = D-1 (sesión mínima AM + ritual de test-day) y el día 96 = jue 4-feb = DÍA DEL EXAMEN** → propuesta: arrancar la intensiva el **vie 5-feb-2027 (= día del pre-test 2026-II, día 97)** o el **lun 8-feb (día 98, semana 1 completa)** (`node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-05 <fecha-examen>` | `… 2027-02-08 …`; con esos D1 el script cuenta offset 96 o 97 y deja los días 93-96 (o 93-97) sin fila) — **decisión de Joseph** (`DATA/PENDIENTES_JOSEPH.md` ⚪ A; default documentado aquí: vie 5-feb).
...
> **Actualización 19-sep-2026 (régimen v5.14):** el mantenimiento se re-sembró con **D1 = lun 21-sep-2026 (92 días = 75 `banqueo1h` + 17 `mini_sim`, backup `study_schedule_bk_0919`**; los `bk_0916` de v5.13, `bk_0915` de v5.12, `bk_0914` de v5.11, `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos). Coherente con la regla de Joseph (no se fusiona ni se recorta nada): el mantenimiento es banqueo puro, se acorta por delante y no pierde temario (la rotación lun-jue corre un hábil entera y pierde su último slot, la 5.ª sesión de III-8 · ley_27815; los 17 mini-sims conservan viernes pero sus parejas de cola larga corren un viernes; el pre-test de arranque pasa a lun 21 + mar 22-sep, ya sin viernes en medio — detalle en `PROTOCOLO_HORA_MANTENIMIENTO.md` §1-bis y §3.4). **Lo nuevo:** el Step 1 cierra ahora el **mié 3-feb-2027 (D95 = D-1 DENTRO del plan; D94 mar 2-feb = última sesión de banco; sáb 30 y dom 31-ene libres entre D92 y D93)** y su examen pasa al **jue 4-feb-2027**: la intensiva ya **no puede** arrancar ni el lun 1-feb (día 93 = D93 del Step 1), ni el mar 2 (día 94 = D94), ni el mié 3 (día 95 = D-1), ni el jue 4-feb (día 96 = examen). Propuesta: **D1 = vie 5-feb** (semana 1 = solo el viernes: pre-test 2026-II, que no cambia de fecha) **o D1 = lun 8-feb** (semana 1 completa 8-12 feb; el pre-test 2026-II del vie 5-feb se rinde fuera de la siembra, el día siguiente al examen Step 1, o pasa al vie 12-feb — decisión de Joseph). **A VERIFICAR (19-sep):** qué hace el script con el slot `senales` del lunes cuando el D1 cae en viernes (estructura de la semana 1, §1) — Joseph decide si `senales` se hace el vie 5 o se absorbe en la semana 2. > *(Histórico v5.13, 16-sep: D1 = jue 17-sep, 94 días, backup `bk_0916`, intensiva propuesta desde el día 97 el mié 3-feb; el Step 1 cerraba el lun 1-feb = D-1 y se rendía el mar 2-feb. v5.12, 15-sep: D1 = mié 16-sep, 95 días, backup `bk_0915`, intensiva propuesta desde el día 97 el mar 2-feb; el Step 1 cerraba el vie 29-ene = D95 y se rendía el lun 1-feb. v5.11, 14-sep: D1 = mar 15-sep, 96 días, backup `bk_0914`, intensiva desde el día 97 el lun 1-feb; el Step 1 cerraba el jue 28-ene = D-1 y se rendía el vie 29-ene. v5.10, 12-sep: D1 = lun 14-sep, 97 días, backup `bk_0912`, intensiva desde el día 98.)*

---

## 0) ⚠️ ALERTA DE FECHA — Semana Santa 2027 y la convocatoria SERUMS 2027-I

Calendario **verificado** (algoritmo de Meeus, `gen_encaps_intensivo_2027.js`): **Jueves Santo = jue 25-mar-2027 · Viernes Santo = vie 26-mar-2027 · Domingo de Pascua = dom 28-mar-2027**. Ambos jueves y viernes son feriados nacionales en el Perú (el régimen —v5.14, como los anteriores— no siembra sesiones en feriados). *(La nota previa del workflow que situaba Semana Santa 2027 el 1-2 de abril era incorrecta: esas fechas corresponden a jueves/viernes comunes; la Semana Santa 2026 fue el 2-3 de abril.)*
...
| Escenario | Examen (dom) | Días hábiles D1→D-1 (con D1 = lun 1-feb, diseño original, numeración desde el día 93; con la propuesta v5.14 D1 = vie 5-feb son cuatro días menos y la numeración arranca en 97 — con D1 = lun 8-feb, cinco menos y arranca en 98) | Semanas | Viernes | Simulacros 100Q tras el pre-test | D-2 dress rehearsal | D-1 medio día | Comando (sustituir `2027-02-01` por `2027-02-05` o `2027-02-08` según lo que decida Joseph) |
|---|---|---|---|---|---|---|---|---|
| **CORTO** (planificar con este hasta la convocatoria) | 14-mar-2027 | 30 (días 93-122) | 6 | 6 | 4 | jue 11-mar | vie 12-mar | `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 2027-03-14` |
| MEDIO | 21-mar-2027 | 35 (93-127) | 7 | 7 | 5 | jue 18-mar | vie 19-mar | `... 2027-02-01 2027-03-21` |
| (asumido hoy, imposible) | 26/28-mar-2027 | 38 (93-130; salta jue 25-mar) | 7.6 | 7 | 6 | mar 23-mar | mié 24-mar | default del script |
| LARGO | 11-abr-2027 (o 4-abr) | 48 (95-142; salta 25/26-mar) | 10 | 9 | 7 | jue 8-abr | vie 9-abr | `... 2027-02-01 2027-04-11` |
...
2. **Generar:** `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 <fecha-examen> [--pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json] [--sims ruta.json] [--bk study_schedule_bk_intensivo_<AAAAMMDD>] [--base 2026-09-21]`  ✅ **19-sep-2026 (v5.14):** el default del script YA es `--base 2026-09-21` (constante `BASE`, comentario v5.14; el script imprime `offset mantenimiento: 92 (esperado 92 si BASE=2026-09-21 y D1=2027-02-01; 96 si D1=2027-02-05; 97 si D1=2027-02-08)`), así que con D1 = 1-feb la intensiva empezaría en el **día 93** (= D93 del Step 1), con la propuesta v5.14 (`... 2027-02-05 <fecha-examen>`) en el **día 97** y con `2027-02-08` en el **día 98** (los días 93 = lun 1-feb = D93, 94 = mar 2-feb = D94, 95 = mié 3-feb = D-1 y 96 = jue 4-feb = examen Step 1 quedan sin fila). Si en un futuro corrimiento el D1 del mantenimiento vuelve a moverse, hay que pasar `--base <nuevo D1>` (o corregir la constante) para que la cuenta de la app no quede desfasada. → escribe `DATA/_scripts/_encaps_intensivo_2027.sql` (backup `--bk` → `DELETE ... WHERE examen='ENCAPS' AND modo='INTENSIVO'` → `INSERT` de N filas `dia 95…` o `97…`). El script avisa si la fecha cae en Semana Santa (⛔) o no es domingo (⚠), no siembra fines de semana ni feriados y continúa la numeración desde el día 92 (última fila del mantenimiento). ⚠ El SQL hoy en disco (`_encaps_intensivo_2027.sql`) sigue siendo el ensayo del 8-sep (dia 101-138, base 9-sep): NO refleja v5.14 — regenerar antes de aplicar.
...
5. Con el pre-test rendido (5-feb): re-generar con `--pretest` y volver a aplicar (solo se reescriben las filas `INTENSIVO`; el mantenimiento 1-94 queda intacto). **Regla:** nunca correr `gen_encaps_mantenimiento_2027.js` después de sembrar la intensiva sin el filtro de modo (gaps_v3b vacío 7).
6. Ensayo recomendado en enero (sin aplicar): `--bk study_schedule_bk_intensivo_test` para no descubrir errores el 1-3 feb.
