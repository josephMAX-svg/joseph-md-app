...
> **Qué es:** las 5-8 semanas en que ENCAPS vuelve a **bloque principal** (el USMLE Step 1 se rinde —target v5.15— el **lun 8-feb-2027**; el vie 5-feb es su D95 = D-1 dentro del plan, el jue 4-feb su D94 = última sesión de banco y el sáb 6 + dom 7-feb el finde libre antes del examen). Diseño original: empieza el **lunes 1-feb-2027 (D1)** y termina el **D-1** del examen SERUMS 2027-I. Continúa la cuenta de días de la app: mantenimiento = días **1-92** (23-sep-2026 → 2-feb-2027, `modo='MANTENIMIENTO'`; re-fechado el 22-sep-2026, régimen v5.15: tampoco se estudiaron el lun 21 ni el mar 22-sep y el **corrimiento es RÍGIDO** — no se toca ni un tema, se amplía el final, así que el ciclo mantiene sus 92 días y su cierre pasa del vie 29-ene al **mar 2-feb-2027**), intensiva = **día 93 en adelante** en el diseño original; con v5.15 el script cuenta offset **96** si D1 = mar 9-feb (intensiva = día **97**+) u offset **100** si D1 = lun 15-feb (día **101**+), y los días 93-96 (o 93-100) simplemente no tienen fila, `modo='INTENSIVO'`. ⚠ **v5.15: el mié 3, el jue 4 y el vie 5-feb siguen ocupados por el Step 1 (jue 4-feb = D94, última sesión de banco; vie 5-feb = D95 = D-1, sesión mínima AM + ritual de test-day), el sáb 6 y dom 7-feb son el finde libre y el lun 8-feb es el DÍA DEL EXAMEN** → la fase intensiva ENCAPS **arranca DESPUÉS del examen Step 1**: propuesta **D1 = mar 9-feb-2027** (primer hábil tras el examen) o **lun 15-feb** (semana 1 completa) (`node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-09 <fecha-examen>` | `… 2027-02-15 …`) — **decisión de Joseph** (`DATA/PENDIENTES_JOSEPH.md` ⚪ A; default documentado aquí: mar 9-feb).
...
> **Actualización 22-sep-2026 (régimen v5.15):** el mantenimiento se re-sembró con **D1 = mié 23-sep-2026 (92 días = 75 `banqueo1h` + 17 `mini_sim`, backup `study_schedule_bk_0922`, régimen `MANTENIMIENTO_2027-1 v6.13`**; los `bk_0919` de v5.14, `bk_0916` de v5.13, `bk_0915` de v5.12, `bk_0914` de v5.11, `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos). **CORRIMIENTO RÍGIDO** (regla nueva de Joseph): solo corren los días — ningún tema se toca, no se fusiona ni se recorta nada, y donde había un fin clavado se **amplían días** en vez de perder sesiones. Por eso el mantenimiento conserva sus 92 días completos (0 sesiones perdidas) y su cierre pasa del vie 29-ene al **mar 2-feb-2027**; el pre-test de arranque pasa a **mié 23 + jue 24-sep** y el primer mini-sim sigue el **vie 25-sep** (detalle en `PROTOCOLO_HORA_MANTENIMIENTO.md` §1-bis y §3.4). **Lo nuevo:** el Step 1 cierra ahora el **vie 5-feb-2027 (D95 = D-1 DENTRO del plan; D94 jue 4-feb = última sesión de banco; sáb 6 y dom 7-feb libres entre D95 y el examen)** y su examen pasa al **lun 8-feb-2027**: la intensiva ya **no puede** arrancar en la semana del 1-feb (mar 2-feb = día 92 del mantenimiento; mié 3, jue 4 y vie 5-feb siguen ocupados por el cierre del Step 1) ni el lun 8-feb (día del examen). Propuesta: **D1 = mar 9-feb** (primer hábil tras el examen; semana 1 = mar-vie) **o D1 = lun 15-feb** (semana 1 completa 15-19 feb) — decisión de Joseph. Con cualquiera de los dos, el pre-test 2026-II se rinde en el **primer viernes de la intensiva** (vie 12-feb o vie 19-feb). **A VERIFICAR (22-sep):** qué hace el script con el slot `senales` del lunes cuando el D1 cae en martes (estructura de la semana 1, §1) — Joseph decide si `senales` se hace el mar 9 o se absorbe en la semana 2. > *(Histórico v5.14, 19-sep: D1 = lun 21-sep, 92 días, backup `bk_0919`, intensiva propuesta desde el vie 5-feb o el lun 8-feb; el Step 1 cerraba el mié 3-feb = D-1 y se rendía el jue 4-feb. v5.13, 16-sep: D1 = jue 17-sep, 94 días, backup `bk_0916`, intensiva propuesta desde el día 97 el mié 3-feb; el Step 1 cerraba el lun 1-feb = D-1 y se rendía el mar 2-feb. v5.12, 15-sep: D1 = mié 16-sep, 95 días, backup `bk_0915`, intensiva propuesta desde el día 97 el mar 2-feb; el Step 1 cerraba el vie 29-ene = D95 y se rendía el lun 1-feb. v5.11, 14-sep: D1 = mar 15-sep, 96 días, backup `bk_0914`, intensiva desde el día 97 el lun 1-feb; el Step 1 cerraba el jue 28-ene = D-1 y se rendía el vie 29-ene. v5.10, 12-sep: D1 = lun 14-sep, 97 días, backup `bk_0912`, intensiva desde el día 98.)*

---

## 0) ⚠️ ALERTA DE FECHA — Semana Santa 2027 y la convocatoria SERUMS 2027-I

Calendario **verificado** (algoritmo de Meeus, `gen_encaps_intensivo_2027.js`): **Jueves Santo = jue 25-mar-2027 · Viernes Santo = vie 26-mar-2027 · Domingo de Pascua = dom 28-mar-2027**. Ambos jueves y viernes son feriados nacionales en el Perú (el régimen —v5.15, como los anteriores— no siembra sesiones en feriados). *(La nota previa del workflow que situaba Semana Santa 2027 el 1-2 de abril era incorrecta: esas fechas corresponden a jueves/viernes comunes; la Semana Santa 2026 fue el 2-3 de abril.)*
...
| Escenario | Examen (dom) | Días hábiles D1→D-1 (columna «orig.» = diseño original con D1 = lun 1-feb; **v5.15** = con D1 = mar 9-feb son **6 hábiles menos** y la numeración arranca en el día **97** (offset 96), con D1 = lun 15-feb **10 menos** y arranca en el **101** (offset 100); el mantenimiento ocupa los días 1-92 hasta el mar 2-feb) | Semanas | Viernes | Simulacros 100Q tras el pre-test | D-2 dress rehearsal | D-1 medio día | Comando (sustituir `2027-02-01` por `2027-02-09` o `2027-02-15` según lo que decida Joseph) |
|---|---|---|---|---|---|---|---|---|
| **CORTO** (planificar con este hasta la convocatoria) | 14-mar-2027 | orig. 30 · **v5.15: 24** (días 97-120) / 20 con D1 = 15-feb | 4.8 | 5 | 3 | jue 11-mar | vie 12-mar | `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-09 2027-03-14` |
| MEDIO | 21-mar-2027 | orig. 35 · **v5.15: 29** (97-125) / 25 con D1 = 15-feb | 5.8 | 6 | 4 | jue 18-mar | vie 19-mar | `... 2027-02-09 2027-03-21` |
| (asumido hoy, imposible) | 26/28-mar-2027 | orig. 38 · **v5.15: 32** (97-128; salta jue 25-mar) / 28 con D1 = 15-feb | 6.4 | 6 | 5 | mar 23-mar | mié 24-mar | default del script |
| LARGO | 11-abr-2027 (o 4-abr) | orig. 48 · **v5.15: 42** (97-138; salta 25/26-mar) / 38 con D1 = 15-feb | 8.4 | 8 | 6 | jue 8-abr | vie 9-abr | `... 2027-02-09 2027-04-11` |
...
Numeración: semana 1 = 1-5 feb (diseño original; con **v5.15** = **9-12 feb** (mar-vie), porque toda la semana del 1-feb sigue siendo del Step 1 (mar 2-feb = día 92 del mantenimiento, jue 4-feb = D94, vie 5-feb = D95 = D-1) y el lun 8-feb es el examen — o 15-19 feb si Joseph prefiere arrancar el lunes siguiente). Lun-jue = **loop diario** (§2). Viernes = **simulacro completo 100Q / 72 s/Q** (§3-§4).

| Semana | Lun | Mar-Jue | Vie |
|---|---|---|---|
| **1** (1-5 feb en el diseño original; **v5.15: 9-12 feb** si la intensiva arranca el martes siguiente al examen Step 1 — el `senales` del lunes se absorbe en el mar 9 o pasa a la semana 2, **A VERIFICAR**; con D1 = lun 15-feb la semana 1 es 15-19 feb) | `senales`: RE-SCAN de señales — QX Tendencias 2027-I, boletín DGE/sala situacional, RM/NTS MINSA publicadas desde sep-2026, convocatoria SERUMS → actualizar `SENALES_2027-I.md` y los pesos del v3 (y el condicional de IV) | `loop` de **calentamiento** sin material nuevo: I-3 (mar) · V-2 (mié) · II-3 (jue) | **PRE-TEST 2026-II** (**v5.15: vie 12-feb**, primer viernes de la intensiva; vie 19-feb si D1 = lun 15-feb — en el diseño original era el vie 5-feb, hoy D95 = D-1 del Step 1): examen real 2026-II, 100Q/72 s, clave oficial 100/100, corrección por código vs vector v3, umbral ≥70 (`PRETEST_2026-II.md`; runner `gen_encaps_minisim.js --pretest`, generar el **jue 4-feb-2027** = D94 del Step 1, o el jueves inmediatamente anterior al viernes en que se rinda) |
| **2-5** (8 feb → 5 mar en el diseño original; **v5.15: 15 feb → 12 mar** con D1 = mar 9-feb) | **BARRIDO de los 8 críticos**: 16 slots lun-jue = 2 pasadas por código, cada pasada en un sub-eje distinto (`SUB_EJES` de `_encaps_ciclo_v3.js`). Orden default por rentabilidad v3: I-3 · V-2 · IV-1+IV-2 · I-4 · II-3 · III-5 · II-5 · II-4 · (2.ª pasada igual). Con `--pretest <json>` el orden y el nº de slots por código se **recalculan por índice de brecha** (n × (1 − % ciego)): todo crítico ≥1 slot (salvo 100 % seguro → 0), máx 3 por código, los slots libres van a los códigos con más brecha (críticos o no). Cada loop incluye **drill de cifras 10 min** (`CIFRAS_CRITICAS_2027-I.md`) dentro del deep prime. | | SIM 100Q #1-#4 (§4) |
| **6-7** (8 mar → en el diseño original; **v5.15: 15 mar →**) | **REBOTES** anti-persistentes (lección L4): II-1 · II-11 · II-8, un día cada uno, con 5-6Q del código de cola larga de turno como secundario | **WATCH-LIST** de cola larga: 3 códigos por día (principal 1 + 2 secundarios de 8-10Q) rotando los 17 códigos de `COLA_LARGA`; repaso multi-temporal de TODO `_registro_resoluciones.json` en el segmento 07:15 | SIM 100Q #5-#7 (§4) |
...
|---|---|---|---|---|
| 0 | **PRE-TEST 2026-II** (**v5.15: vie 12-feb**, primer viernes de la intensiva; 19-feb si D1 = lun 15-feb) | `_examen_2026-2_items.json` · runner `gen_encaps_minisim.js --pretest` | oficial 100/100 | LISTA NEGRA hasta ese día; único uso = pre-test |
...
2. **Generar:** `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-09 <fecha-examen> [--pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json] [--sims ruta.json] [--bk study_schedule_bk_intensivo_<AAAAMMDD>] [--base 2026-09-23]`  ✅ **22-sep-2026 (v5.15):** el default del script YA es `--base 2026-09-23` (constante `BASE`, comentario v5.15), así que con la propuesta v5.15 (`... 2027-02-09 <fecha-examen>`) el offset es **96** y la intensiva empieza en el **día 97**, y con `2027-02-15` el offset es **100** y empieza en el **día 101** (los días 93 = lun 1-feb = D93, 94 = mar 2-feb = D94, 95 = mié 3-feb = D-1 y 96 = jue 4-feb = examen Step 1 quedan sin fila). Si en un futuro corrimiento el D1 del mantenimiento vuelve a moverse, hay que pasar `--base <nuevo D1>` (o corregir la constante) para que la cuenta de la app no quede desfasada. → escribe `DATA/_scripts/_encaps_intensivo_2027.sql` (backup `--bk` → `DELETE ... WHERE examen='ENCAPS' AND modo='INTENSIVO'` → `INSERT` de N filas `dia 95…` o `97…`). El script avisa si la fecha cae en Semana Santa (⛔) o no es domingo (⚠), no siembra fines de semana ni feriados y continúa la numeración desde el día 92 (última fila del mantenimiento). ⚠ El SQL hoy en disco (`_encaps_intensivo_2027.sql`) sigue siendo el ensayo del 8-sep (dia 101-138, base 9-sep): NO refleja v5.14 — regenerar antes de aplicar.
...
5. Con el pre-test rendido (v5.15: vie 12-feb o vie 19-feb, según el D1 que elija Joseph): re-generar con `--pretest` y volver a aplicar (solo se reescriben las filas `INTENSIVO`; el mantenimiento 1-92 queda intacto). **Regla:** nunca correr `gen_encaps_mantenimiento_2027.js` después de sembrar la intensiva sin el filtro de modo (gaps_v3b vacío 7).
6. Ensayo recomendado en enero (sin aplicar): `--bk study_schedule_bk_intensivo_test` para no descubrir errores en la semana del examen Step 1 (3-8 feb).

## 6) Gates y lectura de resultados

| Momento | Métrica | Umbral | Si no se cumple |
|---|---|---|---|
| Primer viernes de la intensiva (v5.15: vie 12-feb o vie 19-feb) — PRE-TEST 2026-II | % bruto / % ciego | ≥70 / ≥55 (arranque previsto) | <60 bruto: alarma → semanas 2-5 = 2 slots por crítico por brecha, semana 6 = 3.ª pasada de los 4 peores (`PRETEST_2026-II.md` §4) |
...
- ✅ **App — RESUELTO el 19-sep (v5.14, sistematización; re-fechado en v5.15)**: `encapsPlan.ts` ya lee el régimen vivo (`regimenDe()`: `study_metrics.extra.d1` / `dias_ciclo`, con fallback 2026-09-23 / 92) y el total de días crece solo con `max(dia)` de `study_schedule`, así que sembrar la intensiva (dia 93+) NO exige tocar código; `itemsForDay` renderiza `modo='INTENSIVO'` (loop de 8 segmentos de `extra.loop`, `sim` /100 con `sim_n = dia` en `study_sim_scores`, `repaso`, `drill_cifras`) y `simDays` entiende `pretest` / `sim100` / `dress_rehearsal` (umbral 85 = `ENCAPS_SIM100_META`, alerta 70; pre-test 70). ⚠ Al sembrar: re-sembrar también `study_metrics.extra.horarios` (weekday/weekend) o la pestaña Horario seguirá mostrando 16:15-17:15. Registro ↔ Supabase: `gen_encaps_semana.js --pull` (ver PROTOCOLO_HORA_MANTENIMIENTO §5). *(texto previo, histórico:)* `STUDY_TOTAL_DAYS` dinámico (máx(dia) leído de `study_schedule`) o constante 92+N al aplicar (hoy vale 92, `encapsPlan.ts` v5.14); rama `modo==='INTENSIVO'` en `itemsForDay` que pinte `extra.loop` (8 ítems chequeables con hora), `extra.sim`, `extra.repaso` (D-1/D-3/D-7) y `extra.drill_cifras`; `simDays` con tipos `pretest`/`sim100`/`dress_rehearsal` (`sim_n` = día) para guardar la nota en `study_sim_scores` contra la meta 85.
...
- **Stock de preguntas:** el barrido consume ~30-40Q/día de críticos; el inventario (`_inventario_banco_por_codigo.json`) muestra que los sets de hoy cubren el arranque, no la intensiva → pre-generar sets `set_<codigo>_2/3` en enero y usar el 2026-II como cantera desde el primer viernes de la intensiva (v5.15: 12-feb o 19-feb).
