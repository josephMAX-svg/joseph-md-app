...
- **Stock real (05-sep-2026):** los 300 ítems reales con clave (2024-2A · 2025-1A · 2025-2) están etiquetados por código v3 + sub-eje en `BANCO_PROPIO/_etiquetas_examenes_reales_v3.json` y repartidos en `set_<codigo>_1.json` (8 críticos, 25Q c/u: reales + nuevos con clave respaldada por texto extraído de compendios locales y norma citada) y `set_reales_otros_1.json` (cola larga/rebotes). Consumo y reglas: `BANCO_PROPIO/README.md`; oferta vs demanda: `_inventario_banco_por_codigo.json` (`--inventario`). Ninguna pregunta NUEVA de esos sets usa como respuesta una cifra que el 2026-II haya preguntado (regla "pregunta parecida"): esas cifras solo viven en `CIFRAS_CRITICAS_2027-I.md`/deck.
