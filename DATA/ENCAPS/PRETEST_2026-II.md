...
> **Re-fechado 10-sep-2026 (régimen v5.9):** el mantenimiento se re-sembró con **D1 = vie 11-sep-2026 · 98 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0910`; los `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos) porque el 10 de septiembre tampoco se estudió (además del 7, el 8 y el 9). **Nada de este documento se mueve:** el pre-test sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**; solo cambia el número de día con que la app continúa la cuenta (la intensiva arranca en el día **99**, no 100 ni 103). El USMLE Step 1 acaba el **mar 26-ene-2027 (D95)**, así que la semana muerta entre el Step 1 y este pre-test sigue siendo la del 27-29 de enero.
