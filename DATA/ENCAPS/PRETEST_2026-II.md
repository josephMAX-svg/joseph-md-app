...
> **Re-fechado 12-sep-2026 (régimen v5.10):** el mantenimiento se re-sembró con **D1 = lun 14-sep-2026 · 97 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0912`; los `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos) porque el 11 de septiembre tampoco se estudió (noveno corrimiento, 31-ago→14-sep). **Nada de este documento se mueve:** el pre-test sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**; solo cambia el número de día con que la app continúa la cuenta (la intensiva arranca en el día **98**, no 99). El USMLE Step 1 acaba el **mié 27-ene-2027 (D95)**, el jue 28-ene es descanso y el examen se rinde el **vie 29-ene** (target): ya no hay semana muerta entre el Step 1 y este pre-test — entre el examen y el pre-test queda exactamente una semana (1-4 feb = calentamiento de la intensiva).
