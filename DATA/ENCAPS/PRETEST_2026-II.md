...
> **Re-fechado 08-sep-2026 (régimen v5.7):** el mantenimiento se re-sembró con **D1 = mié 9-sep-2026 · 100 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0908`) porque el 7 y el 8 de septiembre no se estudiaron. **Nada de este documento se mueve:** el pre-test sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**; solo cambia el número de día con que la app continúa la cuenta (la intensiva arranca en el día **101**, no 103).
