...
> **Cuándo:** viernes **5-feb-2027** (primer viernes de la fase intensiva; D1 intensiva = lun 1-feb en el diseño original — ⚠ v5.12: el lun 1-feb es ahora el examen Step 1, así que la propuesta es D1 = mar 2-feb; el pre-test sigue en viernes). Es el primero de los simulacros 100Q de viernes (`FASE_INTENSIVA_2027-I.md`).
...
> **Re-fechado 15-sep-2026 (régimen v5.12):** el mantenimiento se re-sembró con **D1 = mié 16-sep-2026 · 95 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0915`; los `bk_0914` de v5.11, `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos) porque el mar 15 de septiembre tampoco se estudió (undécimo corrimiento, 31-ago→16-sep). **El pre-test no se mueve:** sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**. Lo que sí cambia: el USMLE Step 1 acaba el **vie 29-ene-2027 (D95 = última sesión; el plan llena la ventana 25-29 ene)** y el examen pasa al **lun 1-feb-2027** (target fuera de la ventana; sáb 30 y dom 31-ene = descanso) — es decir, **el día 96 en que arrancaría la intensiva es el día del examen Step 1** → propuesta: intensiva desde el **mar 2-feb** (continúa en el día **97**; el día 96 queda sin fila), decisión de Joseph. Entre el examen Step 1 y este pre-test quedan 3 días hábiles (2-4 feb = calentamiento). *(v5.11: D1 mar 15-sep, 96 días, Step 1 D95 = jue 28-ene = D-1 y examen vie 29-ene, intensiva desde el día 97 el lun 1-feb. v5.10: D1 lun 14-sep, 97 días, D95 = mié 27-ene con el jue 28 fuera del plan.)*
...
4. El generador de la intensiva lee el JSON de la ronda y **re-ordena solo** las semanas 2-5: `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 <fecha-examen> --pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json` (v5.12: `2027-02-02` si Joseph acepta arrancar la intensiva el martes; la fecha de examen real la fija la convocatoria SERUMS 2027-I, ver `SENALES_2027-I.md`).
