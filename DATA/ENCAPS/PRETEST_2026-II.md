...
> **Re-fechado 09-sep-2026 (régimen v5.8):** el mantenimiento se re-sembró con **D1 = jue 10-sep-2026 · 99 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0909`; el `bk_0908` de v5.7 sigue intacto) porque el 9 de septiembre tampoco se estudió (además del 7 y el 8). **Nada de este documento se mueve:** el pre-test sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**; solo cambia el número de día con que la app continúa la cuenta (la intensiva arranca en el día **100**, no 101 ni 103).
