...
> **Cuándo:** viernes **5-feb-2027** (primer viernes de la fase intensiva; D1 intensiva = lun 1-feb en el diseño original — ⚠ v5.13: el lun 1-feb es ahora el D-1 del Step 1 y el mar 2-feb su examen, así que la propuesta es D1 = mié 3-feb; el pre-test sigue en viernes). Es el primero de los simulacros 100Q de viernes (`FASE_INTENSIVA_2027-I.md`).
...
> **Re-fechado 16-sep-2026 (régimen v5.13):** el mantenimiento se re-sembró con **D1 = jue 17-sep-2026 · 94 días · cierre vie 29-ene-2027** (backup `study_schedule_bk_0916`; los `bk_0915` de v5.12, `bk_0914` de v5.11, `bk_0912` de v5.10, `bk_0910` de v5.9, `bk_0909` de v5.8 y `bk_0908` de v5.7 siguen intactos) porque el mié 16 de septiembre tampoco se estudió (duodécimo corrimiento, 31-ago→17-sep). **El pre-test no se mueve:** sigue el **vie 5-feb-2027** y se genera el **jue 4-feb**. Lo que sí cambia: el USMLE Step 1 acaba el **lun 1-feb-2027 (D95 = D-1 dentro del plan; D94 vie 29-ene = última sesión de banco; sáb 30 y dom 31-ene libres)** y el examen pasa al **mar 2-feb-2027** (target fuera de la ventana 25-29 ene) — es decir, **el día 95 en que arrancaría la intensiva es el D-1 del Step 1 y el día 96 es el examen** → propuesta: intensiva desde el **mié 3-feb** (continúa en el día **97**; los días 95-96 quedan sin fila), decisión de Joseph. Entre el examen Step 1 y este pre-test quedan 2 días hábiles (3-4 feb = calentamiento). *(v5.12: D1 mié 16-sep, 95 días, Step 1 D95 = vie 29-ene = última sesión y examen lun 1-feb, intensiva propuesta desde el día 97 el mar 2-feb. v5.11: D1 mar 15-sep, 96 días, Step 1 D95 = jue 28-ene = D-1 y examen vie 29-ene, intensiva desde el día 97 el lun 1-feb. v5.10: D1 lun 14-sep, 97 días, D95 = mié 27-ene con el jue 28 fuera del plan.)*
...
4. El generador de la intensiva lee el JSON de la ronda y **re-ordena solo** las semanas 2-5: `node DATA/_scripts/gen_encaps_intensivo_2027.js 2027-02-01 <fecha-examen> --pretest DATA/ENCAPS/TRACKING_ERRORES/RONDAS/PRETEST_2026-II.json` (v5.13: `2027-02-03` si Joseph acepta arrancar la intensiva el miércoles; la fecha de examen real la fija la convocatoria SERUMS 2027-I, ver `SENALES_2027-I.md`).
