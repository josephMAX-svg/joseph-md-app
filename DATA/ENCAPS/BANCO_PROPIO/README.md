...
**Stock pre-generado hoy (08-sep-2026, re-fecha a D1 = mié 9-sep):** `eval_2026-09-09` (D1, modo fallos previos: no hay sesión anterior) · `banco_2026-09-09` (II-3 · esquema_intervalos + II-2, 22Q) · `eval_2026-09-10` (código de ayer II-3, 5Q) · `banco_2026-09-10` (I-3 · tipos_vigilancia + I-10, 25Q) · `minisim_2026-09-11` (cola larga II-2 + I-10) · `minisim_2026-09-18` (V-6 + II-6) · `minisim_2026-09-25` (II-10 + I-5+I-6). Los cuatro ficheros de la semana vieja (`banco_2026-09-07/08`, `eval_2026-09-08` y las versiones antiguas del 09 y 10) se borraron y se regeneraron contra el SQL nuevo. 132 ítems en total, **0 ids repetidos** y **0 ítems del 2026-II** (verificado el 08-sep). Avisos de stock vigentes: el secundario **II-2 solo tenía 2Q** en el pool para el 09-sep (receta 4-5) y el sub-eje **tipos_vigilancia solo 2Q** propias para el 10-sep; además **I-3 quedó en 0Q disponibles** tras el banco del 10-sep → reponer `set_I-3_2.json` y cola larga II-2 antes de la semana 3.
