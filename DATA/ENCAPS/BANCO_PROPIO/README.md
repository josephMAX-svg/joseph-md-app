...
**Stock pre-generado hoy (10-sep-2026, re-fecha a D1 = vie 11-sep · régimen v5.9):** `minisim_2026-09-11` (**D1** · cola larga II-2 + I-10) · `banco_2026-09-14` (II-3 · esquema_intervalos + secundario II-2, 22Q) · `eval_2026-09-15` + `banco_2026-09-15` (I-3 · tipos_vigilancia + I-10, 25Q) · `eval_2026-09-16` + `banco_2026-09-16` (V-2 · planeamiento + V-6, 25Q) · `eval_2026-09-17` + `banco_2026-09-17` (III-5 · pertinencia_barreras + II-6, 25Q) · `minisim_2026-09-18` (V-6 + II-6) · `minisim_2026-09-25` (II-10 + I-5+I-6). Al correr el régimen un día más, el **10-sep dejó de tener sesión** y el D1 pasó a ser un **viernes de mini-sim**: desaparecieron `banco_2026-09-10` y `eval_2026-09-10` y la semana 2 (lun 14 → jue 17) se pre-generó entera con `--semana 2026-09-14`. Los tres mini-sims **no se regeneraron**: su `_meta.cola_larga.codigos` sigue coincidiendo 1:1 con la fila `mini_sim` del SQL nuevo (11-sep II-2+I-10 · 18-sep V-6+II-6 · 25-sep II-10+I-5+I-6, releído del `.json` con node) y regenerarlos habría roto la unicidad de ids. **10 ficheros de salida · 187 ítems · 0 ids repetidos · 0 ítems derivados del 2026-II** (verificado el 10-sep con node: ningún `fuente`/`molde`/`verificado_contra` cita ese proceso; tres ítems del pool —BP-0010, BP-0012, BP-0017, moldes 2024-2A/2025-1A con clave oficial— solo lo mencionan como comentario dentro de su `explicacion`). Del pool de 434 ítems quedan **247 disponibles** tras pre-generar estas dos semanas (`_inventario_banco_por_codigo.json`, `_meta.totales`): hay que reponer antes de la semana 3. Comprobado el 10-sep: **`--semana 2026-09-14` es determinista** (borrar sus 7 salidas y volver a correrlo devuelve md5 idénticos), y quedan en **0Q disponibles** los códigos **II-3 · I-3 · II-2 · II-6** (el secundario del 14-sep entró con 2Q de las 4-5 de la receta) frente a **V-2 6Q · III-5 5Q · II-5 25Q · I-4 21Q**, así que la semana del **lun 21-sep** ya necesita `set_II-3_2.json`, `set_I-3_2.json` y cola larga II-2/II-6 antes de pre-generarse.
...
## 4) Stock vs demanda (inventario regenerado el 10-sep-2026 contra el SQL de D1 = vie 11-sep)

Siembra vigente (**D1 = vie 11-sep-2026 · 98 días · cierre vie 29-ene-2027**, backup `study_schedule_bk_0910`): **79 sesiones `banqueo1h` + 19 mini-sims de viernes**, con **I-3 10 · V-2 10 · II-8 4 · el resto 5 sesiones** cada uno (I-4 · II-1 · II-3 · II-4 · II-5 · II-11 · III-5 · III-8 · IV-1+IV-2 · IV-6+IV-7 · V-MED) y 79 slots de secundario de cola larga + 38 slots de cola larga en los viernes. Demanda sembrada en 98 días = **1 886Q** (leída de `_inventario_banco_por_codigo.json`, `_meta.totales.demanda_total_q`). Al arrancar un día más tarde con el cierre fijo del 29-ene, la rotación pasó de 99 a **98 días** y **II-8 bajó de 5 a 4 sesiones** (`extra.de = 4`; el resto de códigos mantiene su cuenta; **A VERIFICAR (10-sep)** con Joseph si esa instancia de II-8 debe recuperarse en la fase intensiva, igual que la de II-3 que se perdió en v5.8). Oferta en el pool: **434 ítems** (348 con clave oficial), de los cuales **247 siguen disponibles** tras pre-generar el D1 y la semana 2. Cubre las **2 primeras semanas** de la rotación y los 3 primeros mini-sims; a partir de la semana 3 hay que reponer: por déficit absoluto los peores son **I-3 (180Q) · V-2 (174Q) · II-3 (90Q) · II-11 (85Q) · III-5 (85Q) · IV-6+IV-7 (84Q) · III-8 (82Q) · II-1 (79Q)**, y en cola larga **II-2 (31) · II-6 (31) · I-10 (29) · V-6 (28) · II-EMG (26) · I-OCC (25)** (cifras de `_meta.totales.deficit_codigos`, no estimadas). Plan de reposición: (a) `set_<codigo>_2.json` con moldes 2024-2A→2026-1 + compendios (viernes tarde, gate §3-bis), (b) QX Banqueo/Theomed postests por ÁREA como complemento no filtrable por código (acceso 2027-I **A VERIFICAR (10-sep)**), (c) desde el 8-feb-2027 el 2026-II como cantera de espejos. Detalle por código: `_inventario_banco_por_codigo.json` (sus `_meta.descripcion`, `_meta.rotacion` y `_meta.totales` se leen del propio SQL: `dias_sembrados`, `d1`, `cierre`).
