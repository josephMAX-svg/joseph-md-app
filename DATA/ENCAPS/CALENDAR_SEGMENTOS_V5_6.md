...
7. **Series principales y rutinas re-etiquetadas a v5.15 (22-sep, 2.ª pasada)**: repaso 07:15 `54lchqggik96dmljmmg3l88s54` (también el TÍTULO: «2Q tema de ayer» → «5Q timed del tema de ayer») · 30Q 11:00 `2eqmmrnh00jr44plevurgcu2as` (tiempos §3.4) · eval 18:00 `utk2laeob9u0847bbe9rm491v4` (10Q · 90 s/Q · rule-in → juez → flag) · **DEEP PRIME 09:00 `cb2uh20jnvu7pgfev4183pgctc`** (la serie principal; la de extensión es otra) · pre-test 08:15 `3tbecd5n03ut6lno3hjvc1sr7k` · MIR 15:15 `2ldp6obaapnvo76li28uprrddg` · MIR 15:30 `00k364heibh1n6f9hfspcv9dpi` · sáb PC `hv2lk04orquvivthtkfhilb1ps` · ANKI AM `i8afj7uppkb3ntj8h9890dhecc` · SYNAPSE 12:30 `j99thg3eaqesosmvppj4rfgvh4` · RESEARCH↔DERMA `3ofg2ljv8kl3p1adm2e5d5nih3` · AURUM `at1nak8f24nbnj1mh2jcd4aggg` · LIVIANO `8epae6hlfmrc9j0h2kib7iuc84` · VIBECODING `udr09j9ng983o0d4nipkfe4494` · ENCAPS `papebi46etlo8glgfs5akd5mig` + 15 rutinas (ALMUERZO, LECTURA, VIAJE VUELTA, ANKI y DESAYUNO de finde, SYNAPSE dom, 4 GYM y 8 BAILE). Barrido final: `list_events` de una semana completa con `fullText "21-sep-2026"` devuelve **0 resultados**. Dos ajustes de criterio: «🎯 VIERNES DE HITO» → «🎯 DÍA DE HITO» (con v5.15 solo el NBME 33 cae en viernes) y las notas de víspera de examen en GYM/BAILE pasan del mié 3-feb al **dom 7-feb**. Sin descripción y por tanto omitidos: ALISTARSE, VIAJE (ida), PREPARAR PARA CORRER; DORMIR y DUCHA la tienen pero sin línea de régimen.

**Pendiente en el Calendar (no bloquea el arranque del mié 23-sep):**
- ~~Las 11 descripciones de hito con texto v5.14~~ **HECHAS el 22-sep**: los 11 overlays restantes (NBME 25-33, UWSA2, Free 120) llevan ya el aviso «los 12 hitos ya NO están anclados por fecha», el cierre del plan v5.15 y las fechas cruzadas corregidas.
- ~~Las ~34 descripciones de serie de la tabla §17.3-D~~ **HECHAS el 22-sep** (ver el punto 7 de arriba). Lo único que queda en v5.14 es **§6 de este fichero**, que a propósito conserva los textos literales anteriores como registro de lo que decía el Calendar antes de esta pasada.
