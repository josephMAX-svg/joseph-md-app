# META · NIVEL · MÉTODO DIARIO — ENCAPS 2026-II

¿Qué nivel para >17/20? · plan 2-jul → examen jue 20-ago · partiendo de CERO.

- >17/20 = ≥85% de aciertos (≥85 de ~100 preguntas del examen SERUMS).
...
## El nivel por área (para >85% global)
...
- Fase 1 (2-24 jul): ≥60% en la Eval del tema recién visto.
- Fase 2 (27-jul→13-ago): ≥75% simulacros · ≥85% en I/II/V.
- Fase 3 (14-19 ago): ≥85-90% consistente · CRÍTICA ≥90%.
- Examen 20-ago: >17/20 (≥85%).

## Método diario (8 bloques · en la app + Calendar)

04:15 Anclaje+Anki · 04:45 20Q warm-up ciegas · 07:15 Repaso D-1/3/7 · 08:15 PRE-TEST 10Q+free recall · **09:00-11:00 Núcleo Deep Prime** (videos QX+NTS+compendio+fichas) · 11:00 30Q consolidación+práctica extra · 17:15 Anclaje vespertino · 18:00 Evaluación diaria (registra % ciego). El contenido exacto del día = app Joseph MD → ENCAPS → ⚡ Hoy.

- ENCAPS es la PRIORIDAD ABSOLUTA hasta el 20-ago. Todo lo demás se subordina.
