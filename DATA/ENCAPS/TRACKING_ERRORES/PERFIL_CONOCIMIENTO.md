# 👤 PERFIL DE CONOCIMIENTO — Joseph (ENCAPS 2027-I) · GENERADO 2026-09-26
...
- Regla del override semanal (gen_encaps_semana.js): un código solo entra en «calientes» con **n ≥ 5**. El **pre-test de arranque** (mié 23 y jue 24-sep-2026 = D1 + D2, 5Q × 8 críticos, ítems reales 2024-2A→2025-2) es la línea base ciega por crítico: el **primer override calculado con n ≥ 5 en los 8 críticos es el de la semana del 5-oct-2026** (cierre semanal del vie 2-oct).
