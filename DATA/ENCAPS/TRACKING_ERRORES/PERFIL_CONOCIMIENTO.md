# 👤 PERFIL DE CONOCIMIENTO — Joseph (ENCAPS 2027-I) · GENERADO 2026-09-22
...
- Regla del override semanal (gen_encaps_semana.js): un código solo entra en «calientes» con **n ≥ 5**. El **pre-test de arranque** (mié 23 y jue 24-sep-2026 = D1 + D2, 5Q × 8 críticos, ítems reales 2024-2A→2025-2) es la línea base ciega por crítico: el **primer override calculado con n ≥ 5 en los 8 críticos es el de la semana del 28-sep-2026** (cierre semanal del vie 25-sep).
...
- Pendiente: resolver `BANCO_PROPIO/pretest_arranque_2026-09-23.html` (mié 23-sep = D1, parte 1: II-3 · I-3 · V-2 · III-5) y `pretest_arranque_2026-09-24.html` (jue 24-sep = D2, parte 2: II-5 · I-4 · IV-1+IV-2 · II-4), exportar el JSON y apendar con `node DATA/_scripts/gen_encaps_minisim.js --registrar <export.json> --append`. Esta tabla se llena sola.
