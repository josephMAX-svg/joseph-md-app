# 🇵🇪 PROTOCOLO DE LA HORA ENCAPS — MANTENIMIENTO 2027-I (16:15–17:15 L-V · D1 vie 11-sep-2026 → vie 29-ene-2027 · 98 días)
...
> 98 días · backup `study_schedule_bk_0910`; los `bk_0909` (v5.8) y `bk_0908` (v5.7) siguen intactos). Siembra: `DATA/_scripts/gen_encaps_mantenimiento_2027.js`
> (configuración compartida en `_encaps_ciclo_v3.js`). Versión **v3.4 (10-sep-2026, régimen v5.9)**: re-fechado a D1 = vie 11-sep (el 10 de septiembre tampoco se estudió; el ciclo pasó de 99 a 98 días · **19 mini-sims de viernes, los mismos que antes** · metas, franjas y fecha de examen intactas). El fin del ciclo NO se mueve (29-ene-2027): el mantenimiento es banqueo puro y se acorta por delante, no por detrás — no hay temario que "dejar atrás", la rotación simplemente arranca un día después. Mantiene de v3.1/v3.2/v3.3: sub-ejes por sesión,
> secundario de cola larga, receta fija del mini-sim, cierre de 1 línea y **lista negra del 2026-II**.
>
> **Efecto exacto del corrimiento a v5.9** (demostrado fila a fila contra el SQL v5.8 regenerado, no estimado): las **79 filas de banqueo** son idénticas salvo su fecha, que pasa a la SIGUIENTE fecha lun-jue del plan; los **19 mini_sim** conservan fecha y solo cambian de `sim_n`; las filas de **II-8** cambian `extra.de` de 5 a 4; y **la última fila de banqueo de v5.8 (jue 28-ene) se cae** — es el único día que el plan pierde y, por ser banqueo puro sobre temario ya rotado, no deja ningún subtema atrás. El D1 pasa a ser un **viernes = mini-sim #1**, así que la rotación lun-jue arranca limpia el lun 14-sep.
...
| Cola larga | **5-6Q** repartidas entre los **2 códigos** que marca el viernes (`extra.cola_larga`) | 19 viernes (38 slots) → cada uno de los 17 códigos cae 2-3× (contado sobre el SQL) |
...
| Código | Sub-ejes en orden (la sesión k del código toma el sub-eje ((k−1) mod total)+1) | Reparto REAL en los 98 días (contado del SQL) |
|---|---|---|
...
| **II-8 ↩ (4)** | paquetes ENT + tamizaje (HEARTS) · metas HTA/DM (HbA1c, 150 min/sem) | **2·2** — es el único código que baja de 5 a 4 con el corrimiento a v5.9 |
...
En 98 días cada código cae **6-8 veces** entre lun-jue (79 slots) y viernes (38 slots), contado del SQL: II-2 · I-10 · V-6 · II-6 caen 8× · II-10 · I-5+I-6 · II-EMG · I-OCC · III-3 · I-11+I-12 · V-1 caen 7× · V-3 · III-1 · III-9 · II-9 · II-7 · I-1 caen 6×. II-EMG e I-OCC existen en `encapsCobertura.ts` desde el re-tier v3 (tier MEDIA, temario mínimo con marcas "A VERIFICAR").
...
|---|---|---|---|---|---|
| 1 (07-sep) | — (no estudiado) | — (no estudiado) | — (no estudiado) | — (no estudiado) | **D1** · SIM #1 · II-2 + I-10 |
| 2 (14-sep) | II-3 · esquema_intervalos (+II-2) | I-3 · tipos_vigilancia (+I-10) | V-2 · planeamiento (+V-6) | III-5 · pertinencia_barreras (+II-6) | SIM #6 · V-6 + II-6 |
| 3 (21-sep) | II-5 · nts_adolescente (+II-10) | I-4 · dengue (+I-5+I-6) | IV-1 · metodo_cientifico (+II-EMG) | II-4 · suplementacion_cifras (+I-OCC) | SIM #11 · II-10 + I-5+I-6 |
| 4 (28-sep) | II-1 · prenatal_emergencias (+III-3) | I-3 · notificacion (+I-11+I-12) | V-2 · clima_calidad (+V-1) | III-8 · ley_27815 (+V-3) | SIM #16 · II-EMG + I-OCC |
| 5 (05-oct) | II-11 · prep_dual_ptmi (+III-1) | IV-6 · imryd (+III-9) | V-7 · farmacovigilancia_urm (+II-9) | II-8 · paquetes_tamizaje (+II-7) | SIM #21 · III-3 + I-11+I-12 |
| 6 (12-oct) | II-3 · novedades_gestante (+I-1) | I-3 · historia_natural (+II-2) | V-2 · residuos_bioseguridad (+I-10) | III-5 · medicina_tradicional (+V-6) | SIM #26 · V-1 + V-3 |
| 7 (19-oct) | II-5 · mci_curso_vida (+II-6) | I-4 · rabia (+II-10) | IV-1 · tipos_estudio (+I-5+I-6) | II-4 · anemia_dx_tto (+II-EMG) | SIM #31 · III-1 + III-9 |
| 8 (26-oct) | II-1 · parto_lactancia (+I-OCC) | I-3 · causalidad_hill (+III-3) | V-2 · planeamiento (+I-11+I-12) | III-8 · historia_clinica (+V-1) | SIM #36 · II-9 + II-7 |
| 9 (02-nov) | II-11 · sifilis_sindromico (+V-3) | IV-6 · etica_publicacion (+III-1) | V-7 · esenciales_sismed (+III-9) | II-8 · metas_hta_dm (+II-9) | SIM #41 · I-1 + II-2 |
| 10 (09-nov) | II-3 · esavi_kit (+II-7) | I-3 · sala_situacional_asis (+I-1) | V-2 · clima_calidad (+II-2) | III-5 · inclusion_migrantes (+I-10) | SIM #46 · I-10 + V-6 |
| 11 (16-nov) | II-5 · nts_adolescente (+V-6) | I-4 · epp_precauciones (+II-6) | IV-1 · muestreo (+II-10) | II-4 · plan_multisectorial (+I-5+I-6) | SIM #51 · II-6 + II-10 |
| 12 (23-nov) | II-1 · prenatal_emergencias (+II-EMG) | I-3 · brote_bloqueo (+I-OCC) | V-2 · residuos_bioseguridad (+III-3) | III-8 · ley_27815 (+I-11+I-12) | SIM #56 · I-5+I-6 + II-EMG |
| 13 (30-nov) | II-11 · prep_dual_ptmi (+V-1) | IV-6 · estadistica_descriptiva (+V-3) | V-7 · contrataciones_digemid (+III-1) | II-8 · paquetes_tamizaje (+III-9) | SIM #61 · I-OCC + III-3 |
| 14 (07-dic) | II-3 · cadena_frio (+II-9) | I-3 · tlp (+II-7) | V-2 · planeamiento (+I-1) | III-5 · pertinencia_barreras (+II-2) | SIM #66 · I-11+I-12 + V-1 |
| 15 (14-dic) | II-5 · mci_curso_vida (+I-10) | I-4 · malaria_zoonosis (+V-6) | IV-1 · instrumentos (+II-6) | II-4 · suplementacion_cifras (+II-10) | SIM #71 · V-3 + III-1 |
| 16 (21-dic) | II-1 · parto_lactancia (+I-5+I-6) | I-3 · desastres (+II-EMG) | V-2 · clima_calidad (+I-OCC) | III-8 · historia_clinica (+III-3) | — (25-dic feriado) |
| 17 (28-dic) | II-11 · sifilis_sindromico (+I-11+I-12) | IV-6 · imryd (+V-1) | V-7 · farmacovigilancia_urm (+V-3) | — (31-dic) | — (1-ene) |
| 18 (04-ene) | II-8 · metas_hta_dm (+III-1) | II-3 · esquema_intervalos (+III-9) | I-3 · tipos_vigilancia (+II-9) | V-2 · residuos_bioseguridad (+II-7) | SIM #83 · III-9 + II-9 |
| 19 (11-ene) | III-5 · medicina_tradicional (+I-1) | II-5 · nts_adolescente (+II-2) | I-4 · dengue (+I-10) | IV-1 · metodo_cientifico (+V-6) | SIM #88 · II-7 + I-1 |
| 20 (18-ene) | II-4 · anemia_dx_tto (+II-6) | II-1 · prenatal_emergencias (+II-10) | I-3 · notificacion (+I-5+I-6) | V-2 · planeamiento (+II-EMG) | SIM #93 · II-2 + I-10 |
| 21 (25-ene) | III-8 · ley_27815 (+I-OCC) | II-11 · prep_dual_ptmi (+III-3) | IV-6 · etica_publicacion (+I-11+I-12) | V-7 · esenciales_sismed (+V-1) | **D98** · SIM #98 · V-6 + II-6 |

⚠ **Lo que cambió respecto a v5.8:** al caer el D1 en viernes, la rotación lun-jue arranca alineada a la semana natural (sem 2 = Sem A completa) en vez de empezar un jueves suelto. La semana 18 abre con el **II-8** que en v5.8 abría la semana 17, y el jueves de la semana 21 (jue 28-ene) — que en v5.8 era el último banqueo, un II-8 — **desaparece**: el plan cierra el vie 29-ene con el mini-sim #98.

Esta tabla se ha releído del SQL sembrado el 10-sep (`DATA/_scripts/_encaps_mantenimiento_2027.sql`, D1 = vie 11-sep-2026, régimen v5.9, 98 filas) parseando fila a fila con `node` — no es una estimación. Un **override semanal** (§5) sustituye solo la semana indicada (máx. 2 slots) y queda anotado en `extra.override`. Cada día sin estudiar = +1 hábil: `node DATA/_scripts/gen_encaps_mantenimiento_2027.js <nuevo D1> --bk study_schedule_bk_XXXX` → `execute_sql` (la tabla se desplaza entera por delante; los sub-ejes y secundarios siguen su contador y el 29-ene no se mueve).
