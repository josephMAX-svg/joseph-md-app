...
> Contexto: régimen **v5.14 (D1 = lun 21-sep-2026; ni el jue 17 ni el vie 18-sep se estudiaron, decimotercer corrimiento 31-ago→21-sep; el Step 1 termina el mié 3-feb-2027 = D-1 dentro del plan y su examen pasa al jue 4-feb-2027)** apoya 95 días de Step 1 en "≤10 tarjetas de MECANISMO/día + APEX" — exactamente el contenido multilínea que el parser perdía. Verificado el 05-sep que los 3 ficheros seguían con mtime 07-may y el bug intacto; corregidos entonces. Vibecoding S1 (**lun 21-sep → vie 25-sep, SHIP sáb 26-sep**, fechas leídas de `vibecodingPlan.ts` con node el 19-sep — con D1 en lunes los bloques S1-S12 coinciden con las semanas de calendario; en v5.13 era jue 17 → mié 23, en v5.12 mié 16 → mar 22, en v5.11 mar 15 → lun 21, mismo SHIP; en v5.10 lun 14 → vie 18, SHIP sáb 19) = validar esto en vivo.
...
Sin cambios hoy: P0-1 (scheduler), P0-4 (cleanup loop), P1-2 (drift de plan — ahora el plan vigente es **v5.14, D1 = lun 21-sep-2026** (19-sep-2026), Step 1 principal con examen target jue 4-feb-2027; `config/fases.json` sigue con `FASE_4.is_current_phase=true` y `FASE_7.inicio=2026-10-01`, mientras `CLAUDE.md` ya dice FASE_7 desde el 7-sep — al alinearlo, `FASE_7.inicio` debe ser `2026-09-21`), seguridad §4 (**sigue abierta**: `datos_tesis` RLS OFF + anon key en repo).
