...
Sin cambios hoy: P0-1 (scheduler), P0-4 (cleanup loop), P1-2 (drift de plan — ahora el plan vigente es **v5.13, D1 = jue 17-sep-2026** (16-sep-2026), Step 1 principal con examen target mar 2-feb-2027; `config/fases.json` sigue con `FASE_4.is_current_phase=true` y `FASE_7.inicio=2026-10-01`, mientras `CLAUDE.md` ya dice FASE_7 desde el 7-sep — al alinearlo, `FASE_7.inicio` debe ser `2026-09-17`), seguridad §4 (**sigue abierta**: `datos_tesis` RLS OFF + anon key en repo).
