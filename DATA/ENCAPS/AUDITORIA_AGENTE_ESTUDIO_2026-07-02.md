...
Sin cambios hoy: P0-1 (scheduler), P0-4 (cleanup loop), P1-2 (drift de plan — ahora el plan vigente es **v5.15, D1 = mié 23-sep-2026** (22-sep-2026), Step 1 principal con examen target lun 8-feb-2027; `config/fases.json` sigue con `FASE_4.is_current_phase=true` y `FASE_7.inicio=2026-10-01`, mientras `CLAUDE.md` ya dice FASE_7 desde el 7-sep — al alinearlo, `FASE_7.inicio` debe ser `2026-09-23`), seguridad §4 (**sigue abierta**: `datos_tesis` RLS OFF + anon key en repo).
