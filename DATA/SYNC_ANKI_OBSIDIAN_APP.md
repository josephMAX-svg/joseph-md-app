...
- Automatizar (decisión de Joseph; NO se ha creado): tarea programada de Windows a las 21:05 con Anki abierto, p. ej.
  ...
  o un hook `SessionEnd` de Claude Code. Es el proyecto **S2 del vibecoding** (`anki-sync-kpi`, lun 5-oct → vie 9-oct-2026, SHIP sáb 10-oct · semana de calendario, v5.16).
...
- **`01_USMLE/_template_day_usmle.md`** — plantilla **plana** (core *Templates*, carpeta `09_PLANTILLAS` configurada; `{{date:YYYY-MM-DD}}`),
  ...
  `date · day_of_week · exam · type: study_day · regimen: v5.16 · d_num · tema` · bloques `b0500_anki · b0715_repaso · b0815_pretest ·
...
### Verificación D1-D3 (lun 28 / mar 29 / mié 30-sep-2026 · el D1 lun 28-sep es el UWSA1, D2-D3 = primeros días de contenido, setup FSRS en D3 = mié 30-sep · v5.16) — A VERIFICAR (30-sep)
...
## Puente MIR ↔ USMLE ↔ Derma en Anki (12-sep-2026) — tag compartido `sys::<sistema>` · tag `step1` · handoff **mié 7-abr-2027** (v5.16)
...
### Receta del handoff (**mié 7-abr-2027** · fin del mantenimiento MIR — el fin se AMPLIÓ en v5.15 (31-mar → 2-abr) y otra vez en v5.16 (→ 7-abr) → MIR principal desde el jue 8-abr)
...
4. **Derma cuenta doble**: `deck:APEX::DERMA tag:step1` es el repaso anclado del D74 (**mar 12-ene-2027** en v5.16, "dermato Step 1" dentro de MSK/Rheum) y en
