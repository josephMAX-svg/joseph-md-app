...
- [ ] PUBLICACION: tener a mano Academic Phrasebank (Manchester) al escribir y leer 'Ten Simple Rules for Structuring Papers' antes del primer manuscrito. Considerar mentoria 1-a-1 gratuita de AuthorAID (disenada para LatAm) para revision de tu primer paper. → **Actualizado 5-sep-2026**: AuthorAID se llama ahora **Rising Scholars** (INASP, <https://risingscholars.net/>; authoraid.info redirige ahí; red y mentoría **gratuitas** para el Sur Global — verificado). Registro: <https://risingscholars.net/accounts/register/>. La solicitud de mentor está redactada (no enviada) en `DATA/RESEARCH/MENTORES.md` (mensaje 2); enviarla en la 2ª semana de sep-2026 porque el emparejamiento tarda semanas.
