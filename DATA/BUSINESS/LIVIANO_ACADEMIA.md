...
> **Franja: 17:15-18:00 L-V · D1 = JUE 17-SEP-2026 (v5.13)** — 90 días L-V → **lun 25-ene-2027** (salta 25-dic, 31-dic y 1-ene);
...
>
> **v5.13 (16-sep-2026).** El mié 16 de septiembre tampoco se estudió → +1 día hábil sobre v5.12 (duodécimo
> corrimiento del ciclo 31-ago→17-sep): el plan se regeneró con
> `node DATA/_scripts/gen_liviano_plan.js 2026-09-17`. **No se fusionó ni se recortó nada**: sigue teniendo
> **90 días, 16 casos y 4 drills** con el currículo entero, y el desfase se absorbe alargando
> el final (fin: vie 22-ene → **lun 25-ene-2027**). Los pre-tests pasan a **19** (`LIV_META.pretests`; lunes desde la semana 2: el plan arranca en jueves y tiene 19 lunes, 21-sep → 25-ene, todos con semana D-7 detrás). La franja y las metas no cambian.
> ⚠ **Los 16 casos NO cambian de fecha respecto a v5.12** (siguen los mismos viernes: el plan sigue teniendo **17 viernes**, 18-sep → 22-ene, y el generador salta el primero: el vie 18-sep = D2 queda sin caso; caso 1 = **vie 25-sep (D7)** · … · caso 16 integral = **vie 22-ene (D89)**). El contenido no-viernes corre un día hábil, así que ahora el **caso 16 integral cae DESPUÉS del capstone (D88 jue 21-ene) pero ANTES de la revisión trimestral II (D90 lun 25-ene)**: inversión de 1 día — el protocolo v1 se ensambla un día antes del caso que debía cerrarlo y la trimestral II vuelve a cerrar el plan. Registrado en `DATA/PENDIENTES_JOSEPH.md` (aceptarlo, o mover a mano el capstone al 22-ene y el caso al 21-ene). Los drills corren un hábil y conservan su D#: **D36 jue 5-nov · D58 lun 7-dic · D75 lun 4-ene · D87 mié 20-ene** (v5.12: D36 mié 4-nov · D57 jue 3-dic · D75 mié 30-dic · D87 mar 19-ene); la trimestral I pasa al mié 18-nov (D45). Todas las tablas de abajo usan los D y las fechas
> REALES de `src/lib/livianoStudyPlan.ts` / `livianoCasos.ts` (parseados con node el 16-sep, no estimados).
...
> → `node DATA/_scripts/gen_liviano_plan.js 2026-09-17` (v5.13) → `src/lib/livianoStudyPlan.ts` + `src/lib/livianoCasos.ts`
...
| 4 · 0 días sobre acceso/regulación en Perú; pendientes rojos sin dueño | **Módulo 7 · Acceso en Perú** (6 días: D39-D41 · D43-D44 · D47-caso) con tarea de verificación anti-alucinación → tabla `LIVIANO_ACCESO_PERU` · 2 filas fijas `LIVIANO_REVISION_TRIMESTRAL` (**D45 mié 18-nov** y **D90 lun 25-ene**) · pendientes rojos con dueño, día y salida |
...
**Redistribución de días** (90 en total, sin tocar la franja; recuento REAL de `LIV_DIAS` v5.13, idéntico al de v5.9-v5.12):
...
## Módulo 1 · Fisiología del peso (20 días: D1-D19 · D22 · jue 17-sep → vie 16-oct · empezar aquí, a fondo)
...
**Produce para el protocolo**: §1 Fundamento (**Síntesis D19 = mar 13-oct-2026**). Casos de viernes 1-4 (mecanismo sin culpa; v5.12 = v5.13: vie 25-sep · 2-oct · 9-oct · 16-oct).

## Módulo 2 · GLP-1 y tirzepatida (20 días: D20-D21 · D23-D38 · D42 · D67 · mié 14-oct → vie 18-dic · la evidencia, con cifras ancla)
...
filas FIJAS en el plan: **D45 = mié 18-nov-2026** y **D90 = lun 25-ene-2027**).
...
**Drill de cifras ancla (ciego)**: **D36 = jue 5-nov-2026**. **Produce para el protocolo**: §2 Elegibilidad + titulación
(**Síntesis D38 = lun 9-nov-2026**; dosis solo desde ficha técnica, si no "A VERIFICAR"). Casos 5-8 (elegir fármaco y titular).

## Módulo 7 · Acceso en Perú (6 días: D39-D41 · D43-D44 · D47 · mar 10-nov → mar 17-nov-2026 + caso 9 el vie 20-nov · NUEVO en v2 — tarea de verificación)
...
| Día | **Fecha v5.13** | Tarea | Salida |
|---|---|---|---|
| D39 | **mar 10-nov** | Registro sanitario DIGEMID de semaglutida (inyectable y oral) y tirzepatida: ¿existen, titular, presentación, vigencia? Portal público de DIGEMID (URL A VERIFICAR), captura con fecha. Si no aparece: "SIN REGISTRO HALLADO (fecha)". | Columnas *registro* de `LIVIANO_ACCESO_PERU` |
| D40 | **mié 11-nov** | Condición de venta (con receta / receta retenida — A VERIFICAR por molécula) y flujo receta → farmacia → paciente en el CRM | Columna *condición* |
| D41 | **jue 12-nov** | Precio real en farmacia: 2 cotizaciones escritas y fechadas (cadena + independiente) por presentación/dosis; recalcular "medicamento 3 m = S/ 3,600" del value stack | Columna *precio farmacia* |
| D43 | **lun 16-nov** | Magistral: legalidad del preparado de molécula comercial (dictamen QF + abogado de salud, cita normativa exacta — A VERIFICAR) + 1 cotización Sterilelabs con certificado de análisis por lote → **cierra los 2 pendientes rojos** | Columna *costo LIVIANO* + KPI COGS |
| D47 | **vie 20-nov** (v5.12 = v5.13; el vie 13-nov = D42 es el caso 8) | **Caso 9**: "Lo consigo más barato en una web" (registro, condición de venta, cadena de frío) | Rúbrica |
| D44 | **mar 17-nov** | Cadena de frío doméstica 2–8 °C: transporte, almacenamiento, tiempo fuera de frío según ficha técnica (A VERIFICAR), excursiones; guion de 8 líneas del kit de bienvenida | Anexo A del protocolo |
| D45 | **mié 18-nov** | **REVISIÓN TRIMESTRAL I** de farmacoterapia y precios (fila fija) | `LIVIANO_REVISION_TRIMESTRAL` |
...
- Legalidad DIGEMID → Joseph + QF y abogado de salud (nombres A VERIFICAR) · **D39-D41 + D43 (10-nov → 16-nov-2026)** · salida: columnas registro/condición con captura fechada + dictamen escrito sobre el magistral.
- Cotización Sterilelabs → Joseph · **D43 (lun 16-nov-2026)** · salida: cotización escrita y fechada → "costo LIVIANO" + KPI COGS del Cockpit.

## Módulo 3 · Nutrición (12 días: D46 · D48-D58 · jue 19-nov → lun 7-dic-2026)
...
**Drill de cifras (ciego)**: **D58 = lun 7-dic-2026** (módulos 2-3-7; la misma sesión es Síntesis del módulo 3).
...
Caso 12 (estancamiento, D62 vie 11-dic; v5.12 = v5.13).

## Módulo 6 · Farmacología no-GLP1 + cirugía (9 días: D69-D75 · D79 · D84 · mar 22-dic-2026 → vie 15-ene-2027 · límites de competencia)
...
**Drill de cifras (ciego)**: **D75 = lun 4-ene-2027** (módulos 4-6; la misma sesión es Síntesis del módulo 6).
...
## Módulo 5 · Conducta (9 días: D76-D78 · D80-D83 · D85-D86 · mar 5-ene → mar 19-ene-2027 · se estudia al final para que el caso integral lo use)
...
en Despegue) · check-in de EA (**Síntesis D86 = mar 19-ene-2027**; en v5.12 = v5.13 va ANTES del caso 16, vie 22-ene).

## Síntesis final (D86-D90 · mar 19-ene → lun 25-ene-2027)

- **D86 (mar 19-ene)** · Síntesis módulo 5 → sección M5 del protocolo (5As · automonitoreo · cadencia de check-in).
- **D87 (mié 20-ene)** · Repaso integral I: **drill ciego de cifras** + mecanismos de los 7 módulos.
- **D88 (jue 21-ene)** · **Capstone**: ensamblaje de `LIVIANO_PROTOCOLO_CLINICO_v1.md` (§1-§6 + Anexo A) + ruta de credencial.
- **D89 (vie 22-ene)** · **Caso 16 integral**: 6 meses en LIVIANO, −16 %, "¿ya puedo dejar todo?" (con la esposa
...
- **D90 (lun 25-ene)** · **REVISIÓN TRIMESTRAL II** + cierre administrativo de la Academia (fila fija; vuelve a cerrar el plan).
  ⚠ **Cambio v5.12 → v5.13 (inversión de 1 día):** el caso 16 integral sigue el **vie 22-ene** (los casos no se mueven) pero el contenido corre un hábil, así que queda **DESPUÉS del capstone (D88 jue 21-ene) y ANTES de la trimestral II (D90 lun 25-ene)**: el protocolo v1 se ensambla un día ANTES del caso que debía cerrarlo. En v5.12 la inversión era de 2 días (caso 16 D90 detrás del capstone D88 y de la trimestral II D89). Secuencia por versión: v5.9 D87 repaso → D88 caso → D89 capstone; v5.10 D87 caso → D88 repaso → D89 capstone → D90 trimestral; v5.11 D86 caso (vie 15-ene) → D87 Síntesis M5 → D88 repaso → D89 capstone → D90 trimestral (jue 21-ene); **v5.12: D86 Síntesis M5 (lun 18-ene) → D87 repaso → D88 capstone → D89 trimestral II → D90 caso 16 (vie 22-ene)**. El caso sigue cayendo en VIERNES (regla dura del generador). Opciones para Joseph (`DATA/PENDIENTES_JOSEPH.md`): aceptar la inversión (el caso funciona como examen final del protocolo ya ensamblado) o intercambiar a mano capstone/trimestral II ↔ caso.
...
|---|---|---|---|---|
| **Pre-test ciego 5Q** | cada LUNES desde la semana 2 (19 en total en v5.13: el plan arranca en jueves y tiene 19 lunes, 21-sep → 25-ene, todos con semana D-7 detrás; en v5.11 y v5.12 eran 18; en v5.10, 19 con el primero sin D-7), primeros 5-7' de los 25' de estudio | 5 tarjetas de mecanismo de la semana D-7 (selección determinista, `livPretest(d)`) | ≥ 80 % | `jmd-liviano-score.pretests[d]` |
| **Drill de cifras ancla** | **D36 jue 5-nov (M2) · D58 lun 7-dic (M2-3-7) · D75 lun 4-ene (M4-6) · D87 mié 20-ene (integral)** | cifras de memoria, sin notas (`LIV_DRILLS`) | ≥ 80 % | `jmd-liviano-score.drills[d]` |
...
Los 16 casos caen **todos en VIERNES** (verificado sobre `LIV_DIAS` el 16-sep: 16/16 con `wd = Vie`). ⚠ Desde v5.12 las 16 fechas **corren una semana** respecto a v5.8-v5.11 (el plan tiene 17 viernes y el generador salta el primero, vie 18-sep = D2 en v5.13 sin caso); en v5.13 las fechas no cambian, solo baja 1 el D#.

| # | D · **fecha v5.13** (= v5.12; v5.11 = una semana antes) | Bloque | Caso |
|---|---|---|---|
| 1 | D7 · **vie 25-sep-2026** | mecanismo sin culpa | La que se culpa: tres dietas, tres rebotes |
| 2 | D12 · **vie 2-oct** | mecanismo sin culpa | El que come de noche: hambre hormonal vs hambre real |
| 3 | D17 · **vie 9-oct** | mecanismo sin culpa | "Quemo menos que antes": adaptación metabólica que persiste |
| 4 | D22 · **vie 16-oct** | mecanismo sin culpa | El escéptico: "es disciplina, mi hermano bajó solo" |
| 5 | D27 · **vie 23-oct** | elegir fármaco y titular | "Quiero la inyección ya": candidatura y consentimiento hablado |
| 6 | D32 · **vie 30-oct** | elegir fármaco y titular | Prediabetes con historia familiar: ¿semaglutida o tirzepatida? |
| 7 | D37 · **vie 6-nov** | elegir fármaco y titular | Semana 3 de titulación: náusea diaria y un vómito — ¿sigo? |
| 8 | D42 · **vie 13-nov** | elegir fármaco y titular | Post-infarto que "solo quiere verse mejor": SELECT y límite de competencia |
| 9 | D47 · **vie 20-nov** | EA · estancamiento · proteína (+ acceso) | "Lo consigo más barato en una web": acceso, registro y cadena de frío |
| 10 | D52 · **vie 27-nov** | EA · estancamiento · proteína | Casi sin apetito, come una vez al día: proteína y masa magra |
| 11 | D57 · **vie 4-dic** | EA · estancamiento · proteína | El fan del 16/8 y del keto que abandona a las 6 semanas |
| 12 | D62 · **vie 11-dic** | EA · estancamiento · proteína | −12 kg y estancado 3 semanas: quiere dejar todo |
| 13 | D67 · **vie 18-dic** | límite de competencia y derivación | Dolor abdominal intenso + vómitos… y está buscando embarazo |
| 14 | D79 · **vie 8-ene-2027** | límite de competencia y derivación | No puede pagar el GLP-1 y pide "pastillas": opciones no-GLP1 y límite |
| 15 | D84 · **vie 15-ene-2027** | límite de competencia y derivación | IMC 41 con diabetes mal controlada y falla a semaglutida: "no quiero que me corten" |
| 16 | D89 · **vie 22-ene-2027** | integral con cierre de programa | 6 meses en LIVIANO, −16 %: "¿ya puedo dejar todo?" (con la esposa presente) |

> El plan tiene **17 viernes** y 16 casos (v5.12 = v5.13): el generador salta el primero, así que el **vie 18-sep (D2 en v5.13; D3 en v5.12) queda sin caso** (en v5.10 y v5.11 eran 16 viernes = 16 casos; en v5.9 el D2, vie 11-sep, era el único sin caso). El primer caso llega tras seis días de contenido (D1-D6, jue 17 → jue 24-sep; caso 1 = D7 vie 25-sep). El salto entre el caso 14 (vie 18-dic) y el 15
...
- **Importar en Anki** (una vez, **D15 · mié 7-oct-2026** (v5.13) "Palmerton: 10 tarjetas…" y cada vez que se regenere): Archivo → Importar →
...
| Sección | Módulo → Síntesis que la redacta | **Día · fecha v5.13** (leídos de `LIV_DIAS` con node el 16-sep) | Estado 5-sep |
|---|---|---|---|
| §1 Fundamento: por qué tratamiento crónico | M1 | **D19 · mar 13-oct-2026** | borrador (desde el currículo) |
| §2 Elegibilidad + titulación | M2 | **D38 · lun 9-nov-2026** (Síntesis módulo 2; el drill de cifras M2 es el D36 jue 5-nov) | borrador (dosis A VERIFICAR) |
| §3 Política nutricional · §4 estándar proteína/fuerza + qué medir | M3 · M4 | **D58 · lun 7-dic** · **D68 · lun 21-dic** | borrador |
| §5 5As · automonitoreo · cadencia de check-in · check-in de EA | M5 | **D86 · mar 19-ene-2027** | borrador |
| §6 Derivación y límites de competencia | M6 | **D75 · lun 4-ene-2027** | borrador |
| Anexo A · Acceso en Perú (tabla + cadena de frío + regla) | M7 | **D39-D41 (mar 10 → jue 12-nov) · D43 (lun 16-nov) · D44 (mar 17-nov)** + **D45 (mié 18-nov, revisión trimestral I)** + **D47 (vie 20-nov, caso 9)** + **D88 (jue 21-ene, capstone)** | pendiente (verificación) |
| Ensamblaje v1 + ruta de credencial | Capstone | **D88 · jue 21-ene-2027** (⚠ v5.13: 1 día ANTES del caso 16 integral, vie 22-ene = D89; la revisión trimestral II D90 lun 25-ene cierra el plan) | pendiente |
...
como referente con certificación internacional real. Se anota en el **capstone (D88 · jue 21-ene-2027, v5.13)**.
...
2. `node DATA/_scripts/gen_liviano_plan.js <YYYY-MM-DD>` (v5.13: `2026-09-17`) → reescribe `livianoStudyPlan.ts`, `livianoCasos.ts` y el CSV.
...
3. Revisión **trimestral** de farmacoterapia (aprobaciones y precios se mueven rápido): filas fijas **D45
   (mié 18-nov-2026)** y **D90 (lun 25-ene-2027)** (v5.13), luego cada trimestre (`LIVIANO_REVISION_TRIMESTRAL`).
...
## Índice v5.13 (16-sep-2026) — D → fecha de los 90 días

Leído de `src/lib/livianoStudyPlan.ts` → `LIV_DIAS` (parseado con node, no estimado). **D1 = jue 17-sep-2026 ·
D90 = lun 25-ene-2027 · 90 días L-V · 25-dic, 31-dic y 1-ene fuera · franja 17:15-18:00 intacta ·
0 fechas en fin de semana o feriado (verificado).**

| Módulo | Días (D) | Nº | Rango de fechas |
|---|---|---|---|
| M1 · FISIOLOGÍA | D1-D19 · D22 | 20 | jue 17-sep → vie 16-oct-2026 |
| M2 · GLP-1 | D20-D21 · D23-D38 · D42 · D67 | 20 | mié 14-oct → vie 18-dic-2026 |
| M7 · ACCESO PERÚ | D39-D41 · D43-D44 · D47 | 6 | mar 10-nov → vie 20-nov-2026 |
| SÍNTESIS (trimestral I + cierre) | D45 · D87-D90 | 5 | mié 18-nov-2026 · mié 20-ene → lun 25-ene-2027 |
| M3 · NUTRICIÓN | D46 · D48-D58 | 12 | jue 19-nov → lun 7-dic-2026 |
| M4 · EJERCICIO | D59-D66 · D68 | 9 | mar 8-dic → lun 21-dic-2026 |
| M6 · FARMACO+QX | D69-D75 · D79 · D84 | 9 | mar 22-dic-2026 → vie 15-ene-2027 |
| M5 · CONDUCTA | D76-D78 · D80-D83 · D85-D86 | 9 | mar 5-ene → mar 19-ene-2027 |
...
**Hitos v5.7 → v5.8 → v5.9 → v5.10 → v5.11 → v5.12 → v5.13** (columnas leídas de los `.ts` de cada versión; el Dn cambia porque el
generador re-sloteó los casos a viernes reales — **la fecha es lo estable, el D# no**)

| Hito | v5.8 | v5.9 | v5.10 | v5.11 | v5.12 | **v5.13 (vigente)** |
|---|---|---|---|---|---|---|
| D1 · arranque | jue 10-sep-2026 | vie 11-sep-2026 | lun 14-sep-2026 (D1) | mar 15-sep-2026 (D1) | mié 16-sep-2026 (D1) | **jue 17-sep-2026** (D1) |
| Caso 1 | vie 18-sep-2026 (D7) | vie 18-sep-2026 (D6) | vie 18-sep-2026 (D5) | vie 18-sep-2026 (D4) *(fecha intacta)* | vie 25-sep-2026 (D8) *(⚠ +1 semana: el vie 18-sep queda sin caso)* | **vie 25-sep-2026** (D7) *(fecha intacta)* |
...
| Drill de cifras M2 | jue 29-oct-2026 (D36) | lun 2-nov-2026 (D37) | mar 3-nov-2026 (D37) | mié 4-nov-2026 (D37) | mié 4-nov-2026 (D36) | **jue 5-nov-2026** (D36) |
| Síntesis M2 | lun 2-nov-2026 (D38) | mar 3-nov-2026 (D38) | mié 4-nov-2026 (D38) | jue 5-nov-2026 (D38) | jue 5-nov-2026 (D37) | **lun 9-nov-2026** (D38) *(el vie 6-nov es el caso 7)* |
| Módulo 7 · Acceso en Perú | mar 3-nov → vie 13-nov-2026 | mié 4-nov → vie 13-nov-2026 | jue 5-nov → vie 13-nov-2026 | lun 9-nov → lun 16-nov-2026 (D40-D45) | lun 9-nov → lun 16-nov-2026 (D39-D42 · D44) + caso 9 vie 20-nov (D48) | **mar 10-nov → mar 17-nov-2026** (D39-D41 · D43-D44) + caso 9 vie 20-nov (D47) |
| REVISIÓN TRIMESTRAL I | mié 11-nov-2026 (D45) | jue 12-nov-2026 (D45) | lun 16-nov-2026 (D46) | mar 17-nov-2026 (D46) | mar 17-nov-2026 (D45) | **mié 18-nov-2026** (D45) |
| Drill M2-3-7 + Síntesis M3 | lun 30-nov-2026 (D58) | mar 1-dic-2026 (D58) | mié 2-dic-2026 (D58) | jue 3-dic-2026 (D58) | jue 3-dic-2026 (D57) | **lun 7-dic-2026** (D58) *(el vie 4-dic es el caso 11)* |
| Síntesis M4 | lun 14-dic-2026 (D68) | mar 15-dic-2026 (D68) | mié 16-dic-2026 (D68) | jue 17-dic-2026 (D68) | jue 17-dic-2026 (D67) | **lun 21-dic-2026** (D68) *(el vie 18-dic es el caso 13)* |
| Drill M4-6 + Síntesis M6 | jue 24-dic-2026 (D76) | lun 28-dic-2026 (D76) | mar 29-dic-2026 (D76) | mié 30-dic-2026 (D76) | mié 30-dic-2026 (D75) | **lun 4-ene-2027** (D75) *(31-dic y 1-ene fuera)* |
| Síntesis M5 | mar 12-ene-2027 (D86) | mié 13-ene-2027 (D86) | jue 14-ene-2027 (D86) | lun 18-ene-2027 (D87) *(pasa detrás del caso 16)* | lun 18-ene-2027 (D86) *(vuelve a ir antes del caso 16)* | **mar 19-ene-2027** (D86) |
| Caso 16 integral · fin del temario | vie 15-ene-2027 (D89) | vie 15-ene-2027 (D88) | vie 15-ene-2027 (D87) | vie 15-ene-2027 (D86) *(fecha intacta)* | vie 22-ene-2027 (D90) *(⚠ +1 semana; detrás del capstone y de la trimestral II)* | **vie 22-ene-2027** (D89) *(fecha intacta; DESPUÉS del capstone, ANTES de la trimestral II)* |
| Repaso integral + drill final | mié 13-ene-2027 (D87) | jue 14-ene-2027 (D87) | lun 18-ene-2027 (D88) | mar 19-ene-2027 (D88) | mar 19-ene-2027 (D87) | **mié 20-ene-2027** (D87) |
| Capstone (protocolo v1) | jue 14-ene-2027 (D88) | lun 18-ene-2027 (D89) | mar 19-ene-2027 (D89) | mié 20-ene-2027 (D89) | mié 20-ene-2027 (D88) | **jue 21-ene-2027** (D88) |
| REVISIÓN TRIMESTRAL II + cierre | lun 18-ene-2027 (D90) | mar 19-ene-2027 (D90) | mié 20-ene-2027 (D90) | jue 21-ene-2027 (D90) | jue 21-ene-2027 (D89) *(no cerraba el plan)* | **lun 25-ene-2027** (D90) *(vuelve a cerrar el plan)* |
