...
> currículo). Fuente: agente macro:liviano-obesidad (27-ago-2026).
...
## Módulo 1 · Fisiología del peso (empezar aquí, a fondo)
...
## Módulo 2 · GLP-1 y tirzepatida (la evidencia, con cifras ancla)
...
cambiar rápido; revisión trimestral de farmacoterapia obligatoria para LIVIANO.
...
saciedad y masa magra (imprescindible con GLP-1).
...
EVALUABLE del protocolo de consulta.
...
## Módulo 6 · Farmacología no-GLP1 + cirugía (límites de competencia)

**Fármacos**: fentermina · fentermina/topiramato · naltrexona/bupropión · orlistat ·
setmelanotida (obesidad monogénica) · metformina off-label.
...
como referente con certificación internacional real.

## Reglas del programa

1. Biblioteca de **metáforas de paciente por módulo** (termostato, hambre hormonal vs real,
   bajar el volumen del ruido de comida) — se ensayan en los 20' de aplicación.
2. Tarjetas de mecanismo (mismo formato Palmerton del resto del sistema de estudio).
3. Revisión **trimestral** de farmacoterapia (aprobaciones y precios se mueven rápido).
4. Todo dato clínico que se publique en contenido LIVIANO se verifica contra la fuente primaria
   (misma regla anti-alucinación del motor de preguntas ENCAPS).
