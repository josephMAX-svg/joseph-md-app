...
| [`golden-brand.md`](golden-brand.md) | **Qori Golden**: web viva (qori-golden.vercel.app) · modelo de venta verificado (criadores élite EE.UU.) · seña S/500, timeline 8 pasos, precios Perú · redes (FB+YT) · data real de Boby el padre · logo |
| [`allpa-terrenos.md`](allpa-terrenos.md) | **ALLPA** (=tierra en quechua, familia PIRQA/QORI/ALLPA): marca SOCIAL de los terrenos · página FB (ID 61590457814813) + YouTube @allpaterrenos creados · logo montañas+surcos · 5 guiones de valor nicho comprador-a-distancia · carpeta nativa D:\allpa-terrenos |
