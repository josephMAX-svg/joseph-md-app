...
> **v5.9 (10-sep-2026) — corrimiento.** El 10 de septiembre tampoco se estudió → **D1 = vie 11-sep-2026**
> (+1 día hábil sobre v5.8; octavo corrimiento del ciclo 31-ago→11-sep). **No se fusionó ni se recortó nada**:
> cada plan conserva su número de días y el desfase se absorbe alargando el final. Business: **123 filas ·
> vie 11-sep-2026 → lun 11-ene-2027** (84 de trabajo + **39 DESCANSO**), **17 OUTPUT** de los cuales **16 caen
> en VIERNES** (S1 vie 11-sep → S15 vie 18-dic, más S16 el vie 8-ene) y 1 en el cierre de enero (el OUTPUT
> extra del lun 11-ene). AURUM: **130 días · vie 11-sep-2026 → mar 16-mar-2027**. LIVIANO: **90 días ·
> vie 11-sep-2026 → mar 19-ene-2027**. Fechas leídas de los `.ts` con node el 10-sep, no estimadas.
...
| [`LIVIANO_ACADEMIA.md`](LIVIANO_ACADEMIA.md) | **Academia LIVIANO** (medicina de la obesidad, 6 módulos + M7 Acceso en Perú): franja 17:15-18:00, **90 días desde el vie 11-sep-2026 → mar 19-ene-2027 (v5.9)**. Plan día a día en `src/lib/livianoStudyPlan.ts`; casos, rúbrica, drills y tarjetas en `src/lib/livianoCasos.ts` (ambos GENERADOS por `DATA/_scripts/gen_liviano_plan.js` desde `liviano_curriculum.json`). |
...
- **AURUM** (`DATA/AURUM/`, `src/lib/aurumDailyPlan.ts`, 14:15-15:15 L-V, 130 días · **11-sep-2026 → mar 16-mar-2027**): todo lo de ventas/oferta/objeciones/cierre. Desde v3 (5-sep) incluye **1 de cada 5 drills en variante LIVIANO** (venta ética de un programa médico con el mismo paciente de la Academia, CMP Art. 73) y la **rúbrica del PITCH** (6 ítems 0-2, 7 viernes de cierre de fase, score persistido) + **Closer Scoreboard editable** por semana.
...
- `src/lib/businessStudyPlan.ts` — GENERADO por `python DATA/_scripts/gen_business_plan.py [YYYY-MM-DD]`
  (**v5.9: `2026-09-11` = D1**) desde `plan_pulso_v3_L.json`: 123 filas = 84 de trabajo + 39 DESCANSO
  (sáb/dom + feriados 25-dic/31-dic/1-ene) · **vie 11-sep-2026 → lun 11-ene-2027** · `BIZ_META.bloque` = formato L ·
...
**Ejecutado el 10-sep-2026 con `2026-09-11` (v5.9).**

### Calendario de OUTPUT v5.9 (los 16 viernes de contenido + el cierre de enero · leído de `BIZ_DIAS` con node)

| # | Fecha | Entregable (1 página salvo indicación) |
|---|---|---|
| S1 · D1 | vie 11-sep-2026 | Régimen biológico del fundador v1 |
| S2 · D8 | vie 18-sep-2026 | Protocolo de sueño transversal Pulso v1 |
| S3 · D15 | vie 25-sep-2026 | Guion de 60 s "luz de mañana y última comida temprano" |
| S4 · D22 | vie 2-oct-2026 | Manual sesiones Calma v0 |
| S5 · D29 | vie 9-oct-2026 | Voz editorial Calma: 5 hooks + 1 tarjeta de mecanismo |
| S6 · D36 | vie 16-oct-2026 | Protocolo Foco adultos v0 |
| S7 · D43 | vie 23-oct-2026 | Plantilla de coaching ejecutivo semanal |
| S8 · D50 | vie 30-oct-2026 | Protocolo Cerca Mujer v0 |
| S9 · D57 | vie 6-nov-2026 | Guion de la "Sesión para la pareja/familia" (bono LIVIANO) |
| S10 · D64 | vie 13-nov-2026 | Protocolo Cerca v0 + mapa de derivación + 5 hooks |
| S11 · D71 | vie 20-nov-2026 | 3 tarjetas de mecanismo Anki (leptina · recompensa · saciedad) |
| S12 · D78 | vie 27-nov-2026 | Guion de 90 s "por qué el ejercicio no adelgaza pero es innegociable" |
| S13 · D85 | vie 4-dic-2026 | Tabla "lo que dice el libro vs lo que dice la evidencia" |
| S14 · D92 | vie 11-dic-2026 | "Decatlón del centenario" + plan personal de 12 semanas |
| S15 · D99 | vie 18-dic-2026 | 10 preguntas abiertas para CURVA_ACADEMIA |
| S16 · D120 | **vie 8-ene-2027** | Documento de cierre v2 + tracker de 16 semanas completo |
| — · D123 | **lun 11-ene-2027** | OUTPUT extra · retro del formato L → ajustes para CURVA/DENSA (febrero) |

⚠ **Cambio v5.9:** el S16 pasa del jue 7-ene al **vie 8-ene** (los 16 OUTPUT de semana quedan TODOS en viernes,
antes eran 15) y el OUTPUT extra se corre al **lun 11-ene**, que es el nuevo último día del plan. Reparto de
