...
> **v5.13 (16-sep-2026) — corrimiento.** El mié 16 de septiembre tampoco se estudió → **D1 = jue 17-sep-2026**
> (+1 día hábil sobre v5.12; duodécimo corrimiento del ciclo 31-ago→17-sep). **No se fusionó ni se recortó nada**:
> las 84 filas de trabajo son las mismas y el desfase se absorbe alargando el final. Business: **121 filas ·
> jue 17-sep-2026 → vie 15-ene-2027** (84 de trabajo + **37 DESCANSO**), **17 OUTPUT** de los cuales **16 caen en VIERNES**
> (S1 vie 18-sep → S15 vie 8-ene, mismas fechas que en v5.10-v5.12; solo baja 1 su D#: S1 = D2), S16 el **jue 14-ene** (D120) y el OUTPUT
> extra el **vie 15-ene** (D121, último día del plan). AURUM: **130 días · jue 17-sep-2026 → lun 22-mar-2027** (pitches v1 mié 7-oct (D15) · v2 mié 4-nov (D35) · v3 mié 2-dic (D55) · v4 lun 4-ene (D75) · v5 lun 1-feb (D95, = D-1 del Step 1) · v6 lun 1-mar (D115) · v7 lun 22-mar (D130)). LIVIANO: **90 días ·
> jue 17-sep-2026 → lun 25-ene-2027** — sus 16 casos siguen en los mismos viernes que en v5.12 (17 viernes, el generador salta el primero) y el **caso integral 16/16 (D89 vie 22-ene) cae DESPUÉS del capstone (D88 jue 21-ene) y ANTES de la trimestral II (D90 lun 25-ene)**: ver `LIVIANO_ACADEMIA.md` y `DATA/PENDIENTES_JOSEPH.md`. Contexto: el Step 1 termina el lun 1-feb (D95 = D-1) → examen target **mar 2-feb-2027**. Fechas leídas de los `.ts` con node el 16-sep, no estimadas.
...
| [`LIVIANO_ACADEMIA.md`](LIVIANO_ACADEMIA.md) | **Academia LIVIANO** (medicina de la obesidad, 6 módulos + M7 Acceso en Perú): franja 17:15-18:00, **90 días desde el jue 17-sep-2026 → lun 25-ene-2027 (v5.13)**. Plan día a día en `src/lib/livianoStudyPlan.ts`; casos, rúbrica, drills y tarjetas en `src/lib/livianoCasos.ts` (ambos GENERADOS por `DATA/_scripts/gen_liviano_plan.js` desde `liviano_curriculum.json`). |
...
- **AURUM** (`DATA/AURUM/`, `src/lib/aurumDailyPlan.ts`, 14:15-15:15 L-V, 130 días · **jue 17-sep-2026 → lun 22-mar-2027**, v5.13): todo lo de ventas/oferta/objeciones/cierre. Desde v3 (5-sep) incluye **1 de cada 5 drills en variante LIVIANO** (venta ética de un programa médico con el mismo paciente de la Academia, CMP Art. 73) y la **rúbrica del PITCH** (6 ítems 0-2, 7 viernes de cierre de fase, score persistido) + **Closer Scoreboard editable** por semana.
...
- `src/lib/businessStudyPlan.ts` — GENERADO por `python DATA/_scripts/gen_business_plan.py [YYYY-MM-DD]`
  (**v5.13: `2026-09-17` = D1**) desde `plan_pulso_v3_L.json`: 121 filas = 84 de trabajo + 37 DESCANSO
  (sáb/dom + feriados 25-dic/31-dic/1-ene) · **jue 17-sep-2026 → vie 15-ene-2027** · `BIZ_META.bloque` = formato L ·
...
**Ejecutado el 16-sep-2026 con `2026-09-17` (v5.13).**

### Calendario de OUTPUT v5.13 (16 viernes + el cierre de enero · leído de `BIZ_DIAS` con node el 16-sep)

| # | Fecha | Entregable (1 página salvo indicación) |
|---|---|---|
| S1 · D2 | vie 18-sep-2026 | Régimen biológico del fundador v1 |
| S2 · D9 | vie 25-sep-2026 | Protocolo de sueño transversal Pulso v1 |
| S3 · D16 | vie 2-oct-2026 | Guion de 60 s "luz de mañana y última comida temprano" |
| S4 · D23 | vie 9-oct-2026 | Manual sesiones Calma v0 |
| S5 · D30 | vie 16-oct-2026 | Voz editorial Calma: 5 hooks + 1 tarjeta de mecanismo |
| S6 · D37 | vie 23-oct-2026 | Protocolo Foco adultos v0 |
| S7 · D44 | vie 30-oct-2026 | Plantilla de coaching ejecutivo semanal |
| S8 · D51 | vie 6-nov-2026 | Protocolo Cerca Mujer v0 |
| S9 · D58 | vie 13-nov-2026 | Guion de la "Sesión para la pareja/familia" (bono LIVIANO) |
| S10 · D65 | vie 20-nov-2026 | Protocolo Cerca v0 + mapa de derivación + 5 hooks |
| S11 · D72 | vie 27-nov-2026 | 3 tarjetas de mecanismo Anki (leptina · recompensa · saciedad) |
| S12 · D79 | vie 4-dic-2026 | Guion de 90 s "por qué el ejercicio no adelgaza pero es innegociable" |
| S13 · D86 | vie 11-dic-2026 | Tabla "lo que dice el libro vs lo que dice la evidencia" |
| S14 · D93 | vie 18-dic-2026 | "Decatlón del centenario" + plan personal de 12 semanas |
| S15 · D114 | **vie 8-ene-2027** | 10 preguntas abiertas para CURVA_ACADEMIA |
| S16 · D120 | **jue 14-ene-2027** | Documento de cierre v2 + tracker de 16 semanas completo |
| — · D121 | **vie 15-ene-2027** | OUTPUT extra · retro del formato L → ajustes para CURVA/DENSA (febrero) |

⚠ **Cambio v5.13:** los 15 OUTPUT de viernes conservan su fecha (solo baja 1 su D#: el vie 18-sep es ahora D2); el **S16 cae en jue 14-ene** (v5.12: mié 13-ene · v5.11: mar 12-ene · v5.10: lun 11-ene) y el OUTPUT extra vuelve a un viernes, el **vie 15-ene**, nuevo último día del plan (las lecturas se agotan antes de la cola de enero). *(v5.10: al arrancar en lunes, cada OUTPUT de semana había corrido una semana, S1 del vie 11 al vie 18-sep.)* Reparto de
