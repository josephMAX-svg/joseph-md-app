...
> **Estado (5-sep-2026): ESQUELETO · fechas al régimen v5.12 (15-sep-2026).** Cada sección la redacta una
> "Síntesis de módulo" de LIVIANO Academia (D1 = **mié 16-sep-2026**, v5.12 — el temario no se recortó, solo
> se re-fechó) y el capstone D88 (**mié 20-ene-2027**) las ensambla. ⚠ v5.12: el caso 16 integral (que debía ser el examen final del protocolo) cae el **vie 22-ene (D90)**, 2 días DESPUÉS del capstone — decisión de Joseph en `DATA/PENDIENTES_JOSEPH.md`. Los D# de abajo son los del plan
...
**Criterio de éxito de la v1**: el caso integral del viernes 16 (D90 · vie 22-ene-2027 en v5.12: varón 48 a, −16 % en 6 meses,
...
|---|---|---|---|
| §1 Fundamento | Síntesis M1 | D19 · lun 12-oct | borrador |
| §2 Elegibilidad + titulación | Síntesis M2 | D37 · jue 5-nov | borrador (dosis A VERIFICAR) |
| §3 Política nutricional | Síntesis M3 | D57 · jue 3-dic | borrador |
| §4 Estándar proteína/fuerza + qué medir | Síntesis M4 | D67 · jue 17-dic | borrador |
| §5 Consulta 5As · automonitoreo · cadencia de check-in | Síntesis M5 | D86 · lun 18-ene | borrador |
| §6 Derivación y límites de competencia | Síntesis M6 | D75 · mié 30-dic | borrador |
| Anexo A · Acceso en Perú | Módulo 7 | D40-D43 · 9-nov → 12-nov (+ D45 16-nov, D46, D90) | pendiente |
| Anexo B · Validación con casos | viernes 1-16 | D8 (25-sep) → D90 (22-ene) (v5.12: los 16 casos corren una semana) | en curso |
| Ensamblaje v1 + ruta de credencial | Capstone | D88 · mié 20-ene | pendiente |
...
**Pendiente D19 (lun 12-oct)**: redactar las 10 líneas finales para el kit de bienvenida (versión paciente).
...
## Anexo A · Acceso en Perú (M7 → D39-D42 + D44, 9→16-nov · v5.12; re-verificación D45 y D89)
...
**Cadena de frío doméstica (kit de bienvenida — guion de 8 líneas, se redacta en D44, lun 16-nov · v5.12)**: 2–8 °C extremo a extremo ·
...
**Tareas con dueño**: Legalidad DIGEMID → Joseph + QF y abogado de salud (A VERIFICAR nombres), D39-D42 (lun 9 → jue 12-nov) · Cotización
Sterilelabs → Joseph, D42 (jue 12-nov) · Cadena de frío / ficha técnica → Joseph, D44 (lun 16-nov) · Re-verificación → D45 (mar 17-nov) y D89 (jue 21-ene).
...
10-11 → §3 · 12 → §4 · 13-15 → §6 · 16 → todo (v5.12: se resuelve el vie 22-ene, D90 — 2 días DESPUÉS del capstone del mié 20-ene, D88). Score persistido en `jmd-liviano-score` (panel Academia).

## Anexo C · Lista consolidada de "A VERIFICAR" (dueño · día)

| Ítem | Fuente esperada | Dueño · día |
|---|---|---|
| Criterio numérico de elegibilidad (IMC/comorbilidad) | Obesity Algorithm 2026 | Joseph · D37 (jue 5-nov) |
...
| Interacciones relevantes (insulina, sulfonilureas, psicofármacos) | ficha técnica / interconsulta | Joseph · D37, D69 (M6, lun 21-dic) |
...
| Criterios de setmelanotida / estudio genético · GLP-1 post-bariátrica | guía específica | Joseph · D70, D74 (v5.12) |
...
| Revisión por par antes de uso clínico | médico con experiencia en obesidad | Joseph · post-D88 (capstone, mié 20-ene) |
