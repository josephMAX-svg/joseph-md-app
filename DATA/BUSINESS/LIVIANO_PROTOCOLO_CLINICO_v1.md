...
> **Estado (5-sep-2026): ESQUELETO · fechas al régimen v5.13 (16-sep-2026).** Cada sección la redacta una
> "Síntesis de módulo" de LIVIANO Academia (D1 = **jue 17-sep-2026**, v5.13 — el temario no se recortó, solo
> se re-fechó) y el capstone D88 (**jue 21-ene-2027**) las ensambla. ⚠ v5.13: el caso 16 integral (que debía ser el examen final del protocolo) cae el **vie 22-ene (D89)**, 1 día DESPUÉS del capstone y antes de la trimestral II (D90 lun 25-ene) — decisión de Joseph en `DATA/PENDIENTES_JOSEPH.md`. Los D# de abajo son los del plan
> generado el 16-sep (v5.13) y parseados con node: **la fecha es lo estable, el número de día puede cambiar** al re-slotear los casos. Aquí está todo lo que **ya se
...
**Criterio de éxito de la v1**: el caso integral del viernes 16 (D89 · vie 22-ene-2027 en v5.13: varón 48 a, −16 % en 6 meses,
...
| §2 Elegibilidad + titulación | Síntesis M2 | D38 · lun 9-nov | borrador (dosis A VERIFICAR) |
| §3 Política nutricional | Síntesis M3 | D58 · lun 7-dic | borrador |
| §4 Estándar proteína/fuerza + qué medir | Síntesis M4 | D68 · lun 21-dic | borrador |
| §5 Consulta 5As · automonitoreo · cadencia de check-in | Síntesis M5 | D86 · mar 19-ene | borrador |
| §6 Derivación y límites de competencia | Síntesis M6 | D75 · lun 4-ene | borrador |
| Anexo A · Acceso en Perú | Módulo 7 | D39-D41 + D43 · 10-nov → 16-nov (+ D44 17-nov, D45, D90) | pendiente |
| Anexo B · Validación con casos | viernes 1-16 | D7 (25-sep) → D89 (22-ene) (v5.13: mismas fechas que v5.12, D# −1) | en curso |
| Ensamblaje v1 + ruta de credencial | Capstone | D88 · jue 21-ene | pendiente |
...
## Anexo A · Acceso en Perú (M7 → D39-D41 + D43-D44, 10→17-nov · v5.13; re-verificación D45 y D90)
...
**Cadena de frío doméstica (kit de bienvenida — guion de 8 líneas, se redacta en D44, mar 17-nov · v5.13)**: 2–8 °C extremo a extremo ·
...
**Tareas con dueño**: Legalidad DIGEMID → Joseph + QF y abogado de salud (A VERIFICAR nombres), D39-D41 (mar 10 → jue 12-nov) · Cotización
Sterilelabs → Joseph, D43 (lun 16-nov) · Cadena de frío / ficha técnica → Joseph, D44 (mar 17-nov) · Re-verificación → D45 (mié 18-nov) y D90 (lun 25-ene).
...
10-11 → §3 · 12 → §4 · 13-15 → §6 · 16 → todo (v5.13: se resuelve el vie 22-ene, D89 — 1 día DESPUÉS del capstone del jue 21-ene, D88). Score persistido en `jmd-liviano-score` (panel Academia).

## Anexo C · Lista consolidada de "A VERIFICAR" (dueño · día)

| Ítem | Fuente esperada | Dueño · día |
|---|---|---|
| Criterio numérico de elegibilidad (IMC/comorbilidad) | Obesity Algorithm 2026 | Joseph · D38 (lun 9-nov) |
...
| Interacciones relevantes (insulina, sulfonilureas, psicofármacos) | ficha técnica / interconsulta | Joseph · D38, D69 (M6, mar 22-dic) |
...
| Criterios de setmelanotida / estudio genético · GLP-1 post-bariátrica | guía específica | Joseph · D70, D74 (v5.13: mié 23-dic y mié 30-dic) |
...
| Revisión por par antes de uso clínico | médico con experiencia en obesidad | Joseph · post-D88 (capstone, jue 21-ene) |
