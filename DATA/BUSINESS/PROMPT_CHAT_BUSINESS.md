...
- src\lib\businessStudyPlan.ts    ← 121 filas (84 trabajo + 37 DESCANSO sáb/dom + feriados, v5.15: mié 23-sep-2026 → jue 21-ene-2027) GENERADO (py DATA\_scripts\gen_business_plan.py YYYY-MM-DD) + re-fechado (node DATA\_scripts\remap_inicio.js YYYY-MM-DD)
