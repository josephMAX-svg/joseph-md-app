...
> `DERMA_CICLO2_META` 2027-04-23 → 2027-07-14). **Contexto del Step 1:** su plan termina el **mié 10-feb-2027 (D95 = D-1 real, ya sin finde libre entre medio; D94 mar 9-feb = última sesión de banco)** y el examen pasa al **JUE 11-FEB-2027** → el taper posicional d44-d49 va del **vie 29-ene** (d44 = día del Free 120, D87) al **vie 12-feb** (d49 = DÍA SIGUIENTE al examen, segunda pasada parcial III: sesión opcional/ligera; ya NO cae el día del examen); **d48 mié 10-feb coincide con el D95 = D-1 real** (1 caso + FSRS, nada nuevo). El vie 22-ene (NBME 31, GO/NO-GO) es día Research (en pausa); el **lun 25-ene (NBME 32) es d42 = colgajos e injertos** y el **mié 27-ene (NBME 33) es d43 = Mohs**, ambos sesión NORMAL de 2 casos (fuera del taper: el NBME no es "el examen"). Alternativa registrada en `DATA/PENDIENTES_JOSEPH.md`: swap d43↔taper — decisión de Joseph. d50 (cicatrización, 3 casos) = **mar 16-feb**. Las menciones "d49 lun 8-feb = día del examen", "examen lun 8-feb" y "d50 mié 10-feb" de más abajo son de v5.15.
> *(Histórico v5.15, 22-sep-2026 — DERMA CORRÍA +1 SLOT: d1 = mié 23-sep-2026 → d73 = jue 15-abr-2027 y ciclo 2 lun 19-abr → jue 8-jul-2027; taper d44-d49 = lun 25-ene → lun 8-feb con d49 = día del examen (lun 8-feb); d42 = mar 19-ene (NBME 31) y d43 = jue 21-ene (Mohs); d50 = mié 10-feb.)* Texto original de v5.15: Ni el lun 21 ni el mar 22-sep
> se estudiaron y el D1 del régimen pasaba al **mié 23-sep-2026** (decimocuarto corrimiento, 31-ago→23-sep, 17 hábiles perdidos), que es día Derma en la alternancia anclada
...
> examen mayor del 11-feb, y d47-d49 la cumplen. Alternativa registrada en `DATA/PENDIENTES_JOSEPH.md` (decisión de Joseph): swap d43↔taper
> (Mohs al vie 12-feb, y el mié 27-ene en modo taper). *(v5.15: ventana lun 25-ene → lun 8-feb con d49 = día del examen, d42 = mar 19-ene = NBME 31, d43 = jue 21-ene · v5.14: jue 21-ene → jue 4-feb, d42 = vie 15-ene = NBME 31, d43 = mar 19-ene.)* La tabla siguiente conserva las fechas v5.10/v5.11 con las que se diseñó el swap; las vigentes están en §12.
