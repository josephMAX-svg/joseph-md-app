# 🚦 PROTOCOLO DE MODO MÍNIMO — VERDE · ÁMBAR · ROJO (v5.13 · re-fechado 16-sep-2026)

> Válvula de burnout del régimen v5.13 (D1 = jue 17-sep-2026 · Step 1 = bloque principal · D94 = vie 29-ene-2027 = última sesión de banco · D95 = lun 1-feb = D-1 dentro del plan · examen target MAR 2-FEB-2027, fuera de la ventana 25-29 ene; sáb 30 y dom 31 libres).
...
> Evidencia de fragilidad que motiva el protocolo: **12 corrimientos seguidos (31-ago→17-sep, 13 días hábiles perdidos)** — 5 en bloque (31-ago→4-sep) y luego uno a uno el 7, 8, 9, 10, 11, 14, 15 y 16 de septiembre — más el 25-jun. El plan ya desborda la ventana 25-29 ene (D95 = lun 1-feb = D-1) y **el examen salió de la ventana: mar 2-feb** (Prometric por agendar/reprogramar, eligibility por confirmar); **cada día más sin estudiar mueve el examen otro hábil o exige recortar temario** (decisión de Joseph). El modo mínimo es ahora la única válvula.
...
4. **Decisión de corrimiento** (al cierre del día o a la mañana siguiente): si NO se hizo el bloque principal, el
   ...
   ya pasado, se movió al D1 en v5.10, v5.11, v5.12 y v5.13: jue 17-sep). ⚠ En v5.13 el D95 ya es el lun 1-feb (D-1 dentro del plan) y el examen quedó FUERA de la ventana (mar 2-feb): **no hay colchón**
...
|---|---|---|---|
| **S7** (S8 en v5.9) | lun 26 → vie 30-oct-2026 | post-NBME 26 (vie 23-oct) | MIR: eval D-1 + 30' (no 60') · ENCAPS: 12Q del tema del día (no 25) + registro · LIVIANO: 25' solo estudio (sin aplicación) · Research/Derma: 20' · AURUM: 30' · SYNAPSE: solo A (15') · Vibecoding: **RESUELTO v5.10b**: el proyecto con `deload: true` es el S7 (motor de preguntas ENCAPS); en v5.13 corre **jue 29-oct → mié 4-nov** (SHIP sáb 7-nov; con D1 en jueves los bloques de 5 hábiles van tres días por detrás de la semana de calendario: el lun 26, el mar 27 y el mié 28-oct son los días 3.º-5.º de S6 a carga normal; v5.12: mié 28-oct → mar 3-nov; v5.11: mar 27-oct → lun 2-nov) · 2 días de 45' + 3 de ≤15' |
| **S13** (S14 en v5.9) | lun 7 → vie 11-dic-2026 | post-NBME 28 (vie 4-dic) | ídem (el vibecoding S1-S12 termina el **mié 9-dic-2026** (v5.13; v5.12: mar 8-dic; v5.11: lun 7-dic) y su último SHIP es el sáb 12-dic; desde el jue 10-dic la franja 04:15 = taper S13 ≤15'/día: sensores verdes + journal) |
...
- **Sueño**: quick-log de VITALS a las 07:00 (20 s, `mv_wellness_logs` tipo `sueno`, user `joseph`). Mientras no
  ...
  Proyecto **S7** del vibecoding (jue 29-oct → mié 4-nov, SHIP sáb 7-nov · v5.13) lleva el dato al Home y sugiere ÁMBAR automáticamente.
- **Eval 18:00 y pre-test**: proyecto **S3** (jue 1-oct → mié 7-oct, SHIP sáb 10-oct · v5.13) crea `jmd-usmle-scores` → Supabase. Hasta entonces se anota
...
- **Días perdidos / niveles**: `jmd-modo-log` (la app) → export de localStorage → `gen_revision_semanal.js`
  ...
  **v5.10 (12-sep; vigente en v5.11-v5.13):** los ✓ de los 10 planes ya no viven solo en el navegador: la app los espeja en Supabase
