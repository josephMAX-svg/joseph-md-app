 ...
 * D1 = LUN 2026-09-28 → D95 = MIÉ 2027-02-10 (v5.16: 31-ago→25-sep no estudiados = 20 hábiles perdidos).
 * EXAMEN: target JUE 11-FEB-2027 (fuera de la ventana original 25-29 ene desde la v5.12). D94 mar 9-feb = última sesión
 * de banco; D95 mié 10-feb = D-1 REAL (sesión mínima AM + ritual de test-day; el examen es al día siguiente, sin finde en medio).
 ...
 * v5.16 (26-sep-2026) · 2.º CORRIMIENTO RÍGIDO (misma regla de v5.15, pedida por Joseph): el plan ENTERO (contenido + los
 * 12 hitos) se desplaza en bloque +3 días hábiles, así que **cada NBME/UWSA conserva su D# y sus días de contenido por
 * delante** (hasta v5.14 los 11 hitos distintos del UWSA1 estaban anclados por fecha y cada corrimiento les robaba preparación).
 * El UWSA1 sigue siendo el D1 (vie 11 → lun 14 → mar 15 → mié 16 → jue 17 → lun 21 → mié 23 → lun 28-sep). El contenido
 * arranca el mar 29-sep (D2). NADA se fusionó ni se recortó: el temario sale 1:1 y el desfase se absorbe por la cola.
 * Con D1 en LUNES los hitos vuelven a caer en VIERNES (D10, D25, D40, D55, D72, D77, D82, D87), salvo NBME 29 (lun 28-dic,
 ...
 *
 * FASES (v5.16, recalculadas sobre las fechas reales): A · Contenido por sistemas D1-D81 (28-sep→jue 21-ene, ~40Q
 ...
 *            (el UWSA2 vie 15-ene = D77 cae DENTRO de la Fase A y el cierre de Bioquímica es el jue 21-ene = D81)
 *        B · Banco intensivo D82-D86 (22-ene→28-ene: el NBME 31 GO/NO-GO abre la fase el día siguiente al cierre de contenido,
 *            random timed 2×40Q + sistema débil D84 mar 26 y D86 jue 28-ene, NBME 32 lun 25 y NBME 33 mié 27-ene dentro)
 *        C · Sprint final D87-D95 (29-ene→10-feb, Free 120 + banco + taper; D88 1-feb y D89 2-feb random timed, D90 3-feb y D91 4-feb
 *            incorrects 2ª pasada, D92 vie 5-feb y D93 lun 8-feb AMBOSS 200 mitades 1 y 2 — alojados dentro del sprint; D94-D95 taper)
 * HITOS (v5.16: todos corren con el plan y conservan su D#): UWSA1 lun 28-sep (baseline, D1) · NBME 25 vie 9-oct · 26 vie 30-oct ·
 *        27 vie 20-nov · 28 vie 11-dic · 29 lun 28-dic · NBME 30 vie 8-ene · UWSA2 vie 15-ene · NBME 31 vie 22-ene (GO/NO-GO) ·
 *        NBME 32 lun 25 / NBME 33 mié 27 / Free 120 vie 29-ene.
 ...
 * v5.10-Palmerton (12-sep-2026, vigente en v5.16): cada día lleva nivelUW (1-5 = los 5 niveles de maestría UWorld) y qDia (Q objetivo);
 ...
 *  · VIERNES DE NIVEL 4 (#6): desde S11 los viernes sin hito de Fase A que serían nivel 3 pasan a nivel 4 (v5.16: solo D60 vie 18-dic, Micro —
 *    con D1 en lunes los hitos vuelven a caer en viernes y las semanas del 25-dic y del 1-ene no tienen viernes hábil: queda uno, no dos)
 ...
 *  · TAPER (#22): D94 (mar 9-feb, D-2 = última sesión de banco) y D95 (mié 10-feb, D-1 real) = 20Q flagged + Anki maduro, cero contenido nuevo (franjaNota);
 *    v5.16: D95 = sesión mínima AM + ritual de test-day → USMLE_TAPER; sin finde libre entre el D95 y el examen (el D-1 real ES el D95);
 *    examen target JUE 11-FEB-2027 (fuera de la ventana 25-29 ene desde la v5.12).
...
export const DAILY_META = {
  step: 1, inicio: '2026-09-28', fin: '2027-02-10', totalDias: 95, // v5.16 (26-sep): 2.º corrimiento RÍGIDO (los hitos también corren) · D95 = mié 10-feb = D-1 real · examen target jue 11-feb-2027
  ...
  /** Ventana original (25-29 ene), superada desde la v5.12; v5.16: el plan termina el mié 10-feb. */
  examenVentana: '2027-01-25 → 2027-01-29 (superada desde v5.12; v5.16: D95 = mié 10-feb)',
  /** Target de examen v5.16 (26-sep): jue 11-feb-2027, primer hábil tras el D95 (sin fin de semana en medio). Agendar/reprogramar Prometric y confirmar eligibility period (decisión de Joseph: o esto, o recortar). */
  examenTarget: '2027-02-11',
  /** D-1 = mié 10-feb = D95, el último día del plan y la víspera real del examen (sesión mínima AM + ritual de test-day; USMLE_TAPER.dMenos1). */
  descansoD1: '2027-02-10',
...
/** Los 5 niveles de maestría UWorld (Palmerton, "UWorld Complete Guide: The Five Levels of Mastery to 260+") mapeados a las fases A/B/C del plan v5.16. */
export const USMLE_NIVELES: NivelUWInfo[] = [
  ...
  { nivel: 3, nombre: 'Sistema completo · timed', fase: 'A', formato: 'Bloques de 10-20Q de TODO el sistema · timed (sin la "ventaja injusta" de saber el subtema)', qDia: 'Palmerton 40-50Q/día → plan: 40Q (10 pre-test + 20Q sistema + 10 tutor)', umbral: '80% en 20Q timed consecutivas del sistema', dondeVive: 'VIERNES sin NBME/UWSA a las 11:00 hasta S10 (v5.16: D15 Cardio · D20 Resp · D35 GI · D45 y D50 Neuro; los viernes que abren sistema —D5 Inmuno, D30 GI— quedan en nivel 1): 20Q del sistema en curso, o del anterior si el sistema lleva <3 días · desde S11 el viernes pasa a nivel 4', color: '#6BB8B0' },
...
/**
 * Día previo de CONTENIDO: salta los hitos 🎯 (fix #6 de la 2.ª capa, 19-sep-2026). En v5.16 (mismos D# que v5.14/v5.15: corrimiento rígido) los días post-hito son
...
/** Fase del plan por número de día (v5.16, mismos D# que v5.14/v5.15: el corrimiento fue rígido): A contenido D1-81 (28-sep→21-ene; UWSA2 D77 dentro) · B banco D82-86 (22→28-ene: NBME 31 abre, random timed D84/D86, NBME 32/33 dentro) · C sprint D87-95 (29-ene→10-feb). */
...
/** Semana del plan: bloques de 7 días desde DAILY_META.inicio (v5.16: D1 = lun 28-sep-2026, así que S1 = lun 28-sep → dom 4-oct y las semanas vuelven a coincidir con las de calendario). Fuera de rango → 0. */
...
/**
 * TAPER y D-1 (Palmerton §8.3 · DIVERGENCIAS §E-5, implementada 12-sep-2026 · v5.16 26-sep: D94 mar 9-feb = última sesión de banco,
 * D95 mié 10-feb = D-1 REAL (sesión mínima + ritual); examen target JUE 11-FEB-2027, al día siguiente del D95).
...
export const USMLE_TAPER = {
  ...
  cierre: 'Desde NBME 31 (D82, vie 22-ene): cero preguntas nuevas y cero tarjetas nuevas (Palmerton: cesar 1-2 semanas antes); solo incorrects/flagged + AMBOSS 200 como repaso de conceptos ya vistos · no repetir NBME ya hechos.',
  d94: { d: 94, fecha: '2027-02-09', rol: 'D-2 · última sesión de banco (mar 9-feb)', resumen: 'Solo Anki MADURO + 20Q flagged/incorrects ya vistos · repaso First Aid de esquemas (sistemas 6-10) · dormir ≥7 h' },
  d95: { d: 95, fecha: '2027-02-10', rol: 'D-1 · mié 10-feb (último día del plan y víspera real del examen · v5.16)', resumen: 'Sesión MÍNIMA solo por la mañana (≤2 h): Anki maduro/vencido + 20Q flagged con los mejores esquemas e imágenes · rapid review FA · tarde: permiso impreso + digital, 2 ID con el nombre EXACTO del permiso, bolsas Ziploc numeradas, ruta al Prometric · nada después de las 17:00' },
  dMenos1: {
    fecha: '2027-02-10', rol: 'D-1 · mié 10-feb · = D95 (último día del plan y víspera real del examen · v5.16)',
    pasos: [
  ...
  examen: {
    fecha: '2027-02-11', rol: 'EXAMEN · jue 11-feb-2027 (target v5.16: fuera de la ventana 25-29 ene → agendar/reprogramar Prometric y confirmar eligibility period)',
    pasos: [
...
export const FRANJAS_REGLAS: Record<number, string[]> = {
  0: [
    ...
    'FRENO POR HITO (§4.10): % del banco / NBME estancado o en declive → nuevas = 0 y días dedicados a limpiar el backlog con honestidad; desde el NBME 31 (D82, vie 22-ene) nuevas = 0.',
