 ...
 * D1 = MAR 2026-09-15 → D95 = JUE 2027-01-28 (v5.11: 31-ago→14-sep no estudiados) · EXAMEN: semana 25–29 ene 2027
 * (target VIE 29-ene; el plan termina el jue 28 = D95 = D-1: el día de descanso pre-examen que en la v5.10 quedaba
 * FUERA del plan se absorbió con el corrimiento del 15-sep — ya no queda ningún margen dentro de la ventana).
 * v5.10/v5.11: el UWSA1 es el único hito que cambia de fecha en cada corrimiento (vie 11 → lun 14 → mar 15-sep) para
 * seguir siendo el D1 (baseline el primer día, como prescribe Palmerton). Los otros 11 hitos conservan su fecha y solo
 * cambian de D#. El contenido arranca el mié 16-sep (D2). NADA se fusionó ni se recortó: el temario sale 1:1 y el
 ...
 *
 * FASES (v5.11, recalculadas sobre las fechas reales): A · Contenido por sistemas D1-D80 (15-sep→7-ene, ~40Q
 ...
 *        B · Banco intensivo D81-D86 (8-ene→15-ene, UWSA2 + random timed + sistema débil + NBME 31 GO/NO-GO)
 *        C · Sprint final D87-D95 (18-ene→28-ene, NBME 32/33 + Free 120 + taper; D88 19-ene, D90 21-ene, D92 25-ene y
 *            D93 26-ene siguen siendo días de banco — incorrects 2ª pasada + AMBOSS 200 mitades 1 y 2 — alojados dentro del sprint)
 * HITOS: UWSA1 mar 15-sep (baseline, D1) · NBME 25/26/27/28/29 en viernes cada ~3 semanas · NBME 30 mié 30-dic ·
 ...
 * v5.10-Palmerton (12-sep-2026, vigente en v5.11): cada día lleva nivelUW (1-5 = los 5 niveles de maestría UWorld) y qDia (Q objetivo);
 ...
 *  · VIERNES DE NIVEL 4 (#6): desde S11 (vie 27-nov, D54) los viernes sin hito de Fase A que serían nivel 3 pasan a nivel 4
 ...
 *  · TAPER (#22): D94 (mié 27-ene, D-2) y D95 (jue 28-ene, D-1) = 20Q flagged + Anki maduro, cero contenido nuevo (franjaNota);
 *    v5.11: el D-1 quedó DENTRO del plan (D95 = sesión mínima por la mañana + ritual de test-day por la tarde) → USMLE_TAPER;
...
export const DAILY_META = {
  step: 1, inicio: '2026-09-15', fin: '2027-01-28', totalDias: 95, // v5.11 (14-sep): Step 1 = bloque principal · examen semana 25-29 ene 2027 (target vie 29-ene)
  ...
  /** Target de examen (decisión 12-sep): último día de la ventana; v5.11: el plan termina el jue 28 (D95 = D-1, dentro del plan). */
  examenTarget: '2027-01-29',
  /** D-1 (jue 28-ene) = D95, DENTRO del plan desde la v5.11 (el descanso pre-examen se absorbió): sesión mínima AM + ritual de test-day (USMLE_TAPER.dMenos1). */
...
/** Los 5 niveles de maestría UWorld (Palmerton, "UWorld Complete Guide: The Five Levels of Mastery to 260+") mapeados a las fases A/B/C del plan v5.11. */
...
/** Fase del plan por número de día (v5.11): A contenido D1-80 (15-sep→7-ene) · B banco D81-86 (8→15-ene) · C sprint D87-95 (18→28-ene). */
export function faseDe(d: number): 'A' | 'B' | 'C' { return d <= 80 ? 'A' : d <= 86 ? 'B' : 'C'; }
...
/** Semana del plan (S1 = semana L-V del D1; v5.11: D1 = mar 15-sep-2026, S1 = 14-18 sep). Fuera de rango → 0. */
...
/**
 * TAPER y D-1 (Palmerton §8.3 · DIVERGENCIAS §E-5, implementada 12-sep-2026 · v5.11 14-sep: el plan termina el jue 28-ene
 * y el D95 ES el D-1 — el día de descanso pre-examen que quedaba fuera del plan se absorbió con el corrimiento);
 * el examen target es el vie 29-ene (último día de la ventana 25-29). Ya no queda margen dentro de la ventana.
...
export const USMLE_TAPER = {
  ...
  cierre: 'Desde NBME 31 (D86, vie 15-ene): cero preguntas nuevas y cero tarjetas nuevas (Palmerton: cesar 1-2 semanas antes); solo incorrects/flagged + AMBOSS 200 como repaso de conceptos ya vistos · no repetir NBME ya hechos.',
  d94: { d: 94, fecha: '2027-01-27', rol: 'D-2', resumen: 'Solo Anki MADURO + 20Q flagged/incorrects ya vistos · repaso First Aid de esquemas (sistemas 6-10) · dormir ≥7 h' },
  d95: { d: 95, fecha: '2027-01-28', rol: 'D-1 (dentro del plan · v5.11)', resumen: 'Sesión MÍNIMA solo por la mañana (≤2 h): Anki maduro/vencido + 20Q flagged con los mejores esquemas e imágenes · rapid review FA · tarde: permiso impreso + digital, 2 ID con el nombre EXACTO del permiso, bolsas Ziploc numeradas, ruta al Prometric · nada después de las 17:00' },
  dMenos1: {
    fecha: '2027-01-28', rol: 'D-1 · jue 28-ene · = D95 (dentro del plan desde la v5.11: el corrimiento del 15-sep absorbió el día de descanso)',
    pasos: [
