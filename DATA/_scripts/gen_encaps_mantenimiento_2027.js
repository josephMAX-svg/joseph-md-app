 ...
 *
 * Régimen v5.11 (D1 = mar 2026-09-15; v5.10: lun 14-sep): ENCAPS = 1h/día (16:15-17:15 L-V) hasta el 29-ene-2027
 ...
 *
 * Uso:
 *   node DATA/_scripts/gen_encaps_mantenimiento_2027.js [D1=2026-09-15] [--bk study_schedule_bk_YYYYMMDD]
...
const D1 = argv.find((a) => /^20\d\d-\d\d-\d\d$/.test(a)) || '2026-09-15';
