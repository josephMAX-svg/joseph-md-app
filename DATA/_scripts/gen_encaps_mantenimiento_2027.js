 ...
 * Aplicar por MCP execute_sql. Backup: study_schedule_bk_0827.
 */
const fs = require('fs');
...
const rows = [];
let dia = 0, slot = 0;
for (const { fecha, dow } of fechas('2026-08-31', '2027-01-29')) {
  dia++;
  if (dow === 5) {
...
BEGIN;
DROP TABLE IF EXISTS study_schedule_bk_0827;
CREATE TABLE study_schedule_bk_0827 AS SELECT * FROM study_schedule;
