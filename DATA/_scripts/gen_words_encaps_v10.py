...
#  2) MAESTRO global 2-jul→20-ago (Fase1 ≤17d TODO el temario front-load Pareto · Fase2 vueltas/preguntas · Fase3 sims)
#  3) SEMANAL detallado 2-jul→5-jul
...
FASE1=[
 ('D1 · Jue 2-jul',['I-3']),('D2 · Vie 3-jul',['V-2']),('D4 · Lun 6-jul',['I-5+I-6']),
 ('D5 · Mar 7-jul',['II-3']),('D6 · Mié 8-jul',['III-5','II-6']),('D7 · Jue 9-jul',['I-4','II-9']),
 ('D8 · Vie 10-jul',['V-3','II-7']),('D10 · Lun 13-jul',['II-11','II-5']),
 ('D11 · Mar 14-jul',['I-1','II-10']),('D12 · Mié 15-jul',['II-1','II-4']),
 ('D13 · Jue 16-jul',['II-8','III-1']),('D14 · Vie 17-jul',['V-1','III-4+III-7']),
 ('D16 · Lun 20-jul',['III-9','I-11+I-12','V-6']),('D17 · Mar 21-jul',['IV-1+IV-2','III-6+III-10','I-7']),
 ('D18 · Mié 22-jul',['I-2','II-2','I-10','III-3']),
 ('D19 · Jue 23-jul',['III-2','V-7+V-10','IV-4','IV-3+IV-5']),
 ('D20 · Vie 24-jul',['III-8','II-12','IV-6+IV-7','I-8','I-9','II-13']),
]
...
d=newdoc()
cover(d,'PLAN MAESTRO ENCAPS 2026-II','2-jul → 20-ago · 43 días hábiles · v10 DATA-DRIVEN (Pareto + repetición espaciada · EXTENDIDO no comprime)')
...
for f,dd,ob in [('FASE 1 · COBERTURA','2-jul → 24-jul (~17 días háb.)','1ª vuelta de TODO el temario, front-load Pareto. Cada tema cierra con banco (retrieval).'),
...
P(d,'')
P(d,'Días 3,9,15,21,27 (sábados) = simulacros · Dom libres. Tras el día 20 (vie 24-jul) → NO más temario nuevo.',bold=True,c=RED,sz=10)
...
d.save(os.path.join(OUT,'Plan_MAESTRO_ENCAPS_v10_2jul-20ago.docx'))

# =================== DOC 3 · SEMANAL detallado ===================
d=newdoc()
cover(d,'PLAN SEMANAL ENCAPS · SEMANA 1','Jue 2-jul → Dom 5-jul · v10 DATA-DRIVEN (detallado)')
P(d,'INICIO DEFINITIVO jue 2-jul (no más reprogramaciones). Semana 1 corta (jue-vie): siembra los 2 temas #1-2 del examen, ambos CRÍTICA (6 vueltas), con deep-work completo. I-5+I-6 (Bioestadística, #3) arranca el lunes 6-jul. Sáb 4-jul = simulacros · Dom 5-jul libre. Examen FIJO jue 20-ago (43 días).',c=GREY)
WK=[('Jueves 2-jul · D1/43','I-3','Directiva 067 RM 506-2020',
    ...
    ('Viernes 3-jul · D2/43','V-2','Directiva CEPLAN 001-2024 (NUEVA)',
...
H(d,'📅 Sábado 4-jul · D3/43 — SIMULACROS',13,RED)
...
P(d,'2 temas CRÍTICA (#1-2 del examen) sembrados jue-vie con deep-work + sábado de simulacros + domingo libre. La próxima semana (lun 6-jul→) acelera con el multi-tema: I-5+I-6, II-3, III-5+II-6… hasta cubrir TODO el temario al vie 24-jul; luego repaso + preguntas + mapas + simulacros hasta el examen (jue 20-ago). META: >17/20 — ver Word META_NIVEL_METODO.')
d.save(os.path.join(OUT,'Plan_Semanal_ENCAPS_v10_2jul-5jul_DATADRIVEN.docx'))
