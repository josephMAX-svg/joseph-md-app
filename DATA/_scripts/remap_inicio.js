...
// 1) USMLE daily (102 · v5) — ⚠ los simulacros de hito están anclados a VIERNES con D1=31-ago;
//    si remapeas a otro START, los hitos caen en otro día de la semana (aceptado: corrimiento determinista).
{const f='src/lib/usmleStep1Daily.ts';if(countFechas(f,'export const DIAS').length!==102)throw new Error('USMLE!=102');const nd=calNoWeekend(START,102);replaceFechas(f,'export const DIAS',nd);setMeta(f,'export const DAILY_META',START,nd[101]);console.log('USMLE ✓ '+nd[0]+'→'+nd[101]);}
// 2) MIR (78)
