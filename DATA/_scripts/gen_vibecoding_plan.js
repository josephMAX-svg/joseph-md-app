...
// Calendario: START = argv[2] (YYYY-MM-DD, default 2026-09-17 = D1 v5.13) · días HÁBILES L-V (salta sáb/dom y los
...
//     (S15 = 4 días, S16 = 3, S20 = 3; v5.13: bloques secuenciales, S20 = jue 28-ene → lun 1-feb-2027 = D95 del Step 1; examen mar 2-feb).
...
//
// Uso:  node DATA/_scripts/gen_vibecoding_plan.js 2026-09-17
...
// Último día del taper = D95 del Step 1 (lun 1-feb-2027 con START=2026-09-17). Se calcula, no se fija a mano:
