...
// Calendario: START = argv[2] (YYYY-MM-DD, default 2026-09-23 = D1 v5.15) · días HÁBILES L-V (salta sáb/dom y los
...
//     (S15 = 4 días, S16 = 3, S20 = 3; v5.15: bloques secuenciales, S20 = mié 3 → vie 5-feb-2027 = D95 del Step 1; examen lun 8-feb).
...
//
// Uso:  node DATA/_scripts/gen_vibecoding_plan.js 2026-09-23
...
// Último día del taper = D95 del Step 1 (vie 5-feb-2027 con START=2026-09-23). Se calcula, no se fija a mano:
