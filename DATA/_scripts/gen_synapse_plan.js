...
//   · F2 · sem 13-19 (lun 7-dic → mar 26-ene, v5.13) = ANTHROPIC ACADEMY RESTANTE + prep CCA-F a 30': Building with the
...
const FIN_PLAN = '2027-01-26'; // v5.13 (16-sep-2026): mar 26-ene-2027. Con D1 = jue 17-sep las 110 A-units corren +1 día más (nada se fusiona; el domingo no cuenta): 30' de lectura, sin PC. v5.12: lun 25-ene · v5.11: sáb 23-ene · v5.10: vie 22-ene. Se comprueba al final.
...
const SEM_MAX = 19; // v5.10-b: sem 13-19 = F2 (v5.13: la última A-unit cae el mar 26-ene-2027; los días 132-133 se clampan a la sem 19 para los bloques B/C)
const dias = [];
 ...
 * Después del ${FIN_PLAN} (mar 26-ene-2027 en v5.13) no hay SYNAPSE: el resto = solo Step 1 (D95 lun 1-feb, examen mar 2-feb).
 */
