...
//   · F2 · sem 13-19 (lun 7-dic → lun 25-ene, v5.12) = ANTHROPIC ACADEMY RESTANTE + prep CCA-F a 30': Building with the
...
const FIN_PLAN = '2027-01-25'; // v5.12 (15-sep-2026): lun 25-ene-2027. Con D1 = mié 16-sep las 110 A-units corren +1 día más (nada se fusiona; el domingo no cuenta) y la última cae el lunes de la semana del examen (25-29 ene): 30' de lectura, sin PC. v5.11: sáb 23-ene · v5.10: vie 22-ene. Se comprueba al final.
...
function buildAUnits() {
  ...
  // v5.10-b · cierre de la sem 12 (vie 4-dic + sáb 5-dic, antes fuera del plan): 2 A-units F1 con lecciones reales aún no usadas
...
const SEM_MAX = 19; // v5.10-b: sem 13-19 = F2 (v5.12: la última A-unit cae el lun 25-ene-2027; ese día se clampa a la sem 19 para los bloques B/C)
const dias = [];
 ...
 * Después del ${FIN_PLAN} (lun 25-ene-2027 en v5.12) no hay SYNAPSE: el resto de la semana del examen = solo Step 1 (examen lun 1-feb).
 */
