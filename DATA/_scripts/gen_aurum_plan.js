...
//  · INICIO = 2026-06-17. Las 130 lecciones se asignan a días HÁBILES consecutivos
...
// ─── Calendario: 130 días hábiles L-V consecutivos desde 2026-06-17 ───
const WD = ['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb'];
const START = new Date('2026-06-17T12:00:00'); // miércoles 17-jun-2026
function nextBusinessDay(date) {
  const d = new Date(date);
  do { d.setTime(d.getTime() + 86400000); } while (d.getDay() === 0 || d.getDay() === 6);
  return d;
}
// primer día hábil ≥ START (17-jun es miércoles → hábil)
