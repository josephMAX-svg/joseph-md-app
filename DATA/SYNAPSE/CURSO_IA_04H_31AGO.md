# 🧠 FRANJA 04:15–05:45 (v5.2 · serie desde lun 31-ago-2026 · D1 efectivo MIÉ 16-SEP-2026, v5.12) — IA VIBECODING + ANKI AM

> **v5.12 (15-sep-2026):** el mar 15 de septiembre tampoco se estudió → D1 efectivo = **mié 16-sep-2026**
> (undécimo corrimiento, 31-ago→16-sep). Regla de este corrimiento: **no se fusiona ni se recorta nada**; el
> desfase se absorbe alargando el final. La franja, el reparto 45'+45' y las metas NO cambian; solo se
> re-fecharon los planes: **vibecoding S1-S12 = 12 bloques de 5 hábiles (mié 16-sep → mar 8-dic-2026; con D1 en miércoles cada
> bloque va mié→mar y el SHIP cae el sábado siguiente: 26-sep → 12-dic — los mismos sábados que en v5.11) + taper
> S13-S20 = bloques SECUENCIALES de `pasos.length` hábiles (mié 9-dic → vie 29-ene-2027; 95 días en total = los del Step 1, d == D#; ningún paso perdido)** y
> **SYNAPSE 132 días · 19 semanas (mié 16-sep-2026 → lun 25-ene-2027; 110 A-units intactas: F0 46 · F1 24 · F2 40; sem 1 = 16-20 sep, corta; F2 sem 13-19)**. ⚠ **El Step 1 llena la ventana 25-29 ene (D95 = vie 29-ene = última sesión) → examen target LUN 1-FEB-2027**, fuera de la ventana; sáb 30 y dom 31-ene = descanso (solo Anki vencido). El Anki AM sigue hasta el vie 29-ene y el domingo solo lo vencido. Fechas leídas con node de `vibecodingPlan.ts` / `synapseDailyPlan.ts` /
> `usmleStep1Daily.ts` el 15-sep, no estimadas. ⚠ Con D1 en miércoles, la **última A-unit de SYNAPSE (d132) cae el LUNES 25-ene**, dentro de la semana final del plan Step 1 (D91; v5.11: sáb 23-ene; v5.10: vie 22-ene): **decisión de Joseph** si se mantiene o se adelanta al viernes 22 (`PENDIENTES_JOSEPH.md`).
> *(v5.11, 14-sep: D1 mar 15-sep · vibecoding mar 15-sep → lun 7-dic, SHIP 26-sep → 12-dic · taper 8-dic → 28-ene · SYNAPSE mar 15-sep → sáb 23-ene, 131 días. v5.10, 12-sep: D1 lun 14-sep · vibecoding lun 14-sep → vie 4-dic, SHIP 19-sep → 5-dic · taper 7-dic → 27-ene · SYNAPSE lun 14-sep → vie 22-ene.)*
>
...
- **Currículo (v5.10-b, RE-SECUENCIADO el 12-sep con lo ya construido; re-fechado a v5.12 el 15-sep)**: `DATA/SYNAPSE/VIBECODING_12_PROYECTOS.md` — 12 proyectos S1-S12
  (**mié 16-sep → mar 8-dic-2026**, 5 pasos hábiles cada uno en bloques mié→mar; SHIP en los sábados **26-sep → 12-dic**) ordenados por
  ...
  **S1** APEX end-to-end (redeploy n8n + 1 APEX USMLE íntegro en Anki y vault + ruteo por subtema) · **S2** Anki sync + KPI
  ...
  tablas sin RLS · **S7** motor de preguntas ENCAPS desde el stock del banco propio (proyecto con flag `deload`: en v5.12 corre **mié 28-oct → mar 3-nov**, dos días
  por detrás de la semana DELOAD post-NBME 26 del 26-30 oct — el lun 26 y el mar 27-oct son los días 4.º y 5.º de S6) · **S8** pool MIR (cuadernillos 2022-2026: clasificación verificada + UI 10Q) ·
...
- **Taper S13-S20 (mié 9-dic-2026 → vie 29-ene-2027, 35 días; el día d del vibecoding = D# del Step 1, 95 en total; desde v5.11 son bloques SECUENCIALES de `pasos.length` hábiles, ningún paso perdido)**:
  ...
  = **deload total**: journal 5' + audio, PC sáb/dom opcional (30' máx, solo VERDE); S20 = cierre del plan (mié 27 → vie 29 = D93-D95,
  vie 29 = última sesión del Step 1; sáb 30 y dom 31 descanso; lun 1-feb EXAMEN). Ningún proyecto nuevo; la decisión de febrero (IA vs ENCAPS intensivo) sigue intacta.
...
- **SYNAPSE 12:30 sem 13-19 (lun 7-dic → lun 25-ene)**: Anthropic Academy restante + prep CCA-F (F2 del motor, 50 días, 40 A-units; sem 17-19
  deload; la última A-unit cae el lun 25-ene, D91 del Step 1 — A DECIDIR si se adelanta al vie 22-ene). La página oficial del examen CCA-F no aparece enlazada en academy.claude.com ni en anthropic.skilljar.com
  (verificado 12-sep): **A VERIFICAR** antes de fijar fecha (post-Step 1, feb-2027).

## 05:00–05:45 · 🇺🇸 USMLE — ANKI AM (L-V, hasta el vie 29-ene = D95; dom 31-ene solo vencido; examen lun 1-feb)
...
- **Fase A (sep-ene, D1-D81 = 16-sep-2026 → lun 11-ene-2027)**: 45' pasada principal FSRS. El bloque de 07:15 queda para el repaso anclado
  D-1/D-3/D-7 + free recall + Anki restante.
- **Fases B-C (ene, B = D82-D85 12→15-ene · C = D86-D95 18→29-ene-2027)**: 05:00-05:12 🔥 **STRESS SET** (10Q uWorld random en 12 min — confiar en
...
- **LIVIANO** — única academia activa hasta enero (17:15–18:00, plan de 90 días en la app: **mié 16-sep-2026 → vie 22-ene-2027**, v5.12; ⚠ sus 16 casos corren una semana y el caso integral cae después del capstone — ver `DATA/BUSINESS/LIVIANO_ACADEMIA.md`).
