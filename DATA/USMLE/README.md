# DATA · USMLE Step 1 — Doc maestro v5.5 (reestructuración 27-ago · corrimiento 3-sep-2026)

**Step 1 es el bloque PRINCIPAL** (heredó las franjas ENCAPS de la mañana): 6h15/día L-V.
**D1 = VIE 4-sep-2026 → D98 = VIE 22-ene-2027 (98 días; 31-ago, 1-sep, 2-sep y 3-sep no se
estudiaron) · EXAMEN: semana 25-29 ene 2027 (target MIÉ 27-ene).**
Sábados y domingos LIBRES. Skip extra: 25-dic, 31-dic, 1-ene.
Fuente de verdad (código): [`src/lib/usmleStep1Daily.ts`](../../src/lib/usmleStep1Daily.ts) **v5.5**
(`DAILY_META.totalDias = 98`, `inicio = 2026-09-04`, `fin = 2027-01-22`).
...
|------|------|--------|-------------|
| **A · Contenido por sistemas** | D1-D83 | vie 4-sep → mié 30-dic | 1ª pasada completa del temario + ~40Q uWorld/día (= 1ª vuelta del banco entero) + 7 simulacros de hito |
| **B · Banco intensivo** | D84-D93 | lun 4-ene → vie 15-ene | Random timed + incorrects + AMBOSS 200 Concepts · UWSA2 (8-ene) · NBME 31 (15-ene, **GO/NO-GO**) |
| **C · Sprint final** | D94-D98 | lun 18-ene → vie 22-ene | NBME 32 · NBME 33 · Free 120 · taper |

## 2. Sistema → días → fechas (según `usmleStep1Daily.ts` v5.5, generado desde `DIAS`)

| Sistema | Días | Fechas | Tier | Nº días |
|---------|------|--------|------|---------|
| Fundamentos (Pathoma 1-2 + setup Anki FSRS) | D1-D2 | 4-sep → 7-sep | CORE | 2 |
| Immunology | D3-D4 | 8-sep → 9-sep | CORE | 2 |
| Cardiovascular | D5 · D7-D15 | 10-sep → 24-sep | CORE | 10 |
| Respiratory | D16-D20 · D22 | 25-sep → 5-oct | CORE | 6 |
| Renal | D23-D28 | 6-oct → 13-oct | CORE | 6 |
| Gastrointestinal | D29-D35 | 14-oct → 22-oct | CORE | 7 |
| Endocrine | D37-D42 | 26-oct → 2-nov | CORE | 6 |
| Nervous System | D43-D50 | 3-nov → 12-nov | CORE | 8 |
| Hematology & Oncology | D52-D57 | 16-nov → 23-nov | HIGH | 6 |
| Microbiology / ID | D58-D64 | 24-nov → 2-dic | HIGH | 7 |
| Reproductive | D65 · D67-D70 | 3-dic → 10-dic | HIGH | 5 |
| Musculoskeletal / Rheum | D71-D73 | 11-dic → 15-dic | HIGH | 3 |
| Psychiatry & Behavioral | D74-D75 · D77 | 16-dic → 21-dic | HIGH | 3 |
| Biostats/Epi + ética (AMBOSS HY 155Q; `system` = Psychiatry & Behavioral) | D78 | 22-dic | HIGH | 1 |
| Biochemistry | D79-D81 | 23-dic → 28-dic | MED | 3 |
| Pharmacology general (PK/PD + toxicología) | D82 | 29-dic | HIGH | 1 |
| Assessment (9 hitos, ver §3) | D6 · D21 · D36 · D51 · D66 · D76 · D83 · D88 · D93 | 11-sep → 15-ene | CORE | 9 |
| Banco intensivo (Fase B) | D84-D87 · D89-D92 | 4-ene → 14-ene | CORE | 8 |
| Sprint final (Fase C) | D94-D98 | 18-ene → 22-ene | CORE | 5 |

> Los huecos dentro de un sistema (D6, D21, D36, D51, D66, D76, D83, D88, D93) son los **días de
> Assessment** (hitos, abajo); en Fase C, D94/D96/D98 son NBME 32/33 y Free 120 con
> `system = 'Sprint final'`.
...
| # | Hito | Día | Fecha | Rol |
|---|------|-----|-------|-----|
| 1 | **UWSA1** | D6 | vie 11-sep | Baseline (esperar bajo, no asustarse) |
| 2 | **NBME 25** | D21 | vie 2-oct | 1ª calibración real |
| 3 | **NBME 26** | D36 | vie 23-oct | Tendencia |
| 4 | **NBME 27** | D51 | vie 13-nov | Tendencia |
| 5 | **NBME 28** | D66 | vie 4-dic | Tendencia |
| 6 | **NBME 29** | D76 | vie 18-dic | Cierre de contenido |
| 7 | **NBME 30** | D83 | **mié 30-dic** | Cierre Fase A (jue 31-dic y vie 1-ene son skip) |
| 8 | **UWSA2** | D88 | vie 8-ene | Predictor fuerte |
| 9 | **NBME 31** | D93 | vie 15-ene | **GO/NO-GO** |
| 10 | NBME 32 · NBME 33 · **Free 120** | D94 · D96 · D98 | lun 18 · mié 20 · vie 22-ene | Sprint final |
...
| Fichero | Rol |
|---------|-----|
| [`src/lib/usmleStep1Daily.ts`](../../src/lib/usmleStep1Daily.ts) | **v5.5 = FUENTE DE VERDAD**: DIAS (98), FRANJAS (6), DAILY_META, helpers |
...
- [`CALENDARIO_5_MESES.md`](CALENDARIO_5_MESES.md) — semana a semana S1-S21 + día a día D1-D98 + reglas de reprogramación + gates ECFMG.
...
> fijos) y a **v5.5** el 3-sep (D1=vie 4-sep, 98 días: 3-sep tampoco se estudió y 1 día de
> contenido USMLE se fusionó en el re-fecheo — mismo pipeline, hitos de viernes intactos). El
> examen ya no es feb-2028: es **ene-2027**.
