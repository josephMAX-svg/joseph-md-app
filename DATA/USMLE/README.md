# DATA · USMLE Step 1 — Doc maestro v5.15 (reestructuración 27-ago · corrimiento RÍGIDO 22-sep-2026 · niveles Palmerton)

**Step 1 es el bloque PRINCIPAL** (heredó las franjas ENCAPS de la mañana): 6h15/día L-V.
**D1 = MIÉ 23-sep-2026 → D95 = VIE 5-feb-2027 (95 días; del 31-ago al 22-sep no se estudió: 17 hábiles perdidos) ·
EXAMEN: D95 = vie 5-feb = D-1 DENTRO del plan (sesión mínima AM + ritual de test-day) → target LUN 8-FEB-2027;
D94 = jue 4-feb = última sesión de banco (D-2); sáb 6 y dom 7-feb libres (solo Anki vencido) entre el D95 y el examen.**
Sábados y domingos LIBRES. Skip extra: 25-dic, 31-dic, 1-ene.
Fuente de verdad (código): [`src/lib/usmleStep1Daily.ts`](../../src/lib/usmleStep1Daily.ts) **v5.15**
(`DAILY_META.totalDias = 95`, `inicio = '2026-09-23'`, `fin = '2027-02-05'`, `examenVentana = '2027-01-25 → 2027-01-29
(superada desde v5.12; v5.15: D95 = vie 5-feb)'`, `examenTarget = '2027-02-08'`, `descansoD1 = '2027-02-05'`).

> **Corrimiento v5.14 → v5.15 (22-sep-2026) · RÍGIDO.** Ni el lunes 21 ni el martes 22 de septiembre se estudiaron, así que
> D1 pasó de lun 21-sep a **mié 23-sep** (regla del sistema: cada día sin estudiar = +1 día hábil). Es el
> **decimocuarto corrimiento** desde el 31-ago (31-ago→22-sep sin estudiar = 17 días hábiles perdidos).
> **REGLA NUEVA DE JOSEPH (v5.15): el corrimiento es RÍGIDO.** Se desplaza el plan ENTERO — contenido **y** los 12
> hitos — en bloque: **no se toca ningún tema** y, donde un plan tenía un final clavado, **se AMPLÍAN días** en vez de
> perder sesiones. Sigue vigente la **REGLA PERMANENTE (v5.8): no se fusiona ni se recorta NADA**: el temario sale 1:1 y
> el desfase se absorbe **alargando el final del plan**, nunca comprimiendo días. D95 pasa de mié 3-feb a
> **vie 5-feb-2027**. Las metas, las franjas horarias y el temario no cambian.
>
> 🆕 **Los 12 hitos NBME/UWSA ya NO están anclados por fecha: corren con el plan y conservan su D# exacto.** Hasta la
> v5.14, 11 de ellos mantenían la fecha y solo bajaba su D#, de modo que **cada corrimiento les robaba días de contenido
> por delante** (el NBME 25 cayó de D18 a D10 y el NBME 31 acabó pegado al cierre de temario). Desde la v5.15 cada NBME
> conserva su preparación y lo que cambia es su fecha. ⚠ Efecto colateral: **los hitos dejan de caer en viernes** — 9
> pasan a **martes** (NBME 25-30, UWSA2, NBME 31 y Free 120), NBME 32 a miércoles y NBME 33 a viernes; a cambio, los
> viernes quedan libres para bloques de nivel 3/4 (5 viernes N3 + **2** N4).
>
> **El UWSA1 vuelve a cambiar de fecha** (lun 21-sep, ya pasada sin estudiar → **mié 23-sep, sigue siendo
> el D1**: baseline el primer día, como prescribe Palmerton). El primer día de CONTENIDO (Fundamentos,
> Pathoma 1-2) es el **jue 24-sep = D2**; Cardio arranca el mié 30-sep (D6). Con el D1 en miércoles, **S1 queda corta
> (23-25 sep, 3 días)** y de S2 en adelante las semanas del plan (`semanaDe`) son semanas de calendario completas:
> S2 = 28-sep … **S20 = 1-5 feb**.
>
> 🔴 **Herencia de la v5.14 que el corrimiento rígido conserva tal cual: el contenido cierra el lun 18-ene (D81) y el
> NBME 31 GO/NO-GO cae AL DÍA SIGUIENTE (mar 19-ene = D82), sin días de banco de consolidación delante.** Los dos random
> timed siguen detrás de él en **D84 (jue 21-ene) y D86 (lun 25-ene)**, intercalados con NBME 32 (D83, mié 20-ene) y
> NBME 33 (D85, vie 22-ene): la **Fase B** es **D82-D86 = NBME 31 → NBME 32 → banco → NBME 33 → banco** y la **Fase C**
> arranca con el **Free 120 (D87, mar 26-ene)**.
> El examen se mueve al **LUN 8-FEB-2027**: el **D95 = vie 5-feb es el D-1 dentro del plan** (sesión mínima solo por la
> mañana: Anki maduro/vencido + 20Q flagged con los mejores esquemas, ≤2 h; tarde de ritual de test-day: permiso + 2 ID +
> Ziploc + ruta al Prometric; nada después de las 17:00 — `USMLE_TAPER.d95` = `USMLE_TAPER.dMenos1`), el **D94 (jue 4-feb)
> es la última sesión de banco (D-2)** y el **sáb 6 y dom 7-feb quedan libres** entre el D95 y el examen (solo Anki
> vencido; repetir el ritual el domingo por la tarde).
> **Target de examen: LUN 8-FEB-2027** (`DAILY_META.examenTarget = '2027-02-08'`,
> `USMLE_TAPER.examen`). **Joseph debe agendar/reprogramar el Prometric para el lun 8-feb y confirmar que su eligibility
> period cubre esa fecha** (si no: extenderlo). La alternativa es **recortar temario** para volver atrás — decisión suya,
> registrada en [`PALMERTON_DIVERGENCIAS_PLAN.md`](PALMERTON_DIVERGENCIAS_PLAN.md) §E-5 (sustituye a la decisión del 19-sep:
> rendir el jue 4-feb).
...
> **idéntico** al de la v5.14 (0 filas perdidas y 0 filas nuevas en las 95) y, al ser un corrimiento rígido, el remapeo
> D#(v5.14) → D#(v5.15) es la **identidad**: los 95 días conservan su D# y solo cambia su fecha (+2 hábiles). El total de
...
|------|------|--------|-------------|----------------------------|
| **A · Contenido por sistemas** | D1-D81 | mié 23-sep → lun 18-ene | UWSA1 baseline (D1) + 1ª pasada completa del temario desde D2 + 30-40Q uWorld/día por nivel (= 1ª vuelta del banco entero) + 8 simulacros de hito (7 NBME/UWSA1 + **UWSA2 D77, que cae DENTRO de la Fase A**) · cierre de Bioquímica = D81 lun 18-ene | **1 → 3** (+ dosis diaria de 4 en la eval 18:00) · **viernes de nivel 4 desde S11** (ahora DOS: D53 vie 4-dic Heme y D63 vie 18-dic Micro — con los hitos fuera de los viernes ninguno se los come) |
| **B · Banco intensivo** | D82-D86 | mar 19-ene → lun 25-ene | **NBME 31 (D82, mar 19-ene, GO/NO-GO) la ABRE, el día siguiente al cierre de contenido** · NBME 32 (D83, mié 20-ene) · random timed 2×40Q + sistema débil #1 (D84 jue 21-ene) · NBME 33 (D85, vie 22-ene) · random timed 2×40Q + sistema débil #1 (D86 lun 25-ene) | **4 → 5** |
| **C · Sprint final** | D87-D95 | mar 26-ene → vie 5-feb | Free 120 (D87) · banco alojado en el sprint (D88 y D89 random timed + sistema débil #2/Mehlman · D90 y D91 incorrects 2ª pasada · D92 AMBOSS 200 mitad 1 · D93 mitad 2) · **taper explícito (D94 jue 4-feb = D-2, última sesión de banco, 20Q flagged + Anki maduro) → D95 vie 5-feb = D-1 dentro del plan (sesión mínima + ritual)** → sáb 6 / dom 7-feb libres → **lun 8-feb examen** (§3b) | **5** + NBME |

Días por fase (`faseDe` en el TS): **A = 81 · B = 5 · C = 9** (total 95). El corte A/B sigue en
**D81** (el **UWSA2 (mar 12-ene) es D77 y queda dentro de la Fase A**; los dos días dobles de Bioquímica, D80 vie 15-ene y
D81 lun 18-ene, cierran la fase íntegros y seguidos detrás del UWSA2). **Herencia de la v5.14 que el corrimiento rígido
conserva: el NBME 31 (D82, mar 19-ene) cae el día siguiente al cierre de contenido, sin días de banco de consolidación
delante** — la Fase B es **D82-D86 (5 días: 3 NBME + 2 random timed)** y el corte B/C queda en **D87** (Free 120, mar 26-ene,
...
> D82-86 / D87-95 es exactamente la misma que en la v5.14 y solo se desplazan las fechas.

## 2. Sistema → días → fechas (generado desde `DIAS` de `usmleStep1Daily.ts` v5.15)

| Sistema | Días | Fechas | Tier | Nº días |
|---------|------|--------|------|---------|
| Assessment | D1 · D10 · D25 · D40 · D55 · D65 · D72 · D77 · D82 | mié 23-sep → mar 19-ene | CORE | 9 |
| Fundamentos | D2-D3 | jue 24-sep → vie 25-sep | CORE | 2 |
| Immunology | D4-D5 | lun 28-sep → mar 29-sep | CORE | 2 |
| Cardiovascular | D6-D9 · D11-D16 | mié 30-sep → mié 14-oct | CORE | 10 |
| Respiratory | D17-D22 | jue 15-oct → jue 22-oct | CORE | 6 |
| Renal | D23-D24 · D26-D29 | vie 23-oct → lun 2-nov | CORE | 6 |
| Gastrointestinal | D30-D36 | mar 3-nov → mié 11-nov | CORE | 7 |
| Endocrine | D37-D39 · D41-D42 | jue 12-nov → jue 19-nov | CORE | 5 |
| Nervous System | D43-D50 | vie 20-nov → mar 1-dic | CORE | 8 |
| Hematology & Oncology | D51-D54 · D56-D57 | mié 2-dic → jue 10-dic | HIGH | 6 |
| Microbiology / ID | D58-D64 | vie 11-dic → lun 21-dic | HIGH | 7 |
| Reproductive | D66-D70 | mié 23-dic → mié 30-dic | HIGH | 5 |
| Musculoskeletal / Rheum | D71 · D73-D74 | lun 4-ene → jue 7-ene | HIGH | 3 |
| Psychiatry & Behavioral | D75-D76 · D78-D79 | vie 8-ene → jue 14-ene | HIGH | 4 |
| Biochemistry | D80-D81 | vie 15-ene → lun 18-ene | MED | 2 |
| Sprint final | D83 · D85 · D87 · D94-D95 | mié 20-ene → vie 5-feb | CORE | 5 |
| Banco intensivo | D84 · D86 · D88-D93 | jue 21-ene → mié 3-feb | CORE | 8 |

> **El D1 (mié 23-sep) es Assessment, no contenido**: el UWSA1 se movió a ese día (su fecha anterior,
> lun 21-sep, ya pasó) y el baseline ocupa el primer día del plan (exactamente lo que prescribe
> Palmerton); **Fundamentos empieza el jue 24-sep = D2**.
> Los demás huecos dentro de un sistema (D10, D25, D40, D55, D65, D72, D77, D82) son los otros
> **días de Assessment** (hitos, §3). Reparto (idéntico al de la v5.14, porque el corrimiento rígido no cambia ningún D#): el NBME 25 (D10) sigue **partiendo
> Cardio** (D6-D9 delante: anatomía/fisiología, hemodinámica, curvas PV/Wiggers D8 y electrofisiología D9; **D11-D16** detrás:
> taquiarritmias, antiarrítmicos, aterosclerosis D13, SCA D14, IC + shock D15 y valvulopatías D16 mié 14-oct); el NBME 26 (D25)
...
> detrás); y **los dos días dobles de Bioquímica (D80 vie 15-ene · D81 lun 18-ene) van íntegros detrás del UWSA2** y cierran
> la Fase A. En Fase B, D82/D83/D85 son NBME 31/32/33 (`system = 'Assessment'` / `'Sprint final'`) y **D84 (jue 21-ene) y D86
> (lun 25-ene) son `system = 'Banco intensivo'`** (random timed 2×40Q + sistema débil #1); en Fase C, D87 es el Free 120 y **D88
> (mié 27-ene), D89 (jue 28-ene), D90 (vie 29-ene), D91 (lun 1-feb), D92 (mar 2-feb) y D93 (mié 3-feb) siguen siendo `system
...
### Qué se movió y qué NO en el corrimiento v5.15 (RÍGIDO)

**Nada se fusionó ni se recortó, y esta vez tampoco se tocó el reparto contenido↔hitos.** El desfase de 2 días hábiles se
pagó **por la cola del plan**: el plan entero (contenido + hitos) se desplazó en bloque y el examen corrió dos hábiles más.

| | v5.14 (D1 = lun 21-sep) | v5.15 (D1 = mié 23-sep) |
|---|---|---|
| Días del plan | 95 | **95** (mismo temario, 1:1) |
| Primer día | lun 21-sep-2026 = UWSA1; contenido en D2, mar 22-sep | **mié 23-sep-2026 = UWSA1** (movido otra vez: su fecha ya había pasado); contenido en D2, **jue 24-sep** |
| Último día | mié 3-feb-2027 = D95 = D-1 dentro del plan; D94 mar 2-feb última sesión de banco | **vie 5-feb-2027 = D95 = D-1 DENTRO del plan** (sesión mínima AM + ritual); D94 jue 4-feb = última sesión de banco (D-2) |
| Target de examen | JUE 4-FEB-2027; sáb 30 y dom 31-ene libres entre D92 y D93 | **LUN 8-FEB-2027**; **sáb 6 y dom 7-feb libres entre el D95 y el examen** (`examenTarget = '2027-02-08'` / `descansoD1 = '2027-02-05'`) |
| Semanas del plan | S1 = 21-25 sep (5 días) … S20 = 1-5 feb | **S1 = 23-25 sep (3 días, el D1 cae en miércoles)** … S20 = 1-5 feb |
| Días de contenido | cada uno en su fecha | **+2 días hábiles cada uno** |
| 12 hitos NBME/UWSA | 11 **anclados por fecha** + UWSA1 al D1; su D# bajaba en cada corrimiento (−2) | 🆕 **los 12 corren CON el plan: D# INTACTO, fecha +2 hábiles** |
| Preparación por delante de cada NBME | se reducía en cada corrimiento (NBME 25 pasó de D18 a D10) | **queda congelada**: ningún NBME vuelve a perder días de contenido |
| Día de la semana de los hitos | 8 en viernes | **9 en martes** (NBME 25-30, UWSA2, NBME 31, Free 120) · 2 en miércoles (UWSA1, NBME 32) · 1 en viernes (NBME 33) |
| Cierre de contenido vs NBME 31 | Biochem D80-D81 (mié 13 · jue 14-ene) → NBME 31 D82 vie 15-ene AL DÍA SIGUIENTE | **igual, corrido**: Biochem D80-D81 (vie 15 · lun 18-ene) → NBME 31 D82 **mar 19-ene**, al día siguiente y sin banco delante |
...
| Viernes de nivel 3 | 5 (D15 Cardio · D20 Resp · D35 GI · D45 y D50 Neuro) | **5** (D8 y D13 Cardio · D28 Renal · D33 GI · D48 Neuro) |
| Viernes de nivel 4 | 1 (D60 Micro/ID) | **2** (D53 Heme/Onc, S11 · D63 Micro/ID, S13) — los hitos ya no ocupan viernes |
...
el contenido se derrame hasta el 18-ene.

## 3. Hitos NBME/UWSA (12) — v5.15: los 12 corren CON el plan · D# intacto · fechas nuevas

| # | Hito | Día | Fecha | Q | Rol |
|---|------|-----|-------|---|-----|
| 1 | **UWSA1** | **D1** | **mié 23-sep-2026** | 160Q | **Baseline en el PRIMER día del plan** (esperar bajo, no asustarse). Movido desde el lun 21-sep (fecha ya pasada): sigue al D1 en cada corrimiento |
| 2 | **NBME 25** | D10 | mar 6-oct-2026 | 200Q | 1ª calibración real · parte el bloque Cardio (D11 taquiarritmias, D12 antiarrítmicos, D13 aterosclerosis, D14 SCA, D15 IC y D16 valvulopatías quedan detrás) |
| 3 | **NBME 26** | D25 | mar 27-oct-2026 | 200Q | Tendencia · parte Renal (D26 electrolitos, D27 ácido-base, D28 glomerulares y D29 AKI/ERC detrás); GI (D30-D36) va íntegro detrás |
| 4 | **NBME 27** | D40 | mar 17-nov-2026 | 200Q | Tendencia · parte Endo (D37-D39 delante; D41 DM y D42 calcio/PTH/MEN detrás); Neuro (D43-D50) íntegro detrás |
| 5 | **NBME 28** | D55 | mar 8-dic-2026 | 200Q | Tendencia · parte Heme/Onc (D51-D54 delante; D56 leucemias y D57 linfomas/mieloma detrás); Micro (D58-D64) íntegro detrás |
| 6 | **NBME 29** | D65 | mar 22-dic-2026 | 200Q | Micro (D58-D64) íntegro delante; Repro (D66-D70) íntegro detrás |
| 7 | **NBME 30** | D72 | mar 5-ene-2027 | 200Q | Primer hito de 2027 (con el corrimiento rígido ya no depende de los skips de fin de año); parte MSK (D71 artritis, lun 4-ene, delante; D73 LES/vasculitis y D74 hueso/anatomía detrás); Repro (D66-D70) cierra 2026 y Psiquiatría (D75-D76 · D78-D79), Biostats (D79) y los 2 días dobles de Biochem (D80-D81) van detrás |
| 8 | **UWSA2** | D77 | mar 12-ene-2027 | 160Q | Predictor de resistencia (la fecha la deciden los NBME) · **cae DENTRO de la Fase A** (parte Psiquiatría: D75-D76 delante, psicofármacos D78 y Biostats D79 detrás; los 2 días dobles de Bioquímica D80-D81 cierran la fase) |
| 9 | **NBME 31** | D82 | mar 19-ene-2027 | 200Q | **GO/NO-GO** · **abre la Fase B el día siguiente al cierre de contenido (D81 lun 18-ene): sin banco de consolidación delante** (herencia de la v5.14 que el corrimiento rígido conserva) |
| 10 | **NBME 32** | D83 | mié 20-ene-2027 | 200Q | Fase B (random timed D84 detrás) |
| 11 | **NBME 33** | D85 | vie 22-ene-2027 | 200Q | Fase B (random timed D86 detrás; cierra la fase) |
| 12 | **FREE 120 oficial** | D87 | mar 26-ene-2027 | 120Q | Abre la Fase C · idealmente en el Prometric real · D-13 del examen (lun 8-feb) |

Los 12 hitos suman **2240Q** de simulacro. Con el corrimiento RÍGIDO **ya no caen en viernes**: 9 en **martes**
(NBME 25-30, UWSA2, NBME 31 y Free 120), 2 en miércoles (UWSA1, D1; y NBME 32) y 1 en viernes (NBME 33, D85).
**Las 12 fechas cambiaron con la v5.15 (+2 hábiles) y los 12 D# quedaron intactos**: es exactamente lo contrario de lo
que pasaba hasta la v5.14 (fecha fija, D# a la baja). El **UWSA1** sigue re-anclado al D1 (lun 21-sep → mié 23-sep).
...
> ⚠ **Consecuencia del decimocuarto corrimiento sobre la semana del examen.** Con D95 = **vie 5-feb**, el
> D-1 sigue **dentro del plan** (fuera de la ventana 25-29 ene desde la v5.12): el target pasa al
> **LUN 8-FEB-2027** (`DAILY_META.examenTarget = '2027-02-08'`); el D94 (jue 4-feb) es la **última sesión de banco (D-2)**, el
> sáb 6 y el dom 7-feb quedan **libres** (solo Anki vencido, y se repite el ritual el domingo) entre el D95 y el examen, y el
> D95 (vie 5-feb, `descansoD1 = '2027-02-05'`) es la **sesión mínima del D-1** (§3b; `USMLE_TAPER.d94/.d95/.dMenos1/.examen`
> en el TS). **Prometric: agendar/reprogramar para el lun 8-feb y confirmar que el eligibility period cubre esa fecha (si no,
...
> Segunda consecuencia (heredada, no nueva): **el NBME 31 GO/NO-GO (D82, mar 19-ene) cae el día siguiente al cierre de
> contenido (D81, lun 18-ene)**, con los 2 días de random timed detrás de él (D84 y D86).

## 3b. Semana de examen: taper D94 · D95 = D-1 dentro del plan · test day lun 8-feb · protocolo de burnout (REGLA)

*(12-sep-2026, tarde — divergencias Palmerton #22 y #29 implementadas sin tocar horario, temario ni fechas; remapeadas el
22-sep a la v5.15. Fuente de cada paso: [`PALMERTON_METODO_COMPLETO.md`](PALMERTON_METODO_COMPLETO.md) §8.3-§8.4 y §9.12; código:
...
|-----|-------|-------------|---|---------|
| desde **D82** (NBME 31) | mar 19-ene | **Cese de lo nuevo**: cero preguntas nuevas y cero tarjetas nuevas (Palmerton: 1-2 semanas antes); solo incorrects/flagged + AMBOSS 200 como repaso de conceptos ya vistos; no repetir NBME ya hechos | — | sin cambio |
| **sáb 6 · dom 7** | sáb 6 · dom 7-feb | **Libres** (régimen): sin banco; solo Anki vencido — entre el D95 (vie 5-feb, D-1) y el examen (lun 8-feb); repetir el ritual de test-day el domingo por la tarde | — | — |
| **D94 · D-2 (última sesión de banco)** | **jue 4-feb** | Solo Anki **maduro** + 20Q flagged/incorrects ya vistos (sin bloque timed, sin AMBOSS) · repaso First Aid de esquemas (sistemas 6-10) · dormir ≥7 h ya desde hoy | **20** | 05:00 · 07:15 · 11:00 |
| **D95 · D-1 (DENTRO del plan)** | **vie 5-feb** | **Sesión MÍNIMA solo por la mañana (≤2 h)**: Anki maduro/vencido + 20Q flagged con los mejores esquemas e imágenes · rapid review FA · cero preguntas nuevas, cero tarjetas nuevas, ningún bloque timed, no abrir First Aid "para ver cuánto sé" · **tarde: permiso impreso + digital, 2 ID con el nombre EXACTO del permiso, bolsas Ziploc numeradas (Break #1-#4), ruta al Prometric** · nada de estudio después de las 17:00 (journaling, ejercicio suave, visualización, cena con proteína) · somnífero **nunca por primera vez** esta noche · dormir ≥7-8 h, alarma y ruta comprobadas (`USMLE_TAPER.d95` = `.dMenos1`) | **20** | 05:00 · 07:15 (mínimo) |
| **EXAMEN** | **lun 8-feb** | Desayuno proteína + grasa, sin carbohidratos simples; el café de siempre · tutorial: comprobar auriculares y terminar (+15 min de descanso = 60) · bloques **1-2 seguidos → 10 min · 3-4 → 10 min · 5 → almuerzo 20-30 min · 6 → 10 min · 7** · entre bloques las 40Q dejan de existir; nunca revisar ni abrir FA en el casillero · nunca salir a mitad de bloque · post-test: premiarse | 280 | — |
...
`DIAS[].franjaNota` (el `sub` no cambia: regla de no recortar contenido). **v5.15**: el taper es **jue 4 + vie 5-feb**, seguidos,
y el finde libre (**sáb 6 y dom 7-feb**) queda entre el D95 y el examen del **lun 8-feb** — la mejor posición posible del taper
(día de descanso completo antes del examen); volver a la ventana 25-29 ene exige recortar temario.
...
en el plan** (`remap_inicio.js`): no se recorta ni se fusiona temario — y en v5.15 eso ya implica **mover el examen un
hábil más allá del lun 8-feb** (o recortar). Se reanuda **por el gate del 80%**, no por la fecha; si el siguiente hito vuelve
...
**Las HORAS no cambiaron con el corrimiento v5.15** (ni con ninguno de los anteriores).
...
mar 2-feb — en v5.15 se AMPLIÓ el fin, antes vie 29-ene: se amplían días, no se pierden sesiones; feb-mar 2027 vuelve a
...
eval de 18:00 ≈ 71h). **No bajó respecto de la v5.14**: como esta vez tampoco se recortó contenido sino
...
desplazó las fechas y el examen pasa al **lun 8-feb**.
...
- Fase A cierra con **D77 = UWSA2** (nivel 5, mar 12-ene), los dos últimos días de Psiquiatría **D78-D79** (nivel 2) y los dos días dobles de Bioquímica **D80 (vie 15-ene) y D81 (lun 18-ene)** (nivel 1).
...
- Fase C (D87-D95): **nivel 5** salvo **D88 (mié 27-ene) y D89 (jue 28-ene), nivel 4** (random timed 2×40Q + sistema débil #2 / Mehlman HY del sistema); **D90 (vie 29-ene), D91 (lun 1-feb), D92 (mar 2-feb) y D93 (mié 3-feb)** siguen siendo días de banco (incorrects 2ª pasada · AMBOSS 200 mitades 1 y 2, 80Q cada uno) y los días sin simulacro son **taper** (`TAPER_ACTIVO`): solo flagged/incorrects ya vistos + Anki maduro, cero preguntas y cero tarjetas nuevas (**D94 = 20Q · D95 = 20Q**; ver §3b).
- La eval de las 18:00 (10Q mixta timed) es la **dosis diaria de nivel 4** durante toda la Fase A; los stress sets 10Q/12min (nivel 5) solo en Fases B-C a las 05:00 (desde D82, mar 19-ene).
- Los cuatro días con `franjaNota` (D53 y D63 viernes N4 · D94 · D95 taper) llevan el texto de la franja 11:00 en el propio `DIAS[]`; **el `sub` de esos días no cambia** (multiconjunto de contenido idéntico a la v5.14, verificado con `node` por `(system, sub)`: dif 0).
...
> Respecto de la v5.14 cambian los **viernes** (el contenido no): al correr todo +2 días hábiles el viernes de cada sistema
> cae en otro subtema y, sobre todo, **los hitos dejan de ocupar viernes**, así que aparece un segundo viernes de nivel 4.
> Los N3 pasan a ser D8 y D13 (Cardio), D28 (Renal), D33 (GI) y D48 (Neuro); los N4 de Fase A son **D53 (Heme/Onc, S11) y
> D63 (Micro/ID, S13)**. Totales: N3×5 sin cambio, **N4×5 → N4×6** (2 viernes + D84/D86 en Fase B + D88/D89 en Fase C),
> **N2×39 → N2×38**, N1×28 sin cambio. El total sigue en **5560Q** — el multiconjunto (sistema, subtema) es idéntico (dif 0).
...
**Viernes** (18 en el plan; **solo 1 es hito** — el NBME 33, D85 vie 22-ene — y los otros dos fuera de Fase A son el D90,
vie 29-ene, banco, y el D95, vie 5-feb, taper D-1). Los **15 viernes de Fase A sin hito**:
D3 (25-sep) Fundamentos **N1** · **D8 (2-oct) Cardio N3** · **D13 (9-oct) Cardio N3** · D18 (16-oct) Resp **N1** · D23 (23-oct) Renal **N1** · **D28 (30-oct) Renal N3** · **D33 (6-nov) GI N3** · D38 (13-nov) Endo **N1** · D43 (20-nov) Neuro **N1** · **D48 (27-nov) Neuro N3** · **D53 (4-dic) Heme/Onc N4** (S11) · D58 (11-dic) Micro/ID **N1** · **D63 (18-dic) Micro/ID N4** (S13) · D75 (8-ene) Psiquiatría **N1** · D80 (15-ene) Biochem **N1**.
Los que quedan en **N1** lo hacen porque su sistema lleva <3 días: ese día el bloque de
sistema completo timed se hace del sistema **anterior**. Los viernes 25-dic y 1-ene son skip; **desde S11, y como los hitos
ya no ocupan viernes, hay dos viernes de nivel 4 hasta el fin de la Fase A** (D53 y D63): el flag es regla, no lista.
...
Divergencias técnica Palmerton ↔ plan v5.15 (resueltas y pendientes de decisión):
...
| Fichero | Rol |
|---------|-----|
| [`src/lib/usmleStep1Daily.ts`](../../src/lib/usmleStep1Daily.ts) | **v5.15 = FUENTE DE VERDAD**: DIAS (95, con `nivelUW`/`qDia`/`franjaNota`), FRANJAS (6, con nivel/gate), DAILY_META (+`metodo`, `examenVentana` superada, `examenTarget = '2027-02-08'`, `descansoD1 = '2027-02-05'`, `viernesN4DesdeSemana`), USMLE_NIVELES, USMLE_GATE, **USMLE_TAPER** (D94 jue 4-feb D-2 última sesión de banco · D95 vie 5-feb D-1 dentro del plan · examen lun 8-feb · burnout), helpers (`faseDe` 81/86, `nivelInfo`, `esHito`, `hitosDelPlan`, `semanaDe`, `esViernesNivel4`, `esDiaTaper`, `esDiaDermaStep1`). Generado por `gen_usmle_v5.js` → `assemble_usmle_ts.js` (`DATA/_scripts/usmle/`; flags `VIERNES_N4_DESDE_SEMANA`, `TAPER_ACTIVO`) |
...
| [`src/lib/usmleStep1Plan.ts`](../../src/lib/usmleStep1Plan.ts) | Plan macro (SISTEMAS con `diaInicio` alineado a DIAS, PLAN_META; `inicio = '2026-09-23'`) |
...
- [`PALMERTON_POR_MATERIA.md`](PALMERTON_POR_MATERIA.md) — **v3 catálogo completo**:
  por materia + 5 niveles UWorld + Anki fino + test-taking/test-day + planificación NBME (D# y fechas v5.15).
- [`CALENDARIO_5_MESES.md`](CALENDARIO_5_MESES.md) — semana a semana S1-S20 (v5.15) + día a día D1-D95 + reglas de reprogramación + gates ECFMG (agendar el lun 8-feb y confirmar el eligibility period).
- [`RECURSOS_META_2026.md`](RECURSOS_META_2026.md) — rol de cada recurso, fase, horas, qué NO usar.
- [`PALMERTON_DIVERGENCIAS_PLAN.md`](PALMERTON_DIVERGENCIAS_PLAN.md) — **técnica Palmerton → qué hace el plan v5.15 →
  divergencia → resolución aplicada / propuesta para decisión de Joseph** (incluye la decisión del 22-sep: D95 = D-1 dentro del
  plan → examen lun 8-feb, con la alternativa de recortar temario; sustituye a la del 19-sep sobre el jue 4-feb; y la regla
  nueva del corrimiento RÍGIDO: los hitos corren con el plan y conservan su D#).
  **§E con estado al 22-sep**: implementadas #2 viernes de nivel 4 (ahora D53 y D63), #5 taper + D-1 dentro del plan y #7 burnout (REGLA);
  siguen siendo DECISIÓN de Joseph #1 (20Q permanente), #3 (GO sin UWSA2), #4 (Free 120 en Prometric + maratón), #6 (eval a las
  12:00), #8 (arranque a 20Q si el UWSA1 <40%) y la de #5 (rendir el lun 8-feb vs recortar temario).
- [`PALMERTON_METODO_COMPLETO.md`](PALMERTON_METODO_COMPLETO.md) — el método de la A a la Z; §12 = mapeo al plan v5.15 (D# y fechas).
...
> D95 = vie 5-feb = D-1 dentro del plan, el finde 6-7 feb queda libre y el examen pasa al lun 8-feb-2027).
> **Punto de inflexión en la v5.8, confirmado en v5.9 → v5.15**: de la v5.3 a la v5.7 el desfase
...
> tenía un fin clavado, **se amplían días** en vez de perder sesiones.
> El examen ya **no** está en la ventana 25-29 ene (target lun 8-feb): **cada día perdido desde hoy mueve el examen un
