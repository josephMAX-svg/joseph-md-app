...
|---|---|---|
| Tesis L0 → research letter | Dr. Ciro (último autor) · AuthorAID/Rising Scholars (inglés; **gate 2 en T-7, mié 25-nov**; plan B editor decidido el vie 30-oct — v5.14) · Finlay (permiso CADI; coautoría L6 futura) | ninguno confirmado |
| Carta al editor (CARTA_1) | Dr. Ciro (coautor) | no propuesto |
| Case report #1 | Dr. Ciro o colega SPD (senior author; fuente B se activa el mar 20-oct si no hay caso) · Rising Scholars (inglés, CR-6; comprobado en X-2) | sin caso |
| PROSPERO SR-1 | Dr. Ciro (revisor #2 / validación clínica) + colaborador IMG (2º cribado) — la invitación de X-1 (lun 7-dic, v5.14) declara la carga real ≈ 40-70 h fuera del bloque (L4 §9.4) y exige aceptación escrita | sin revisor #2 |
