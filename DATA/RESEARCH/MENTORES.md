...
| 6 | Colega dermatólogo/a de la Sociedad Peruana de Dermatología (plan B del caso) | Senior author alternativo para el case report | 1 caso de complicación de relleno/láser con fotos (Joseph redacta) | Vía Dr. Ciro (nombre concreto) | — | ⚪ solo si #1 no tiene caso en 3 semanas | **Activar el mar 20-oct-2026 (d11 = C-4; ~3 semanas desde M1 lun 28-sep) si #1 no dio caso**: un solo mensaje concreto (`CASE_REPORT_1/caso_candidatos.md` §2, fuente B, texto listo); el caso debe estar elegido en CR-1 (vie 30-oct, último hábil antes del 31-oct) y con consentimiento en CR-2 (mar 3-nov — ya después del 31-oct: firmarlo el mismo vie 30-oct si se puede) — fechas v5.14 (19-sep) |
...
| 16-sep-2026 | — | — | **v5.13 (Research vuelve a correr +2 hábiles, mismo orden y mismos d#; el D1 del régimen, jue 17-sep, es día Derma → ciclo 1 desde el vie 18-sep; leído de `researchDailyPlan.ts` con node):** M1 **jue 24-sep** · M2 **mié 30-sep** · T-1 **mar 6-oct** · M3 **jue 8-oct** · plan B de inglés: decisión **mié 28-oct** (4 semanas desde M2) · fuente B del caso: **mié 14-oct** (d10) · CR-1 mié 28-oct · CR-2 vie 30-oct · T-7 lun 23-nov · T-8 vie 27-nov · X-1 jue 3-dic · X-2 mié 9-dic. El examen Step 1 pasa al **mar 2-feb-2027**; CR-9 (lun 1-feb) queda en la víspera del examen (D95 = D-1) → decisión de Joseph | Joseph ejecuta según el plan; nada enviado aún |
| 19-sep-2026 | — | — | **v5.14 (Research vuelve a correr +2 hábiles, mismo orden y mismos d#; el D1 del régimen, lun 21-sep, es día Derma → ciclo 1 desde el mar 22-sep; leído de `researchDailyPlan.ts` con node):** M1 **lun 28-sep** · M2 **vie 2-oct** · T-1 **jue 8-oct** · M3 **lun 12-oct** · plan B de inglés: decisión **vie 30-oct** (4 semanas desde M2) · fuente B del caso: **mar 20-oct** (d11) · CR-1 vie 30-oct · CR-2 mar 3-nov (🔴 después del 31-oct) · T-7 mié 25-nov · T-8 mar 1-dic · X-1 lun 7-dic · X-2 vie 11-dic. El examen Step 1 pasa al **jue 4-feb-2027**; CR-9 (lun 1-feb) ya NO es la víspera (es el D93) → decisión B de PENDIENTES resuelta | Joseph ejecuta según el plan; nada enviado aún |
| 22-sep-2026 | — | — | **v5.15 (Research vuelve a correr +2 hábiles — corrimiento RÍGIDO: mismo orden, mismos átomos; el D1 del régimen, mié 23-sep, es día Derma → ciclo 1 desde el jue 24-sep; leído de `researchDailyPlan.ts` con node):** M1 **mié 30-sep** · M2 **mar 6-oct** · T-1 **lun 12-oct** · M3 **mié 14-oct** · plan B de inglés: decisión **mar 3-nov** (4 semanas desde M2) · fuente B del caso: **jue 22-oct** (d11) · CR-1 mar 3-nov y CR-2 jue 5-nov (🔴 **los dos después del 31-oct**) · T-7 vie 27-nov · T-8 jue 3-dic · X-1 mié 9-dic · X-2 mar 15-dic. El examen Step 1 pasa al **lun 8-feb-2027**; CR-9 (lun 1-feb) es el D91, a una semana del examen | Joseph ejecuta según el plan; nada enviado aún |
...
> kappa 0.81), which I am rewriting as a 500-600-word research letter for JAAD International / International Journal of
> Dermatology. I am looking for a mentor with experience in dermatology or clinical epidemiology publishing who could
> (1) review one draft of the research letter for clarity and English usage (mid-November 2026), (2) briefly comment
> on a 500-word letter to the editor (October 2026), and (3) review the English of a short CARE case report (early December
> 2026). Total time requested: about 3-4 hours over four months, by email or shared document; I will send clean,
> STROBE/CARE-checked drafts with verified references. I use Spanish as my first
...
|---|---|---|
| Tesis L0 → research letter | Dr. Ciro (último autor) · AuthorAID/Rising Scholars (inglés; **gate 2 en T-7, vie 27-nov**; plan B editor decidido el mar 3-nov — v5.15) · Finlay (permiso CADI; coautoría L6 futura) | ninguno confirmado |
| Carta al editor (CARTA_1) | Dr. Ciro (coautor) | no propuesto |
| Case report #1 | Dr. Ciro o colega SPD (senior author; fuente B se activa el jue 22-oct si no hay caso) · Rising Scholars (inglés, CR-6; comprobado en X-2) | sin caso |
| PROSPERO SR-1 | Dr. Ciro (revisor #2 / validación clínica) + colaborador IMG (2º cribado) — la invitación de X-1 (mié 9-dic, v5.15) declara la carga real ≈ 40-70 h fuera del bloque (L4 §9.4) y exige aceptación escrita | sin revisor #2 |
