...
| 6 | Colega dermatólogo/a de la Sociedad Peruana de Dermatología (plan B del caso) | Senior author alternativo para el case report | 1 caso de complicación de relleno/láser con fotos (Joseph redacta) | Vía Dr. Ciro (nombre concreto) | — | ⚪ solo si #1 no tiene caso en 3 semanas | **Activar el mié 14-oct-2026 (d10 = C-3; ~3 semanas desde M1 jue 24-sep) si #1 no dio caso**: un solo mensaje concreto (`CASE_REPORT_1/caso_candidatos.md` §2, fuente B, texto listo); el caso debe estar elegido en CR-1 (mié 28-oct) y con consentimiento en CR-2 (vie 30-oct) — fechas v5.13 (16-sep) |
...
|---|---|---|
| Tesis L0 → research letter | Dr. Ciro (último autor) · AuthorAID/Rising Scholars (inglés; **gate 2 en T-7, lun 23-nov**; plan B editor decidido el mié 28-oct — v5.13) · Finlay (permiso CADI; coautoría L6 futura) | ninguno confirmado |
| Carta al editor (CARTA_1) | Dr. Ciro (coautor) | no propuesto |
| Case report #1 | Dr. Ciro o colega SPD (senior author; fuente B se activa el mié 14-oct si no hay caso) · Rising Scholars (inglés, CR-6; comprobado en X-2) | sin caso |
| PROSPERO SR-1 | Dr. Ciro (revisor #2 / validación clínica) + colaborador IMG (2º cribado) — la invitación de X-1 (jue 3-dic, v5.13) declara la carga real ≈ 40-70 h fuera del bloque (L4 §9.4) y exige aceptación escrita | sin revisor #2 |
