...
|-------|-----|----------------|
| M1-2 (sep-oct 2026) | ORCID + Zotero · leer CARE + 10 case reports de JAADCR/DOJ · escribir **1 carta al editor** (respuesta a artículo 2026 de JAAD/IJD) · identificar 1-2 casos peruanos con consentimiento — **v5.15: R0 jue 24-sep · C-6 SUBMIT mié 28-oct ⚠ · CR-1 caso mar 3-nov 🔴 (ya DESPUÉS del 31-oct)** | transversal |
| M3-4 (nov-dic 2026) | **Tesis L0 → research letter SUBMIT (T-8 jue 3-dic)** · **Case report #1** con mentor local: borrador, fotos, CARE y **paquete CONGELADO (CR-8 lun 21-dic)** — el SUBMIT a DOJ se ejecuta el 1-feb-2027, no en diciembre · revisor #2 nombrado (X-1 mié 9-dic) | L4 si es complicación estética; si no, el mejor caso disponible |
| M5 (ene-2027) | **PAUSA TOTAL — examen Step 1** (4-ene → 29-ene-2027 = 0 átomos de research; v5.15: el lun 1-feb es el D91 del Step 1, el vie 5-feb su D95, sáb 6 y dom 7-feb libres y el examen se rinde el **lun 8-feb**) | — |
| M6-7 (feb-mar 2027) | **SUBMIT case report #1 (CR-9 lun 1-feb = D91 del Step 1, banco intensivo; a una semana del examen)** · protocolo de **revisión sistemática** en derm estética y **registro PROSPERO (R10 vie 5-mar)** · reclutar 2-3 coautores IMG · campaña de cold emails (K1 mar 9-mar · K2 lun 15-mar) | **SR-1 (L4)** o **SR-2 (L5)** — las líneas ACTIVAS del programa |
| M8-10 (abr-jun 2027) | Ejecutar SR (extracción R22-R25 jue 22-abr → jue 6-may · MA en R may-2027) · case report #2 · 1 estudio bibliométrico · abstracts a AAD/CILAD/RADLA | L4/L5 + transversal |
| M11-12 (jul-ago 2027) | **SUBMIT SR-1 (R43 jue 15-jul)** · SR-2 abierta (protocolo R45 lun 16-ago · PROSPERO R46 mié 18-ago) · **balance (X-12 vie 20-ago)** | — |
...
|---|---|---|---|---|---|---|---|---|---|
| `carta-1` | Carta al editor #1 | Letter / Notes & Comments (≤500 palabras) · `agentic/prompts_claude_code/letter_to_editor.md` | JAAD o JCD (elegir en C-2; candidatos en `CARTA_1/candidatos.md`) → plan B misma familia | Dr. Ciro (coautor) | **elegir artículo: ≤ 2ª sem. sep-2026 · enviar: ≤ 15-oct-2026** (fecha límite interna de la fila elegida) · *plan v5.15: diana C-2 = jue 8-oct-2026 · SUBMIT C-6 = mié 28-oct-2026 🔴 13 días tarde vs el ≤15-oct (§9.1)* | — | **idea** → candidatos con DOI verificado (C-1 hecho) | $0 | — |
| `tesis-L0` | Tesis IGA×CADI → research letter | Research letter STROBE (≈500-600 palabras · ≤5 refs · 1 tabla o 1 figura + apéndice «versión larga» 800/3/10) · `TESIS_L0/` · `research_letter_STROBE.md` | JAAD International → IJD → Actas Dermo-Sifiliográficas → Anais Brasileiros | Dr. Ciro (último autor) · Rising Scholars (inglés) · Finlay (permiso CADI) | ética/CEI: oct-2026 · borrador: dic-2026 · **enviar: ≤ 15-feb-2027** · *plan v5.10b re-fechado a v5.15 (22-sep): ética T-1 = **lun 12-oct-2026** (solicitud CEI expedita presentada ese día — 🔴 12 días DESPUÉS del límite interno ≤ 30-sep) · SUBMIT T-8 = jue 3-dic-2026 (74 días de margen) — **GATES en T-7/T-8: sin nº de CEI o exención, o sin inglés revisado, NO se envía → feb-2027*** | — | **borrador** (outline + checklists; bloqueado por CEI/consentimientos A VERIFICAR) | $0-1.288 | — |
| `case-report-1` | Case report #1 | CARE 2013 (13 ítems) · `CASE_REPORT_1/` · `case_report_CARE.md` | Dermatology Online Journal → IJD (correspondence) → JAAD Case Reports | Dr. Ciro o colega SPD (senior author) | caso + consentimiento: **31-oct-2026** · borrador: dic-2026 · **enviar: ≤ 28-feb-2027** · *plan v5.10b re-fechado a v5.15 (22-sep): CR-1 (caso) = **mar 3-nov-2026** 🔴 3 días DESPUÉS del 31-oct · CR-2 (consentimiento) = **jue 5-nov-2026** 🔴 5 días DESPUÉS del 31-oct (en v5.14 CR-1 aún caía el vie 30-oct; ahora **ningún** átomo llega al plazo interno → cerrar caso + consentimiento fuera del átomo o aceptar el retraso) · seguimiento con el Dr. Ciro el lun 12-oct (d7) y el jue 22-oct (d11, ~3 semanas desde M1; sin caso el 22-oct → fuente B) · paquete congelado CR-8 = lun 21-dic-2026 · SUBMIT CR-9 = lun 1-feb-2027 (sin mover; D91 del Step 1, a una semana del examen)* | — | **idea** (sin caso; plantillas listas) | ≤ $300 | — |
| `prospero-SR-1` | Registro PROSPERO de SR-1 (L4) | Protocolo PRISMA-P · equipo de revisión (revisor #2 humano) | PROSPERO | Dr. Ciro (revisor #2 / validación clínica) + colaborador IMG | **≤ 31-mar-2027** · *plan v5.15: revisor #2 nombrado X-1 = mié 9-dic-2026 (la invitación declara la carga real ≈ 40-70 h fuera del bloque y exige aceptación escrita · L4 §9.4) · equipo confirmado X-9 = lun 1-mar-2027 · REGISTRO R10 = vie 5-mar-2027 (26 días de margen); las fechas previstas que se copian a PROSPERO son las de L4 §9.4 (con margen), no las de los átomos* | — | **idea** (corpus de 200 papers descubierto 11-jun-2026, 0 cribados; export Rayyan listo: `exportResearchCorpus`) | $0 | — |
| `SR-1` | Revisión sistemática L4 (complicaciones de inyectables, fototipos IV-VI) | PRISMA 2020 + GRADE · `agentic/` (pipeline SR) | Dermatologic Surgery → JAAD → JAAD International | Cotofana (contacto feb-mar 2027) · coautores IMG | ejecución abr-jun 2027 · **enviar: ≤ 31-ago-2027** · *plan v5.15: extracción R22-R25 = jue 22-abr → jue 6-may-2027 · SUBMIT R43 = jue 15-jul-2027 (47 días de margen)* | — | **idea** | $0 (techo $1.288) | — |

### 9.1 Calendario editorial v5.10b (re-orden del 12-sep-2026) → v5.11-v5.12 → v5.13 → v5.14 (19-sep) → **v5.15 (re-fechado el 22-sep-2026: Research corre +2 hábiles más, corrimiento RÍGIDO)** (fechas leídas con `node` de `researchDailyPlan.ts` / `researchDailyPlan2027.ts`)
...
del lun 14 al **mié 16-sep**, porque el mar 15-sep es día Derma) y el ciclo 2 corre con él (d43 = lun 15-feb-2027); en v5.12 (D1 del régimen = mié 16-sep, ya día Research) no cambió nada; **en v5.13 vuelve a correr +2 días hábiles** (su d1 pasa del mié 16 al **vie 18-sep**, porque el jue 17-sep es día Derma) y el ciclo 2 corre con él (d43 = mié 17-feb-2027); en v5.14 corrió otros +2 (d1 = mar 22-sep); **en v5.15 corre +2 más** (su d1 pasa del mar 22 al **jue 24-sep**, porque el mié 23-sep es día Derma) y el ciclo 2 con él (d43 = mar 23-feb-2027). La columna **v5.15** es la fecha REAL del
átomo que ejecuta el hito (parseada de los `.ts` el 22-sep-2026), no una estimación. El **orden v5.10b (12-sep-2026, gaps v3b 1-3)** se mantiene: mismos 42
átomos; T-1 en d7, M3 en d8, R9 en d9 (antes de R6, d14), CR-1 en d15, CR-2 en d16, T-2 en d19, R7 en d21 y R2 en **d33**. ⚠ Lo único que cambia de índices: **R3 cruza la pausa** (pasa al d37), así que X-7 baja a d34, CR-9 a d35 y X-8 a d36.

| Hito | Átomo | v5.13 | v5.14 | **v5.15 (vigente)** | Deadline externo | Margen |
|------|-------|---------------|-------|--------------------|------------------|--------|
| Infra académica (10 cuentas) | R0 | vie 18-sep-2026 | mar 22-sep-2026 | **jue 24-sep-2026** | — | — |
| Mentor: email al Dr. Ciro (3 coautorías) | M1 | jue 24-sep-2026 | lun 28-sep-2026 | **mié 30-sep-2026** | — | — |
| Artículo DIANA de la carta + deadline calculado | C-2 | vie 2-oct-2026 | mar 6-oct-2026 | **jue 8-oct-2026** | ventana del journal | según fila elegida |
| ¿Existe ya la SR? AMSTAR-2 de 5 SR vecinas + decisión a/b/c (L4 §6) | R9 | lun 12-oct-2026 | mié 14-oct-2026 | **vie 16-oct-2026** | — | gate del PICO |
| PICO de SR-1 fijado | R6 | lun 26-oct-2026 | mié 28-oct-2026 | **vie 30-oct-2026** | — | — |
| **SUBMIT carta al editor #1** | C-6 | jue 22-oct-2026 | lun 26-oct-2026 | **mié 28-oct-2026** | ≤ 15-oct-2026 | 🔴 **−13 días (VENCIDO)** |
| Ética / CEI de la tesis: nº archivado o **solicitud expedita PRESENTADA ese día** | T-1 | mar 6-oct-2026 | jue 8-oct-2026 | **lun 12-oct-2026** | solicitud ≤ 30-sep | 🔴 **−12 días (VENCIDO)** (la aprobación tarda semanas → gate en T-7/T-8; presentar la solicitud el mié 30-sep —día de M1— fuera del átomo si se quiere respetar el ≤ 30-sep) |
| **Caso + senior author del case report** | CR-1 | mié 28-oct-2026 | vie 30-oct-2026 | **mar 3-nov-2026** | 31-oct-2026 | 🔴 **−3 días (VENCIDO)** — ya no queda átomo antes del plazo |
| Consentimiento de publicación firmado | CR-2 | vie 30-oct-2026 | mar 3-nov-2026 | **jue 5-nov-2026** | 31-oct-2026 | 🔴 **−5 días (VENCIDO)** → cerrar caso + consentimiento fuera del átomo (vie 30-oct, día de R6) o aceptar el retraso interno |
| **SUBMIT research letter de la tesis (L0)** | T-8 | vie 27-nov-2026 | mar 1-dic-2026 | **jue 3-dic-2026** (gates: nº CEI/exención + inglés revisado; si fallan → feb-2027) | ≤ 15-feb-2027 | 74 días |
| Revisor humano #2 nombrado (pre-PROSPERO) | X-1 | jue 3-dic-2026 | lun 7-dic-2026 | **mié 9-dic-2026** | antes de PROSPERO | 86 días |
| **Paquete del case report CONGELADO** | CR-8 | mar 15-dic-2026 | jue 17-dic-2026 | **lun 21-dic-2026** | antes del submit | 42 días |
| Cierre antes de la pausa de enero | X-7 | mar 29-dic-2026 (d36) | mar 29-dic-2026 (d35) | **mar 29-dic-2026** *(no se movió: anclado a la pausa; ahora d34 — R3 salta al otro lado de la pausa)* | — | — |
| *(pausa Step 1: 4-ene → 29-ene-2027 = 0 átomos)* | — | igual | igual | **igual** | — | — |
| **SUBMIT case report #1 (DOJ)** | CR-9 | lun 1-feb-2027 (D95 = D-1) | lun 1-feb-2027 (d36 · D93) | **lun 1-feb-2027** *(no se movió: primer día-Research tras la pausa; ahora d35)* — ✅ **v5.15: es el D91 del Step 1 (banco intensivo), a una semana del examen (lun 8-feb)**; el mié 3-feb es X-8 (D93) y el vie 5-feb es R3 (D95), ninguno es un submit | ≤ 28-feb-2027 | 27 días |
| Equipo de revisión CONFIRMADO | X-9 | mar 23-feb-2027 | jue 25-feb-2027 | **lun 1-mar-2027** | antes de PROSPERO | 4 días |
| **REGISTRO PROSPERO de SR-1** | R10 | lun 1-mar-2027 | mié 3-mar-2027 | **vie 5-mar-2027** | ≤ 31-mar-2027 | 26 días |
| Extracción doble de SR-1 | R22-R25 | vie 16-abr → vie 30-abr-2027 | mar 20-abr → mar 4-may-2027 | **jue 22-abr → jue 6-may-2027** | — | — |
| **SUBMIT SR-1** | R43 | vie 9-jul-2027 | mar 13-jul-2027 | **jue 15-jul-2027** | ≤ 31-ago-2027 | 47 días |
| Balance 12 meses | X-12 | lun 16-ago-2027 | mié 18-ago-2027 | **vie 20-ago-2027** | — | — |

> **🔴 DEADLINES ROTOS tras el corrimiento de v5.15 — decisión de Joseph, no de la app:**
> - **C-6 = mié 28-oct-2026** contra el ≤ 15-oct. En v5.8 quedaba 1 día de margen; desde v5.9 el átomo
>   cae tarde (1 día en v5.9/v5.10, 5 días en v5.11/v5.12, 7 días en v5.13, 11 en v5.14, **13 días en v5.15**). Opciones: (a) hacer el SUBMIT el jue 15-oct fuera del átomo (el paquete ya
>   está listo en C-5, lun 26-oct → en v5.15 habría que adelantar también C-3/C-4/C-5 o cerrar el paquete el vie 16-oct, día de R9), (b) elegir en C-2 (jue 8-oct) una fila de candidatos cuya ventana
>   cierre más tarde. **Lo que NO vale es dejarlo correr:** la ventana del journal no se negocia.
> - **T-1 = lun 12-oct-2026** contra la solicitud ≤ 30-sep (interno): **12 días tarde**; si importa, presentar la solicitud CEI el mié 30-sep (día Research: M1) fuera del átomo.
> - **🔴 CR-1 = mar 3-nov y CR-2 = jue 5-nov: LOS DOS DESPUÉS del 31-oct** (3 y 5 días tarde). El intercambio v5.10b con T-2 y R7 se había agotado ya en v5.14 (CR-1 aún alcanzaba el vie 30-oct); en v5.15 **ningún átomo llega al plazo interno**, contra el chip "sin caso antes del 31-oct el entregable de feb-2027 no ocurre". Regla operativa: seguimiento con el Dr. Ciro
>   el lun 12-oct (d7) y el jue 22-oct (d11, ~3 semanas desde M1 mié 30-sep); sin caso el 22-oct → fuente B (colega SPD) con el mensaje único de
>   `CASE_REPORT_1/caso_candidatos.md` §2 (MENTORES fila 6); caso y consentimiento hay que cerrarlos **fuera del átomo** (p. ej. el vie 30-oct, día de R6) o aceptar el retraso. **Decisión de Joseph.**
> - **X-9 = lun 1-mar-2027 → R10 = vie 5-mar-2027**: 4 días entre confirmar el equipo y registrar (6 en v5.10-v5.14). El revisor #2 debe estar comprometido desde X-1 (mié 9-dic-2026); X-9 solo confirma.
>
...
> tramo dic-2026 mientras puede (en v5.11 X-3 pasó del lun 21 al mié 23-dic; en v5.13 X-3 saltó al otro lado de la pausa; en v5.14 lo hizo R8); **en v5.15 el tramo dic-2026 cede otro átomo: R3 salta al otro lado de la pausa (d37, vie 5-feb; X-7 pasa a ser d34, CR-9 d35, X-8 d36 y R8 se queda en d38) y el ciclo 1 termina el vie 19-feb (X-6, d42) en vez del mié 17-feb**, empujando el ciclo 2 un slot (d43 = mar 23-feb).
> **✅ v5.15:** el examen Step 1 es el **lun 8-feb-2027**, el vie 5-feb su D95, el sáb 6 y el dom 7-feb libres, y el lun 1-feb (día de CR-9) es su **D91 (banco intensivo)**: el SUBMIT del case report queda a una semana entera del examen y **la decisión B de `PENDIENTES_JOSEPH.md` sigue RESUELTA**. Restos: X-8 cae el mié 3-feb (D93) y **R3 el vie 5-feb (D95, último día del plan)** → hacerlos dentro de las ≤2 h de la mañana o saltarlos (ninguno es un submit; nada de pantallas después de las 17:00). El generador sigue anclando CR-9 a la pausa 4→29-ene, no a `DAILY_META.examenTarget`: si un corrimiento futuro vuelve a poner un submit en la víspera, reaparece el problema.
