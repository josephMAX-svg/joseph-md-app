...
> **⚠ v5.14 (19-sep-2026) — Research VUELVE A CORRER +2 días hábiles (+1 slot interdiario), mismo orden y mismos d#: ciclo 1 = 42 átomos mar 22-sep-2026 → mié 17-feb-2027 · ciclo 2 = 67 átomos vie 19-feb → mar 24-ago-2027.** Ni el jue 17 ni el vie 18 de septiembre se estudiaron y el D1 del régimen pasa al **lun 21-sep-2026** (decimotercer corrimiento, 31-ago→21-sep, 15 hábiles perdidos), que es día **Derma** en la alternancia (Derma corre +1 slot: d1 lun 21-sep → d73 mar 13-abr-2027), así que el ciclo 1 de Research arranca el primer día-Research ≥ D1: el **mar 22-sep**. Los 10 hitos anteriores a la pausa corren 2 hábiles (M1 lun 28-sep · C-2 mar 6-oct · T-1 jue 8-oct · C-6 lun 26-oct · CR-1 vie 30-oct · CR-2 mar 3-nov · T-8 mar 1-dic · X-1 lun 7-dic · CR-8 jue 17-dic); X-7 sigue anclado al mar 29-dic (ahora d35: el tramo dic-2026 pierde otro átomo, R8, que salta al vie 5-feb) y **CR-9 sigue el lun 1-feb-2027 (d36)**; el ciclo 2 corre con él (X-9 jue 25-feb · R10 mié 3-mar · R43 mar 13-jul). Releído con node el 19-sep de `RESEARCH_HITOS` y de los dos `.ts`; los 12 overlays 🔬 del Calendar los re-fecha hoy otro agente con `gen_research_calendar.js` (A VERIFICAR 19-sep con `get_event`). **✅ Lo que cambia de contexto: el Step 1 termina el mié 3-feb-2027 (D95 = D-1 DENTRO del plan; D94 mar 2-feb = última sesión de banco) y su examen pasa al JUE 4-FEB-2027 — CR-9 (SUBMIT del case report #1, lun 1-feb) ya NO cae en la víspera del examen: es el D93 del Step 1, primer día-Research tras la pausa.** Resto menor: X-8 (re-arranque post-Step 1, d37) cae el mié 3-feb = D-1 (hacerlo dentro de las ≤2 h de la mañana o saltarlo; no es un submit). La pausa de research sigue siendo 4→29-ene = 0 átomos.
> **🔴 Consecuencia editorial (v5.14):** el deadline interno de la carta (≤15-oct) ya estaba roto desde v5.9 y ahora **C-6 cae el lun 26-oct-2026 (11 días tarde)**; el paquete queda listo en C-5 (jue 22-oct), así que el SUBMIT hay que hacerlo fuera del átomo (jue 15-oct, adelantando C-3/C-4/C-5) o elegir en C-2 (mar 6-oct) una diana con ventana más larga. **CR-1 (vie 30-oct) es el último hábil ANTES del 31-oct (margen 1 día) y CR-2 (mar 3-nov) ya cae DESPUÉS del 31-oct (3 días tarde)**: el re-orden v5.10b se agotó — el consentimiento hay que dejarlo firmado el mismo vie 30-oct (CR-1) o aceptar CR-2 fuera del plazo interno. Los deadlines NO se mueven, los átomos sí: **decisión de Joseph, no de la app** (§9.1).
...
|-------|-----|----------------|
| M1-2 (sep-oct 2026) | ORCID + Zotero · leer CARE + 10 case reports de JAADCR/DOJ · escribir **1 carta al editor** (respuesta a artículo 2026 de JAAD/IJD) · identificar 1-2 casos peruanos con consentimiento — **v5.14: R0 mar 22-sep · C-6 SUBMIT lun 26-oct ⚠ · CR-1 caso vie 30-oct ✅ (último hábil antes del 31-oct)** | transversal |
...
|---|---|---|---|---|---|---|---|---|---|
| `carta-1` | Carta al editor #1 | Letter / Notes & Comments (≤500 palabras) · `agentic/prompts_claude_code/letter_to_editor.md` | JAAD o JCD (elegir en C-2; candidatos en `CARTA_1/candidatos.md`) → plan B misma familia | Dr. Ciro (coautor) | **elegir artículo: ≤ 2ª sem. sep-2026 · enviar: ≤ 15-oct-2026** (fecha límite interna de la fila elegida) · *plan v5.14: diana C-2 = mar 6-oct-2026 · SUBMIT C-6 = lun 26-oct-2026 🔴 11 días tarde vs el ≤15-oct (§9.1)* | — | **idea** → candidatos con DOI verificado (C-1 hecho) | $0 | — |
| `tesis-L0` | Tesis IGA×CADI → research letter | Research letter STROBE (≈500-600 palabras · ≤5 refs · 1 tabla o 1 figura + apéndice «versión larga» 800/3/10) · `TESIS_L0/` · `research_letter_STROBE.md` | JAAD International → IJD → Actas Dermo-Sifiliográficas → Anais Brasileiros | Dr. Ciro (último autor) · Rising Scholars (inglés) · Finlay (permiso CADI) | ética/CEI: oct-2026 · borrador: dic-2026 · **enviar: ≤ 15-feb-2027** · *plan v5.10b re-fechado a v5.14 (19-sep): ética T-1 = **jue 8-oct-2026** (solicitud CEI expedita presentada ese día) · SUBMIT T-8 = mar 1-dic-2026 (76 días de margen) — **GATES en T-7/T-8: sin nº de CEI o exención, o sin inglés revisado, NO se envía → feb-2027*** | — | **borrador** (outline + checklists; bloqueado por CEI/consentimientos A VERIFICAR) | $0-1.288 | — |
| `case-report-1` | Case report #1 | CARE 2013 (13 ítems) · `CASE_REPORT_1/` · `case_report_CARE.md` | Dermatology Online Journal → IJD (correspondence) → JAAD Case Reports | Dr. Ciro o colega SPD (senior author) | caso + consentimiento: **31-oct-2026** · borrador: dic-2026 · **enviar: ≤ 28-feb-2027** · *plan v5.10b re-fechado a v5.14 (19-sep): CR-1 (caso) = **vie 30-oct-2026** (último hábil antes del 31-oct) · CR-2 (consentimiento) = **mar 3-nov-2026** 🔴 3 días DESPUÉS del 31-oct (firmar el consentimiento el mismo vie 30-oct o aceptar el retraso; en v5.13 caían mié 28 / vie 30-oct, en v5.9 el 3-nov / 9-nov) · seguimiento con el Dr. Ciro el jue 8-oct (d7) y el mar 20-oct (d11, ~3 semanas desde M1; sin caso el 20-oct → fuente B) · paquete congelado CR-8 = jue 17-dic-2026 · SUBMIT CR-9 = lun 1-feb-2027 (sin mover; D93 del Step 1, ya no la víspera)* | — | **idea** (sin caso; plantillas listas) | ≤ $300 | — |
| `prospero-SR-1` | Registro PROSPERO de SR-1 (L4) | Protocolo PRISMA-P · equipo de revisión (revisor #2 humano) | PROSPERO | Dr. Ciro (revisor #2 / validación clínica) + colaborador IMG | **≤ 31-mar-2027** · *plan v5.14: revisor #2 nombrado X-1 = lun 7-dic-2026 (la invitación declara la carga real ≈ 40-70 h fuera del bloque y exige aceptación escrita · L4 §9.4) · equipo confirmado X-9 = jue 25-feb-2027 · REGISTRO R10 = mié 3-mar-2027 (28 días de margen); las fechas previstas que se copian a PROSPERO son las de L4 §9.4 (con margen), no las de los átomos* | — | **idea** (corpus de 200 papers descubierto 11-jun-2026, 0 cribados; export Rayyan listo: `exportResearchCorpus`) | $0 | — |
| `SR-1` | Revisión sistemática L4 (complicaciones de inyectables, fototipos IV-VI) | PRISMA 2020 + GRADE · `agentic/` (pipeline SR) | Dermatologic Surgery → JAAD → JAAD International | Cotofana (contacto feb-mar 2027) · coautores IMG | ejecución abr-jun 2027 · **enviar: ≤ 31-ago-2027** · *plan v5.14: extracción R22-R25 = mar 20-abr → mar 4-may-2027 · SUBMIT R43 = mar 13-jul-2027 (49 días de margen)* | — | **idea** | $0 (techo $1.288) | — |

### 9.1 Calendario editorial v5.10b (re-orden del 12-sep-2026) → v5.11 (14-sep) = v5.12 (15-sep) → v5.13 (16-sep) → **v5.14 (re-fechado el 19-sep-2026: Research corre +2 hábiles más)** (fechas leídas con `node` de `researchDailyPlan.ts` / `researchDailyPlan2027.ts`)
...
del lun 14 al **mié 16-sep**, porque el mar 15-sep es día Derma) y el ciclo 2 corre con él (d43 = lun 15-feb-2027); en v5.12 (D1 del régimen = mié 16-sep, ya día Research) no cambió nada; **en v5.13 vuelve a correr +2 días hábiles** (su d1 pasa del mié 16 al **vie 18-sep**, porque el jue 17-sep es día Derma) y el ciclo 2 corre con él (d43 = mié 17-feb-2027); **en v5.14 corre otros +2 días hábiles** (su d1 pasa del vie 18 al **mar 22-sep**, porque el lun 21-sep es día Derma) y el ciclo 2 con él (d43 = vie 19-feb-2027). La columna **v5.14** es la fecha REAL del
átomo que ejecuta el hito (parseada de los `.ts` el 19-sep-2026), no una estimación. El **orden v5.10b (12-sep-2026, gaps v3b 1-3)** se mantiene: mismos 42
átomos; T-1 en d7, M3 en d8, R9 en d9 (antes de R6, d14), CR-1 en d15, CR-2 en d16, T-2 en d19, R7 en d21 y R2 en d35.

| Hito | Átomo | v5.11 = v5.12 | v5.13 | **v5.14 (vigente)** | Deadline externo | Margen |
|------|-------|---------------|-------|--------------------|------------------|--------|
| Infra académica (10 cuentas) | R0 | mié 16-sep-2026 | vie 18-sep-2026 | **mar 22-sep-2026** | — | — |
| Mentor: email al Dr. Ciro (3 coautorías) | M1 | mar 22-sep-2026 | jue 24-sep-2026 | **lun 28-sep-2026** | — | — |
| Artículo DIANA de la carta + deadline calculado | C-2 | mié 30-sep-2026 | vie 2-oct-2026 | **mar 6-oct-2026** | ventana del journal | según fila elegida |
| ¿Existe ya la SR? AMSTAR-2 de 5 SR vecinas + decisión a/b/c (L4 §6) | R9 | jue 8-oct-2026 | lun 12-oct-2026 | **mié 14-oct-2026** | — | gate del PICO |
| PICO de SR-1 fijado | R6 | jue 22-oct-2026 | lun 26-oct-2026 | **mié 28-oct-2026** | — | — |
| **SUBMIT carta al editor #1** | C-6 | mar 20-oct-2026 | jue 22-oct-2026 | **lun 26-oct-2026** | ≤ 15-oct-2026 | 🔴 **−11 días (VENCIDO)** |
| Ética / CEI de la tesis: nº archivado o **solicitud expedita PRESENTADA ese día** | T-1 | vie 2-oct-2026 | mar 6-oct-2026 | **jue 8-oct-2026** | solicitud ≤ 30-sep | 🔴 −8 días (la aprobación tarda semanas → gate en T-7/T-8; presentar la solicitud el mié 30-sep —día de C-1— fuera del átomo si se quiere respetar el ≤ 30-sep) |
| **Caso + senior author del case report** | CR-1 | lun 26-oct-2026 | mié 28-oct-2026 | **vie 30-oct-2026** | 31-oct-2026 | ✅ +1 día (último hábil antes del plazo) |
| Consentimiento de publicación firmado | CR-2 | mié 28-oct-2026 | vie 30-oct-2026 | **mar 3-nov-2026** | 31-oct-2026 | 🔴 **−3 días (VENCIDO)** → firmar el consentimiento el mismo vie 30-oct (CR-1) o aceptar el retraso interno |
| **SUBMIT research letter de la tesis (L0)** | T-8 | mié 25-nov-2026 | vie 27-nov-2026 | **mar 1-dic-2026** (gates: nº CEI/exención + inglés revisado; si fallan → feb-2027) | ≤ 15-feb-2027 | 76 días |
| Revisor humano #2 nombrado (pre-PROSPERO) | X-1 | mar 1-dic-2026 | jue 3-dic-2026 | **lun 7-dic-2026** | antes de PROSPERO | 86 días |
| **Paquete del case report CONGELADO** | CR-8 | vie 11-dic-2026 | mar 15-dic-2026 | **jue 17-dic-2026** | antes del submit | 46 días |
| Cierre antes de la pausa de enero | X-7 | mar 29-dic-2026 | mar 29-dic-2026 (d36) | **mar 29-dic-2026** *(no se movió: anclado a la pausa; ahora d35 — R8 salta al otro lado de la pausa)* | — | — |
| *(pausa Step 1: 4-ene → 29-ene-2027 = 0 átomos)* | — | igual | igual | **igual** | — | — |
| **SUBMIT case report #1 (DOJ)** | CR-9 | lun 1-feb-2027 | lun 1-feb-2027 (D95 = D-1 del Step 1) | **lun 1-feb-2027** *(no se movió: primer día-Research tras la pausa; d36)* — ✅ **v5.14: es el D93 del Step 1 (última semana de banco), ya NO la víspera del examen (jue 4-feb)**; el mié 3-feb (D-1) es X-8, no un submit | ≤ 28-feb-2027 | 27 días |
| Equipo de revisión CONFIRMADO | X-9 | vie 19-feb-2027 | mar 23-feb-2027 | **jue 25-feb-2027** | antes de PROSPERO | 6 días |
| **REGISTRO PROSPERO de SR-1** | R10 | jue 25-feb-2027 | lun 1-mar-2027 | **mié 3-mar-2027** | ≤ 31-mar-2027 | 28 días |
| Extracción doble de SR-1 | R22-R25 | mié 14-abr → mié 28-abr-2027 | vie 16-abr → vie 30-abr-2027 | **mar 20-abr → mar 4-may-2027** | — | — |
| **SUBMIT SR-1** | R43 | mié 7-jul-2027 | vie 9-jul-2027 | **mar 13-jul-2027** | ≤ 31-ago-2027 | 49 días |
| Balance 12 meses | X-12 | jue 12-ago-2027 | lun 16-ago-2027 | **mié 18-ago-2027** | — | — |

> **🔴 DEADLINES ROTOS tras el corrimiento de v5.14 — decisión de Joseph, no de la app:**
> - **C-6 = lun 26-oct-2026** contra el ≤ 15-oct. En v5.8 quedaba 1 día de margen; desde v5.9 el átomo
>   cae tarde (1 día en v5.9/v5.10, 5 días en v5.11/v5.12, 7 días en v5.13, **11 días en v5.14**). Opciones: (a) hacer el SUBMIT el jue 15-oct fuera del átomo (el paquete ya
>   está listo en C-5, jue 22-oct → en v5.14 habría que adelantar también C-3/C-4/C-5 o cerrar el paquete el mié 14-oct, día de R9), (b) elegir en C-2 (mar 6-oct) una fila de candidatos cuya ventana
>   cierre más tarde. **Lo que NO vale es dejarlo correr:** la ventana del journal no se negocia.
> - **T-1 = jue 8-oct-2026** contra la solicitud ≤ 30-sep (interno): 8 días tarde; si importa, presentar la solicitud CEI el mié 30-sep (día Research: C-1) fuera del átomo.
> - **CR-1 = vie 30-oct (último hábil antes del 31-oct) y CR-2 = mar 3-nov (3 días DESPUÉS del 31-oct)**: el intercambio v5.10b con T-2 y R7 se agotó en este corrimiento (aguantó v5.11-v5.13 con 5/3, 3/1 días). Regla operativa: seguimiento con el Dr. Ciro
>   el jue 8-oct (d7) y el mar 20-oct (d11, ~3 semanas desde M1 lun 28-sep); sin caso el 20-oct → fuente B (colega SPD) con el mensaje único de
>   `CASE_REPORT_1/caso_candidatos.md` §2 (MENTORES fila 6); el consentimiento se firma en la misma cita del vie 30-oct si el paciente está disponible.
> - **X-9 = jue 25-feb-2027 → R10 = mié 3-mar-2027**: 6 días entre confirmar el equipo y registrar (igual que en v5.10-v5.13). El revisor #2 debe estar comprometido desde X-1 (lun 7-dic-2026); X-9 solo confirma.
>
...
> tramo dic-2026 mientras puede (en v5.11 X-3 pasó del lun 21 al mié 23-dic y el hueco entre X-3 y X-7 se cerró; en v5.13 X-3 saltó al otro lado de la pausa); **en v5.14 el tramo dic-2026 vuelve a ceder un átomo: R8 salta al otro lado de la pausa (d38, vie 5-feb; X-7 pasa a ser d35 y CR-9 d36) y el ciclo 1 termina el mié 17-feb (X-6, d42) en vez del lun 15-feb**, empujando el ciclo 2 un slot (d43 = vie 19-feb).
> **✅ v5.14:** el examen Step 1 es el **jue 4-feb-2027**, el mié 3-feb su D-1 y el lun 1-feb (día de CR-9) es su **D93 (última semana de banco: AMBOSS 200 mitad 2)**: el SUBMIT del case report ya no compite con la víspera del examen y **la decisión B de `PENDIENTES_JOSEPH.md` queda RESUELTA**. Único resto: X-8 (re-arranque post-Step 1) cae el mié 3-feb = D-1 → hacerlo dentro de las ≤2 h de la mañana o saltarlo (no es un submit; nada de pantallas después de las 17:00). El generador sigue anclando CR-9 a la pausa 4→29-ene, no a `DAILY_META.examenTarget`: si un corrimiento futuro vuelve a poner el lun 1-feb en D-1, reaparece el problema.
