...
>
> **Plan v5.10b (12-sep-2026 · gap 2) re-fechado a v5.16 (26-sep-2026; Research corre +2 hábiles respecto a v5.15 — corrimiento RÍGIDO, mismo orden y mismos átomos):** M1 (petición al Dr. Ciro) = **vie 2-oct** · **seguimiento** = mié 14-oct (d7, T-1) y **lun 26-oct**
> (d11, ~3 semanas desde M1) · **sin caso el 26-oct → fuente B** con el mensaje único de §2 · **CR-1 (caso elegido) = jue 5-nov** — 🔴 **5 días DESPUÉS del 31-oct** ·
> **CR-2 (consentimiento firmado) = lun 9-nov** — 🔴 **9 días DESPUÉS del 31-oct**. En v5.14 CR-1 aún alcanzaba el vie 30-oct; desde v5.15 **ningún átomo llega al plazo interno** (v5.15: mar 3 / jue 5-nov; en v5.13 caían mié 28 / vie 30-oct con margen 3 y 1 día; en v5.11/v5.12 lun 26 / mié 28-oct; en v5.9 el 3-nov y el 9-nov; en v5.10b jue 22 / lun 26-oct). ⚠ Esto contradice el chip "sin caso antes del 31-oct el entregable de feb-2027 no ocurre". Regla práctica: cerrar caso + consentimiento **fuera del átomo** (el vie 30-oct, día de C-6, es el último hábil antes del plazo) o aceptar el retraso — **decisión de Joseph**.
...
- **Mensaje único listo (activar el lun 26-oct-2026 si el Dr. Ciro no dio caso — v5.16; v5.15: jue 22-oct; WhatsApp o email, 6 líneas):**
...
1. **CR-1 (jue 5-nov-2026 · v5.16: 🔴 ya después del 31-oct — elegir el caso el vie 30-oct si se puede; v5.15: mar 3-nov)** Rellenar la fila; búsqueda de novedad en PubMed/OpenAlex documentada (base, fecha, términos, n) → si
...
2. **CR-2 (lun 9-nov-2026; v5.16: 9 días después del 31-oct — firmarlo el vie 30-oct si se puede; v5.15: jue 5-nov)** Consentimiento de publicación firmado (ES) en la siguiente cita del paciente; escanear y guardar en
...
8. **CR-8** (mié 23-dic-2026 en v5.16: paquete congelado) → **CR-9** SUBMIT el vie 5-feb-2027 (primer día-Research tras la pausa, D92 del Step 1; el examen es el jue 11-feb): cuenta en el sistema de envío de la revista creada con
...
| 19-sep-2026 | v5.14: Research corre +2 hábiles (D1 del régimen = lun 21-sep, día Derma → ciclo 1 desde el mar 22-sep). M1 lun 28-sep · seguimiento jue 8-oct (d7) y mar 20-oct (d11) · **CR-1 vie 30-oct (último hábil antes del 31-oct) · CR-2 mar 3-nov (🔴 3 días después del 31-oct: firmar el consentimiento el mismo vie 30-oct)** · CR-8 jue 17-dic. ✅ El examen Step 1 pasa al **jue 4-feb-2027** y CR-9 (lun 1-feb, sin cambio) ya NO es la víspera: es el D93 del Step 1 (última semana de banco) — la decisión B de PENDIENTES queda resuelta. Leído de `researchDailyPlan.ts` con node. | Claude (v5.14) — CR-2 fuera del plazo interno: decisión de Joseph |
| 22-sep-2026 | v5.15 (corrimiento RÍGIDO): Research corre +2 hábiles (D1 del régimen = mié 23-sep, día Derma → ciclo 1 desde el jue 24-sep). M1 mié 30-sep · seguimiento lun 12-oct (d7) y jue 22-oct (d11) · 🔴 **CR-1 mar 3-nov y CR-2 jue 5-nov: LOS DOS DESPUÉS del 31-oct (3 y 5 días)** — ya no queda átomo antes del plazo interno · CR-8 lun 21-dic. ✅ El examen Step 1 pasa al **lun 8-feb-2027** y CR-9 (lun 1-feb, sin cambio) es el D91 del Step 1 (banco intensivo), a una semana del examen. Leído de `researchDailyPlan.ts` con node. | Claude (v5.15) — CR-1 y CR-2 fuera del plazo interno: **decisión de Joseph** |
| 26-sep-2026 | v5.16 (corrimiento RÍGIDO): Research corre +2 hábiles (D1 del régimen = lun 28-sep, día Research → ciclo 1 desde el mismo lun 28-sep, R0) y la pausa del Step 1 +3 (jue 7-ene → mié 3-feb). M1 vie 2-oct · seguimiento mié 14-oct (d7) y lun 26-oct (d11) · 🔴 **CR-1 jue 5-nov y CR-2 lun 9-nov: LOS DOS DESPUÉS del 31-oct (5 y 9 días)** · CR-8 mié 23-dic. ✅ El examen Step 1 pasa al **jue 11-feb-2027** y CR-9 corre al **vie 5-feb** (d36, primer día-Research tras la pausa) = D92 del Step 1 (banco intensivo), 4 hábiles antes del examen; el átomo que cae el día del examen es R8 (PRISMA-P, recortable). Leído de `researchDailyPlan.ts` con node. | Claude (v5.16) — CR-1 y CR-2 fuera del plazo interno: **decisión de Joseph** |
