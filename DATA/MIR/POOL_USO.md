...
| **Mini-MIR D77 40Q** (30-dic) | `preguntasMixtasSinUsar(40, usadas, '2026-12-30', { soloPlan: true })` → tabla de neto por asignatura para la baseline de D78 | `miniMIR` | 40 |
...
## 3. Banqueo ene-mar 2027 (`src/lib/mirMantenimiento.ts`, 62 días, 5-ene → 31-mar)
...
| lun-jue `banco` (reducido, hasta 27-ene) | `preguntasMixtasSinUsar(10, usadas, fecha, { nums: [dia.num, dia.num2] })` | — | `mantenimiento` |
