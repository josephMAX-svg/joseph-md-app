...
const st = StyleSheet.create({
  ...
  temaTitle: { fontSize: FontSize.bodyLg, fontWeight: '800', color: Colors.onSurface, marginTop: 8, lineHeight: 21 },
  temaSub: { fontSize: FontSize.labelSm, color: Colors.muted, marginTop: 3, lineHeight: 16 },
  ...
  franjaHora: { borderRadius: BorderRadius.sm, paddingVertical: 3, paddingHorizontal: 7, minWidth: 96, alignItems: 'center' },
  franjaHoraTxt: { fontSize: FontSize.labelSm, fontWeight: '800' },
  franjaFase: { fontSize: FontSize.labelMd, color: Colors.onSurfaceVariant, lineHeight: 16 },
  franjaDet: { fontSize: FontSize.labelSm, marginTop: 2, fontWeight: '600' },
