...
export const USMLE_READINESS = {
  ...
  next: 'UWSA1 jue 17-sep (D1, baseline) → luego NBME 25/26/27/28/29 cada ~3 semanas (plan v5.13). Registra el % de cada hito en 📏 Medición (Cola de hoy): el gauge se ancla al último hito y muestra la distancia al mínimo on-track.',
};
