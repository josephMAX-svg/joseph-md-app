...
/** D1 del Step 1 (v5.10 = lun 14-sep-2026) — misma fuente que usmleStep1Daily.DAILY_META.inicio. */
export const STEP1_INICIO = DAILY_META.inicio;
export const STEP1_SEMANAS = 20; // S1 14-sep → S20 18-22 ene (examen semana 25-29 ene 2027)
...
export const HITOS_STEP1: { fecha: string; nombre: string; minimo: string }[] = [
  { fecha: '2026-09-14', nombre: 'UWSA1', minimo: 'baseline (cualquier valor)' },
