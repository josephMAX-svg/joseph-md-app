 ...
 * PAUSA 2027-01-04 → 2027-01-29 = 0 átomos, Step 1). d1-d40 caben antes de la pausa (último: 2027-02-03);
...
export const DAILY_META = {
  inicio: '2026-09-14', fin: '2027-02-09', totalDias: 42, // ciclo 1 · D1=Lun 2026-09-14 · alterna con Derma · sáb+dom libres · salta 25-dic/31-dic/1-ene · d41-d42 tras la pausa
  ciclo: 1 as const,
  finNucleo: '2027-02-03', // último átomo antes de la pausa de enero
...
export const DIAS: DiaResearch[] = [
  ...
  { d: 35, fecha: '2026-12-17', ciclo: 1, fase: 'R1', pista: 'R', code: 'R9', prioridad: 'ALTA', objetivo: '¿Existe ya una SR publicada o registrada del mismo PICO? Búsqueda en PROSPERO + PubMed ("systematic review" filler vascular occlusion hyaluronidase) → decisión seguir / afinar el ángulo (tiempo-a-tratamiento + LATAM)', entregable: 'Lista de SR y registros vecinos + decisión escrita (seguir / afinar) en L4 §6', artefacto: 'lines/L4-complicaciones.md §6 actualizado', tool: 'PROSPERO · PubMed', recs: ['PROS', 'PM', 'AMSTAR'], apex: null },
  // X · Transversal · cierre
...
export const RESEARCH_HITOS: Record<string, { code: string; fecha: string; ciclo: number; d: number }> = {
  ...
  'tesis-etica': { code: 'T-1', fecha: '2026-10-20', ciclo: 1, d: 14 },
  'cr-caso': { code: 'CR-1', fecha: '2026-11-03', ciclo: 1, d: 19 },
