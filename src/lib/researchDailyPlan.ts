...
export const DIAS: DiaResearch[] = [
  // R0 · Cimientos & método
  { d: 1,  fecha: '2026-09-04', fase: 'R0', code: 'R1',  prioridad: 'CRITICA', objetivo: 'Montar la infra: cuenta NCBI + key OpenAlex (gratis) + alerta PubMed; citas por IA (no Zotero)', entregable: 'Cuenta NCBI + API key OpenAlex + 1 alerta + 3 case reports modelo', tool: 'OpenAlex · PubMed', recs: ['OPENALEX', 'PM'], apex: { id: 'infra', t: 'Infra del motor lista (key OpenAlex)' } },
  { d: 2,  fecha: '2026-09-08', fase: 'R0', code: 'R2',  prioridad: 'CRITICA', objetivo: 'Formular preguntas en PICO y distinguir tipos (terapia/dx/pronóstico)', entregable: '3 PICO escritos (1 será el de SR-1)', tool: '—', recs: ['CIL1', 'GREEN'], apex: null },
  { d: 3,  fecha: '2026-09-10', fase: 'R0', code: 'R3',  prioridad: 'CRITICA', objetivo: 'Diseños de estudio y niveles de evidencia (case report vs original)', entregable: 'Mapa 1-página: diseño → nivel → sesgos típicos', tool: '—', recs: ['STEPSR', 'STAT', 'ZED'], apex: null },
  { d: 4,  fecha: '2026-09-14', fase: 'R0', code: 'R4',  prioridad: 'ALTA',    objetivo: 'Cómo leer un paper críticamente (método Greenhalgh)', entregable: '1 abstract del nicho leído con plantilla PICO + tipo de estudio', tool: '—', recs: ['GREEN'], apex: null },
  { d: 5,  fecha: '2026-09-16', fase: 'R0', code: 'R5',  prioridad: 'CRITICA', objetivo: 'Ver una SR de punta a punta (visión global antes de ejecutar)', entregable: 'Esquema de las 8 fases con la herramienta de cada una', tool: '—', recs: ['STEPSR', 'CIL1'], apex: { id: 'sr-map', t: 'Las 8 fases de una SR' } },
  // R1 · Pregunta & protocolo
  { d: 6,  fecha: '2026-09-18', fase: 'R1', code: 'R6',  prioridad: 'CRITICA', objetivo: 'Fijar el PICO de SR-1 (complicaciones vasculares de fillers) + 1 outcome primario', entregable: 'PICO de SR-1 escrito y validado contra la ficha L4', tool: '—', recs: ['DELO', 'CIL1'], apex: { id: 'pico-sr1', t: 'PICO de SR-1' } },
  { d: 7,  fecha: '2026-09-22', fase: 'R1', code: 'R7',  prioridad: 'CRITICA', objetivo: 'Criterios de elegibilidad (inclusión/exclusión) y diseños admitidos', entregable: 'Tabla de criterios PICOS de SR-1', tool: '—', recs: ['COCHB'], apex: null },
  { d: 8,  fecha: '2026-09-24', fase: 'R1', code: 'R8',  prioridad: 'ALTA',    objetivo: 'Protocolo PRISMA-P (estructura, qué congela)', entregable: 'Borrador de protocolo SR-1 (secciones PRISMA-P)', tool: '—', recs: ['PRISMA', 'COCHB'], apex: null },
  { d: 9,  fecha: '2026-09-28', fase: 'R1', code: 'R9',  prioridad: 'ALTA',    objetivo: '¿Hay SR ya publicada/registrada del mismo PICO?', entregable: 'Búsqueda en PROSPERO + PubMed → decisión seguir/afinar', tool: 'PROSPERO', recs: ['PROS', 'PM'], apex: null },
  // R2 · Registro PROSPERO
  { d: 10, fecha: '2026-09-30', fase: 'R2', code: 'R10', prioridad: 'CRITICA', objetivo: 'Rellenar el formulario PROSPERO (campos obligatorios)', entregable: 'Registro PROSPERO de SR-1 ENVIADO', tool: 'PROSPERO', recs: ['PROS'], apex: { id: 'prospero', t: 'SR-1 registrada (CRD)' } },
  { d: 11, fecha: '2026-10-02', fase: 'R2', code: 'R11', prioridad: 'MEDIA',   objetivo: 'Plan B si no encaja (scoping → OSF) + esperar CRD', entregable: 'CRD recibido o registro en OSF; protocolo congelado', tool: 'OSF', recs: ['PROS', 'OSF'], apex: null },
  // R3 · Búsqueda N bases
  { d: 12, fecha: '2026-10-06', fase: 'R3', code: 'R12', prioridad: 'CRITICA', objetivo: 'Estrategia maestra: OpenAlex (troncal, booleana) + MeSH en MEDLINE/PubMed', entregable: 'Query booleana de SR-1 en OpenAlex + sintaxis PubMed (líneas numeradas)', tool: 'OpenAlex · PubMed', recs: ['OPENALEX', 'NLM1', 'PM'], apex: { id: 'mesh', t: 'Query OpenAlex + MeSH' } },
  { d: 13, fecha: '2026-10-08', fase: 'R3', code: 'R13', prioridad: 'ALTA',    objetivo: 'Trasladar a Europe PMC + CENTRAL + Semantic Scholar (5 fuentes)', entregable: 'Sintaxis + nº de resultados por fuente', tool: 'Europe PMC · S2', recs: ['EPMC', 'CENT', 'SEMSCH'], apex: null },
  { d: 14, fecha: '2026-10-12', fase: 'R3', code: 'R14', prioridad: 'ALTA',    objetivo: 'LILACS/BVS (ventaja LATAM) + registros de ensayos', entregable: 'Búsqueda LILACS + ClinicalTrials.gov + ICTRP anotada', tool: 'LILACS · CT.gov', recs: ['LILACS', 'CT', 'ICTRP'], apex: null },
  { d: 15, fecha: '2026-10-14', fase: 'R3', code: 'R15', prioridad: 'ALTA',    objetivo: 'PRISMA-S (16 ítems): documentar cada componente', entregable: 'Tabla PRISMA-S de SR-1 (fecha, base, interfaz, sintaxis, nº)', tool: '—', recs: ['PRISMAS'], apex: null },
  { d: 16, fecha: '2026-10-16', fase: 'R3', code: 'R16', prioridad: 'MEDIA',   objetivo: 'Texto completo (cascada Unpaywall→…) + dedup por DOI → cribado', entregable: 'PDFs OA resueltos + biblioteca dedup lista para Rayyan', tool: 'Unpaywall · Rayyan', recs: ['UNPAY', 'RAY'], apex: null },
  // R4 · Screening
  { d: 17, fecha: '2026-10-20', fase: 'R4', code: 'R17', prioridad: 'CRITICA', objetivo: 'Montar Rayyan y subir el corpus; etiquetas y ciego', entregable: 'Proyecto Rayyan de SR-1 con todos los registros', tool: 'Rayyan', recs: ['RAY', 'RAYHC', 'RAYYT'], apex: { id: 'rayyan', t: 'Cribado en Rayyan' } },
  { d: 18, fecha: '2026-10-22', fase: 'R4', code: 'R18', prioridad: 'CRITICA', objetivo: 'Cribado título/abstract (nivel 1), 2 revisores o 2 pases', entregable: 'Nivel 1 completado; conflictos marcados', tool: 'Rayyan', recs: ['RAY'], apex: null },
  { d: 19, fecha: '2026-10-26', fase: 'R4', code: 'R19', prioridad: 'ALTA',    objetivo: 'Texto completo (nivel 2) con razones de exclusión', entregable: 'Excluidos con motivo (alimenta el flujo PRISMA)', tool: 'Rayyan', recs: ['RAY'], apex: null },
  { d: 20, fecha: '2026-10-28', fase: 'R4', code: 'R20', prioridad: 'ALTA',    objetivo: 'Kappa interobservador (acuerdo de inclusión) en Python/R', entregable: 'κ calculado + IC; conflictos a checkpoint humano', tool: 'Python/R', recs: ['STEPSR'], apex: null },
  { d: 21, fecha: '2026-10-30', fase: 'R4', code: 'R21', prioridad: 'ALTA',    objetivo: 'Diagrama de flujo PRISMA 2020 (4 fases, vías separadas)', entregable: 'PRISMA flow de SR-1 con números reales', tool: 'eshackathon Shiny', recs: ['PRISMAF'], apex: { id: 'prisma-flow', t: 'Diagrama PRISMA 2020' } },
  // R5 · Extracción
  { d: 22, fecha: '2026-11-03', fase: 'R5', code: 'R22', prioridad: 'ALTA',    objetivo: 'Formulario de extracción piloteado (qué variables)', entregable: 'Plantilla de extracción de SR-1 (diseño, n, outcomes, sesgo)', tool: 'Sheets', recs: ['COCHB'], apex: null },
  { d: 23, fecha: '2026-11-05', fase: 'R5', code: 'R23', prioridad: 'ALTA',    objetivo: 'Piloto de extracción en 2-3 estudios + ajustar formulario', entregable: 'Formulario v2 + 3 filas piloto', tool: '—', recs: ['COCHB'], apex: null },
  { d: 24, fecha: '2026-11-09', fase: 'R5', code: 'R24', prioridad: 'MEDIA',   objetivo: 'Extracción asistida (Elicit) como segundo par de ojos', entregable: 'Filas extraídas de los incluidos (doble chequeo)', tool: 'Elicit', recs: ['ELI'], apex: null },
  { d: 25, fecha: '2026-11-11', fase: 'R5', code: 'R25', prioridad: 'MEDIA',   objetivo: 'Cerrar la tabla de características de estudios', entregable: 'Tabla completa de SR-1 (lista para Results)', tool: '—', recs: ['COCHB'], apex: { id: 'extraction', t: 'Tabla de extracción cerrada' } },
  // R6 · Sesgo & GRADE
  { d: 26, fecha: '2026-11-13', fase: 'R6', code: 'R26', prioridad: 'ALTA',    objetivo: 'Riesgo de sesgo: RoB 2 (ECA) / ROBINS-I (no-aleatorizados)', entregable: 'Evaluación RoB por estudio incluido', tool: 'riskofbias.info', recs: ['ROB2', 'ROBINS'], apex: { id: 'rob', t: 'Riesgo de sesgo evaluado' } },
  { d: 27, fecha: '2026-11-17', fase: 'R6', code: 'R27', prioridad: 'ALTA',    objetivo: 'GRADE (4 niveles, 5 dominios) + Summary of Findings', entregable: 'SoF table de SR-1 por desenlace', tool: 'GRADEpro', recs: ['GRADE'], apex: null },
  { d: 28, fecha: '2026-11-19', fase: 'R6', code: 'R28', prioridad: 'MEDIA',   objetivo: 'AMSTAR-2 para apreciar SR vecinas y posicionar la nuestra', entregable: 'Nota AMSTAR-2 sobre 2-3 SR previas del tema', tool: '—', recs: ['AMSTAR'], apex: null },
  // R7 · Meta-análisis en R
  { d: 29, fecha: '2026-11-23', fase: 'R7', code: 'R29', prioridad: 'ALTA',    objetivo: 'Montar R + metafor/meta y cargar los datos extraídos', entregable: 'Script R que lee la tabla y calcula 1 effect size', tool: 'R', recs: ['DMAR', 'METAFOR'], apex: { id: 'r-setup', t: 'metafor cargado' } },
  { d: 30, fecha: '2026-11-25', fase: 'R7', code: 'R30', prioridad: 'ALTA',    objetivo: 'Tamaño de efecto correcto + modelo fijo vs aleatorio', entregable: 'Pooled estimate con IC95%', tool: 'R', recs: ['DMAR'], apex: null },
  { d: 31, fecha: '2026-11-27', fase: 'R7', code: 'R31', prioridad: 'ALTA',    objetivo: 'Forest plot + heterogeneidad (I², τ²)', entregable: 'Forest plot TIFF 300 dpi + I²/τ² reportados', tool: 'R', recs: ['DMAR', 'METAFOR', 'COCHYT'], apex: { id: 'forest', t: 'Forest plot + heterogeneidad' } },
  { d: 32, fecha: '2026-12-01', fase: 'R7', code: 'R32', prioridad: 'MEDIA',   objetivo: 'Sesgo de publicación: funnel plot + test de Egger', entregable: 'Funnel + Egger de SR-1', tool: 'R', recs: ['DMAR'], apex: null },
  { d: 33, fecha: '2026-12-03', fase: 'R7', code: 'R33', prioridad: 'MEDIA',   objetivo: 'Subgrupos/sensibilidad (tiempo-a-hialuronidasa, zona, training)', entregable: 'Análisis de subgrupos + sensibilidad', tool: 'R', recs: ['DMAR'], apex: null },
  // R8 · Manuscrito & envío
  { d: 34, fecha: '2026-12-07', fase: 'R8', code: 'R34', prioridad: 'ALTA',    objetivo: 'Methods + Results con PRISMA 2020 (registro, búsqueda, flujo, síntesis)', entregable: 'Methods+Results de SR-1 redactados', tool: 'Sistema agéntico', recs: ['PRISMA', 'PRISMAC'], apex: { id: 'methods-results', t: 'Methods+Results escritos' } },
  { d: 35, fecha: '2026-12-09', fase: 'R8', code: 'R35', prioridad: 'ALTA',    objetivo: 'Introduction (gap + objetivo) y Discussion (límites + certeza)', entregable: 'Intro+Discussion de SR-1 redactados', tool: 'Sistema agéntico', recs: ['EQ', 'PRISMAC'], apex: null },
  { d: 36, fecha: '2026-12-11', fase: 'R8', code: 'R36', prioridad: 'ALTA',    objetivo: 'Checklist PRISMA 2020 de 27 ítems + supplementary', entregable: 'Checklist 27 ítems marcada + supplements (PRISMA-S, SoF, CRD)', tool: '—', recs: ['PRISMAC'], apex: null },
  { d: 37, fecha: '2026-12-15', fase: 'R8', code: 'R37', prioridad: 'MEDIA',   objetivo: 'Elegir journal + APC (Diamond OA vs 50% LMIC, Research4Life)', entregable: 'Journal target decidido + plan de coste', tool: '—', recs: ['EQ'], apex: null },
  { d: 38, fecha: '2026-12-17', fase: 'R8', code: 'R38', prioridad: 'MEDIA',   objetivo: 'Cover letter + formateo al journal (Editorial Manager/ScholarOne)', entregable: 'Cover letter + manuscrito formateado', tool: '—', recs: ['EQ'], apex: null },
