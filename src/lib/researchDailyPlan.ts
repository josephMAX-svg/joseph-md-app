 ...
 * PAUSA 2027-01-04 → 2027-01-29 = 0 átomos, Step 1). d1-d38 caben antes de la pausa (último: 2026-12-29);
 * d39-d42 van tras la pausa (CR-9 SUBMIT del case report · X-8 re-arranque · X-5 / X-6 desplazados por no caber antes) — el total 42 es
...
export const DAILY_META = {
  inicio: '2026-09-14', fin: '2027-02-09', totalDias: 42, // ciclo 1 · D1=Lun 2026-09-14 · alterna con Derma · sáb+dom libres · salta 25-dic/31-dic/1-ene · d39-d42 tras la pausa
  ciclo: 1 as const,
...
export const RESEARCH_HITOS: Record<string, { code: string; fecha: string; ciclo: number; d: number }> = {
  'mentor': { code: 'M1', fecha: '2026-09-18', ciclo: 1, d: 3 },
  'carta-diana': { code: 'C-2', fecha: '2026-09-28', ciclo: 1, d: 6 },
  'tesis-etica': { code: 'T-1', fecha: '2026-09-30', ciclo: 1, d: 7 },
  'carta-1': { code: 'C-6', fecha: '2026-10-16', ciclo: 1, d: 13 },
  'cr-caso': { code: 'CR-1', fecha: '2026-10-22', ciclo: 1, d: 15 },
  'tesis-L0': { code: 'T-8', fecha: '2026-11-23', ciclo: 1, d: 26 },
  'revisor2': { code: 'X-1', fecha: '2026-11-27', ciclo: 1, d: 28 },
  'cr-paquete': { code: 'CR-8', fecha: '2026-12-09', ciclo: 1, d: 32 },
  'case-report-1': { code: 'CR-9', fecha: '2027-02-01', ciclo: 1, d: 39 },
  'equipo': { code: 'X-9', fecha: '2027-02-17', ciclo: 2, d: 45 },
  'PROSPERO-SR1': { code: 'R10', fecha: '2027-02-23', ciclo: 2, d: 47 },
  'SR-1': { code: 'R43', fecha: '2027-07-05', ciclo: 2, d: 94 },
};
