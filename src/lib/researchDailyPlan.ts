 ...
 * 40 átomos (mié 10-jun-2026 → lun 28-sep-2026), 1 átomo por DÍA-RESEARCH.
...
export const DAILY_META = {
  inicio: '2026-06-10', fin: '2026-09-28', totalDias: 40,
...
export const DIAS: DiaResearch[] = [
  ...
  { d: 5,  fecha: '2026-06-22', fase: 'R0', code: 'R5',  prioridad: 'CRITICA', objetivo: 'Ver una SR de punta a punta (visión global antes de ejecutar)', entregable: 'Esquema de las 8 fases con la herramienta de cada una', tool: '—', recs: ['STEPSR', 'CIL1'], apex: { id: 'sr-map', t: 'Las 8 fases de una SR' } },
  // R1 · Pregunta & protocolo
  { d: 6,  fecha: '2026-06-24', fase: 'R1', code: 'R6',  prioridad: 'CRITICA', objetivo: 'Fijar el PICO de SR-1 (complicaciones vasculares de fillers) + 1 outcome primario', entregable: 'PICO de SR-1 escrito y validado contra la ficha L4', tool: '—', recs: ['DELO', 'CIL1'], apex: { id: 'pico-sr1', t: 'PICO de SR-1' } },
  { d: 7,  fecha: '2026-06-26', fase: 'R1', code: 'R7',  prioridad: 'CRITICA', objetivo: 'Criterios de elegibilidad (inclusión/exclusión) y diseños admitidos', entregable: 'Tabla de criterios PICOS de SR-1', tool: '—', recs: ['COCHB'], apex: null },
  { d: 8,  fecha: '2026-06-30', fase: 'R1', code: 'R8',  prioridad: 'ALTA',    objetivo: 'Protocolo PRISMA-P (estructura, qué congela)', entregable: 'Borrador de protocolo SR-1 (secciones PRISMA-P)', tool: '—', recs: ['PRISMA', 'COCHB'], apex: null },
  { d: 9,  fecha: '2026-07-02', fase: 'R1', code: 'R9',  prioridad: 'ALTA',    objetivo: '¿Hay SR ya publicada/registrada del mismo PICO?', entregable: 'Búsqueda en PROSPERO + PubMed → decisión seguir/afinar', tool: 'PROSPERO', recs: ['PROS', 'PM'], apex: null },
  ...
  { d: 19, fecha: '2026-07-30', fase: 'R4', code: 'R19', prioridad: 'ALTA',    objetivo: 'Texto completo (nivel 2) con razones de exclusión', entregable: 'Excluidos con motivo (alimenta el flujo PRISMA)', tool: 'Rayyan', recs: ['RAY'], apex: null },
  { d: 20, fecha: '2026-08-03', fase: 'R4', code: 'R20', prioridad: 'ALTA',    objetivo: 'Kappa interobservador (acuerdo de inclusión) en Python/R', entregable: 'κ calculado + IC; conflictos a checkpoint humano', tool: 'Python/R', recs: ['STEPSR'], apex: null },
  { d: 21, fecha: '2026-08-05', fase: 'R4', code: 'R21', prioridad: 'ALTA',    objetivo: 'Diagrama de flujo PRISMA 2020 (4 fases, vías separadas)', entregable: 'PRISMA flow de SR-1 con números reales', tool: 'eshackathon Shiny', recs: ['PRISMAF'], apex: { id: 'prisma-flow', t: 'Diagrama PRISMA 2020' } },
  // R5 · Extracción
  { d: 22, fecha: '2026-08-07', fase: 'R5', code: 'R22', prioridad: 'ALTA',    objetivo: 'Formulario de extracción piloteado (qué variables)', entregable: 'Plantilla de extracción de SR-1 (diseño, n, outcomes, sesgo)', tool: 'Sheets', recs: ['COCHB'], apex: null },
  { d: 23, fecha: '2026-08-11', fase: 'R5', code: 'R23', prioridad: 'ALTA',    objetivo: 'Piloto de extracción en 2-3 estudios + ajustar formulario', entregable: 'Formulario v2 + 3 filas piloto', tool: '—', recs: ['COCHB'], apex: null },
  { d: 24, fecha: '2026-08-13', fase: 'R5', code: 'R24', prioridad: 'MEDIA',   objetivo: 'Extracción asistida (Elicit) como segundo par de ojos', entregable: 'Filas extraídas de los incluidos (doble chequeo)', tool: 'Elicit', recs: ['ELI'], apex: null },
  { d: 25, fecha: '2026-08-17', fase: 'R5', code: 'R25', prioridad: 'MEDIA',   objetivo: 'Cerrar la tabla de características de estudios', entregable: 'Tabla completa de SR-1 (lista para Results)', tool: '—', recs: ['COCHB'], apex: { id: 'extraction', t: 'Tabla de extracción cerrada' } },
  // R6 · Sesgo & GRADE
  { d: 26, fecha: '2026-08-19', fase: 'R6', code: 'R26', prioridad: 'ALTA',    objetivo: 'Riesgo de sesgo: RoB 2 (ECA) / ROBINS-I (no-aleatorizados)', entregable: 'Evaluación RoB por estudio incluido', tool: 'riskofbias.info', recs: ['ROB2', 'ROBINS'], apex: { id: 'rob', t: 'Riesgo de sesgo evaluado' } },
  { d: 27, fecha: '2026-08-21', fase: 'R6', code: 'R27', prioridad: 'ALTA',    objetivo: 'GRADE (4 niveles, 5 dominios) + Summary of Findings', entregable: 'SoF table de SR-1 por desenlace', tool: 'GRADEpro', recs: ['GRADE'], apex: null },
  { d: 28, fecha: '2026-08-25', fase: 'R6', code: 'R28', prioridad: 'MEDIA',   objetivo: 'AMSTAR-2 para apreciar SR vecinas y posicionar la nuestra', entregable: 'Nota AMSTAR-2 sobre 2-3 SR previas del tema', tool: '—', recs: ['AMSTAR'], apex: null },
  // R7 · Meta-análisis en R
  { d: 29, fecha: '2026-08-27', fase: 'R7', code: 'R29', prioridad: 'ALTA',    objetivo: 'Montar R + metafor/meta y cargar los datos extraídos', entregable: 'Script R que lee la tabla y calcula 1 effect size', tool: 'R', recs: ['DMAR', 'METAFOR'], apex: { id: 'r-setup', t: 'metafor cargado' } },
  { d: 30, fecha: '2026-08-31', fase: 'R7', code: 'R30', prioridad: 'ALTA',    objetivo: 'Tamaño de efecto correcto + modelo fijo vs aleatorio', entregable: 'Pooled estimate con IC95%', tool: 'R', recs: ['DMAR'], apex: null },
  { d: 31, fecha: '2026-09-02', fase: 'R7', code: 'R31', prioridad: 'ALTA',    objetivo: 'Forest plot + heterogeneidad (I², τ²)', entregable: 'Forest plot TIFF 300 dpi + I²/τ² reportados', tool: 'R', recs: ['DMAR', 'METAFOR', 'COCHYT'], apex: { id: 'forest', t: 'Forest plot + heterogeneidad' } },
  { d: 32, fecha: '2026-09-04', fase: 'R7', code: 'R32', prioridad: 'MEDIA',   objetivo: 'Sesgo de publicación: funnel plot + test de Egger', entregable: 'Funnel + Egger de SR-1', tool: 'R', recs: ['DMAR'], apex: null },
  { d: 33, fecha: '2026-09-08', fase: 'R7', code: 'R33', prioridad: 'MEDIA',   objetivo: 'Subgrupos/sensibilidad (tiempo-a-hialuronidasa, zona, training)', entregable: 'Análisis de subgrupos + sensibilidad', tool: 'R', recs: ['DMAR'], apex: null },
  // R8 · Manuscrito & envío
  { d: 34, fecha: '2026-09-10', fase: 'R8', code: 'R34', prioridad: 'ALTA',    objetivo: 'Methods + Results con PRISMA 2020 (registro, búsqueda, flujo, síntesis)', entregable: 'Methods+Results de SR-1 redactados', tool: 'Sistema agéntico', recs: ['PRISMA', 'PRISMAC'], apex: { id: 'methods-results', t: 'Methods+Results escritos' } },
  { d: 35, fecha: '2026-09-14', fase: 'R8', code: 'R35', prioridad: 'ALTA',    objetivo: 'Introduction (gap + objetivo) y Discussion (límites + certeza)', entregable: 'Intro+Discussion de SR-1 redactados', tool: 'Sistema agéntico', recs: ['EQ', 'PRISMAC'], apex: null },
