 ...
 * GENERADO por DATA/_scripts/gen_research_plan.js (2026-09-19) — NO editar a mano: `node DATA/_scripts/gen_research_plan.js [YYYY-MM-DD]`
 *
 * 42 átomos · D1 = Mar 2026-09-22 → D42 = Mié 2027-02-17 · 1 átomo por DÍA-RESEARCH
 * (interdiario con Derma: researchData.ts → diaEstudioTipo · sáb+dom libres · salta 25-dic/31-dic/1-ene ·
 * PAUSA 2027-01-04 → 2027-01-29 = 0 átomos, Step 1). d1-d35 caben antes de la pausa (último: 2026-12-29);
...
export const DAILY_META = {
  inicio: '2026-09-22', fin: '2027-02-17', totalDias: 42, // ciclo 1 · D1=Mar 2026-09-22 · alterna con Derma · sáb+dom libres · salta 25-dic/31-dic/1-ene · d36-d42 tras la pausa
  ciclo: 1 as const,
...
export const RESEARCH_HITOS: Record<string, { code: string; fecha: string; ciclo: number; d: number }> = {
  'mentor': { code: 'M1', fecha: '2026-09-28', ciclo: 1, d: 3 },
  'carta-diana': { code: 'C-2', fecha: '2026-10-06', ciclo: 1, d: 6 },
  'tesis-etica': { code: 'T-1', fecha: '2026-10-08', ciclo: 1, d: 7 },
  'carta-1': { code: 'C-6', fecha: '2026-10-26', ciclo: 1, d: 13 },
  'cr-caso': { code: 'CR-1', fecha: '2026-10-30', ciclo: 1, d: 15 },
  'tesis-L0': { code: 'T-8', fecha: '2026-12-01', ciclo: 1, d: 26 },
  'revisor2': { code: 'X-1', fecha: '2026-12-07', ciclo: 1, d: 28 },
  'cr-paquete': { code: 'CR-8', fecha: '2026-12-17', ciclo: 1, d: 32 },
  'case-report-1': { code: 'CR-9', fecha: '2027-02-01', ciclo: 1, d: 36 },
  'equipo': { code: 'X-9', fecha: '2027-02-25', ciclo: 2, d: 45 },
  'PROSPERO-SR1': { code: 'R10', fecha: '2027-03-03', ciclo: 2, d: 47 },
  'SR-1': { code: 'R43', fecha: '2027-07-13', ciclo: 2, d: 94 },
};
