 ...
 * GENERADO por DATA/_scripts/gen_research_plan.js (2026-09-09) — NO editar a mano: `node DATA/_scripts/gen_research_plan.js [YYYY-MM-DD]`
 *
 * 42 átomos · D1 = Jue 2026-09-10 → D42 = Vie 2027-02-05 · 1 átomo por DÍA-RESEARCH
 * (interdiario con Derma: researchData.ts → diaEstudioTipo · sáb+dom libres · salta 25-dic/31-dic/1-ene ·
 * PAUSA 2027-01-04 → 2027-01-29 = 0 átomos, Step 1). d1-d40 caben antes de la pausa (último: 2027-02-01);
...
export const DAILY_META = {
  inicio: '2026-09-10', fin: '2027-02-05', totalDias: 42, // ciclo 1 · D1=Jue 2026-09-10 · alterna con Derma · sáb+dom libres · salta 25-dic/31-dic/1-ene · d41-d42 tras la pausa
  ciclo: 1 as const,
  finNucleo: '2027-02-01', // último átomo antes de la pausa de enero
...
export const RESEARCH_HITOS: Record<string, { code: string; fecha: string; ciclo: number; d: number }> = {
  'mentor': { code: 'M1', fecha: '2026-09-16', ciclo: 1, d: 3 },
  'carta-diana': { code: 'C-2', fecha: '2026-09-24', ciclo: 1, d: 6 },
  'carta-1': { code: 'C-6', fecha: '2026-10-14', ciclo: 1, d: 13 },
  'tesis-etica': { code: 'T-1', fecha: '2026-10-16', ciclo: 1, d: 14 },
  'cr-caso': { code: 'CR-1', fecha: '2026-10-30', ciclo: 1, d: 19 },
  'tesis-L0': { code: 'T-8', fecha: '2026-11-19', ciclo: 1, d: 26 },
  'revisor2': { code: 'X-1', fecha: '2026-11-25', ciclo: 1, d: 28 },
  'cr-paquete': { code: 'CR-8', fecha: '2026-12-07', ciclo: 1, d: 32 },
  'case-report-1': { code: 'CR-9', fecha: '2027-02-01', ciclo: 1, d: 40 },
  'equipo': { code: 'X-9', fecha: '2027-02-15', ciclo: 2, d: 45 },
  'PROSPERO-SR1': { code: 'R10', fecha: '2027-02-19', ciclo: 2, d: 47 },
  'SR-1': { code: 'R43', fecha: '2027-07-01', ciclo: 2, d: 94 },
};
