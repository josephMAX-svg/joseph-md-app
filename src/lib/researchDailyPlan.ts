 ...
 * GENERADO por DATA/_scripts/gen_research_plan.js (2026-09-26) — NO editar a mano: `node DATA/_scripts/gen_research_plan.js [YYYY-MM-DD]`
 *
 * 42 átomos · D1 = Lun 2026-09-28 → D42 = Mar 2027-02-23 · 1 átomo por DÍA-RESEARCH
 * (interdiario con Derma: researchData.ts → diaEstudioTipo · sáb+dom libres · salta 25-dic/31-dic/1-ene ·
 * PAUSA 2027-01-07 → 2027-02-03 = 0 átomos, Step 1). d1-d35 caben antes de la pausa (último: 2027-01-06);
 * d36-d42 van tras la pausa (CR-9 SUBMIT del case report · X-8 re-arranque · R8 / X-3 / X-4 / X-5 / X-6 desplazados por no caber antes) — el total 42 es
...
export const DAILY_META = {
  inicio: '2026-09-28', fin: '2027-02-23', totalDias: 42, // ciclo 1 · D1=Lun 2026-09-28 · alterna con Derma · sáb+dom libres · salta 25-dic/31-dic/1-ene · d36-d42 tras la pausa
  ciclo: 1 as const,
  finNucleo: '2027-01-06', // último átomo antes de la pausa de enero
  pausa: '2027-01-07 → 2027-02-03 · 0 átomos (Step 1)',
...
export const DIAS: DiaResearch[] = [
  // R0 · Cimientos & infra
  { d: 1, fecha: '2026-09-28', ciclo: 1, fase: 'R0', pista: 'R', code: 'R0', prioridad: 'CRITICA', objetivo: 'Infra académica: abrir las 10 cuentas que exige el circuito editorial (checklist marcable en Desk → Infra académica)', entregable: '10/10 cuentas: ORCID · Google Scholar · CTI Vitae/RENACYT · Editorial Manager · ScholarOne · eScholarship/DOJ · PROSPERO · Rayyan · Zotero · OpenAlex + NCBI keys', artefacto: 'Checklist "Infra académica" (app · clave research-infra) + IDs (ORCID iD, CTI Vitae) guardados en DATA/RESEARCH/MENTORES.md §Identificadores', tool: 'ORCID · CTI Vitae · Rayyan', recs: ['ORCID', 'SCHOLAR', 'CTI', 'NCBIACC', 'OPENALEX', 'PROS', 'RAY', 'ZOT'], apex: { id: 'infra', t: 'Infra académica 10/10' } },
  { d: 2, fecha: '2026-09-30', ciclo: 1, fase: 'R0', pista: 'R', code: 'R1', prioridad: 'CRITICA', objetivo: 'PICO: formular 3 preguntas (terapia / diagnóstico / pronóstico) y leer 1 abstract del nicho con el método Greenhalgh', entregable: '3 PICO escritos + 1 abstract (fillers · fototipos IV-VI) clasificado por diseño de estudio', artefacto: 'Nota 01_PICO.md (3 PICO + plantilla Greenhalgh) en el vault → SR-1/_hoja_de_ruta', tool: '—', recs: ['CIL1', 'GREEN'], apex: null },
  // M · Mentores & red
  { d: 3, fecha: '2026-10-02', ciclo: 1, fase: 'M', pista: 'M', code: 'M1', prioridad: 'CRITICA', objetivo: 'Dr. Ciro Rodríguez (Hospital Regional Daniel Alcides Carrión, Huancayo): propuesta CONCRETA de 3 coautorías — tesis→research letter (él senior), carta al editor (coautor) y case report de SU consulta (él senior author)', entregable: 'Mensaje o reunión con las 3 coautorías propuestas + respuesta registrada (sí / no / cuándo)', artefacto: 'DATA/RESEARCH/MENTORES.md: fila Dr. Ciro (qué pido · fecha · estado · siguiente paso)', tool: 'WhatsApp / presencial', recs: ['ICMJE', 'CREDIT'], chips: ['antes de T-1 (mié 14-oct-2026): reunir los 10 documentos de etica.md §1 y preguntar al Dr. Ciro la vía CEI (expedita / retrospectiva / exención)'], apex: { id: 'mentor-ciro', t: 'Senior author local confirmado' } },
  // C · Carta al editor
  { d: 4, fecha: '2026-10-06', ciclo: 1, fase: 'C', pista: 'C', code: 'C-1', prioridad: 'CRITICA', objetivo: 'Discovery de 5 artículos 2026 (últimos 30-60 días) en JAAD / JAAD Intl / IJD / JCD / Dermatol Surg sobre derma estética · fototipos IV-VI · complicaciones de fillers, con la ventana de letters y los límites de cada journal', entregable: 'Tabla de 5 candidatos: journal · fecha de publicación · ventana de correspondencia (URL de Author Guidelines) · límite palabras/refs · coste · ángulo de la carta (dato peruano/latino que el paper no considera)', artefacto: 'DATA/RESEARCH/CARTA_1/candidatos.md (tabla de 5) + correo a IJD Editorial Office pidiendo su política de correspondencia (pendiente desde 27-ago)', tool: 'research-discovery · PubMed', recs: ['PM', 'OPENALEX', 'JAADINT', 'IJD'], chips: ['ventana de letters típica 4-12 semanas · A VERIFICAR por journal (JAAD/IJD dieron 403 el 05-sep)'], apex: null },
  // M · Mentores & red
  { d: 5, fecha: '2026-10-08', ciclo: 1, fase: 'M', pista: 'M', code: 'M2', prioridad: 'ALTA', objetivo: 'Rising Scholars (ex-AuthorAID, INASP): solicitar mentor 1-a-1 gratuito para la revisión en inglés del primer manuscrito — tarda semanas, pedirlo YA; el mentor debe cubrir la carta (C), la tesis (T-7) y el case report (CR-6)', entregable: 'Perfil creado + solicitud de mentor enviada (área: dermatología / escritura científica)', artefacto: 'MENTORES.md: fila Rising Scholars (fecha de solicitud · estado · fecha de decisión del plan B)', tool: 'risingscholars.net', recs: ['RISING', 'SCIWRITE', 'PHRASE'], chips: ['plan B (editor profesional US$200-400 · RUTA §3.1) se decide el jue 05-nov-2026 (4 semanas) si no hay mentor asignado — MENTORES fila 2'], apex: null },
  // C · Carta al editor
  { d: 6, fecha: '2026-10-12', ciclo: 1, fase: 'C', pista: 'C', code: 'C-2', prioridad: 'CRITICA', objetivo: 'Elegir 1 artículo diana con FECHA LÍMITE de submit calculada (ventana del journal) + leer 5 letters modelo del mismo journal (cita → aporte u objeción con 1 dato verificable → implicación)', entregable: 'Artículo diana fijado + deadline en la Mesa editorial + esqueleto de la carta (3 párrafos) calcado de los 5 modelos', artefacto: 'CARTA_1/diana.md (DOI del artículo, deadline, límites, esqueleto) + Mesa editorial: carta-1 → borrador', tool: 'PubMed · Mesa editorial', recs: ['PM', 'PHRASE', 'ICMJE'], apex: { id: 'carta-diana', t: 'Artículo diana + deadline' } },
  // T · Tesis · research letter
  { d: 7, fecha: '2026-10-14', ciclo: 1, fase: 'T', pista: 'T', code: 'T-1', prioridad: 'CRITICA', objetivo: 'Ética de la tesis (adolescentes, colegio): verificar y ARCHIVAR nº y fecha de aprobación del CEI (FMH-UNCP u hospital). Los consentimientos YA constan (censo con consentimiento parental + asentimiento: 291 excluidas por no consentir, portada de datos_tesis_acne.xlsx → etica.md 1.4-1.5). Si no hubo CEI formal → PRESENTAR HOY la solicitud de revisión expedita/retrospectiva (o pedir la constancia de exención) con protocolo + modelos de consentimiento/asentimiento + oficio de la I.E. + resumen de resultados (etica.md §2.1)', entregable: 'Nº de CEI archivado O solicitud de revisión expedita PRESENTADA (nº de cargo + fecha) + párrafo de ética/consentimiento listo para Methods', artefacto: 'DATA/RESEARCH/TESIS_L0/etica.md (nº CEI o nº de cargo de la solicitud, fecha, consentimientos, párrafo para Methods)', tool: 'Archivo de la tesis · asesor · mesa de partes del CEI', recs: ['ICMJE', 'COPE'], chips: ['sin nº de CEI o constancia de exención JAAD Intl e IJD rechazan de entrada → gate en T-7/T-8', 'solicitud CEI expedita presentada ≤ mié 14-oct-2026 (HOY): documentos reunidos desde M1 (vie 02-oct-2026) · desbloquea M3 (versión del CADI · etica.md 1.7)'], apex: null },
  // M · Mentores & red
  { d: 8, fecha: '2026-10-16', ciclo: 1, fase: 'M', pista: 'M', code: 'M3', prioridad: 'ALTA', objetivo: 'Email a Prof. Andrew Finlay (Cardiff, creador CADI/DLQI): 6 líneas — permiso / versión española del CADI + ofrecer los datos de la tesis (n=316, rs=0.637) como validación peruana; desbloquea L6', entregable: 'Email enviado (6 líneas, asunto claro, 1 pregunta concreta) + copia archivada', artefacto: 'MENTORES.md: fila Finlay (fecha · estado) + copia del email en §Plantillas', tool: 'Email institucional', recs: ['PHRASE', 'ICMJE'], chips: ['requiere T-1 (versión del CADI usada · etica.md 1.7)', 'seguimiento del caso con el Dr. Ciro (M1 vie 02-oct-2026); si el jue 22-oct-2026 (3 semanas desde M1) no hay caso → activar fuente B (colega SPD) con el mensaje único de caso_candidatos.md §2'], apex: null },
  // R1 · Pregunta & protocolo
  { d: 9, fecha: '2026-10-20', ciclo: 1, fase: 'R1', pista: 'R', code: 'R9', prioridad: 'CRITICA', objetivo: '¿Existe ya una SR del mismo PICO? AMSTAR-2 RÁPIDO (16 ítems, 10 min por SR) de las 5 SR/MA que ya solapan con SR-1 — PMID 41249530 (protocolo de hialuronidasa, SR+MA 2026) · 37178872 (complicaciones vasculares con necrosis, SR 2024) · 39214904 (alta vs baja dosis, SR+MA 2024) · 36574028 (hialuronidasa en pérdida visual, SR 2024) · 40406769 (factores de riesgo, Cureus 2025) — + búsqueda PROSPERO/PubMed de registros nuevos → DECISIÓN ESCRITA en L4 §6 con UNA de tres salidas: (a) ángulo diferencial defendible (tiempo-a-hialuronidasa <24 h / ≥24 h, rellenos no-HA, inyectores no médicos, LATAM/LILACS), (b) pivotar SR-1 a scoping review, (c) adelantar SR-2 (L5, fototipos IV-VI) como SR-1', entregable: 'AMSTAR-2 rápido de las 5 SR vecinas + decisión escrita (a) / (b) / (c) en L4 §6 — ANTES de fijar el PICO (R6)', artefacto: 'lines/L4-complicaciones.md §6 actualizado (tabla AMSTAR-2 + decisión firmada con fecha)', tool: 'PROSPERO · PubMed · AMSTAR-2', recs: ['AMSTAR', 'PROS', 'PM'], chips: ['gate: R6 (PICO) no se fija sin la salida (a)/(b)/(c) escrita en L4 §6'], apex: null },
  // C · Carta al editor
  { d: 10, fecha: '2026-10-22', ciclo: 1, fase: 'C', pista: 'C', code: 'C-3', prioridad: 'ALTA', objetivo: 'Borrador de la carta: 400-600 palabras, ≤5 referencias, 3 párrafos (qué dice el artículo → qué falta u objeción con 1 dato verificable de Perú/LATAM/fototipos IV-VI → implicación clínica); frases del Academic Phrasebank', entregable: 'Borrador v1 completo (400-600 palabras) con marcadores [CIT:id] en lugar de referencias escritas', artefacto: 'CARTA_1/borrador_v1.md', tool: 'Obsidian · Phrasebank', recs: ['PHRASE', 'SCIWRITE'], chips: ['HOY jue 22-oct-2026 vence el plazo del Dr. Ciro (3 semanas desde M1 vie 02-oct-2026): sin caso → activar fuente B (colega SPD) con el mensaje único de caso_candidatos.md §2 (MENTORES fila 6)'], apex: { id: 'carta-v1', t: 'Borrador de la carta' } },
  { d: 11, fecha: '2026-10-26', ciclo: 1, fase: 'C', pista: 'C', code: 'C-4', prioridad: 'CRITICA', objetivo: 'Citas verificadas: cada [CIT:id] resuelto a DOI/PMID real con citation_verifier.py (Crossref/PubMed + CSL-JSON → Vancouver); cero referencias de memoria', entregable: '≤5 referencias con status verified + lista Vancouver generada; ninguna needs_review / rejected', artefacto: 'CARTA_1/refs_verified.json (salida de citation_verifier.py) + borrador v2 con [n]', tool: 'python DATA/RESEARCH/agentic/citation_verifier.py', recs: ['CROSSREF', 'PM'], apex: null },
  { d: 12, fecha: '2026-10-28', ciclo: 1, fase: 'C', pista: 'C', code: 'C-5', prioridad: 'MEDIA', objetivo: 'Formateo al journal del artículo diana (Author Guidelines: título, autores + ORCID, conflictos, límite exacto) + cover letter de 5 líneas + cuenta activa en el portal del journal (Editorial Manager / ScholarOne)', entregable: 'Manuscrito formateado (.docx) + cover letter + cuenta del portal activa', artefacto: 'CARTA_1/carta_final.docx + cover_letter.md', tool: 'Editorial Manager / ScholarOne', recs: ['EM', 'ICMJE', 'COPE'], apex: null },
  { d: 13, fecha: '2026-10-30', ciclo: 1, fase: 'C', pista: 'C', code: 'C-6', prioridad: 'CRITICA', objetivo: 'SUBMIT carta al editor #1 (antes del deadline calculado en C-2) + registrar la fecha de envío y el nº de manuscrito en la Mesa editorial', entregable: 'Carta ENVIADA ✅ · estado carta-1 → enviado', artefacto: 'Mesa editorial: carta-1 = enviado (fecha) + MENTORES.md actualizado si hay coautor', tool: 'Editorial Manager / ScholarOne', recs: ['ICMJE'], apex: { id: 'carta-submit', t: 'Carta #1 enviada' } },
  // R1 · Pregunta & protocolo
  { d: 14, fecha: '2026-11-03', ciclo: 1, fase: 'R1', pista: 'R', code: 'R6', prioridad: 'CRITICA', objetivo: 'Fijar el PICO de SR-1 (complicaciones vasculares de fillers + tiempo-a-hialuronidasa) + 1 desenlace primario, validado contra la ficha L4 y según la salida (a)/(b)/(c) de R9 · PICO v1 PROVISIONAL: se revalida en R6b (ciclo 2) cuando Derma d19-20 haya cubierto el mecanismo de la oclusión', entregable: 'PICO de SR-1 escrito (P/I/C/O + desenlace primario único) y contrastado con L4 §2', artefacto: 'lines/L4-complicaciones.md §2 actualizado + nota 01_protocolo_PICO en el vault', tool: '—', recs: ['DELO', 'CIL1', 'COCHB'], chips: ['requiere Derma d19-20 (oclusión vascular)', 'requiere R9: el PICO se fija según la salida (a)/(b)/(c) escrita en L4 §6'], apex: { id: 'pico-sr1', t: 'PICO de SR-1' } },
  // CR · Case report (CARE)
  { d: 15, fecha: '2026-11-05', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-1', prioridad: 'CRITICA', objetivo: 'CASE REPORT #1 — decidir la FUENTE del caso antes del 31-oct: (a) Dr. Ciro: 1-2 casos de su consulta (ideal complicación de inyectable = L4, o caso raro con buenas fotos) con él como senior author; (b) plan B: dermatólogo de la Sociedad Peruana de Dermatología', entregable: 'Tabla de casos candidatos (diagnóstico · por qué es publicable · fotos disponibles · senior author · estado) + 1 caso ELEGIDO', artefacto: 'DATA/RESEARCH/CASE_REPORT_1/caso_candidatos.md + Mesa editorial: senior author del case report', tool: 'Dr. Ciro · SPD', recs: ['CARE', 'DOJ', 'JAADCR'], chips: ['⚠ v5.16: este átomo cae el jue 5-nov (y CR-2 el lun 9-nov), ya DESPUÉS del 31-oct. La regla "sin caso antes del 31-oct el entregable de feb-2027 no ocurre" sigue viva: el caso y el senior author hay que cerrarlos FUERA del bloque de 45 min, antes de que llegue este día', 'si el Dr. Ciro no dio caso el jue 22-oct-2026, la fuente B ya debe estar activada (MENTORES fila 6)'], apex: { id: 'cr-caso', t: 'Caso + senior author' } },
  { d: 16, fecha: '2026-11-09', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-2', prioridad: 'CRITICA', objetivo: 'Consentimiento de PUBLICACIÓN (distinto del asistencial): plantilla bilingüe ES/EN según lo que exigen DOJ y CARE, con fotos y datos clínicos; firmado por el paciente (o tutor)', entregable: 'Consentimiento firmado y escaneado (sin él no hay case report)', artefacto: 'CASE_REPORT_1/consentimiento_publicacion_ES_EN.md (plantilla) + consentimiento_firmado.pdf (fuera del repo)', tool: 'Plantilla + consulta', recs: ['CARE', 'COPE', 'ICMJE'], chips: ['el consentimiento depende de la próxima cita del paciente (no controlable): si la cita cae después del 31-oct, pedir al senior author que lo obtenga él en consulta'], apex: null },
  // T · Tesis · research letter
  { d: 17, fecha: '2026-11-11', ciclo: 1, fase: 'T', pista: 'T', code: 'T-3', prioridad: 'ALTA', objetivo: 'Research letter AL LÍMITE MÁS ESTRICTO de la cascada (≈500-600 palabras, ≤5 refs, 1 tabla O 1 figura · límites por revista en research_letter_outline.md §1, releídos ese día): Introduction (gap: QoL en acné adolescente andino, CADI en LMIC) + Methods (transversal censal 23-mar→1-abr-2026, n=316, IGA como gold standard del Dr. Ciro, CADI, rs de Spearman, κ)', entregable: 'Intro + Methods redactados (≤250 palabras) con [CIT:id]', artefacto: 'TESIS_L0/research_letter_v1.md (Intro + Methods)', tool: 'Obsidian · Phrasebank', recs: ['PHRASE', 'STROBE', 'SCIWRITE'], apex: null },
  { d: 18, fecha: '2026-11-13', ciclo: 1, fase: 'T', pista: 'T', code: 'T-4', prioridad: 'ALTA', objetivo: 'Results: 1 tabla (características + IGA×CADI; n por grado 112/110/60/34) y 1 figura (CADI por grado IGA o correlación rs=0.637) con gtsummary / R base — UNA va al texto principal (límite estricto: 1 tabla O 1 figura), la otra al apéndice "versión larga"; prevalencia 39.8 %, κ=0.81', entregable: 'Tabla 1 + Figura 1 (300 dpi) generadas desde la base + párrafo de Results (≤150 palabras); una pieza en el texto, la otra en el apéndice', artefacto: 'TESIS_L0/tabla1.docx + figura1.tiff + research_letter_v1.md (Results)', tool: 'R · gtsummary', recs: ['GTS', 'BBR'], apex: { id: 'tesis-results', t: 'Tabla 1 + Figura 1 de la tesis' } },
  { d: 19, fecha: '2026-11-17', ciclo: 1, fase: 'T', pista: 'T', code: 'T-2', prioridad: 'ALTA', objetivo: 'STROBE (transversal, 22 ítems) sobre la tesis y el borrador v1 (T-3/T-4): marcar qué ítem ya está, qué falta y qué se recorta para el formato research letter (lo que no cabe en 500-600 palabras va al apéndice "versión larga")', entregable: 'Checklist STROBE rellenada (22 ítems con página / estado) — base del Methods', artefacto: 'TESIS_L0/STROBE_checklist.md', tool: 'STROBE', recs: ['STROBE', 'EQ'], apex: null },
  { d: 20, fecha: '2026-11-19', ciclo: 1, fase: 'T', pista: 'T', code: 'T-5', prioridad: 'ALTA', objetivo: 'Discussion (≤150 palabras: hallazgo, comparación con la literatura CADI, limitaciones, implicación) + apéndice "versión larga" (800 palabras / 3 tablas-figuras / 10 refs para Actas; 1.000 / 4 / 10 para Anais Cartas-Investigação) + decidir la CASCADA y el coste: JAAD International (OA, 50 % Grupo B) → IJD → Actas Dermo-Sifiliográficas ($0) → Anais Brasileiros ($0)', entregable: 'Discussion redactada (v1 completa ≈500-600 palabras) + apéndice "versión larga" + cascada con APC verificado en la web de cada journal (con fecha) o "A VERIFICAR"', artefacto: 'TESIS_L0/research_letter_v1.md (completo) + research_letter_v1_larga.md (apéndice) + TESIS_L0/cascada_journals.md', tool: 'Obsidian', recs: ['JAADINT', 'IJD', 'ACTAS', 'ANAIS', 'PHRASE'], apex: null },
  // R1 · Pregunta & protocolo
  { d: 21, fecha: '2026-11-23', ciclo: 1, fase: 'R1', pista: 'R', code: 'R7', prioridad: 'ALTA', objetivo: 'Criterios de elegibilidad de SR-1 (inclusión / exclusión, diseños admitidos, idiomas, años) en tabla PICOS', entregable: 'Tabla PICOS de SR-1 congelable para el protocolo', artefacto: 'lines/L4-complicaciones.md §3 actualizado + nota 01_protocolo_PICO', tool: '—', recs: ['COCHB', 'PRISMA'], apex: null },
  // T · Tesis · research letter
  { d: 22, fecha: '2026-11-25', ciclo: 1, fase: 'T', pista: 'T', code: 'T-6', prioridad: 'ALTA', objetivo: 'Revisión del research letter por el Dr. Ciro (coautor / senior): comentarios incorporados + criterios ICMJE de autoría + roles CRediT + conflictos + ORCID de ambos', entregable: 'v2 revisada por el senior author + página de autoría (ICMJE / CRediT / conflictos)', artefacto: 'TESIS_L0/research_letter_v2.md + autoria.md', tool: 'Dr. Ciro', recs: ['ICMJE', 'CREDIT', 'COPE'], apex: null },
  // CR · Case report (CARE)
  { d: 23, fecha: '2026-11-27', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-3', prioridad: 'ALTA', objetivo: 'Fotos clínicas estandarizadas: fondo neutro, misma distancia e iluminación, sin datos identificables (recortar u ocultar ojos y tatuajes), pre/post si hay; nombrar por fecha; protocolo escrito', entregable: 'Set de fotos (≥2, 300 dpi, anonimizadas) + protocolo fotográfico', artefacto: 'CASE_REPORT_1/protocolo_fotos.md + carpeta fotos/ (fuera del repo)', tool: 'Cámara / móvil · editor de imagen', recs: ['CARE', 'DOJ'], apex: null },
  // T · Tesis · research letter
  { d: 24, fecha: '2026-12-01', ciclo: 1, fase: 'T', pista: 'T', code: 'T-7', prioridad: 'CRITICA', objetivo: 'Formateo a JAAD International (Guide for Authors leída ESE DÍA con Chrome · Editorial Manager): research letter al límite real de la revista (≈500-600 palabras, ≤5 refs verificadas con citation_verifier.py, 1 tabla o 1 figura), declaración de ética con nº de CEI o exención (T-1), inglés revisado (mentor / editor), cover letter', entregable: 'Manuscrito formateado + refs verified + cover letter + declaración de ética + constancia de revisión de inglés', artefacto: 'TESIS_L0/research_letter_final.docx + refs_verified.json + cover_letter.md', tool: 'citation_verifier.py · Editorial Manager', recs: ['JAADINT', 'CROSSREF', 'EM'], chips: ['GATE 1: sin nº de CEI o constancia de exención NO se envía a JAAD Intl/IJD → T-8 pasa a feb-2027 (cascada) y el átomo se convierte en seguimiento del CEI', 'GATE 2: inglés revisado por el mentor de Rising Scholars o por editor (US$200-400 · RUTA §3.1); si no hay revisión, T-8 se desplaza al siguiente día-Research'], apex: null },
  // CR · Case report (CARE)
  { d: 25, fecha: '2026-12-03', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-4', prioridad: 'ALTA', objetivo: 'CARE (13 ítems): rellenar la checklist + tabla TIMELINE del paciente + párrafo de perspectiva del paciente + declaración de consentimiento', entregable: 'CARE checklist 13/13 con página + timeline en tabla', artefacto: 'CASE_REPORT_1/CARE_checklist_13.md + timeline.md', tool: 'CARE', recs: ['CARE', 'EQ'], apex: { id: 'care', t: 'CARE 13/13' } },
  // T · Tesis · research letter
  { d: 26, fecha: '2026-12-07', ciclo: 1, fase: 'T', pista: 'T', code: 'T-8', prioridad: 'CRITICA', objetivo: 'SUBMIT research letter de la tesis a JAAD International (o al siguiente de la cascada si el primero no aplica) + registrar en la Mesa editorial y en CTI Vitae', entregable: 'Tesis ENVIADA ✅ (nº de manuscrito) · estado tesis-L0 → enviado', artefacto: 'Mesa editorial: tesis-L0 = enviado (fecha) + CTI Vitae actualizado', tool: 'Editorial Manager', recs: ['JAADINT', 'ICMJE'], chips: ['GATE 1: sin nº de CEI o constancia de exención NO se envía → T-8 pasa a feb-2027 (cascada)', 'GATE 2: sin revisión de inglés (mentor / editor) el envío se desplaza al siguiente día-Research'], apex: { id: 'tesis-submit', t: 'Tesis enviada' } },
  // CR · Case report (CARE)
  { d: 27, fecha: '2026-12-09', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-5', prioridad: 'ALTA', objetivo: 'Borrador del case report (límite de palabras de DOJ: A VERIFICAR en sus guías): presentación → hallazgos → diagnóstico → tratamiento → evolución → discusión con 3-5 refs [CIT:id] + "por qué este caso enseña algo"', entregable: 'Borrador v1 completo siguiendo el orden CARE', artefacto: 'CASE_REPORT_1/borrador_v1.md', tool: 'Obsidian · Phrasebank', recs: ['CARE', 'PHRASE', 'DOJ'], apex: null },
  // X · Transversal · cierre
  { d: 28, fecha: '2026-12-11', ciclo: 1, fase: 'X', pista: 'R', code: 'X-1', prioridad: 'ALTA', objetivo: 'SR-1 · EQUIPO DE REVISIÓN: nombrar al revisor humano #2 ANTES de PROSPERO (opciones: Dr. Ciro · egresado UNCP con interés en investigación · colaborador IMG de la campaña); ofrecer coautoría por 2º cribado + extracción; cuenta Rayyan (gratis ≤3 revisiones). La invitación declara la CARGA REAL por revisor, fuera del bloque 13:30 (agenda post-Step 1): cribado título/abstract ≈ 6-12 h · texto completo ≈ 10-16 h · extracción doble ≈ 15-25 h · riesgo de sesgo ≈ 8-14 h entre mar y may-2027 (campo horas de researchDailyPlan2027.ts)', entregable: 'Revisor #2 propuesto (nombre, afiliación, ORCID, conflicto) + invitación enviada con la carga horaria escrita', artefacto: 'lines/L4-complicaciones.md §9 "Equipo de revisión" rellenado + MENTORES.md', tool: 'Rayyan', recs: ['RAY', 'PROS', 'COCHB'], chips: ['PRISMA 2020 ítem 8 y Cochrane exigen ≥2 revisores independientes; 2 pases de la misma persona NO son cribado dual', 'sin aceptación escrita de las horas (≈40-70 h en 3 meses) no hay revisor #2 ni PROSPERO'], apex: null },
  // CR · Case report (CARE)
  { d: 29, fecha: '2026-12-15', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-6', prioridad: 'ALTA', objetivo: 'Revisión del case report por el senior author (mentor local) + mentor de Rising Scholars (inglés): incorporar cambios y verificar cada afirmación clínica contra fuente primaria', entregable: 'v2 con comentarios del senior + inglés revisado · estado case-report-1 → revision-mentor', artefacto: 'CASE_REPORT_1/borrador_v2.md', tool: 'Senior author · Rising Scholars', recs: ['RISING', 'CARE'], apex: null },
  // X · Transversal · cierre
  { d: 30, fecha: '2026-12-17', ciclo: 1, fase: 'X', pista: 'C', code: 'X-2', prioridad: 'MEDIA', objetivo: 'Post-submit de la carta: plantilla de rebuttal punto por punto (comentario → respuesta → cambio exacto) + actualizar el estado real (en-revisión / decisión) en la Mesa editorial; si llegó decisión, responder en ≤7 días. Además: comprobar que el mentor de Rising Scholars (M2) revisó o revisará (≤7 días) el inglés del case report (CR-6) antes del formateo CR-7; si no, activar el plan B de MENTORES fila 2', entregable: 'Plantilla de rebuttal lista + estado real de carta-1 + confirmación escrita del mentor para el case report', artefacto: 'CARTA_1/rebuttal_plantilla.md + Mesa editorial + MENTORES.md fila 2', tool: 'Mesa editorial', recs: ['REBUTTAL', 'SCIWRITE'], chips: ['sin revisor de inglés para el case report, CR-7 formatea sobre un inglés no revisado → activar editor (plan B)'], apex: null },
  // CR · Case report (CARE)
  { d: 31, fecha: '2026-12-21', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-7', prioridad: 'ALTA', objetivo: 'Formateo a Dermatology Online Journal (eScholarship): guías de autor (A VERIFICAR: límite de palabras / fotos / coste ≤US$300), refs verificadas con citation_verifier.py, figuras con leyenda, consentimiento adjunto', entregable: 'Manuscrito formateado + refs verified + figuras + consentimiento + cover letter', artefacto: 'CASE_REPORT_1/case_report_final.docx + refs_verified.json + cover_letter.md', tool: 'citation_verifier.py · eScholarship', recs: ['DOJ', 'CROSSREF', 'CARE'], apex: null },
  { d: 32, fecha: '2026-12-23', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-8', prioridad: 'CRITICA', objetivo: 'Paquete de envío CONGELADO (manuscrito + fotos + consentimiento + CARE + cover) — el SUBMIT se ejecuta el vie 5-feb-2027 (CR-9 = d36 del ciclo 1, primer día-Research tras la pausa · = D92 del Step 1, antes del examen del jue 11-feb)', entregable: 'Paquete completo y revisado; nada pendiente para febrero · estado → revision-mentor', artefacto: 'CASE_REPORT_1/_PAQUETE_ENVIO/ (todo lo que se sube) + Mesa editorial: fecha objetivo vie 5-feb-2027', tool: '—', recs: ['CARE', 'DOJ'], apex: { id: 'cr-paquete', t: 'Case report listo para enviar' } },
  // R0 · Cimientos & infra
  { d: 33, fecha: '2026-12-29', ciclo: 1, fase: 'R0', pista: 'R', code: 'R3', prioridad: 'ALTA', objetivo: 'Ver una SR de punta a punta (8 fases) + des-riesgar el meta-análisis: instalar R + metafor y reproducir 1 forest plot del libro "Doing Meta-Analysis in R" (para que R29-R33 del ciclo 2 no sean la primera vez)', entregable: 'Esquema de las 8 fases con su herramienta + script R que reproduce un forest plot de ejemplo', artefacto: 'Vault SR-1/_hoja_de_ruta (8 fases) + 05_manuscrito/ejemplo_metafor.R', tool: 'R · metafor', recs: ['STEPSR', 'DMAR', 'METAFOR'], apex: { id: 'sr-map', t: '8 fases + metafor instalado' } },
  { d: 34, fecha: '2027-01-04', ciclo: 1, fase: 'R0', pista: 'R', code: 'R2', prioridad: 'ALTA', objetivo: 'Diseños de estudio y niveles de evidencia + regla EQUATOR: elegir la guía de reporte ANTES de escribir (carta = sin guía · tesis = STROBE transversal · case report = CARE · SR = PRISMA 2020)', entregable: 'Mapa de 1 página: diseño → nivel → sesgos típicos → guía de reporte que exige el journal', artefacto: 'Nota 02_disenos_guias.md en el vault + checklists STROBE y CARE descargadas a DATA/RESEARCH/', tool: '—', recs: ['EQ', 'STROBE', 'CARE', 'STAT'], chips: ['las checklists STROBE y CARE ya existen en DATA/RESEARCH (05-sep): este átomo cierra el mapa diseño → guía con lo aprendido en T y CR'], apex: null },
  // X · Transversal · cierre
  { d: 35, fecha: '2027-01-06', ciclo: 1, fase: 'X', pista: 'X', code: 'X-7', prioridad: 'CRITICA', objetivo: 'CIERRE ANTES DE LA PAUSA (7-ene→3-feb = 0 átomos · Step 1): nada que venza en enero — rebuttals respondidos o programados, PROSPERO aún NO registrado, revisor #2 confirmado, paquete del case report congelado; la cola del ciclo 1 (CR-9, d36) arranca el vie 5-feb-2027 con el SUBMIT del case report; el ciclo 2 sigue tras d42', entregable: 'Checklist de pausa 100 % + primer átomo del ciclo 2 leído', artefacto: 'Mesa editorial: cada entregable con estado y próxima fecha · Vault Dashboard_Research', tool: 'Mesa editorial', recs: ['ICMJE'], apex: { id: 'cierre-c1', t: 'Ciclo 1 cerrado · pausa Step 1' } },
  // CR · Case report (CARE)
  { d: 36, fecha: '2027-02-05', ciclo: 1, fase: 'CR', pista: 'CR', code: 'CR-9', prioridad: 'CRITICA', objetivo: 'SUBMIT case report #1 a Dermatology Online Journal (paquete congelado en CR-8) + registrar el nº de manuscrito — primer día-Research tras la pausa (vie 5-feb-2027 = D92 del Step 1; el examen es el jue 11-feb)', entregable: 'Case report ENVIADO ✅ · estado case-report-1 → enviado', artefacto: 'Mesa editorial: case-report-1 = enviado (fecha)', tool: 'eScholarship', recs: ['DOJ', 'CARE'], apex: { id: 'cr-submit', t: 'Case report #1 enviado' } },
  // X · Transversal · cierre
  { d: 37, fecha: '2027-02-09', ciclo: 1, fase: 'X', pista: 'X', code: 'X-8', prioridad: 'ALTA', objetivo: 'Re-arranque tras la pausa (mar 9-feb-2027 = D94 del Step 1; el examen Step 1 es el jue 11-feb): repasar las 8 fases de una SR + estado de carta / tesis / case report en la Mesa editorial (decisiones recibidas, rebuttals pendientes) + revisar que las 10 cuentas de la infra siguen activas', entregable: 'Mesa editorial al día + lista de pendientes editoriales', artefacto: 'Mesa editorial + Dashboard_Research', tool: 'Mesa editorial', recs: ['STEPSR', 'REBUTTAL'], apex: null },
  // R1 · Pregunta & protocolo
  { d: 38, fecha: '2027-02-11', ciclo: 1, fase: 'R1', pista: 'R', code: 'R8', prioridad: 'ALTA', objetivo: 'Protocolo PRISMA-P de SR-1: borrador de secciones (pregunta, elegibilidad, fuentes, estrategia, selección con 2 revisores, extracción doble, sesgo, síntesis) — se congela en el ciclo 2', entregable: 'Borrador de protocolo (secciones PRISMA-P) con huecos marcados [PROTOCOL GAP]', artefacto: 'Vault SR-1/01_protocolo_PICO/protocolo_PRISMA-P_v0.md', tool: '—', recs: ['PRISMA', 'COCHB'], chips: ['⚠ v5.16: este átomo (d38) cae el jue 11-feb-2027 = DÍA DEL EXAMEN Step 1 → saltar o mover al lun 15-feb — decisión de Joseph (DATA/PENDIENTES_JOSEPH.md)'], apex: null },
  // X · Transversal · cierre
  { d: 39, fecha: '2027-02-15', ciclo: 1, fase: 'X', pista: 'R', code: 'X-3', prioridad: 'MEDIA', objetivo: 'Corpus SR-1 YA descubierto: inventariar los 200 registros de research_papers (pending_human desde 11-jun-2026; 151 OA sin PDF resuelto) — contar, exportar CSV (título, autores, año, DOI, abstract) y NO re-correr discovery hasta tener la query PRISMA-S final (ciclo 2 · R12)', entregable: 'CSV del corpus + nota de estado (n, OA, duplicados por DOI)', artefacto: 'Vault SR-1/02_busqueda/corpus_2026-06_inventario.csv + nota', tool: 'Supabase (consola) · Sheets', recs: ['RAY', 'UNPAY'], apex: null },
  { d: 40, fecha: '2027-02-17', ciclo: 1, fase: 'X', pista: 'B', code: 'X-4', prioridad: 'MEDIA', objetivo: 'Congresos con abstract alcanzable (AAD · CILAD · RADLA): verificar en la web oficial la fecha límite de abstracts 2027 y el formato; elegir 1 al que llegue la tesis o la SR-1 preliminar', entregable: '1 congreso elegido con deadline VERIFICADO (URL + fecha) o marcado "A VERIFICAR"', artefacto: 'DATA/RESEARCH/MENTORES.md §Congresos con la fecha verificada', tool: 'Web oficial de cada congreso', recs: ['SCIWRITE', 'PHRASE'], apex: null },
  { d: 41, fecha: '2027-02-19', ciclo: 1, fase: 'X', pista: 'K', code: 'X-5', prioridad: 'MEDIA', objetivo: 'Campaña de cold emails (feb-mar 2027): lista de 20-30 autores de papers recientes del corpus SR-1 y de L5 (fototipos IV-VI) con el trabajo concreto que ofrezco a cada uno (cribado PRISMA, extracción, draft) — nunca "quiero experiencia"', entregable: 'Lista de 20-30 nombres (paper · email institucional · oferta concreta) + plantilla de email de 8 líneas', artefacto: 'MENTORES.md §Campaña feb-2027 (tabla) + plantilla', tool: 'Corpus SR-1 · OpenAlex (autores)', recs: ['OPENALEX', 'PHRASE', 'ICMJE'], apex: null },
  { d: 42, fecha: '2027-02-23', ciclo: 1, fase: 'X', pista: 'X', code: 'X-6', prioridad: 'ALTA', objetivo: 'Retro del ciclo 1 + Mesa editorial: estado REAL de carta-1 / tesis-L0 / case-report-1 (enviado · en-revisión · decisión), MENTORES.md al día, presupuesto 2026-27 (carta $0 · tesis $0-APC · case report ≤$300 · SR-1 $0)', entregable: 'Mesa editorial con los 3 estados reales + presupuesto escrito + 3 lecciones del ciclo', artefacto: 'Mesa editorial (app) + RUTA_PUBLICACION_2027.md §3 presupuesto', tool: 'Mesa editorial', recs: ['COPE', 'ICMJE'], apex: null },
];
...
export const RESEARCH_HITOS: Record<string, { code: string; fecha: string; ciclo: number; d: number }> = {
  'mentor': { code: 'M1', fecha: '2026-10-02', ciclo: 1, d: 3 },
  'carta-diana': { code: 'C-2', fecha: '2026-10-12', ciclo: 1, d: 6 },
  'tesis-etica': { code: 'T-1', fecha: '2026-10-14', ciclo: 1, d: 7 },
  'carta-1': { code: 'C-6', fecha: '2026-10-30', ciclo: 1, d: 13 },
  'cr-caso': { code: 'CR-1', fecha: '2026-11-05', ciclo: 1, d: 15 },
  'tesis-L0': { code: 'T-8', fecha: '2026-12-07', ciclo: 1, d: 26 },
  'revisor2': { code: 'X-1', fecha: '2026-12-11', ciclo: 1, d: 28 },
  'cr-paquete': { code: 'CR-8', fecha: '2026-12-23', ciclo: 1, d: 32 },
  'case-report-1': { code: 'CR-9', fecha: '2027-02-05', ciclo: 1, d: 36 },
  'equipo': { code: 'X-9', fecha: '2027-03-03', ciclo: 2, d: 45 },
  'PROSPERO-SR1': { code: 'R10', fecha: '2027-03-09', ciclo: 2, d: 47 },
  'SR-1': { code: 'R43', fecha: '2027-07-19', ciclo: 2, d: 94 },
};
