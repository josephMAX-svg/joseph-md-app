...
// (fila en LIVIANO_ACCESO_PERU). Las fechas son las del plan v5.10 (D1 = lun 14-sep-2026): si el
...
export interface PendienteLiviano {
  ...
  fecha?: string;      // fecha límite (plan v5.10) — se recalcula si el plan se corre
...
// D39-D48 del plan (v5.10; las fechas se recalculan desde livianoStudyPlan) y se re-verifica en cada REVISIÓN TRIMESTRAL.
...
export const LIVIANO_ACCESO_PERU_REGLAS = {
  ...
  ventana: 'D39-D48 (v5.10 · noviembre-2026) · re-verificación en cada revisión trimestral · fechas exactas en livianoStudyPlan',
  pasos: [
...
export const LIVIANO_PROTOCOLO = {
  version: 'v1 · esqueleto (sep-2026) → v1 completa en el capstone (D89, v5.10)',
