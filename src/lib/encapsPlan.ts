...
export const STUDY_D1: Record<string, string> = {
  ENCAPS: '2026-07-08',   // D1=MIÉ 8-jul (re-shift 8-jul: 7-jul fueron trámites de título/tesis, no estudió → corre a mañana) · EXAMEN FIJO jue 20-ago (38 días). Filosofía: EXTENDER días de estudio (17 temas, cero saltos) + REDUCIR días de pregunta (repaso) para caber al 20-ago. Evaluaciones intactas: 2 bundles de sim sobrantes FUSIONADOS en el dx 19-ago (recta final). Generador: gen_encaps_reshift_2jul_exam20.js 2026-07-08 (parametrizado; backup Supabase study_schedule_bk_0708). 38 días = 30 weekday (17 temas + 13 repaso multi-tema front-load Pareto) + 6 sáb simulacros + dx mié 19-ago + EXAMEN jue 20-ago. 17 temas verificados, cero saltos. Tras el reshift: re-aplicar gen_encaps_cola_live.js --apply + gen_encaps_cobertura.js --apply + gen_videos_por_tema.js (125 videos QX vivos — +2 mapas conceptuales SP re-scrape 08-jul; NO usar el viejo gen_encaps_cola_alinear).
...
const STUDY_TOTAL_DAYS: Record<string, number> = { ENCAPS: 38 };
