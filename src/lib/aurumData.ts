...
export const AURUM_FASES: AurumFase[] = [
  ...
  },
  {
    ...
    materiales: [
      ...
      { nombre: 'Canal de YouTube de Brian Tracy (videos de ventas gratuitos)', referente: 'Brian Tracy', tipo: 'canal', url: 'https://www.youtube.com/@BrianTracySpeaker', idioma: 'en', confianza: 'estable', porQue: 'Clips cortos sobre comunicacion, cierre y psicologia del vendedor; util para drillear un concepto por sesion.' },
  ...
  },
  {
    ...
    materiales: [
      ...
      { nombre: 'Commoncog — How Mark Roberge Built HubSpot\'s Sales Engine (caso gratuito)', referente: 'Mark Roberge', tipo: 'articulo', url: 'https://commoncog.com/c/cases/how-mark-roberge-built-hubspots-sales-engine/', idioma: 'en', confianza: 'verificado', porQue: 'Como construir una maquina de ventas medible y escalable (contratacion, metricas, proceso). El playbook del CRO que escalo HubSpot.' },
...
export const AURUM_BIBLIOTECA: { categoria: string; icon: string; items: AurumMaterial[] }[] = [
  { categoria: 'Canales de los referentes', icon: '🎬', items: [
    ...
    { nombre: 'Canal de YouTube de Brian Tracy', referente: 'Brian Tracy', tipo: 'canal', url: 'https://www.youtube.com/@BrianTracySpeaker', idioma: 'en', confianza: 'estable', porQue: 'Psicologia del vendedor, ciclo de la venta, cierre y manejo del tiempo. Clips cortos perfectos para drillear un concepto.' },
  ...
  { categoria: 'Podcasts (para tus huecos)', icon: '🎧', items: [
    ...
    { nombre: 'AFP Conversations — Chris Voss (ex-FBI) sobre negociacion', referente: 'Chris Voss', tipo: 'podcast', url: 'https://www.afponline.org/ideas-inspiration/discussions/afp-conversations-podcast/Details/chris-voss-ex-fbi-hostage-negotiator-explains-why-you-should-never-split-the-difference/', idioma: 'en', confianza: 'verificado', porQue: 'Voss explica por que nunca dividir la diferencia y como aplicar empatia tactica fuera del cuarto de rehenes.' },
  ] },
  { categoria: 'Artículos y guías', icon: '📄', items: [
    ...
    { nombre: 'Commoncog — How Mark Roberge Built HubSpot\'s Sales Engine', referente: 'Mark Roberge', tipo: 'articulo', url: 'https://commoncog.com/c/cases/how-mark-roberge-built-hubspots-sales-engine/', idioma: 'en', confianza: 'verificado', porQue: 'Caso detallado de como construir una maquina de ventas medible: contratacion, metricas y proceso.' },
