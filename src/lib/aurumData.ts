...
export const AURUM_BIBLIOTECA: { categoria: string; icon: string; items: AurumMaterial[] }[] = [
  ...
  // ── Academias top con resultados (YC · HubSpot · Stanford/Wharton/Kellogg · First Round) ──
  { categoria: 'Academias top (YC · HubSpot · Stanford/Wharton/Kellogg)', icon: '🎓', items: [
    { nombre: 'Y Combinator — Startup School (curso gratis)', referente: 'Y Combinator', tipo: 'articulo', url: 'https://www.startupschool.org/', idioma: 'en', confianza: 'verificado', porQue: 'YC financió Airbnb/Stripe/DoorDash (>$600B). Cómo arrancar, hablar con usuarios y vender lo primero — directo para validar ALLPA/Qori.' },
    { nombre: 'Y Combinator — Startup Library', referente: 'Y Combinator', tipo: 'articulo', url: 'https://www.ycombinator.com/library', idioma: 'en', confianza: 'verificado', porQue: 'Ensayos y charlas de los fundadores que más escalaron. La biblioteca de growth/ventas tempranas más respetada.' },
    { nombre: 'How to Talk to Users (Eric Migicovsky, YC)', referente: 'Eric Migicovsky (Pebble)', tipo: 'video', url: 'https://www.youtube.com/watch?v=z1iF1c8w5Lg', idioma: 'en', confianza: 'verificado', porQue: 'Cómo entrevistar clientes sin sesgar la respuesta — la base para vender lo que la gente sí quiere (terrenos/cachorros).' },
    { nombre: 'HubSpot Academy — cursos y certificaciones (gratis)', referente: 'HubSpot Academy', tipo: 'articulo', url: 'https://academy.hubspot.com/courses', idioma: 'es', confianza: 'verificado', porQue: 'HubSpot llegó a IPO; +250k certificados. Inbound, ventas, CRM, contenido — práctico y gratis (mucho en español).' },
    { nombre: 'HubSpot Academy — Inbound Sales (certificación gratis)', referente: 'HubSpot Academy', tipo: 'articulo', url: 'https://academy.hubspot.com/courses/inbound-sales', idioma: 'en', confianza: 'verificado', porQue: 'Metodología de venta inbound (identificar→conectar→explorar→asesorar) con certificado. Para vender sin presionar.' },
    { nombre: 'Stanford GSB — Insights', referente: 'Stanford Graduate School of Business', tipo: 'articulo', url: 'https://www.gsb.stanford.edu/insights', idioma: 'en', confianza: 'verificado', porQue: 'Research gratis de la GSB (top-5 mundial) en marketing, negociación y liderazgo.' },
    { nombre: 'Knowledge@Wharton — Marketing', referente: 'Wharton (UPenn)', tipo: 'articulo', url: 'https://knowledge.wharton.upenn.edu/category/marketing/', idioma: 'en', confianza: 'verificado', porQue: 'Research de marketing de Wharton, gratis. Estrategia basada en evidencia, no gurús.' },
    { nombre: 'Kellogg Insight — Marketing', referente: 'Kellogg (Northwestern)', tipo: 'articulo', url: 'https://insight.kellogg.northwestern.edu/browse/topic/marketing', idioma: 'en', confianza: 'verificado', porQue: 'Kellogg es la escuela #1 de marketing del mundo; su research gratis es oro para decisiones de marca.' },
    { nombre: 'First Round Review — go-to-market y primeras ventas', referente: 'First Round Capital', tipo: 'articulo', url: 'https://review.firstround.com/', idioma: 'en', confianza: 'verificado', porQue: 'First Round fue semilla de Uber/Notion/Square. Sus guías de GTM y primeras ventas son de operadores reales.' },
  ] },
  // ── Referentes con RESULTADOS REALES (LatAm + global · español de alto valor) ──
  { categoria: 'Referentes con resultados reales (LatAm + global)', icon: '🌎', items: [
    { nombre: 'Carlos Muñoz (Master Muñoz) — 4S Real Estate', referente: 'Carlos Muñoz', tipo: 'canal', url: 'https://www.youtube.com/channel/UCe4iDO6MnwLTGPf0th3VlfA', idioma: 'es', confianza: 'verificado', porQue: 'Cofundador de 4S Real Estate (consultora inmobiliaria #1 de LatAm). Metodología inmobiliaria REAL — directísima para ALLPA (terrenos). Toma su contenido de negocio/inmobiliaria, no el de "hazte millonario".' },
    { nombre: 'David Gómez — Bien Pensado (blog)', referente: 'David Gómez', tipo: 'articulo', url: 'https://bienpensado.com/blog/', idioma: 'es', confianza: 'verificado', porQue: '20+ años ayudando a cientos de empresas a vender POR VALOR, no por precio. El antídoto a competir por descuento — clave para terrenos y cachorros premium.' },
    { nombre: 'Bien Pensado (David Gómez) — YouTube', referente: 'David Gómez', tipo: 'canal', url: 'https://www.youtube.com/@Bienpensado/videos', idioma: 'es', confianza: 'verificado', porQue: 'Entrenamiento de ventas y diferenciación en español, accionable. Vender por valor sin guru-talk.' },
    { nombre: 'Vilma Núñez — Blog (marketing digital + IA)', referente: 'Vilma Núñez', tipo: 'articulo', url: 'https://vilmanunez.com/blog/', idioma: 'es', confianza: 'verificado', porQue: 'Fundadora del Grupo Convierte Más (agencia + escuela). Marketing digital aplicado en español, ahora con IA.' },
