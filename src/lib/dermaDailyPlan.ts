...
export const DERMA_DAILY_META = {
  inicio: '2026-07-29', fin: '2027-02-08', totalDias: 70, // D1=Vie 2026-06-19 (1er slot-derma ≥19-jun) · alterna con Research (ancla 10-jun) · 68 átomos + 2 colchón → fin 30-dic
...
export const DERMA_DIAS: DiaDerma[] = [
  ...
  { d: 1, fecha: '2026-07-29', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Lesiones elementales 1ª/2ª + descripción semiológica (el alfabeto)', referente: null,
  ...
  { d: 2, fecha: '2026-07-31', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Estructura de la piel: epidermis, queratinocitos, barrera', referente: null,
  ...
  { d: 3, fecha: '2026-08-04', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'BMZ + dermis + anejos (ancla de las bullosas)', referente: null,
  ...
  { d: 4, fecha: '2026-08-06', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Melanocito, pigmentación, fototipos Fitzpatrick + piel de color', referente: null,
  ...
  { d: 5, fecha: '2026-08-10', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Inmunología cutánea: Th1/Th2/Th17 + hipersensibilidades', referente: null,
  ...
  { d: 6, fecha: '2026-08-12', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Genética básica: queratinas, colágenos, mosaicismo', referente: null,
  ...
  { d: 7, fecha: '2026-08-14', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Terapéutica básica: vehículos, corticoides por potencia, FTU', referente: null,
  ...
  { d: 8, fecha: '2026-08-18', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Ictiosis y cornificación (+ Darier / Hailey-Hailey)', referente: null,
    access: { t: 'Color Atlas 9e · S4 Ichthyoses', url: ca(275941889) }, qbankly: null, promir: { t: 'Cap 9 §2', url: pm(PM_CAP.c9) }, extra: null },
  { d: 9, fecha: '2026-08-20', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Epidermólisis bullosas', referente: null,
    access: { t: 'Color Atlas 9e · S6 Bullous Diseases', url: ca(275942016) }, qbankly: null, promir: { t: 'Cap 9 §2.4', url: pm(PM_CAP.c9) }, extra: null },
  { d: 10, fecha: '2026-08-24', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Facomatosis: NF1, esclerosis tuberosa, Sturge-Weber, VHL', referente: null,
  ...
  { d: 11, fecha: '2026-08-26', bloque: B.B, bKey: 'B', tier: 'MED', sub: 'Genodermatosis con riesgo tumoral (Gorlin, XP) + Marfan/PXE/Ehlers-Danlos', referente: null,
  ...
  { d: 12, fecha: '2026-08-28', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Dermatosis neonatales + exantemas pediátricos', referente: null,
  ...
  { d: 13, fecha: '2026-09-01', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Bacterianas: impétigo, celulitis/erisipela, SSSS, TSS', referente: null,
  ...
  { d: 14, fecha: '2026-09-03', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'Micobacterias: TB cutánea, lepra', referente: null,
  ...
  { d: 15, fecha: '2026-09-07', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Sífilis (estadios) + ITS cutáneas', referente: null,
    access: { t: 'Color Atlas 9e · S30 STDs', url: ca(275946713) }, qbankly: null, promir: { t: 'Cap 2 Infecciosas', url: pm(PM_CAP.c2) }, extra: null },
  { d: 16, fecha: '2026-09-09', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Virales: HSV/VZV, VPH, molusco, exantemas (PM 10,17%)', referente: null,
  ...
  { d: 17, fecha: '2026-09-11', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Micosis superficiales/profundas + KOH (PM 5,42%)', referente: null,
  ...
  { d: 18, fecha: '2026-09-15', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Parasitosis: escabiosis, leishmaniasis (Perú), pediculosis, larva migrans', referente: null,
  ...
  { d: 19, fecha: '2026-09-17', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Tumores benignos + nevus melanocíticos', referente: null,
  ...
  { d: 20, fecha: '2026-09-21', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Queratosis actínica + campo de cancerización', referente: null,
  ...
  { d: 21, fecha: '2026-09-23', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Carcinoma basocelular + espinocelular', referente: null,
  ...
  { d: 22, fecha: '2026-09-25', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Melanoma: ABCDE, Breslow, TNM, manejo (PM 10,85% — subtema nº1)', referente: null,
  ...
  { d: 23, fecha: '2026-09-29', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Dermatoscopia I: lesiones melanocíticas', referente: null,
  ...
  { d: 24, fecha: '2026-10-01', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Dermatoscopia II: no-melanocíticas + 2-step/chaos&clues', referente: null,
  ...
  { d: 25, fecha: '2026-10-05', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Linfomas cutáneos (MF/Sézary), Merkel, Kaposi, DFSP, mastocitosis', referente: null,
  ...
  { d: 26, fecha: '2026-10-07', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Cómo leer una biopsia + patrones de inflamación', referente: null,
  ...
  { d: 27, fecha: '2026-10-09', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Ampollosas en biopsia: inmunofluorescencia directa/indirecta', referente: null,
  ...
  { d: 28, fecha: '2026-10-13', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Tumores en histología (correlación con bloque D)', referente: null,
  ...
  { d: 29, fecha: '2026-10-15', bloque: B.E, bKey: 'E', tier: 'MED', sub: 'Depósitos, infiltrados, paniculitis + drill 20Q Challenge', referente: null,
  ...
  { d: 30, fecha: '2026-10-19', bloque: B.F, bKey: 'F', tier: 'CRIT', sub: 'Anatomía quirúrgica facial: zonas de peligro, RSTL, unidades estéticas', referente: 'Cotofana (puente a X)',
  ...
  { d: 31, fecha: '2026-10-21', bloque: B.F, bKey: 'F', tier: 'CRIT', sub: 'Biopsias: punch / shave / excisional + anestesia local (dosis máximas)', referente: null,
  ...
  { d: 32, fecha: '2026-10-23', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Suturas: instrumental, nudos, técnicas (Kantor)', referente: null,
  ...
  { d: 33, fecha: '2026-10-27', bloque: B.F, bKey: 'F', tier: 'MED', sub: 'Colgajos e injertos (avance, rotación, romboidal, bilobulado)', referente: null,
    access: { t: 'Facial Flap Surgery', url: book(2829) }, qbankly: null, promir: null, extra: { t: '30 casos Surgical Dermatology', url: cases(1546) } },
  { d: 34, fecha: '2026-10-29', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Mohs + control de márgenes + complicaciones quirúrgicas', referente: null,
  ...
  { d: 35, fecha: '2026-11-02', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Corticoides tópicos (potencias) y sistémicos', referente: null,
  ...
  { d: 36, fecha: '2026-11-04', bloque: B.G, bKey: 'G', tier: 'CRIT', sub: 'Retinoides + isotretinoína (teratogenia = no errar)', referente: 'Global Alliance',
  ...
  { d: 37, fecha: '2026-11-06', bloque: B.G, bKey: 'G', tier: 'MED', sub: 'Inmunosupresores clásicos: MTX, ciclosporina, azatioprina', referente: null,
    access: { t: "Fitzpatrick's Therapeutics", url: book(3332) }, qbankly: null, promir: null, extra: null },
  { d: 38, fecha: '2026-11-10', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Biológicos: anti-TNF, anti-IL-17/23, dupilumab, JAK', referente: null,
  ...
  { d: 39, fecha: '2026-11-12', bloque: B.G, bKey: 'G', tier: 'MED', sub: 'Antifúngicos y antivirales sistémicos', referente: null,
  ...
  { d: 40, fecha: '2026-11-16', bloque: B.H, bKey: 'H', tier: 'CRIT', sub: 'Acné + rosácea + hidradenitis (mecanismo→adherencia; tesis CADI/IGA)', referente: 'Global Alliance (JAAD 2018)',
  ...
  { d: 41, fecha: '2026-11-18', bloque: B.H, bKey: 'H', tier: 'CRIT', sub: 'Eccemas: dermatitis atópica, de contacto, seborreica', referente: null,
  ...
  { d: 42, fecha: '2026-11-20', bloque: B.H, bKey: 'H', tier: 'CRIT', sub: 'Psoriasis + papuloescamosas (liquen plano, pitiriasis rosada/rubra)', referente: null,
  ...
  { d: 43, fecha: '2026-11-24', bloque: B.H, bKey: 'H', tier: 'CRIT', sub: 'Ampollosas autoinmunes: pénfigo vs penfigoide, DH (DD = perla MIR)', referente: null,
  ...
  { d: 44, fecha: '2026-11-26', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Urticaria y angioedema + prurito sine materia', referente: null,
  ...
  { d: 45, fecha: '2026-11-30', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Conectivopatías: lupus cutáneo, dermatomiositis, morfea/esclerodermia', referente: null,
  ...
  { d: 46, fecha: '2026-12-02', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Vasculitis, paniculitis (eritema nodoso), neutrofílicas (Sweet, PG)', referente: null,
  ...
  { d: 47, fecha: '2026-12-04', bloque: B.H, bKey: 'H', tier: 'CRIT', sub: 'Farmacodermias graves: SJS/TEN, DRESS, AGEP (no errar)', referente: null,
  ...
  { d: 48, fecha: '2026-12-08', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Piel y enfermedad sistémica: porfirias (PM 6,1%), paraneoplásicas, endocrino', referente: null,
  ...
  { d: 49, fecha: '2026-12-10', bloque: B.H, bKey: 'H', tier: 'MED', sub: 'Fotodermatosis + fotoprotección', referente: null,
  ...
  { d: 50, fecha: '2026-12-14', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Pigmentación (vitíligo, melasma, PIH) + piel de color (queloides, CCCA)', referente: null,
  ...
  { d: 51, fecha: '2026-12-16', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Pelo y uñas: alopecias, tricoscopia, melanoniquia vs melanoma', referente: null,
  ...
  // ── CIERRE board ──
  { d: 52, fecha: '2026-12-18', bloque: B.Z, bKey: 'Z', tier: 'CRIT', sub: 'High-Yield Buzz Words + simulacro mixto (381Q Pictorial + DD Challenge)', referente: null,
  ...
  { d: 53, fecha: '2026-12-22', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Anatomía facial 3D: 5 capas, SMAS, espacios profundos', referente: 'Cotofana',
  ...
  { d: 54, fecha: '2026-12-24', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Compartimentos grasos + ligamentos de retención + reabsorción ósea', referente: 'Cotofana',
  ...
  { d: 55, fecha: '2026-12-28', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Arterias peligrosas + zonas seguras: nariz, glabela, temple (no errar)', referente: 'Cotofana',
  ...
  { d: 56, fecha: '2026-12-30', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Análisis facial: tercios, cánones, MD ASA (H1-H5, 8 atributos)', referente: 'de Maio',
    access: { t: 'MD ASA (J Cosmet Dermatol 2021)', url: 'https://pubmed.ncbi.nlm.nih.gov/33977669/' }, qbankly: null, promir: null, extra: null },
  { d: 57, fecha: '2027-01-01', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Envejecimiento estructural: hueso → grasa → ligamento → piel', referente: 'de Maio',
  ...
  { d: 58, fecha: '2027-01-05', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: "Reología del HA: G', cohesividad + bioestimuladores (CaHA/PLLA)", referente: 'de Maio / Carruthers',
  ...
  { d: 59, fecha: '2027-01-07', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'MD Codes I: fundación (mejilla Ck, temple T, lagrimal Tt)', referente: 'de Maio',
  ...
  { d: 60, fecha: '2027-01-11', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'MD Codes II + myomodulation (MD DYNA)', referente: 'de Maio',
  ...
  { d: 61, fecha: '2027-01-13', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina I: mecanismo, serotipos, unidades, tercio superior', referente: 'Carruthers',
  ...
  { d: 62, fecha: '2027-01-15', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina II: tercio inferior, Nefertiti, masetero, hiperhidrosis', referente: 'Carruthers',
  ...
  { d: 63, fecha: '2027-01-19', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Oclusión vascular + HDPH: recitar el protocolo completo (no errar)', referente: 'DeLorenzi',
  ...
  { d: 64, fecha: '2027-01-21', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Ceguera por relleno: prevención + manejo inmediato + kit de emergencia', referente: 'Goodman/Magnusson 2020',
  ...
  { d: 65, fecha: '2027-01-25', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Fototermólisis selectiva: cromóforo → λ → pulso → enfriamiento', referente: 'Anderson',
  ...
  { d: 66, fecha: '2027-01-27', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Fraccional, RF, HIFU, criolipólisis + seguridad en fototipos altos', referente: 'Manstein/Anderson',
  ...
  { d: 67, fecha: '2027-01-29', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Peelings químicos: superficial / medio / profundo, por fototipo', referente: 'Baumann',
  ...
  { d: 68, fecha: '2027-02-02', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Microneedling + PRP + cosmecéuticos / skincare basado en evidencia', referente: 'Baumann',
  ...
  { d: 69, fecha: '2027-02-04', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'COLCHÓN 1 · Repaso libre: incorrects de QBanks + flashcards de los bloques más flojos', referente: null,
  ...
  { d: 70, fecha: '2027-02-08', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'COLCHÓN 2 · Dermki/Anki segunda pasada + tabla de conceptos que aún fallan', referente: null,
