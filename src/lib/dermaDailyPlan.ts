 ...
 *
 * ⚠ FECHAS re-fechadas v5.12: D1 jue 2026-09-17 → D73 vie 2027-04-09 (interdiario con Research,
...
export const DERMA_DAILY_META = {
  ...
  /** Primera sesión con carga completa tras el examen Step 1 (lun 1-feb-2027 en v5.12; d49 mar 2-feb sigue siendo taper opcional): desde aquí 3 casos/sesión. */
  postStep1D1: 50,
  /** Ventana del taper Step 1 (inclusive). v5.12 (15-sep): el taper es POSICIONAL (d44-d49) y con D1 Derma = jue 17-sep cae del mar 19-ene (día tras el NBME 32)
   *  al mar 2-feb (día tras el examen del lun 1-feb); el vie 15-ene (NBME 31) es d43 = sesión normal (Mohs). Alternativa registrada en PENDIENTES: mover Mohs al 2-feb (swap d43↔taper). */
  taperStep1: { desdeD: 44, hastaD: 49, desde: '2027-01-19', hasta: '2027-02-02' },
};
...
const TAPER_STEP1 = (nota: string): DermaTaper => ({ modo: 'step1', motivo: 'Ventana v5.12: mar 19-ene (día tras el NBME 32) → mar 2-feb (día tras el examen Step 1 del lun 1-feb-2027)', casos: 1, nota });
/**
...
export const DERMA_DIAS: DiaDerma[] = [
  ...
  { d: 1, fecha: '2026-09-17', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Lesiones elementales 1ª/2ª: el vocabulario del paso ① (describir ANTES de diagnosticar)', referente: null,
  ...
  { d: 2, fecha: '2026-09-21', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Color, distribución y configuración (anular, herpetiforme, lineal/Blaschko) — completa la descripción estándar', referente: null,
  ...
  { d: 3, fecha: '2026-09-23', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Estructura de la piel: epidermis → BMZ → dermis → anejos (la base de toda tarjeta de MECANISMO)', referente: null,
  ...
  { d: 4, fecha: '2026-09-25', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Fototipos I–VI + piel de color: cómo cambian los signos (eje Perú · conecta con L4/L5 de research)', referente: null,
  ...
  { d: 5, fecha: '2026-09-29', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Anatomía facial + DANGER ZONES: a. facial/angular/supratroclear · glabela y nariz = máximo riesgo de oclusión (sin esto nada de estética es seguro)', referente: 'Cotofana',
  ...
  { d: 6, fecha: '2026-10-01', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Dermatoscopia temprana: patrones básicos (3 de los 4 módulos CORE la preguntan transversalmente) · arranca el micro-track DermNet CME', referente: null,
  ...
  { d: 7, fecha: '2026-10-05', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Psoriasis + papuloescamosas (liquen plano, pitiriasis rosada/rubra)', referente: null,
  ...
  { d: 8, fecha: '2026-10-07', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Eccemas: dermatitis atópica, de contacto, seborreica', referente: null,
  ...
  { d: 9, fecha: '2026-10-09', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Acné + rosácea + hidradenitis (mecanismo → tratamiento; puente futuro a láser-acné y peelings)', referente: null,
  ...
  { d: 10, fecha: '2026-10-13', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Ampollosas autoinmunes: pénfigo vs penfigoide + dermatitis herpetiforme (nivel de la ampolla = mecanismo)', referente: null,
  ...
  { d: 11, fecha: '2026-10-15', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Urticaria y angioedema + prurito sine materia', referente: null,
  ...
  { d: 12, fecha: '2026-10-19', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Farmacodermias graves: SJS/TEN, DRESS, AGEP (no errar)', referente: null,
  ...
  { d: 13, fecha: '2026-10-21', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Conectivopatías (lupus, dermatomiositis, morfea) + vasculitis y paniculitis', referente: null,
  ...
  { d: 14, fecha: '2026-10-23', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Bacterianas: impétigo, celulitis/erisipela, SSSS, fascitis (cuándo NO es celulitis)', referente: null,
  ...
  { d: 15, fecha: '2026-10-27', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Sífilis (la gran imitadora) + ITS cutáneas + micobacterias (TB cutánea, lepra)', referente: null,
  ...
  { d: 16, fecha: '2026-10-29', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Virales: HSV/VZV (Tzanck), VPH, molusco', referente: null,
  ...
  { d: 17, fecha: '2026-11-02', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Micosis superficiales y profundas + KOH (esporotricosis, cromoblastomicosis)', referente: null,
  ...
  { d: 18, fecha: '2026-11-04', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Parasitosis: escabiosis, leishmaniasis (Perú), pediculosis, larva migrans', referente: null,
  ...
  { d: 19, fecha: '2026-11-06', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'OCLUSIÓN VASCULAR: reconocimiento inmediato + protocolo HDPH de hialuronidasa DE MEMORIA (no errar) — adelantado desde la fase X (swap v2.1) para preceder a la revalidación del PICO (R6b) y la extracción de SR-1 (R22-R25)', referente: 'DeLorenzi',
  ...
  { d: 20, fecha: '2026-11-10', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Ceguera por relleno: prevención, manejo inmediato, kit de emergencia (no errar) — adelantado desde la fase X (swap v2.1) · cierre de módulo C (CORE bank)', referente: 'Goodman/Magnusson',
  ...
  { d: 21, fecha: '2026-11-12', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Tumores benignos: q. seborreica, nevus melanocíticos, quistes (qué NO biopsiar)', referente: null,
  ...
  { d: 22, fecha: '2026-11-16', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Queratosis actínica + campo de cancerización (base del manejo con peelings/PDT después)', referente: null,
  ...
  { d: 23, fecha: '2026-11-18', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Carcinoma basocelular + espinocelular: subtipos, riesgo, manejo', referente: null,
  ...
  { d: 24, fecha: '2026-11-20', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Melanoma: ABCDE, Breslow, TNM, manejo (acral/lentiginoso en fototipos altos = Perú)', referente: null,
  ...
  { d: 25, fecha: '2026-11-24', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Dermatoscopia II: lesiones melanocíticas (patrones, 2-step)', referente: null,
  ...
  { d: 26, fecha: '2026-11-26', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Dermatoscopia III: no-melanocíticas + chaos & clues', referente: null,
  ...
  { d: 27, fecha: '2026-11-30', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Linfomas cutáneos (MF/Sézary), Merkel, Kaposi, DFSP', referente: null,
  ...
  { d: 28, fecha: '2026-12-02', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Fotoenvejecimiento + fotoprotección (ciencia básica que el CORE surgical exige → estética)', referente: null,
  ...
  { d: 29, fecha: '2026-12-04', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Cómo leer una biopsia: los patrones de inflamación (el mapa antes del territorio)', referente: null,
  ...
  { d: 30, fecha: '2026-12-08', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Vocabulario dermpath: espongiosis, acantosis, interfase, granulomas (el idioma de la discusión del caso)', referente: null,
  ...
  { d: 31, fecha: '2026-12-10', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Ampollosas al microscopio: nivel de la ampolla + IF directa/indirecta', referente: null,
  ...
  { d: 32, fecha: '2026-12-14', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Histología de tumores: correlación clínica ↔ dermatoscopia ↔ histo del módulo D', referente: null,
  ...
  { d: 33, fecha: '2026-12-16', bloque: B.E, bKey: 'E', tier: 'MED', sub: 'Depósitos, infiltrados y paniculitis + drill dermpath de cierre', referente: null,
  ...
  { d: 34, fecha: '2026-12-18', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Dermatosis neonatales + hemangiomas infantiles y malformaciones vasculares', referente: null,
  ...
  { d: 35, fecha: '2026-12-22', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Exantemas pediátricos + Kawasaki (el que no puedes fallar)', referente: null,
  ...
  { d: 36, fecha: '2026-12-24', bloque: B.F, bKey: 'F', tier: 'CRIT', sub: 'Facomatosis: NF1, esclerosis tuberosa, Sturge-Weber (criterios en la piel)', referente: null,
  ...
  { d: 37, fecha: '2026-12-28', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Genodermatosis: ictiosis + epidermólisis bullosas (queratinas y colágenos = mecanismo)', referente: null,
  ...
  { d: 38, fecha: '2026-12-30', bloque: B.F, bKey: 'F', tier: 'MED', sub: 'Atopia pediátrica + acné neonatal/infantil + repaso del módulo', referente: null,
  ...
  { d: 39, fecha: '2027-01-05', bloque: B.G, bKey: 'G', tier: 'CRIT', sub: 'Anatomía quirúrgica facial II: RSTL, subunidades estéticas, nervios en riesgo (temporal, marginal)', referente: 'Cotofana',
    ...
    atlasUrl: ANIM3D, dermatoscopiaImg: DSA },
  { d: 40, fecha: '2027-01-07', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Biopsias (punch/shave/excisional) + anestesia local: lidocaína y dosis máximas', referente: null,
  ...
  { d: 41, fecha: '2027-01-11', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Suturas y cierre: instrumental, nudos, técnicas (Kantor + sus 91 vídeos)', referente: null,
  ...
  { d: 42, fecha: '2027-01-13', bloque: B.G, bKey: 'G', tier: 'MED', sub: 'Colgajos e injertos: avance, rotación, romboidal, bilobulado', referente: null,
  ...
  { d: 43, fecha: '2027-01-15', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Mohs + control de márgenes: indicaciones (área H) y lógica', referente: null,
  ...
  { d: 44, fecha: '2027-01-19', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'TAPER Step 1 (semana NBME 32/33 + FREE 120; día tras el NBME 32) · El paciente agudo con fiebre y rash: meningococemia, endocarditis, necrotizantes — átomo ligero C absorbido en la ventana del examen (swap v2.1 → v3; antes d57)', referente: null,
    ...
    atlasUrl: `${DN}/topics/meningococcal-disease`, dermatoscopiaImg: DSP.infl, taper: TAPER_STEP1('Átomo ligero MED absorbido en la ventana de examen (mar 19-ene, día tras el NBME 32; el NBME 31 fue el vie 15 = d43): 1 caso ciego + review = FSRS de fallos del ledger (sin preguntas nuevas) + lectura ligera 10′ del átomo, sin ficha del cerebro ni tarjetas nuevas obligatorias.') },
  { d: 45, fecha: '2027-01-21', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'TAPER Step 1 (semana NBME 32/33 + FREE 120) · Pelo y uñas infecciosos (tiña capitis, onicomicosis) + repaso del módulo C — átomo ligero absorbido en la ventana del examen (antes d58)', referente: null,
  ...
  { d: 46, fecha: '2027-01-25', bloque: B.X, bKey: 'X', tier: 'MED', sub: 'TAPER Step 1 (última semana del plan Step 1, D91-D95) · Contorno corporal (criolipólisis, HIFU) + escleroterapia básica (ambos en el temario CORE surgical) — átomo ligero X absorbido en la ventana del examen (antes d66)', referente: null,
    ...
    atlasUrl: `${DN}/topics/sclerotherapy`, dermatoscopiaImg: DSP.glob, taper: TAPER_STEP1('Átomo ligero MED (X) en la última semana del plan Step 1 (lun 25-ene, D91): 1 caso ciego + FSRS de fallos + lectura ligera 10′.') },
  { d: 47, fecha: '2027-01-27', bloque: B.H, bKey: 'H', tier: 'MED', sub: 'TAPER Step 1 · Segunda pasada parcial I: 1 caso ciego + repaso FSRS de los fallos del ledger de los módulos A-D (0 lectura nueva — última semana del plan Step 1)', referente: null,
    ...
    atlasUrl: IMG_LIB, dermatoscopiaImg: DSA, taper: TAPER_STEP1('Última semana del plan Step 1 (mié 27-ene, D93): 0 lectura nueva. 1 caso ciego + repaso FSRS de los casos y preguntas fallados de los módulos A-D (ledger), en voz baja y sin cronómetro.') },
  { d: 48, fecha: '2027-01-29', bloque: B.H, bKey: 'H', tier: 'MED', sub: 'TAPER Step 1 · Segunda pasada parcial II: 1 caso ciego + repaso FSRS de los fallos de los módulos E-G + drill HDPH mental sin cronómetro (vie 29-ene = D95, última sesión del Step 1; sáb 30 y dom 31 descanso)', referente: null,
    ...
    atlasUrl: DN_QUIZ, dermatoscopiaImg: DSP.three, taper: TAPER_STEP1('Taper final del Step 1 (vie 29-ene = D95 = última sesión; sáb 30 y dom 31 = descanso pre-examen; examen lun 1-feb): 0 lectura nueva. 1 caso ciego + FSRS de fallos de los módulos E-G + drill HDPH mental (recitar, sin cronómetro).') },
  { d: 49, fecha: '2027-02-02', bloque: B.H, bKey: 'H', tier: 'MED', sub: 'TAPER Step 1 · Segunda pasada parcial III — DÍA SIGUIENTE AL EXAMEN Step 1 (lun 1-feb; sesión OPCIONAL: 1 caso ciego + 5′ FSRS; si se salta no se pierde nada, los fallos siguen en la cola)', referente: null,
    access: CASO_FALLOS, qbankly: rFALLOS, promir: null, extra: null, casoIds: [198],
    morfologia: 'Repaso', sitio: 'Difuso', ddx: ['Sesión opcional: es el día siguiente al examen Step 1 (~8 h el lun 1-feb); Derma solo si hay energía real', 'Si se hace: 1 caso ciego + FSRS de las tarjetas vencidas (5′) y cerrar', 'Nada se recorta: el ciclo sigue el jue 4-feb con d50 (cicatrización, cierre del módulo G)'],
    atlasUrl: IMG_LIB, dermatoscopiaImg: DSA, taper: TAPER_STEP1('DÍA SIGUIENTE AL EXAMEN Step 1 (mar 2-feb; el examen es el lun 1-feb): sesión OPCIONAL. Si hay energía: 1 caso ciego + 5′ de FSRS. Si se salta, no se pierde nada: los fallos siguen en la cola y el ciclo continúa el jue 4-feb (d50).') },
  // ── MÓDULO G · cierre (desplazado por el taper: antes d44) ──
  { d: 50, fecha: '2027-02-04', bloque: B.G, bKey: 'G', tier: 'CRIT', sub: 'Cicatrización + complicaciones quirúrgicas y su manejo (ciencia CORE surgical)', referente: null,
  ...
  { d: 51, fecha: '2027-02-08', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 1: mapa de fallos por módulo CORE (med/ped/surg/path) desde el ledger → qué re-drillear en FSRS', referente: null,
  ...
  { d: 52, fecha: '2027-02-10', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 2: re-drill de fallos etiquetados + pares del DD Challenge de tus áreas flojas + drill oclusión vascular 90 s', referente: null,
  ...
  { d: 53, fecha: '2027-02-12', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Anatomía facial 3D: 5 capas, SMAS, compartimentos grasos, ligamentos de retención', referente: 'Cotofana',
    ...
    atlasUrl: ANIM3D, dermatoscopiaImg: DSA },
  { d: 54, fecha: '2027-02-16', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Arterias peligrosas + zonas seguras: glabela, nariz, temple, surco nasogeniano (no errar)', referente: 'Cotofana',
  ...
  { d: 55, fecha: '2027-02-18', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Envejecimiento estructural (hueso → grasa → ligamento → piel) + análisis facial: tercios, MD ASA', referente: 'de Maio',
  ...
  { d: 56, fecha: '2027-02-22', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Toxina I: mecanismo (clivaje de SNAP-25), serotipos, unidades NO intercambiables entre marcas', referente: 'Carruthers',
  ...
  { d: 57, fecha: '2027-02-24', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina II: tercio superior (frontal, glabela, patas de gallo) — músculos, dosis, cómo evitar la ptosis', referente: 'Carruthers',
  ...
  { d: 58, fecha: '2027-02-26', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina III: tercio inferior, Nefertiti, masetero, hiperhidrosis', referente: 'Carruthers',
  ...
  { d: 59, fecha: '2027-03-02', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Toxina IV: complicaciones y manejo — ptosis (apraclonidina), asimetrías, difusión (seguridad primero)', referente: 'Carruthers',
    ...
    atlasUrl: `${DN}/topics/botulinum-toxin`, dermatoscopiaImg: DSA },
  { d: 60, fecha: '2027-03-04', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: "Rellenos I: reología del HA (G', cohesividad) + bioestimuladores (CaHA/PLLA)", referente: 'de Maio',
  ...
  { d: 61, fecha: '2027-03-08', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos II: planos de inyección, aguja vs cánula, técnicas por región', referente: 'de Maio',
  ...
  { d: 62, fecha: '2027-03-10', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos III: MD Codes fundación (Ck, T, Tt) + myomodulation', referente: 'de Maio',
  ...
  { d: 63, fecha: '2027-03-12', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos IV: consideraciones étnicas y de género + fat transfer', referente: 'de Maio',
  ...
  { d: 64, fecha: '2027-03-16', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Peelings I: profundidad (superficial/medio/profundo), agentes (glicólico, salicílico, TCA, fenol), frosting', referente: 'Baumann',
  ...
  { d: 65, fecha: '2027-03-18', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Peelings II: por fototipo (IV–VI), prevención de PIH, complicaciones (conecta con L4/L5 research)', referente: 'Baumann',
  ...
  { d: 66, fecha: '2027-03-22', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Láser I: fototermólisis selectiva (Anderson-Parrish) — cromóforo → λ → duración de pulso → enfriamiento (la MISMA física del CORE surgical)', referente: 'Anderson',
  ...
  { d: 67, fecha: '2027-03-24', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Láser II: lesiones vasculares (PDL) + pigmento y tatuajes (Q-switched/pico)', referente: 'Anderson',
  ...
  { d: 68, fecha: '2027-03-26', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Láser III: resurfacing fraccional (ablativo/no-ablativo) + radiofrecuencia + tightening', referente: 'Manstein/Anderson',
  ...
  { d: 69, fecha: '2027-03-30', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Láser IV: seguridad en fototipos IV–VI — parámetros, PIH, depilación en piel étnica (no errar)', referente: 'Anderson',
    ...
    atlasUrl: `${DN}/topics/ethnic-dermatology`, dermatoscopiaImg: DSA, puenteResearch: PR_L5(SR2_NOTA) },
  { d: 70, fecha: '2027-04-01', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Microneedling + PRP + skinboosters: evidencia y técnica', referente: 'Baumann',
  ...
  { d: 71, fecha: '2027-04-05', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Ciencia cosmecéutica: Baumann Skin Typing, retinoides tópicos, antioxidantes, fotoprotección (protocolo Nítida)', referente: 'Baumann',
  ...
  { d: 72, fecha: '2027-04-07', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 1: segunda pasada FSRS — SOLO casos y preguntas fallados del ledger, por módulo CORE más flojo', referente: null,
  ...
  { d: 73, fecha: '2027-04-09', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 2: mapa final de debilidades + arranque del CICLO 2 (dermaCiclo2.ts: 36 casos restantes a 3/sesión en d74-d85 + Pictorial 3e/Barnhill + G+1…G+9)', referente: null,
