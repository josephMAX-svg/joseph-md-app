...
export const DERMA_DAILY_META = {
  inicio: '2026-09-07', fin: '2027-03-22', totalDias: 70, // v5.4 (1-sep): D1=jue 3-sep-2026 · interdiario con Research (paridad researchData.ts) · sáb+dom libres · salta 25-dic/31-dic/1-ene · NO tocar a mano
...
export const DERMA_DIAS: DiaDerma[] = [
  ...
  { d: 6, fecha: '2026-09-21', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Dermatoscopia temprana: patrones básicos (3 de los 4 módulos CORE la preguntan transversalmente)', referente: null,
  ...
  { d: 19, fecha: '2026-10-27', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'El paciente agudo con fiebre y rash: meningococemia, endocarditis, necrotizantes', referente: null,
    access: CASO, qbankly: rPIC, promir: null, extra: { t: 'Color Atlas 9e · S8 The Acutely Ill Patient', url: ca(275942269) } },
  { d: 20, fecha: '2026-10-29', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'Pelo y uñas infecciosos (tiña capitis, onicomicosis) + repaso del módulo', referente: null,
  ...
  { d: 45, fecha: '2027-01-11', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 1: mapa de fallos por módulo CORE (med/ped/surg/path) → qué re-drillear en FSRS', referente: null,
    access: CASO_DD, qbankly: rQOTW, promir: null, extra: { t: 'ABD CORE Study Guide (PDF oficial)', url: ABD_GUIDE } },
  { d: 46, fecha: '2027-01-13', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 2: re-drill de fallos etiquetados + pares del DD Challenge de tus áreas flojas', referente: null,
  ...
  { d: 57, fecha: '2027-02-12', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'OCLUSIÓN VASCULAR: reconocimiento inmediato + protocolo HDPH de hialuronidasa DE MEMORIA (no errar)', referente: 'DeLorenzi',
    access: CASO, qbankly: rQOTW, promir: null, extra: { t: 'HDPH Protocol (ASJ 2017)', url: 'https://pubmed.ncbi.nlm.nih.gov/28333326/' } },
  { d: 58, fecha: '2027-02-16', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Ceguera por relleno: prevención, manejo inmediato, kit de emergencia (no errar)', referente: 'Goodman/Magnusson',
  ...
  { d: 68, fecha: '2027-03-16', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Ciencia cosmecéutica: Baumann Skin Typing, retinoides tópicos, antioxidantes, fotoprotección', referente: 'Baumann',
  ...
  { d: 69, fecha: '2027-03-18', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 1: segunda pasada FSRS — SOLO casos y preguntas fallados, por módulo CORE más flojo', referente: null,
    access: CASO_FALLOS, qbankly: rPIC, promir: null, extra: { t: 'Guidebook to Dermatologic Diagnosis (repaso)', url: book(2960) } },
  { d: 70, fecha: '2027-03-22', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 2: mapa final de debilidades + plan del ciclo siguiente (post-Step 1: subir a 5 casos/sesión)', referente: null,
    access: CASO_DD, qbankly: rQOTW, promir: null, extra: { t: 'ABD CORE Study Guide (PDF oficial)', url: ABD_GUIDE } },];
