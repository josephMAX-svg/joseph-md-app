...
export const DERMA_DIAS: DiaDerma[] = [
  ...
  { d: 1, fecha: '2026-09-09', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Lesiones elementales 1ª/2ª: el vocabulario del paso ① (describir ANTES de diagnosticar)', referente: null,
  ...
  { d: 2, fecha: '2026-09-11', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Color, distribución y configuración (anular, herpetiforme, lineal/Blaschko) — completa la descripción estándar', referente: null,
  ...
  { d: 3, fecha: '2026-09-15', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Estructura de la piel: epidermis → BMZ → dermis → anejos (la base de toda tarjeta de MECANISMO)', referente: null,
  ...
  { d: 4, fecha: '2026-09-17', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Fototipos I–VI + piel de color: cómo cambian los signos (eje Perú · conecta con L4/L5 de research)', referente: null,
  ...
  { d: 5, fecha: '2026-09-21', bloque: B.A, bKey: 'A', tier: 'CRIT', sub: 'Anatomía facial + DANGER ZONES: a. facial/angular/supratroclear · glabela y nariz = máximo riesgo de oclusión (sin esto nada de estética es seguro)', referente: 'Cotofana',
  ...
  { d: 6, fecha: '2026-09-23', bloque: B.A, bKey: 'A', tier: 'ALTA', sub: 'Dermatoscopia temprana: patrones básicos (3 de los 4 módulos CORE la preguntan transversalmente) · arranca el micro-track DermNet CME', referente: null,
  ...
  { d: 7, fecha: '2026-09-25', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Psoriasis + papuloescamosas (liquen plano, pitiriasis rosada/rubra)', referente: null,
  ...
  { d: 8, fecha: '2026-09-29', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Eccemas: dermatitis atópica, de contacto, seborreica', referente: null,
  ...
  { d: 9, fecha: '2026-10-01', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Acné + rosácea + hidradenitis (mecanismo → tratamiento; puente futuro a láser-acné y peelings)', referente: null,
  ...
  { d: 10, fecha: '2026-10-05', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Ampollosas autoinmunes: pénfigo vs penfigoide + dermatitis herpetiforme (nivel de la ampolla = mecanismo)', referente: null,
  ...
  { d: 11, fecha: '2026-10-07', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Urticaria y angioedema + prurito sine materia', referente: null,
  ...
  { d: 12, fecha: '2026-10-09', bloque: B.B, bKey: 'B', tier: 'CRIT', sub: 'Farmacodermias graves: SJS/TEN, DRESS, AGEP (no errar)', referente: null,
  ...
  { d: 13, fecha: '2026-10-13', bloque: B.B, bKey: 'B', tier: 'ALTA', sub: 'Conectivopatías (lupus, dermatomiositis, morfea) + vasculitis y paniculitis', referente: null,
  ...
  { d: 14, fecha: '2026-10-15', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Bacterianas: impétigo, celulitis/erisipela, SSSS, fascitis (cuándo NO es celulitis)', referente: null,
  ...
  { d: 15, fecha: '2026-10-19', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Sífilis (la gran imitadora) + ITS cutáneas + micobacterias (TB cutánea, lepra)', referente: null,
  ...
  { d: 16, fecha: '2026-10-21', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Virales: HSV/VZV (Tzanck), VPH, molusco', referente: null,
  ...
  { d: 17, fecha: '2026-10-23', bloque: B.C, bKey: 'C', tier: 'ALTA', sub: 'Micosis superficiales y profundas + KOH (esporotricosis, cromoblastomicosis)', referente: null,
  ...
  { d: 18, fecha: '2026-10-27', bloque: B.C, bKey: 'C', tier: 'CRIT', sub: 'Parasitosis: escabiosis, leishmaniasis (Perú), pediculosis, larva migrans', referente: null,
  ...
  { d: 19, fecha: '2026-10-29', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'OCLUSIÓN VASCULAR: reconocimiento inmediato + protocolo HDPH de hialuronidasa DE MEMORIA (no errar) — adelantado desde d57 para preceder a la extracción de SR-1 (R22-R25)', referente: 'DeLorenzi',
  ...
  { d: 20, fecha: '2026-11-02', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Ceguera por relleno: prevención, manejo inmediato, kit de emergencia (no errar) — adelantado desde d58 · cierre de módulo C (CORE bank)', referente: 'Goodman/Magnusson',
  ...
  { d: 21, fecha: '2026-11-04', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Tumores benignos: q. seborreica, nevus melanocíticos, quistes (qué NO biopsiar)', referente: null,
  ...
  { d: 22, fecha: '2026-11-06', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Queratosis actínica + campo de cancerización (base del manejo con peelings/PDT después)', referente: null,
  ...
  { d: 23, fecha: '2026-11-10', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Carcinoma basocelular + espinocelular: subtipos, riesgo, manejo', referente: null,
  ...
  { d: 24, fecha: '2026-11-12', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Melanoma: ABCDE, Breslow, TNM, manejo (acral/lentiginoso en fototipos altos = Perú)', referente: null,
  ...
  { d: 25, fecha: '2026-11-16', bloque: B.D, bKey: 'D', tier: 'CRIT', sub: 'Dermatoscopia II: lesiones melanocíticas (patrones, 2-step)', referente: null,
  ...
  { d: 26, fecha: '2026-11-18', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Dermatoscopia III: no-melanocíticas + chaos & clues', referente: null,
  ...
  { d: 27, fecha: '2026-11-20', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Linfomas cutáneos (MF/Sézary), Merkel, Kaposi, DFSP', referente: null,
  ...
  { d: 28, fecha: '2026-11-24', bloque: B.D, bKey: 'D', tier: 'ALTA', sub: 'Fotoenvejecimiento + fotoprotección (ciencia básica que el CORE surgical exige → estética)', referente: null,
  ...
  { d: 29, fecha: '2026-11-26', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Cómo leer una biopsia: los patrones de inflamación (el mapa antes del territorio)', referente: null,
  ...
  { d: 30, fecha: '2026-11-30', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Vocabulario dermpath: espongiosis, acantosis, interfase, granulomas (el idioma de la discusión del caso)', referente: null,
  ...
  { d: 31, fecha: '2026-12-02', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Ampollosas al microscopio: nivel de la ampolla + IF directa/indirecta', referente: null,
  ...
  { d: 32, fecha: '2026-12-04', bloque: B.E, bKey: 'E', tier: 'ALTA', sub: 'Histología de tumores: correlación clínica ↔ dermatoscopia ↔ histo del módulo D', referente: null,
  ...
  { d: 33, fecha: '2026-12-08', bloque: B.E, bKey: 'E', tier: 'MED', sub: 'Depósitos, infiltrados y paniculitis + drill dermpath de cierre', referente: null,
  ...
  { d: 34, fecha: '2026-12-10', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Dermatosis neonatales + hemangiomas infantiles y malformaciones vasculares', referente: null,
  ...
  { d: 35, fecha: '2026-12-14', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Exantemas pediátricos + Kawasaki (el que no puedes fallar)', referente: null,
  ...
  { d: 36, fecha: '2026-12-16', bloque: B.F, bKey: 'F', tier: 'CRIT', sub: 'Facomatosis: NF1, esclerosis tuberosa, Sturge-Weber (criterios en la piel)', referente: null,
  ...
  { d: 37, fecha: '2026-12-18', bloque: B.F, bKey: 'F', tier: 'ALTA', sub: 'Genodermatosis: ictiosis + epidermólisis bullosas (queratinas y colágenos = mecanismo)', referente: null,
  ...
  { d: 38, fecha: '2026-12-22', bloque: B.F, bKey: 'F', tier: 'MED', sub: 'Atopia pediátrica + acné neonatal/infantil + repaso del módulo', referente: null,
  ...
  { d: 39, fecha: '2026-12-24', bloque: B.G, bKey: 'G', tier: 'CRIT', sub: 'Anatomía quirúrgica facial II: RSTL, subunidades estéticas, nervios en riesgo (temporal, marginal)', referente: 'Cotofana',
    ...
    atlasUrl: ANIM3D, dermatoscopiaImg: DSA },
  { d: 40, fecha: '2026-12-28', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Biopsias (punch/shave/excisional) + anestesia local: lidocaína y dosis máximas', referente: null,
  ...
  { d: 41, fecha: '2026-12-30', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Suturas y cierre: instrumental, nudos, técnicas (Kantor + sus 91 vídeos)', referente: null,
  ...
  { d: 42, fecha: '2027-01-05', bloque: B.G, bKey: 'G', tier: 'MED', sub: 'Colgajos e injertos: avance, rotación, romboidal, bilobulado', referente: null,
  ...
  { d: 43, fecha: '2027-01-07', bloque: B.G, bKey: 'G', tier: 'ALTA', sub: 'Mohs + control de márgenes: indicaciones (área H) y lógica', referente: null,
  ...
  { d: 44, fecha: '2027-01-11', bloque: B.G, bKey: 'G', tier: 'CRIT', sub: 'Cicatrización + complicaciones quirúrgicas y su manejo (ciencia CORE surgical)', referente: null,
  ...
  { d: 45, fecha: '2027-01-13', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 1: mapa de fallos por módulo CORE (med/ped/surg/path) desde el ledger → qué re-drillear en FSRS', referente: null,
  ...
  { d: 46, fecha: '2027-01-15', bloque: B.H, bKey: 'H', tier: 'ALTA', sub: 'Checkpoint 2: re-drill de fallos etiquetados + pares del DD Challenge de tus áreas flojas + drill oclusión vascular 90 s', referente: null,
  ...
  { d: 47, fecha: '2027-01-19', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Anatomía facial 3D: 5 capas, SMAS, compartimentos grasos, ligamentos de retención', referente: 'Cotofana',
    ...
    atlasUrl: ANIM3D, dermatoscopiaImg: DSA },
  { d: 48, fecha: '2027-01-21', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Arterias peligrosas + zonas seguras: glabela, nariz, temple, surco nasogeniano (no errar)', referente: 'Cotofana',
  ...
  { d: 49, fecha: '2027-01-25', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Envejecimiento estructural (hueso → grasa → ligamento → piel) + análisis facial: tercios, MD ASA', referente: 'de Maio',
  ...
  { d: 50, fecha: '2027-01-27', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Toxina I: mecanismo (clivaje de SNAP-25), serotipos, unidades NO intercambiables entre marcas', referente: 'Carruthers',
  ...
  { d: 51, fecha: '2027-01-29', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina II: tercio superior (frontal, glabela, patas de gallo) — músculos, dosis, cómo evitar la ptosis', referente: 'Carruthers',
  ...
  { d: 52, fecha: '2027-02-02', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Toxina III: tercio inferior, Nefertiti, masetero, hiperhidrosis', referente: 'Carruthers',
  ...
  { d: 53, fecha: '2027-02-04', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Toxina IV: complicaciones y manejo — ptosis (apraclonidina), asimetrías, difusión (seguridad primero)', referente: 'Carruthers',
    ...
    atlasUrl: `${DN}/topics/botulinum-toxin`, dermatoscopiaImg: DSA },
  { d: 54, fecha: '2027-02-08', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: "Rellenos I: reología del HA (G', cohesividad) + bioestimuladores (CaHA/PLLA)", referente: 'de Maio',
  ...
  { d: 55, fecha: '2027-02-10', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos II: planos de inyección, aguja vs cánula, técnicas por región', referente: 'de Maio',
  ...
  { d: 56, fecha: '2027-02-12', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos III: MD Codes fundación (Ck, T, Tt) + myomodulation', referente: 'de Maio',
  ...
  { d: 57, fecha: '2027-02-16', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'El paciente agudo con fiebre y rash: meningococemia, endocarditis, necrotizantes (trasladado desde d19 por el swap de seguridad de fillers)', referente: null,
  ...
  { d: 58, fecha: '2027-02-18', bloque: B.C, bKey: 'C', tier: 'MED', sub: 'Pelo y uñas infecciosos (tiña capitis, onicomicosis) + repaso del módulo (trasladado desde d20)', referente: null,
  ...
  { d: 59, fecha: '2027-02-22', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Rellenos IV: consideraciones étnicas y de género + fat transfer', referente: 'de Maio',
  ...
  { d: 60, fecha: '2027-02-24', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Peelings I: profundidad (superficial/medio/profundo), agentes (glicólico, salicílico, TCA, fenol), frosting', referente: 'Baumann',
  ...
  { d: 61, fecha: '2027-02-26', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Peelings II: por fototipo (IV–VI), prevención de PIH, complicaciones (conecta con L4/L5 research)', referente: 'Baumann',
  ...
  { d: 62, fecha: '2027-03-02', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Láser I: fototermólisis selectiva (Anderson-Parrish) — cromóforo → λ → duración de pulso → enfriamiento (la MISMA física del CORE surgical)', referente: 'Anderson',
  ...
  { d: 63, fecha: '2027-03-04', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Láser II: lesiones vasculares (PDL) + pigmento y tatuajes (Q-switched/pico)', referente: 'Anderson',
  ...
  { d: 64, fecha: '2027-03-08', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Láser III: resurfacing fraccional (ablativo/no-ablativo) + radiofrecuencia + tightening', referente: 'Manstein/Anderson',
  ...
  { d: 65, fecha: '2027-03-10', bloque: B.X, bKey: 'X', tier: 'CRIT', sub: 'Láser IV: seguridad en fototipos IV–VI — parámetros, PIH, depilación en piel étnica (no errar)', referente: 'Anderson',
    ...
    atlasUrl: `${DN}/topics/ethnic-dermatology`, dermatoscopiaImg: DSA, puenteResearch: PR_L5(SR2_NOTA) },
  { d: 66, fecha: '2027-03-12', bloque: B.X, bKey: 'X', tier: 'MED', sub: 'Contorno corporal (criolipólisis, HIFU) + escleroterapia básica (ambos en el temario CORE surgical)', referente: null,
  ...
  { d: 67, fecha: '2027-03-16', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Microneedling + PRP + skinboosters: evidencia y técnica', referente: 'Baumann',
  ...
  { d: 68, fecha: '2027-03-18', bloque: B.X, bKey: 'X', tier: 'ALTA', sub: 'Ciencia cosmecéutica: Baumann Skin Typing, retinoides tópicos, antioxidantes, fotoprotección (protocolo Nítida)', referente: 'Baumann',
  ...
  { d: 69, fecha: '2027-03-22', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 1: segunda pasada FSRS — SOLO casos y preguntas fallados del ledger, por módulo CORE más flojo', referente: null,
    ...
    atlasUrl: IMG_LIB, dermatoscopiaImg: DSA },
  { d: 70, fecha: '2027-03-24', bloque: B.Z, bKey: 'Z', tier: 'MED', sub: 'REPASO 2: mapa final de debilidades + plan del ciclo siguiente (post-Step 1: 5 casos/sesión con los 60 casos restantes)', referente: null,
