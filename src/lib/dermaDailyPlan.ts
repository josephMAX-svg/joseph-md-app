...
export const DERMA_DIAS: DiaDerma[] = [
  ...
  { d: 49, fecha: '2027-02-04', bloque: B.H, bKey: 'H', tier: 'MED', sub: 'TAPER Step 1 · Segunda pasada parcial III — DÍA DEL EXAMEN Step 1 (jue 4-feb; sesión OPCIONAL: 1 caso ciego + 5′ FSRS; si se salta no se pierde nada, los fallos siguen en la cola)', referente: null,
    ...
    morfologia: 'Repaso', sitio: 'Difuso', ddx: ['Sesión opcional: el examen Step 1 dura ~8 h (jue 4-feb); Derma solo si queda energía real por la tarde', 'Si se hace: 1 caso ciego + FSRS de las tarjetas vencidas (5′) y cerrar', 'Nada se recorta: el ciclo sigue el jue 4-feb con d50 (cicatrización, cierre del módulo G)'],
