 ...
 *
 * v5.16 (26-sep-2026): D1 = LUN 28-sep-2026 → D95 = mié 10-feb-2027 · Step 1 = BLOQUE PRINCIPAL (6h15/día L-V):
 *  05:00 ANKI AM · 07:15 repaso anclado · 08:15 PRE-TEST 10Q · 09:00-11:00 DEEP PRIME · 11:00 30Q · 18:00 eval examen.
 *  Sáb y dom LIBRES (skip 25-dic, 31-dic, 1-ene). Examen target jue 11-feb-2027 (v5.16; ventana original 25-29 ene superada). Los diaInicio apuntan
 *  al plan de 95 días de usmleStep1Daily.ts (fuente de verdad): Fase A D1-81 · B D82-86 · C D87-95.
 *  El D1 (lun 28-sep) es el UWSA1 baseline (vie 11 → lun 14 → mar 15 → mié 16 → jue 17 → lun 21 → mié 23 → lun 28-sep); el contenido arranca el mar 29-sep (D2).
 *  v5.16 (misma regla que v5.15): CORRIMIENTO RÍGIDO — los 12 hitos corren con el plan y conservan su D#, así ningún NBME pierde días de contenido.
 *  Examen: D95 = mié 10-feb = D-1 REAL (el examen es al día siguiente, sin finde en medio) → target JUE 11-FEB-2027; Prometric por agendar/reprogramar.
 *
...
export const PLAN_META = {
  inicio: '2026-09-28', // v5.16 (26-sep): D1=lun 28-sep (UWSA1 baseline) · Step 1 = bloque PRINCIPAL (6h15/día L-V) · sáb y dom libres · examen target jue 11-feb-2027 (D95 mié 10-feb = D-1 real)
  ...
  nota: 'Prioridad Step 1 (v5.16 · corrimiento rígido: los hitos corren con el plan). D1 = lun 28-sep = UWSA1 baseline (movido del mié 23-sep) · D2 mar 29-sep Fundamentos/Pathoma · D6 Cardiovascular (lun 5-oct). Fase A contenido D1-81 · Fase B banco D82-86 · Fase C sprint D87-95 (D95 = mié 10-feb-2027 = D-1 real · examen target jue 11-feb).',
};
...
export interface SistemaUSMLE {
  ...
  uworldQ: number;
  tier: 'CORE' | 'HIGH' | 'MED';
  diaInicio: number; // día del plan en que empieza (Día 1 = lun 28-sep-2026 = UWSA1 · v5.16; lo regenera update_diainicio.js desde usmleStep1Daily.ts)
...
export const SISTEMAS: SistemaUSMLE[] = [
  ...
  {
    sistema: 'Gastrointestinal', uworldQ: 263, tier: 'CORE', diaInicio: 30,
  ...
  {
    sistema: 'Endocrine', uworldQ: 199, tier: 'CORE', diaInicio: 37,
  ...
  {
    sistema: 'Reproductive', uworldQ: 169, tier: 'HIGH', diaInicio: 66,
  ...
  {
    sistema: 'Immunology', uworldQ: 108, tier: 'HIGH', diaInicio: 4,
  ...
  {
    sistema: 'Biochemistry', uworldQ: 159, tier: 'MED', diaInicio: 80,
...
export const UNIDADES: UnidadDia[] = [
  { dia: 1, fecha: '2026-09-28', sistema: 'Cardiovascular', foco: 'Anatomía + Fisiología cardíaca (la base de todo cardio)', bbVideo: { titulo: 'B&B Step 1 · 01 - Cardiac Anatomy', min: 15 }, uworld: 'uWorld · Cardiovascular → Normal structure & function (pre-test 2-3Q)', sketchy: 'Sketchy Anatomy → Heart (Chambers / Coronary circulation)', palmerton: { titulo: 'Palmerton · Cómo los 260+ dominan el cardio', id: 'TYe-wrDuFqg' }, flash: 'uWorld Step 1 FlashCards → Cardiovascular (mazo del día)' },
  { dia: 2, fecha: '2026-09-29', sistema: 'Cardiovascular', foco: 'Fisiología cardíaca II (PV loops, Wiggers, Starling)', bbVideo: { titulo: 'B&B Step 1 · 02 - Cardiac Physiology', min: 27 }, uworld: 'uWorld · Cardiovascular → Normal structure & function (10Q)', flash: 'FlashCards → Cardiovascular' },
  { dia: 3, fecha: '2026-09-30', sistema: 'Cardiovascular', foco: 'Hemodinámica + regulación de la PA', bbVideo: { titulo: 'B&B Step 1 · 04-05 Blood Flow / BP Regulation', min: 32 }, uworld: 'uWorld · Cardiovascular → Hypertension (10Q)', flash: 'FlashCards → Cardiovascular' },
  { dia: 4, fecha: '2026-10-01', sistema: 'Cardiovascular', foco: 'Cardiopatía isquémica (atero → SCA)', bbVideo: { titulo: 'B&B Step 1 · Cardiac Ischemia (01-06)', min: 64 }, uworld: 'uWorld · Cardiovascular → Coronary heart disease (10Q)', palmerton: { titulo: 'Palmerton · High Yield Cardiology', id: 'hOGhcie47nM' }, flash: 'FlashCards → Cardiovascular' },
  { dia: 5, fecha: '2026-10-02', sistema: 'Cardiovascular', foco: 'Arritmias (potenciales de acción → taqui/bradi)', bbVideo: { titulo: 'B&B Step 1 · Arrhythmias (01-08)', min: 90 }, uworld: 'uWorld · Cardiovascular → Cardiac arrhythmias (10Q)', flash: 'FlashCards → Cardiovascular' },
];
